...
public class HandlerListeArticleViewSupportAbon extends LgrAbstractHandler {
	
	static Logger logger = Logger.getLogger(HandlerListeArticleViewSupportAbon.class.getName());
