...
public class HandlerFamilleUnite extends LgrAbstractHandler {
	
	static Logger logger = Logger.getLogger(HandlerFamilleUnite.class.getName());
	...
	public Object execute(ExecutionEvent event) throws ExecutionException {
		...
		try {
			IEditorPart editor = EJBLgrEditorPart.verifEditeurOuvert(EditorFamilleUnite.ID);
			if(editor==null){
			IEditorPart e = PlatformUI.getWorkbench().getActiveWorkbenchWindow().
			getActivePage().openEditor(new EditorInputFamille(), EditorFamilleUnite.ID);
