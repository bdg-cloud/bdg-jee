 ...
 */
public class PaFamilleTiers extends fr.legrain.lib.gui.DefaultFrameFormulaireSWT {
	...
	public static void showGUI() {
		...
		PaFamilleTiers inst = new PaFamilleTiers(shell, SWT.NULL);
	...
	public PaFamilleTiers(org.eclipse.swt.widgets.Composite parent, int style) {
		super(parent, style);
		initGUI();
	}
