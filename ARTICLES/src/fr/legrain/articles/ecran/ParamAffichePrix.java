...
public class ParamAffichePrix extends ParamAffiche {
	public static final String C_TITRE_FORMULAIRE = "Fiche tarif";
	public static final String C_TITRE_GRILLE = "Liste des tarifs";
	public static final String C_SOUS_TITRE = "Gestion des tarifs";
	private JComponent focusDefaut = null;
	private String idArticle = null;
	private Control focusDefautSWT = null;

	public ParamAffichePrix() {
