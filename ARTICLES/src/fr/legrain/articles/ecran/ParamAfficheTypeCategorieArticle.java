...
public class ParamAfficheTypeCategorieArticle extends ParamAffiche {
	public static final String C_TITRE_FORMULAIRE = "Fiche categorie";
	public static final String C_TITRE_GRILLE = "Liste des categories";
	public static final String C_SOUS_TITRE = "Gestion des categories";
	private JComponent focusDefaut = null;
	private String idArticle = null;
	private Control focusDefautSWT = null;

	public ParamAfficheTypeCategorieArticle() {
