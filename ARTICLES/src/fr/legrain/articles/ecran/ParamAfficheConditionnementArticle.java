...
public class ParamAfficheConditionnementArticle extends ParamAffiche {
	public static final String C_TITRE_FORMULAIRE = "Fiche conditionnement";
	public static final String C_TITRE_GRILLE = "Liste des conditionnements";
	public static final String C_SOUS_TITRE = "Gestion des conditionnements";

	private String idArticle = null;
	private Control focusDefautSWT = null;

	public ParamAfficheConditionnementArticle() {
