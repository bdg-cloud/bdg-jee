...
public class PaTypeArticleSWT extends fr.legrain.lib.gui.DefaultFrameFormulaireSWT {
	...
	private ControlDecoration fieldTypeSupport;
	private ControlDecoration fieldTypeAbonnement;
	private ControlDecoration fieldArticleAbonnement;
	...
	*/
		...
		try {
			{
				...
				}
				{
					...
					//if(!decore) {
						...
						fieldTypeSupport = new ControlDecoration(tfTypeSupport, SWT.TOP | SWT.RIGHT);
					//} else {					
				...
				}
				{
					...
					//if(!decore) {
						...
						fieldTypeAbonnement = new ControlDecoration(tfTypeAbonnement, SWT.TOP | SWT.RIGHT);
					//} else {					
				...
				}
				{
					...
					//if(!decore) {
						...
						fieldArticleAbonnement = new ControlDecoration(tfArticleAbonnement, SWT.TOP | SWT.RIGHT);
					//} else {					
	...
	public ControlDecoration getFieldTypeSupport() {
		return fieldTypeSupport;
	}

	public ControlDecoration getFieldTypeAbonnement() {
		return fieldTypeAbonnement;
	}

	public ControlDecoration getFieldArticleAbonnement() {
