...
public class ParamAfficheRapportUnite extends ParamAffiche {
	public static final String C_TITRE_FORMULAIRE = "Fiche rapport entre unités";
	public static final String C_TITRE_GRILLE = "Liste des rapports entre unités";
	public static final String C_SOUS_TITRE = "Gestion des rapports entre unités";
	private JComponent focusDefaut = null;
	private String idArticle = null;
	private Control focusDefautSWT = null;

	public ParamAfficheRapportUnite() {
