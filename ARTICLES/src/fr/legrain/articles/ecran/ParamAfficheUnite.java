...
public class ParamAfficheUnite extends ParamAffiche {
	private String titreFormulaire = "Fiche unité";
	private String titreGrille = "liste des unités";
	private String sousTitre = "Liste des unités";
