...
public class ParamAfficheTypeConditionnement extends ParamAffiche {
	public static final String C_TITRE_FORMULAIRE = "Fiche type de conditionnement";
	public static final String C_TITRE_GRILLE = "Liste des types de conditionnements";
	public static final String C_SOUS_TITRE = "Gestion des types de conditionnements";

	private String idArticle = null;
	private Control focusDefautSWT = null;

	public ParamAfficheTypeConditionnement() {
