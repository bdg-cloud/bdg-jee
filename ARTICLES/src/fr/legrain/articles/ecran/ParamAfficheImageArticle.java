...
public class ParamAfficheImageArticle extends ParamAffiche {
	public static final String C_TITRE_FORMULAIRE = "Fiche image";
	public static final String C_TITRE_GRILLE = "Liste des images";
	public static final String C_SOUS_TITRE = "Gestion des images";
	private JComponent focusDefaut = null;
	private String idArticle = null;
	private Control focusDefautSWT = null;

	public ParamAfficheImageArticle() {
