...
public class ParamAfficheActionArticle extends ParamAffiche {
	public static final String C_TITRE_FORMULAIRE = "Actions";
	public static final String C_TITRE_GRILLE = "Actions";
	public static final String C_SOUS_TITRE = "Actions";
	private JComponent focusDefaut = null;
	private String idArticle = null;
	private Control focusDefautSWT = null;

	public ParamAfficheActionArticle() {
