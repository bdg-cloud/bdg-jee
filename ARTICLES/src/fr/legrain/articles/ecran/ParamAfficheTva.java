...
public class ParamAfficheTva extends ParamAffiche {
	private String titreFormulaire = "Fiche code tva";
	private String titreGrille = "liste des codes tva";
	private String sousTitre = "Liste des codes tva";
