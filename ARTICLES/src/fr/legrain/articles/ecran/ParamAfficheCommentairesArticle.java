...
public class ParamAfficheCommentairesArticle extends ParamAffiche {
	public static final String C_TITRE_FORMULAIRE = "Fiche commentaire";
	public static final String C_TITRE_GRILLE = "Commentaire";
	public static final String C_SOUS_TITRE = "Commentaire";
	private JComponent focusDefaut = null;
	private String idArticle = null;
	private Control focusDefautSWT = null;

	public ParamAfficheCommentairesArticle() {
