...
public class PaLabelSWT extends fr.legrain.lib.gui.DefaultFrameFormulaireSWT {
	...
	private ControlDecoration fieldLabel;
...
//					if(!decore) {
						...
						fieldLabel = new ControlDecoration(tfLabel, SWT.TOP | SWT.RIGHT);
//					} else {					
//					fieldLabel = new ControlDecoration(paCorpsFormulaire, SWT.BORDER, new TextControlCreator());
...
//							tfLIBL_COMMENTAIRE, tfCODE_BANQUE, tfEntite, composite3 });
	...
	public ControlDecoration getFieldLabel() {
		return fieldLabel;
	}
