...
public class ParamAfficheTypeLabelArticle extends ParamAffiche {
	public static final String C_TITRE_FORMULAIRE = "Fiche label";
	public static final String C_TITRE_GRILLE = "Liste des labels";
	public static final String C_SOUS_TITRE = "Gestion des labels";
	private JComponent focusDefaut = null;
	private String idArticle = null;
	private Control focusDefautSWT = null;

	public ParamAfficheTypeLabelArticle() {
