...
public class ParamAfficheCatalogueWeb extends ParamAffiche {
	public static final String C_TITRE_FORMULAIRE = "Fiche infos web";
	public static final String C_TITRE_GRILLE = "Liste des infos web";
	public static final String C_SOUS_TITRE = "Gestion des infos web";
	private JComponent focusDefaut = null;
	private String idArticle = null;
	private Control focusDefautSWT = null;

	public ParamAfficheCatalogueWeb() {
