...
public class FichierDonneesArticle implements fr.legrain.lib.data.IFichierDonnees<TaArticle>{
	
	static Logger logger = Logger.getLogger(FichierDonneesArticle.class.getName());
