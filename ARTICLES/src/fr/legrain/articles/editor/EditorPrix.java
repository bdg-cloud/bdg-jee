...
public class EditorPrix extends EJBLgrEditorPart implements ILgrEditor, ILgrRetourEditeur {
	
	static Logger logger = Logger.getLogger(EditorPrix.class.getName());
	
	public static final String ID = "fr.legrain.articles.editor.EditorPrix";
	
	private boolean enabled = true;
	private PaPrixSWT composite = null;
	...
	public EditorPrix(EditorPart parent) {
		super(parent);
	}
	
	public EditorPrix(EditorPart parent,EntityManager em) {
		super(parent);
		this.em=em;
	}
...
//	}
	...
	public void createPartControl(Composite parent) {
		composite = new PaPrixSWT(parent,SWT.NONE);
		if(getController()==null) {
			setController(new SWTPaPrixController(composite,em));
		} else {
