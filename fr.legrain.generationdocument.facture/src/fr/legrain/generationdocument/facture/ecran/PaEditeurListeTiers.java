...
public class PaEditeurListeTiers extends org.eclipse.swt.widgets.Composite {
	...
	*/
		...
		try {
			...
			}
			{
				...
				}
				{
					...
					laNbFactureLData.widthHint = 86;
					laNbFactureLData.heightHint = 13;
				...
				}
				{
					...
					button1LData1.horizontalAlignment = GridData.CENTER;
				...
				}
				{
					...
					cbLData.heightHint = 16;
					cbLData.horizontalAlignment = GridData.FILL;
					getCbPrint = new Button(composite1, SWT.CHECK | SWT.LEFT);
					getCbPrint.setLayoutData(cbLData);
					getCbPrint.setText("Imprimer direct");
					getCbPrint.setSelection(false);
				}
			}
			{
	...
	public void setCbPrint(Button getCbPrint) {
		this.getCbPrint = getCbPrint;
	}
