...
public class ParamAfficheReportStocks extends ParamAffiche {
	public static final String C_TITRE_FORMULAIRE = "Report de stock CRD";
	public static final String C_TITRE_GRILLE = "Liste des Reports de stock CRD";
	public static final String C_SOUS_TITRE = "Liste des Reports de stock CRD";
	
	
	public ParamAfficheReportStocks() {
