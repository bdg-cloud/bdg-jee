...
*/
public class PaEtatStocksPeriode extends org.eclipse.swt.widgets.Composite {
...
//	private DecoratedField fieldUN2_STOCK;
	...
	*/
	public static void showGUI() {
		...
		PaEtatStocksPeriode inst = new PaEtatStocksPeriode(shell, SWT.NULL);
	...
	public PaEtatStocksPeriode(org.eclipse.swt.widgets.Composite parent, int style) {
		super(parent, style);
		initGUI();
	}
...
//					tfDATEFIN.setPattern("dd/MM/yyyy");
				}
			{
				...
				laCODE_ARTICLE.setText("Code CRD");
			}
