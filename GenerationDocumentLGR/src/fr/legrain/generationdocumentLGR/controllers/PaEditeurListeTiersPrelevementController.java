...
////import fr.legrain.document.divers.Impression;
...
//import fr.legrain.prelevement.divers.Impression;
...
//
//
//public class PaEditeurListeTiersPrelevementController extends JPABaseControllerSWTStandard implements
//RetourEcranListener {
//	
//	static Logger logger = Logger.getLogger(PaEditeurListeTiersPrelevementController.class.getName());		
//	private PaEditeurListeTiers vue = null; // vue
//	private TaTiersDAO dao = null;//new TaTiersDAO();
//	private TaWlgrDAO wlgrDao = null;//new TaWlgrDAO();
...
//	private Impression impressionGeneration = null ;
...
//	
//	public PaEditeurListeTiersPrelevementController(PaEditeurListeTiers vue) {
//		this(vue,null);
//	}
//
//	public PaEditeurListeTiersPrelevementController(PaEditeurListeTiers vue,EntityManager em) {
//		try{
//			vue.setCursor(Display.getCurrent().getSystemCursor(SWT.CURSOR_WAIT));
//		if(em!=null) {
//			setEm(em);
//		}else
//			setEm(new TaWlgrDAO().getEntityManager());
//		dao = new TaTiersDAO(getEm());
//		wlgrDao = new TaWlgrDAO(getEm());
//		try {
//			setVue(vue);
//
//			this.vue=vue;
//			vue.getShell().addShellListener(this);
//			impressionFacture= new fr.legrain.prelevement.divers.Impression(vue.getShell());
//			impressionGeneration= new Impression(vue.getShell());
...
//		TaWlgrDAO taWlgrDAO = new TaWlgrDAO(getEm());
//		String[] valeurs = null;
//		List<TaWlgr> l = taWlgrDAO.selectAllClientNonTraiteAPrelever();
...
//	}
//	
//	public PaEditeurListeTiersPrelevementController getThis(){
//		return this;
//	}
//	
//	@Override
...
//			genereDocument.setCommentaire(prelevementPlugin.getDefault().getPreferenceStore().getString(PreferenceConstants.COMMENTAIRE));
...
//							document= (TaPrelevement) genereDocument.generePrelevementLGR(getEm());
//							TaWlgr taWlgr = wlgrDao.findByCode(this.codeTiers);
...
//						if(document!=null){
//							String dif="";
//							if(document.getNetTtcCalc().compareTo(taWlgr.getTtc_du())!=0)
//								dif=" ("+LibConversion.bigDecimalToString(document.getNetTtcCalc().subtract(taWlgr.getTtc_du()))+")";
//							message+="tiers : "+codeTiers+" - Doc : "+document.getCodeDocument()+
//							" bdg : "+document.getNetTtcCalc()+" Wlgr : "+taWlgr.getTtc_du()+dif+finDeLigne;
...
//			MessageDialog.openWarning(Workbench.getInstance()
//					.getActiveWorkbenchWindow().getShell(),
//					"Attention", "Vous n'avez pas renseigné correctement le libellé du document ou le(s) client(s) !!!");
//		}
//
//		actRefresh();	
//	}
...
//		vue.getLaSumWlgr().setText(LibConversion.bigDecimalToString(wlgrDao.selectSommeRestantePrelevement())+" € à venir");
//		vue.getTfLibelle().setText("Prélèvement maintenance 2013");
...
//					String idEditor = PrelevementMultiPageEditor.ID_EDITOR;
...
//				final List<TaPrelevement> finalIdFactureAImprimer = idFactureAImprimer;
...
//							impressionFacture.imprimerChoix(ConstEdition.FICHE_FILE_REPORT_PRELEVEMENT,"Prelevement",
//									finalIdFactureAImprimer,TaPrelevement.class.getSimpleName(),
//									preview,flagPrint);
...
//				LgrPartListener.getLgrPartListener().setLgrActivePart(null);
//
//				List<TaPrelevement> idFactureAImprimer = new ArrayList<TaPrelevement>();
//				final boolean preview = vue.getCbReExport().getSelection();
//				final boolean flagPrint = vue.getCbPrint().getSelection();
//
//				String codeDeb = null;
...
//							impressionGeneration.imprimerChoix(ConstEdition.FICHE_FILE_REPORT_PRELEVEMENT,"Prelevement",
//									finalIdFactureAImprimer,TaPrelevement.class.getSimpleName(),
//									preview,flagPrint);
//							ConstEdition constEdition = new ConstEdition(); 
//							constEdition.setFlagEditionMultiple(true);
...
//		TaWlgrDAO taWlgrDAO = new TaWlgrDAO(getEm());
//		String[][] valeurs = null;
//		List<TaWlgr> l = taWlgrDAO.selectAll();
...
//		vue.getLaNbFacture().setText(LibConversion.integerToString(nbFactures)+" document(s)");
//	}
//}
//
