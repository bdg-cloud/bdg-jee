...
public class EditorEditeurListeTiers extends LgrEditorPart implements ILgrEditor, ILgrRetourEditeur {
	
	static Logger logger = Logger.getLogger(EditorEditeurListeTiers.class.getName());
									 
	public static final String ID = "fr.legrain.generationdocumentLGR.editor.EditorEditeurListeTiers";
	
	private boolean enabled = true;
	private PaEditeurListeTiers composite = null;
	private EntityManager em = null;

	public EditorEditeurListeTiers() {
		super();
	}
	
	public EditorEditeurListeTiers(EditorPart parent) {
		super(parent);
	}
	
	public EditorEditeurListeTiers(EditorPart parent,EntityManager em) {
		super(parent);
		this.em=em;
	}
...
//	}
	...
	public void createPartControl(Composite parent) {
		...
		if(getController()==null) {
			setController(new PaEditeurListeTiersController(composite,em));
		} else {
