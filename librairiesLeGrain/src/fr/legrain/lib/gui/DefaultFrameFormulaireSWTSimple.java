...
*/
public class DefaultFrameFormulaireSWTSimple extends org.eclipse.swt.widgets.Composite {
...
//	private Composite compositeForm;
	...
	*/
	public static void showGUI() {
		...
		DefaultFrameFormulaireSWTSimple inst = new DefaultFrameFormulaireSWTSimple(shell, SWT.FILL);
	...
	public DefaultFrameFormulaireSWTSimple(org.eclipse.swt.widgets.Composite parent, int style) {
		super(parent, style);
		initGUI();
	}
	
	public DefaultFrameFormulaireSWTSimple(org.eclipse.swt.widgets.Composite parent, int style, int ordreComposite) {
		super(parent, style);
	 ...
	 * @param tableStyle
	 */
	public DefaultFrameFormulaireSWTSimple(org.eclipse.swt.widgets.Composite parent, int style, int ordreComposite, int tableStyle) {
		super(parent, style);
		this.ordreComposite = ordreComposite;
