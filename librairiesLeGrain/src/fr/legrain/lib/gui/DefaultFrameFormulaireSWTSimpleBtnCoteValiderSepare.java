...
*/
public class DefaultFrameFormulaireSWTSimpleBtnCoteValiderSepare extends org.eclipse.swt.widgets.Composite {
...
//	private Composite compositeForm;
	...
	*/
	public static void showGUI() {
		...
		DefaultFrameFormulaireSWTSimpleBtnCoteValiderSepare inst = new DefaultFrameFormulaireSWTSimpleBtnCoteValiderSepare(shell, SWT.FILL);
	...
	public DefaultFrameFormulaireSWTSimpleBtnCoteValiderSepare(org.eclipse.swt.widgets.Composite parent, int style) {
		super(parent, style);
		initGUI();
	}
	
	public DefaultFrameFormulaireSWTSimpleBtnCoteValiderSepare(org.eclipse.swt.widgets.Composite parent, int style, int ordreComposite) {
		super(parent, style);
	 ...
	 * @param tableStyle
	 */
	public DefaultFrameFormulaireSWTSimpleBtnCoteValiderSepare(org.eclipse.swt.widgets.Composite parent, int style, int ordreComposite, int tableStyle) {
		super(parent, style);
		this.ordreComposite = ordreComposite;
...
//				}
				...
				}
				{
					...
					label1LData.widthHint = 51;
					label1LData.heightHint = 14;
					label1 = new Label(paBtn, SWT.NONE);
