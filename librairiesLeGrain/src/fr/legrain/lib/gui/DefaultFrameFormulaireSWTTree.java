...
*/
public class DefaultFrameFormulaireSWTTree extends org.eclipse.swt.widgets.Composite {
...
//	private Composite compositeForm;
	...
	*/
	public static void showGUI() {
		...
		DefaultFrameFormulaireSWTTree inst = new DefaultFrameFormulaireSWTTree(shell, SWT.FILL);
	...
	public DefaultFrameFormulaireSWTTree(org.eclipse.swt.widgets.Composite parent, int style) {
		super(parent, style);
		initGUI();
	}
	
	public DefaultFrameFormulaireSWTTree(org.eclipse.swt.widgets.Composite parent, int style, int ordreComposite) {
		super(parent, style);
	 ...
	 * @param tableStyle
	 */
	public DefaultFrameFormulaireSWTTree(org.eclipse.swt.widgets.Composite parent, int style, int ordreComposite, int tableStyle) {
		super(parent, style);
		this.ordreComposite = ordreComposite;
...
//				compositeForm.setLayoutData(compositeFormLData);
				...
				}
				{
					...
					paGrille.setLayoutData(compositeGrilleLData);
					{
						...
						laTitreGrille.setText("titre arbre");
					}
					{
