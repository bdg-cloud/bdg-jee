...
*/
public class DefaultFrameGrilleSansBouton_grilleReduite extends org.eclipse.swt.widgets.Composite {
	...
	*/
	...
	public DefaultFrameGrilleSansBouton_grilleReduite(org.eclipse.swt.widgets.Composite parent, int style) {
		super(parent, style);
		initGUI();
	}
	
	public DefaultFrameGrilleSansBouton_grilleReduite(org.eclipse.swt.widgets.Composite parent, int style, int ordreComposite) {
		super(parent, style);
	 ...
	 * @param tableStyle
	 */
	public DefaultFrameGrilleSansBouton_grilleReduite(org.eclipse.swt.widgets.Composite parent, int style, int ordreComposite, int tableStyle) {
		super(parent, style);
		this.ordreComposite = ordreComposite;
...
//									| SWT.CHECK);
			...
			if(ordreComposite == ORDRE_GRILLE_FORMULAIRE) {
				...
				compositeFormLData1.heightHint = 105;
