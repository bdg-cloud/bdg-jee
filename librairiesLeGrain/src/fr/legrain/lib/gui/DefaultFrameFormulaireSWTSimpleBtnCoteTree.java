...
*/
public class DefaultFrameFormulaireSWTSimpleBtnCoteTree extends org.eclipse.swt.widgets.Composite {
...
//	private Composite compositeForm;
	...
	*/
	public static void showGUI() {
		...
		DefaultFrameFormulaireSWTSimpleBtnCoteTree inst = new DefaultFrameFormulaireSWTSimpleBtnCoteTree(shell, SWT.FILL);
	...
	public DefaultFrameFormulaireSWTSimpleBtnCoteTree(org.eclipse.swt.widgets.Composite parent, int style) {
		super(parent, style);
		initGUI();
	}
	
	public DefaultFrameFormulaireSWTSimpleBtnCoteTree(org.eclipse.swt.widgets.Composite parent, int style, int ordreComposite) {
		super(parent, style);
	 ...
	 * @param tableStyle
	 */
	public DefaultFrameFormulaireSWTSimpleBtnCoteTree(org.eclipse.swt.widgets.Composite parent, int style, int ordreComposite, int tableStyle) {
		super(parent, style);
		this.ordreComposite = ordreComposite;
				...
				}
				{
					...
					}
					{
						if(tableStyle==SWT.NULL) {
							tree = new Tree(paGrille, SWT.SINGLE
									| SWT.FULL_SELECTION
									| SWT.H_SCROLL
									| SWT.V_SCROLL
									| SWT.BORDER);
//									| SWT.CHECK);
							...
							tree = new Tree(paGrille, tableStyle);
						}
						...
						tree.setLayoutData(grilleLData);
