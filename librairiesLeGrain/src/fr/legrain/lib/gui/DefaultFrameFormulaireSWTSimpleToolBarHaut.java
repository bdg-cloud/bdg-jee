...
*/
public class DefaultFrameFormulaireSWTSimpleToolBarHaut extends org.eclipse.swt.widgets.Composite {
...
//	private Composite compositeForm;
	...
	private int weightDefautForm = 50;
	private int weightDefautGrille = 50;
	...
	*/
	...
	public DefaultFrameFormulaireSWTSimpleToolBarHaut(org.eclipse.swt.widgets.Composite parent, int style) {
		super(parent, style);
		initGUI();
	}
	
	public DefaultFrameFormulaireSWTSimpleToolBarHaut(org.eclipse.swt.widgets.Composite parent, int style, int ordreComposite) {
		super(parent, style);
	 ...
	 * @param tableStyle
	 */
	public DefaultFrameFormulaireSWTSimpleToolBarHaut(org.eclipse.swt.widgets.Composite parent, int style, int ordreComposite, int tableStyle) {
		super(parent, style);
		this.ordreComposite = ordreComposite;
		...
		try {
			...
			}
			{
				...
				compositeForm = new SashForm(this, SWT.BORDER);
				{
					...
					compositeFormulaireLData.grabExcessHorizontalSpace = true;
	...
	public int getOrdreComposite() {
		return ordreComposite;
	}

	public void setOrdreComposite(int ordreComposite) {
		this.ordreComposite = ordreComposite;
	}
