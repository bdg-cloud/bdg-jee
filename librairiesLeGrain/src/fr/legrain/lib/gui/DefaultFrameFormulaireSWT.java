...
*/
public class DefaultFrameFormulaireSWT extends org.eclipse.swt.widgets.Composite {
...
//	private Composite compositeForm;
	...
	*/
	...
	public DefaultFrameFormulaireSWT(org.eclipse.swt.widgets.Composite parent, int style) {
		super(parent, style);
		initGUI();
	}
	
	public DefaultFrameFormulaireSWT(org.eclipse.swt.widgets.Composite parent, int style, int ordreComposite) {
		super(parent, style);
	 ...
	 * @param tableStyle
	 */
	public DefaultFrameFormulaireSWT(org.eclipse.swt.widgets.Composite parent, int style, int ordreComposite, int tableStyle) {
		super(parent, style);
		this.ordreComposite = ordreComposite;
