...
public class EJBCtrlInterface implements IValidator {

	static Logger logger = Logger.getLogger(EJBCtrlInterface.class.getName());
	...
	public EJBCtrlInterface(EJBBaseController ibTable,String nomChamp) {
...
//		if(nomChamp.equals("codeDocument")) {
//			System.out.println("EJBCtrlInterface.validate()");
//		}
		...
		if(s==null || s.getSeverity()==IStatus.ERROR) {
			...
			System.err.println("Erreur de validation sur le champ "+nomChamp+" avec la valeur "+value);
