...
public class EJBLookup<I> extends EJBLookupName {
	...
	public static final String EJB_NAME_CTRL_APPLICATION  = "JPACtrl_Application";
	...
	public static final String EJB_NAME_TA_MODELE_CONFORMITE_SERVICE = "TaModeleConformiteService";
	...
	public static final String EJB_NAME_TA_DOCUMENT_EDITABLE_SERVICE = "TaDocumentEditableService";
	...
	public static final String EJB_NAME_TA_APPORTEUR_SERVICE = "TaApporteurService";
	public static final String EJB_NAME_TA_L_APPORTEUR_SERVICE = "TaLApporteurService";
	public static final String EJB_NAME_TA_INFOS_APPORTEUR_SERVICE = "TaInfosApporteurService";
	 
	public static final String EJB_NAME_TA_AVOIR_SERVICE = "TaAvoirService";
	public static final String EJB_NAME_TA_L_AVOIR_SERVICE = "TaLAvoirService";
	public static final String EJB_NAME_TA_INFOS_AVOIR_SERVICE = "TaInfosAvoirService";
	 
	public static final String EJB_NAME_TA_BONCDE_SERVICE = "TaBoncdeService";
	public static final String EJB_NAME_TA_L_BONCDE_SERVICE = "TaLBoncdeService";
	public static final String EJB_NAME_TA_INFOS_BONCDE_SERVICE = "TaInfosBoncdeService";
	 
	public static final String EJB_NAME_TA_BONLIV_SERVICE = "TaBonlivService";
	public static final String EJB_NAME_TA_L_BONLIV_SERVICE = "TaLBonlivService";
	public static final String EJB_NAME_TA_INFOS_BONLIV_SERVICE = "TaInfosBonlivService";
	 
	public static final String EJB_NAME_TA_PROFORMA_SERVICE = "TaProformaService";
	public static final String EJB_NAME_TA_L_PROFORMA_SERVICE = "TaLProformaService";
	public static final String EJB_NAME_TA_INFOS_PROFORMA_SERVICE = "TaInfosProformaService";
	
	public static final String EJB_NAME_TA_ACOMPTE_SERVICE = "TaAcompteService";
	public static final String EJB_NAME_TA_L_ACOMPTE_SERVICE = "TaLAcompteService";
	public static final String EJB_NAME_TA_INFOS_ACOMPTE_SERVICE = "TaInfosAcompteService";
	
	public static final String EJB_NAME_TA_PRELEVEMENT_SERVICE = "TaPrelevementService";
	public static final String EJB_NAME_TA_L_PRELEVEMENT_SERVICE = "TaLPrelevementService";
	public static final String EJB_NAME_TA_INFOS_PRELEVEMENT_SERVICE = "TaInfosPrelevementService";
	
	public static final String EJB_NAME_TA_AVIS_ECHEANCE_SERVICE = "TaAvisEcheanceService";
	public static final String EJB_NAME_TA_L_AVIS_ECHEANCE_SERVICE = "TaLAvisEcheanceService";
	public static final String EJB_NAME_TA_INFOS_AVIS_ECHEANCE_SERVICE = "TaInfosAvisEcheanceService";
	
	public static final String EJB_NAME_TA_REGLEMENT_SERVICE = "TaReglementService";
	public static final String EJB_NAME_TA_REMISE_SERVICE = "TaRemiseService";
	
	public static final String EJB_NAME_TA_ETAT_SERVICE = "TaEtatService";
	...
	public static final String EJB_NAME_TA_GROUPE_SERVICE = "TaGroupeService";
	public static final String EJB_NAME_TA_MODELE_GROUPE_SERVICE = "TaModeleGroupeService";
	public static final String EJB_NAME_TA_TYPE_CONFORMITE_SERVICE = "TaTypeConformiteService";
	
	public static final String EJB_NAME_TA_R_REGLEMENT_SERVICE = "TaRReglementService";
	public static final String EJB_NAME_TA_R_AVOIR_SERVICE = "TaRAvoirService";
	public static final String EJB_NAME_TA_R_ACOMPTE_SERVICE = "TaRAcompteService";
	public static final String EJB_NAME_TA_R_DOCUMENT_SERVICE = "TaRDocumentService";
