...
public class Impression implements IImpressionDocumentTiers {
	...
	public void imprimerSelection(int idDoc,final String codeDoc,boolean preview,String fileEditionDefaut,String namePlugin, String nomEntity){
		...
		reportParam.put(ConstEditionAvoir.PARAM_CHOIX_DEST,choix);
		
		String typeAdresseCorrespondance = avoirPLugin.getDefault().getPreferenceStore().
											getString(PreferenceConstants.TYPE_ADRESSE_CORRESPONDANCE);
...
//		constEdition.prepartionEditionBirt();
		...
		try {
			if(!affiche){
				...
				ConstEdition.CONTENT_COMMENTS =ConstEditionAvoir.COMMENTAIRE_EDITION_DEFAUT;
...
//				constEdition.addValues(idSWTTiers,oneIDSWTTiers);
				...
				constEdition.setPARAM_ID_TABLE(ConstEditionAvoir.PARAM_ID_AVOIR);
				constEdition.paramId = ConstEditionAvoir.PARAM_ID_AVOIR;
