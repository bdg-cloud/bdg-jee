...
public class PreferenceInitializer extends AbstractPreferenceInitializer {
	...
	public static void initDefautProperties(){
		try {
			IPreferenceStore storeProgramme = avoirPLugin.getDefault().getPreferenceStore_Old();
			...
			store.setDefault(PreferenceConstants.P_PATH_EDITION_DEFAUT,ConstEdition.FICHE_FILE_REPORT_AVOIR);		
