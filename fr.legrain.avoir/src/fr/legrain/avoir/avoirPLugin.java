 ...
 */
public class avoirPLugin extends AbstractUIPlugin {
	static Logger logger = Logger.getLogger(avoirPLugin.class.getName());	
	// The plug-in ID
	public static final String PLUGIN_ID = "Avoir";

	// The shared instance
	private static avoirPLugin plugin;
	 ...
	 */
	public static avoirPLugin getDefault() {
		return plugin;
	}
