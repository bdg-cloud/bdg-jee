...
public class EditorTotaux extends JPALgrEditorPart implements ILgrEditor, ILgrRetourEditeur {
	...
	public static final String ID = "fr.legrain.editor.avoir.EditorTotaux";
	
	private boolean enabled = true;
	private PaTotauxAvoir composite = null;
	...
	public void createPartControl(Composite parent) {
		composite = new PaTotauxAvoir(parent,SWT.NONE);
		if(getController()==null) {
			setController(new PaEditorAvoirTotauxController(composite,em));
		} else {
	...
	public PaTotauxAvoir getComposite() {
		return composite;
	}
