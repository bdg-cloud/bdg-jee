...
public class EditorLigne extends JPALgrEditorPart implements ILgrEditor, ILgrRetourEditeur {
	...
	public static final String ID = "fr.legrain.editor.avoir.EditorLigne";
	
	private boolean enabled = true;
	private PaSaisieLignesAvoir composite = null;
	...
	public void createPartControl(Composite parent) {
		composite = new PaSaisieLignesAvoir(parent,SWT.NONE);
		if(getController()==null) {
			setController(new PaLigneAvoirController(composite,em));
		} else {
	...
	public PaSaisieLignesAvoir getComposite() {
		return composite;
	}
