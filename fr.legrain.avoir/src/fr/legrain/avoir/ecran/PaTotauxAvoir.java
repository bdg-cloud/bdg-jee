 ...
 */
public class PaTotauxAvoir extends org.eclipse.swt.widgets.Composite {
	private Table tableTVA;
	private Composite paTotaux;
	private Label laTX_REM_HT_AVOIR;
	private Text tfCODE_T_PAIEMENT;
	private Label laCODE_T_PAIEMENT;
	private Text tfREGLE_AVOIR;
	private Label laREGLE_AVOIR;
	...
	private Text tfTX_REM_TTC_AVOIR;
	private Label laTX_REM_TTC_AVOIR;
	private Text tfTX_REM_HT_AVOIR;

	private DecoratedField fieldMT_TTC_CALC;
	private DecoratedField fieldTTC;
	private DecoratedField fieldTX_REM_TTC_AVOIR;
	private DecoratedField fieldMT_HT_CALC;
	private DecoratedField fieldTX_REM_HT_AVOIR;
	private DecoratedField fieldREGLE_AVOIR;
...
//	final private boolean decore = false;
	...
	public static void showGUI() {
		...
		PaTotauxAvoir inst = new PaTotauxAvoir(shell, SWT.NULL);
	...
	public PaTotauxAvoir(org.eclipse.swt.widgets.Composite parent, int style) {
		super(parent, style);
		initGUI();
	}
	...
	private void initGUI() {
		try {
			...
			}
			{
				...
				{
					laTX_REM_HT_AVOIR = new Label(paTotaux, SWT.NONE);
					laTX_REM_HT_AVOIR.setText("Remise globale %");
				}
				{
					GridData tfTX_REM_HT_AVOIRLData = new GridData();
					tfTX_REM_HT_AVOIRLData.widthHint = 127;
					if(!decore) {
						tfTX_REM_HT_AVOIR = new Text(paTotaux, SWT.BORDER);
						tfTX_REM_HT_AVOIR.setLayoutData(tfTX_REM_HT_AVOIRLData);
						tfTX_REM_HT_AVOIR.setText("TX_REM_HT_AVOIR");
					} else {
						fieldTX_REM_HT_AVOIR = new DecoratedField(paTotaux, SWT.BORDER, new TextControlCreator());
						tfTX_REM_HT_AVOIR = (Text)fieldTX_REM_HT_AVOIR.getControl();
						fieldTX_REM_HT_AVOIR.getLayoutControl().setLayoutData(tfTX_REM_HT_AVOIRLData);
					}
				}
				{
					laTX_REM_TTC_AVOIR = new Label(paTotaux, SWT.NONE);
					laTX_REM_TTC_AVOIR.setText("Escompte accordé %");
				}
				{
					GridData tfTX_REM_TTC_AVOIRLData = new GridData();
					tfTX_REM_TTC_AVOIRLData.horizontalSpan = 3;
					tfTX_REM_TTC_AVOIRLData.widthHint = 125;
					if(!decore) {
						tfTX_REM_TTC_AVOIR = new Text(paTotaux, SWT.BORDER);
						tfTX_REM_TTC_AVOIR.setLayoutData(tfTX_REM_TTC_AVOIRLData);
						tfTX_REM_TTC_AVOIR.setText("TX_REM_TTC_AVOIR");
					} else {
						fieldTX_REM_TTC_AVOIR = new DecoratedField(paTotaux, SWT.BORDER, new TextControlCreator());
						tfTX_REM_TTC_AVOIR = (Text)fieldTX_REM_TTC_AVOIR.getControl();
						fieldTX_REM_TTC_AVOIR.getLayoutControl().setLayoutData(tfTX_REM_TTC_AVOIRLData);
					}
				}
				{
				...
				{
					laREGLE_AVOIR = new Label(paTotaux, SWT.NONE);
					laREGLE_AVOIR.setText("Montant Affecté");
				}
				{
					GridData tfREGLE_AVOIRLData = new GridData();
					tfREGLE_AVOIRLData.widthHint = 125;
					if(!decore) {
						tfREGLE_AVOIR = new Text(paTotaux, SWT.BORDER);
						tfREGLE_AVOIR.setLayoutData(tfREGLE_AVOIRLData);
						tfREGLE_AVOIR.setText("REGLE_AVOIR");
					} else {
						fieldREGLE_AVOIR = new DecoratedField(paTotaux, SWT.BORDER, new TextControlCreator());
						tfREGLE_AVOIR = (Text)fieldREGLE_AVOIR.getControl();
						fieldREGLE_AVOIR.getLayoutControl().setLayoutData(tfREGLE_AVOIRLData);
					}
				}
				{
...
//	}
	...
	public Label getLaTX_REM_HT_AVOIR() {
		return laTX_REM_HT_AVOIR;
	}
	...
	public Text getTfREGLE_AVOIR() {
		return tfREGLE_AVOIR;
	}

	public Label getLaREGLE_AVOIR() {
		return laREGLE_AVOIR;
	}
	...
	public Text getTfTX_REM_TTC_AVOIR() {
		return tfTX_REM_TTC_AVOIR;
	}

	public Label getLaTX_REM_TTC_AVOIR() {
		return laTX_REM_TTC_AVOIR;
	}

	public Text getTfTX_REM_HT_AVOIR() {
		return tfTX_REM_HT_AVOIR;
	}
	...
	public DecoratedField getFieldTX_REM_TTC_AVOIR() {
		return fieldTX_REM_TTC_AVOIR;
	}
	...
	public DecoratedField getFieldTX_REM_HT_AVOIR() {
		return fieldTX_REM_HT_AVOIR;
	}

	public DecoratedField getFieldREGLE_AVOIR() {
		return fieldREGLE_AVOIR;
	}
