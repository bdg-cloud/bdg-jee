...
public class LgrDatabindingUtilEJB {
	
	static Logger logger = Logger.getLogger(LgrDatabindingUtilEJB.class.getName());
	
	private Map<Table,LgrTableViewer> mapLgrTableViewer = null;
	
	public LgrDatabindingUtilEJB() {}
	
	public LgrDatabindingUtilEJB(EJBBaseControllerSWTStandard controllerPourValidation) {
