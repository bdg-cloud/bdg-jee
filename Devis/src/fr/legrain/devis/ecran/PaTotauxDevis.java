 ...
 */
public class PaTotauxDevis extends org.eclipse.swt.widgets.Composite {
	private Table tableTVA;
	private Composite paTotaux;
	private Label laTX_REM_HT_DEVIS;
	...
	private Text tfTX_REM_TTC_DEVIS;
	private Label laTX_REM_TTC_DEVIS;
	private Text tfTX_REM_HT_DEVIS;

	private ControlDecoration fieldMT_TTC_CALC;
	private ControlDecoration fieldTTC;
	private ControlDecoration fieldTX_REM_TTC_DEVIS;
	private ControlDecoration fieldMT_HT_CALC;
	private ControlDecoration fieldTX_REM_HT_DEVIS;
	private ControlDecoration fieldREGLE_DOCUMENT;
...
//	final private boolean decore = false;
	...
	public static void showGUI() {
		...
		PaTotauxDevis inst = new PaTotauxDevis(shell, SWT.NULL);
	...
	public PaTotauxDevis(org.eclipse.swt.widgets.Composite parent, int style) {
		super(parent, style);
		initGUI();
	}
	...
	private void initGUI() {
		try {
			...
			}
			{
				...
				{
					laTX_REM_HT_DEVIS = new Label(paTotaux, SWT.NONE);
					laTX_REM_HT_DEVIS.setText("Remise globale %");
				}
				{
					GridData tfTX_REM_HT_FACTURELData = new GridData();
					tfTX_REM_HT_FACTURELData.widthHint = 127;
//					if(!decore) {
						tfTX_REM_HT_DEVIS = new Text(paTotaux, SWT.BORDER);
						tfTX_REM_HT_DEVIS.setLayoutData(tfTX_REM_HT_FACTURELData);
						tfTX_REM_HT_DEVIS.setText("TX_REM_HT_DEVIS");
						fieldTX_REM_HT_DEVIS = new ControlDecoration(tfTX_REM_HT_DEVIS, SWT.TOP | SWT.RIGHT);
//					} else {
//						fieldTX_REM_HT_DEVIS = new ControlDecoration(paTotaux, SWT.BORDER, new TextControlCreator());
//						tfTX_REM_HT_DEVIS = (Text)fieldTX_REM_HT_DEVIS.getControl();
//						fieldTX_REM_HT_DEVIS.getLayoutControl().setLayoutData(tfTX_REM_HT_FACTURELData);
//					}
				}
				{
					laTX_REM_TTC_DEVIS = new Label(paTotaux, SWT.NONE);
					laTX_REM_TTC_DEVIS.setText("Escompte accordé %");
				}
				{
...
//					if(!decore) {
						tfTX_REM_TTC_DEVIS = new Text(paTotaux, SWT.BORDER);
						tfTX_REM_TTC_DEVIS.setLayoutData(tfTX_REM_TTC_FACTURELData);
						tfTX_REM_TTC_DEVIS.setText("TX_REM_TTC_DEVIS");
						fieldTX_REM_TTC_DEVIS = new ControlDecoration(tfTX_REM_TTC_DEVIS, SWT.TOP | SWT.RIGHT);
//					} else {
//						fieldTX_REM_TTC_DEVIS = new ControlDecoration(paTotaux, SWT.BORDER, new TextControlCreator());
//						tfTX_REM_TTC_DEVIS = (Text)fieldTX_REM_TTC_DEVIS.getControl();
//						fieldTX_REM_TTC_DEVIS.getLayoutControl().setLayoutData(tfTX_REM_TTC_FACTURELData);
//					}
				}
				{
...
//					if(!decore) {
						...
						fieldMT_HT_CALC = new ControlDecoration(tfMT_HT_CALC, SWT.TOP | SWT.RIGHT);
//					} else {
//						fieldMT_HT_CALC = new ControlDecoration(paTotaux, SWT.BORDER, new TextControlCreator());
...
//					if(!decore) {
						...
						fieldMT_TTC_CALC = new ControlDecoration(tfMT_TTC_CALC, SWT.TOP | SWT.RIGHT);
//					} else {
//						fieldMT_TTC_CALC = new ControlDecoration(paTotaux, SWT.BORDER, new TextControlCreator());
...
//					if(!decore) {
						...
						fieldImprimer = new ControlDecoration(cbImprimer, SWT.TOP | SWT.RIGHT);
//					} else {
//						fieldImprimer = new ControlDecoration(paTotaux, SWT.CHECK | SWT.LEFT, new ButtonControlCreator());
...
//					if(!decore) {
						...
						fieldMT_TVA_CALC = new ControlDecoration(tfMT_TVA_CALC, SWT.TOP | SWT.RIGHT);
//					} else {
//						fieldMT_TVA_CALC = new ControlDecoration(paTotaux, SWT.BORDER, new TextControlCreator());
...
//					if(!decore) {
						...
						tfREGLE_DOCUMENT.setText("REGLE_FACTURE");
						fieldREGLE_DOCUMENT = new ControlDecoration(tfREGLE_DOCUMENT, SWT.TOP | SWT.RIGHT);
//					} else {
//						fieldREGLE_DOCUMENT = new ControlDecoration(paTotaux, SWT.BORDER, new TextControlCreator());
...
//					}
				...
				}
				{
					...
					tfCODE_T_PAIEMENTLData.widthHint = 28;
					tfCODE_T_PAIEMENTLData.heightHint = 13;
//					if(!decore) {
...
//					} else {
//						fieldCODE_T_PAIEMENT = new ControlDecoration(paTotaux, SWT.BORDER, new TextControlCreator());
...
//				} else {
//					fieldTX_REM_HT_FACTURE = new ControlDecoration(paTotaux, SWT.BORDER, new TextControlCreator());
...
//				} else {
//					fieldTX_REM_TTC_FACTURE = new ControlDecoration(paTotaux, SWT.BORDER, new TextControlCreator());
...
//				} else {
//					fieldREGLE_FACTURE = new ControlDecoration(paTotaux, SWT.BORDER, new TextControlCreator());
...
//	}
	...
	public Label getLaTX_REM_HT_DEVIS() {
		return laTX_REM_HT_DEVIS;
	}
...
//	public Text getTfREGLE_DEVIS() {
//		return tfREGLE_DEVIS;
//	}
//
//	public Label getLaREGLE_DEVIS() {
//		return laREGLE_DEVIS;
//	}
	...
	public Text getTfTX_REM_TTC_DEVIS() {
		return tfTX_REM_TTC_DEVIS;
	}

	public Label getLaTX_REM_TTC_DEVIS() {
		return laTX_REM_TTC_DEVIS;
	}

	public Text getTfTX_REM_HT_DEVIS() {
		return tfTX_REM_HT_DEVIS;
	}
	...
	public ControlDecoration getFieldTX_REM_TTC_DEVIS() {
		return fieldTX_REM_TTC_DEVIS;
	}
	...
	public ControlDecoration getFieldTX_REM_HT_DEVIS() {
		return fieldTX_REM_HT_DEVIS;
	}

//	public ControlDecoration getFieldREGLE_DEVIS() {
//		return fieldREGLE_DEVIS;
//	}
	...
	public ControlDecoration getFieldREGLE_DOCUMENT() {
