...
public class EditorTotaux extends EJBLgrEditorPart implements ILgrEditor, ILgrRetourEditeur {
	...
	public static final String ID = "fr.legrain.editor.devis.EditorTotaux";
	
	private boolean enabled = true;
	private PaTotauxDevis composite = null;
	...
	public void createPartControl(Composite parent) {
		composite = new PaTotauxDevis(parent,SWT.NONE);
		if(getController()==null) {
			setController(new PaEditorTotauxDevisController(composite,em));
		} else {
//			getController().setEm(em);
	...
	public PaTotauxDevis getComposite() {
		return composite;
	}
