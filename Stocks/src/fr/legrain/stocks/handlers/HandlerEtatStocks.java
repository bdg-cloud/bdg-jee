...
import fr.legrain.stocks.divers.ParamImpressionStocks;
import fr.legrain.stocks.ecran.PaEtatStocks;


public class HandlerEtatStocks extends LgrAbstractHandler {
	
	static Logger logger = Logger.getLogger(HandlerEtatStocks.class.getName());
