...
public class ParamAfficheStocks extends ParamAffiche {
	public static final String C_TITRE_FORMULAIRE = "Mouvement de stocks";
	public static final String C_TITRE_GRILLE = "liste des Mouvements de stocks";
	public static final String C_SOUS_TITRE = "Liste des Mouvements de stocks";
