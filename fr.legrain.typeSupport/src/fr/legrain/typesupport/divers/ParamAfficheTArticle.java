package fr.legrain.typesupport.divers;
...
public class ParamAfficheTArticle extends ParamAffiche {
	public static final String C_TITRE_FORMULAIRE = "Fiche type support";
	public static final String C_TITRE_GRILLE = "Liste des types support";
	public static final String C_SOUS_TITRE = "Gestion des types support";
	private JComponent focusDefaut = null;
	private String idArticle = null;
	private Control focusDefautSWT = null;

	public ParamAfficheTArticle() {
