package fr.legrain.tiers.statistiques;
...
public class Activator extends AbstractUIPlugin {
	...
	// The plug-in ID
	public static final String PLUGIN_ID = "fr.legrain.tiers.statistiques";
	...
	private void registerImage(ImageRegistry registry, String key,
		...
		try {
			...
			IPath path = new Path("icons_test/" + fileName); //$NON-NLS-1$
			URL url = find(path);
			if (url!=null) {
