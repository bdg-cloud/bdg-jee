 ...
 *
 */
public class RepartitionControllerDevis extends RepartitionControllerMini{
	static Logger logger = Logger.getLogger(RepartitionControllerDevis.class.getName());	
	...
	public RepartitionControllerDevis(FormPageControllerPrincipal masterContoller,
	...
	public void initialiseModelIHM() {
		...
		if (Outils.isInternetReachable()){	// Connexion internet active
			...
			List<Object> listeRegions = taDepartementsDAO.chiffreDocParRegions("TaDevis",
			...
			mapChart.setLabel("Montant des Devis");
			...
			" carte des devis requiert une connexion internet active.");
		}
