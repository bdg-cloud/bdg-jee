package fr.legrain.prelevement.exportation.ecrans.presentationBanque;
 ...
 */
public class PaCriterePrelevementPresentation extends org.eclipse.swt.widgets.Composite {
	...
	private Button prelevExport; //prelevement exporté
	private Button prelevNonExport; //prelevemenet non exporté
	private Button prelevTous;
...
//	final private boolean decore = false;
	...
	public static void showGUI() {
		...
		PaCriterePrelevementPresentation inst = new PaCriterePrelevementPresentation(shell, SWT.NULL);
	...
	public PaCriterePrelevementPresentation(org.eclipse.swt.widgets.Composite parent, int style) {
		super(parent, style);
		initGUI();
	}
...
//				}
				{
					prelevExport = new Button(groupParam, SWT.RADIO | SWT.CENTER);
...
//					prelevExportLData.horizontalAlignment = GridData.END;
				...
				{
					prelevNonExport = new Button(groupParam, SWT.RADIO | SWT.CENTER);
...
//					prelevNonExportLData.horizontalAlignment = GridData.END;
				...
				{
					prelevTous = new Button(groupParam, SWT.RADIO | SWT.LEFT);
					GridData rdExportLData = new GridData();
					prelevTous.setLayoutData(rdExportLData);
					prelevTous.setText("Tous");
				}
				{
...
//					btnValiderParamLData.verticalAlignment = GridData.FILL;
			...
			}
			{
				...
				groupFactureNonRegle.setText("Sélection des prélèvements à présenter à la banque");
...
/*	public Button getBtnListeDoc() {
	...
	public Button getPrelevExport() {
		return prelevExport;
	}

	public Button getPrelevNonExport() {
		return prelevNonExport;
	}
	
	public Button getRdExport() {
		return prelevTous;
	}

	public Button getPrelevTous() {
		return prelevTous;
	}
