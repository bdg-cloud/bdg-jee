...
*/
public class PaSelectionLignePresentation extends fr.legrain.lib.gui.DefaultFrameFormulaireSWTSimpleBtnCote {
...
//	final private boolean decore = false;
	...
	*/
	public static void showGUI() {
		...
		PaSelectionLignePresentation inst = new PaSelectionLignePresentation(shell, SWT.NULL);
	...
	public PaSelectionLignePresentation(Composite parent, int style,
			int ordreComposite, int tableStyle) {
		super(parent, style, ordreComposite, tableStyle);
		initGUI();
	}

	public PaSelectionLignePresentation(org.eclipse.swt.widgets.Composite parent, int style) {
		super(parent, style);
		initGUI();
	}
...
//			GridData compositeFormLData = new GridData();
			...
			GridData paBtnLData2 = new GridData();
			paBtnLData2.verticalAlignment = GridData.BEGINNING;
			super.getCompositeForm().setLayoutData(compositeFormLData);
			super.getPaBtn().setLayoutData(paBtnLData2);
