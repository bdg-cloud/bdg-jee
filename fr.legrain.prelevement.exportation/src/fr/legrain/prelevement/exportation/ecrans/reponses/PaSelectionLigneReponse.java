...
*/
public class PaSelectionLigneReponse extends fr.legrain.lib.gui.DefaultFrameFormulaireSWTSimpleBtnCote {
...
//	final private boolean decore = false;
	...
	*/
	public static void showGUI() {
		...
		PaSelectionLigneReponse inst = new PaSelectionLigneReponse(shell, SWT.NULL);
	...
	public PaSelectionLigneReponse(Composite parent, int style,
			int ordreComposite, int tableStyle) {
		super(parent, style, ordreComposite, tableStyle);
		initGUI();
	}

	public PaSelectionLigneReponse(org.eclipse.swt.widgets.Composite parent, int style) {
		super(parent, style);
		initGUI();
	}
