...
import fr.legrain.prelevement.exportation.divers.iso.std.iso._20022.tech.xsd.pain_008_001_02.*;
...
//	    PaymentTypeInformation20 pti = new PaymentTypeInformation20();
	    ServiceLevel8Choice slc = new ServiceLevel8Choice();
	    slc.setCd("SEPA");
//	    slc.setPrtry("SEPA");
	    pmtTpInf.setSvcLvl(slc);
	    
	    LocalInstrument2Choice lic = new LocalInstrument2Choice();
	    lic.setCd("CORE");
//	    lic.setPrtry("SEPA");
	    pmtTpInf.setLclInstrm(lic);
	    
	    
//	    paymentGroup.setPmtTpInf(pti);
	    // Set group type
...
//		prvtId.getOthr().addAll(0, othrId.getSchmeNm().getPrtry());
