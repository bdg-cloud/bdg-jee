 ...
 * Commit 8c6d852fdfee8e5c644cf673edf6bedc7ec7c40d
 */
PrimeFaces.widget.TabView = PrimeFaces.widget.DeferredWidget.extend({
    ...
    */
    /*Legrain : http://stackoverflow.com/questions/26472265/scroll-to-the-selected-tab-if-the-selected-tab-is-hidden-in-ptabview-on-intial */
    initScrolling: function() {
        if(this.jq.is(':visible')) {
