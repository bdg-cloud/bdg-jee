...
import fr.legrain.bdg.webapp.stocks.MouvementStockController;
...
public class ArticleLotEntrepotDTOMouvementStockConverter implements Converter, Serializable {
	
	@Inject @Named(value="mouvementStockController")
	private MouvementStockController mouvementStockControllerConverter;
    ...
    public Object getAsObject(FacesContext context, UIComponent component, String submittedValue) {
    	...
    	if (submittedValue!=null && submittedValue.trim().equals("")) {  
    		...
    		try {  
    			...
    			if(submittedValue!=null && mouvementStockControllerConverter.getListArticleLotEntrepot()!=null) {
    			
	    			//return taArticleService.findByCode(submittedValue);
	    			ArticleLotEntrepotDTO a = null;
	    			for(ArticleLotEntrepotDTO l : mouvementStockControllerConverter.getListArticleLotEntrepot()) {
...
//    			e.printStackTrace();
	...
	public MouvementStockController getmouvementStockControllerConverter() {
		return mouvementStockControllerConverter;
	}

	public void setmouvementStockControllerConverter(
			MouvementStockController mouvementStockControllerConverter) {
		this.mouvementStockControllerConverter = mouvementStockControllerConverter;
	}
