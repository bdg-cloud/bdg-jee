...
@FacesConverter(forClass=TaTTiers.class)
//@FacesConverter(value="taTTiersConverter")
//http://stackoverflow.com/questions/13156671/how-can-i-inject-in-facesconverter
//@Named
//@SessionScoped
public class TaTTiersConverter implements Converter, Serializable {
	
	@EJB ITaTTiersServiceRemote  taTTiersService;
    ...
    public String getAsString(FacesContext context, UIComponent component, Object valueToRender) {
    	if (valueToRender == null || valueToRender.equals("")) {  
        	...
        	return String.valueOf(((TaTTiers) valueToRender).getCodeTTiers());
        }  
    }
    ...
    public Object getAsObject(FacesContext context, UIComponent component, String submittedValue) {
    	...
    	if (submittedValue!=null && submittedValue.trim().equals("")) {  
    		...
    		try {  
    			...
    			taTTiersService = new EJBLookup<ITaTTiersServiceRemote>().doLookup(new InitialContext(),EJBLookup.EJB_NAME_TA_T_TIERS_SERVICE, ITaTTiersServiceRemote.class.getName());

    			return taTTiersService.findByCode(submittedValue);
