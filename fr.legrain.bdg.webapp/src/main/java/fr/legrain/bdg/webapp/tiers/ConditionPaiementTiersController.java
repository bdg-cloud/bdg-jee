...
@Named
@ViewScoped  
public class ConditionPaiementTiersController implements Serializable {  
	 ...
	 */
	private boolean conditionPaiementDocument = false;
	...
	public ConditionPaiementTiersController() {  
	}  
