...
public class GuestPreferences implements Serializable {
	...
	private String topbar = "topbar.xhtml";
	private String layoutmenu = "layoutmenu.xhtml";
	private String footer = "footer.xhtml";
	
	//private String mode = "mirage";
	private String mode = "icarus";
	private String themeWebXml = null;

    private String layoutPrimaryColor = "legrain"; //green

    private String componentTheme = "legrain"; //green
    
    private String menuTheme = "legrain"; //green
    
    private String menuColor = "dark"; //legrain
    
    private String selectedMenuColor;

    private boolean horizontalMenu;
    
    private boolean darkMode = false; //null

    private List<ComponentTheme> componentThemes = new ArrayList<ComponentTheme>();
    
    private Map<String, List<MenuTheme>> menuColors = new HashMap<String, List<MenuTheme>>();
    ...
    public void init() {        
        ...
        componentThemes.add(new ComponentTheme("Legrain", "legrain", "green.svg"));
        ...
        menuThemes.add(new MenuTheme("Legrain", "legrain", "green.svg"));
    ...
    public String getLayoutConfig() {
        ...
        if(menuTheme.equals("legrain")) {
        	sb.append("layout-menu-").append(menuColor);
        } else {
        	sb.append("layout-menu-").append(color); //original
        }
...
//    	componentTheme = "legrain";
    ...
    /* ***************************************************************************** */
    public void changerTheme(ActionEvent ae) {
    	if(mode.equals("icarus")) {
    		setMode("mirage");
    	} else if(mode.equals("mirage")) {
    		setMode("icarus");
    	}
    }
	...
	public void setMode(String mode) {
		this.mode = mode;
		if(mode.equals("icarus")) {
			template = "template_icarus.xhtml";
			topbar = "topbar_icarus.xhtml";
			layoutmenu = "layoutmenu_icarus.xhtml";
			footer = "footer_icarus.xhtml";
		} else { //mirage
			template = "template.xhtml";
			topbar = "topbar.xhtml";
			layoutmenu = "layoutmenu.xhtml";
			footer = "footer.xhtml";
		}
	}

	public String getThemeWebXml() {
		if(mode.equals("icarus")) {
			themeWebXml = "icarus-green";
		} else { //mirage
			themeWebXml = "mirage-"+getTheme();
		}
		return themeWebXml;
	}

	public void setThemeWebXml(String themeWebXml) {
		this.themeWebXml = themeWebXml;
	}
}