...
public class TaTiersConverter implements Converter, Serializable {
    ...
    public String getAsString(FacesContext context, UIComponent component, Object valueToRender) {
    	if (valueToRender == null || valueToRender.equals("")) {  
        	...
        	return String.valueOf(((TaTiers) valueToRender).getCodeTiers());
        }  
    }
    ...
    public Object getAsObject(FacesContext context, UIComponent component, String submittedValue) {
    	...
    	if (submittedValue!=null && submittedValue.trim().equals("")) {  
    		...
    		try {  
    			...
    			taTiersService = new EJBLookup<ITaTiersServiceRemote>().doLookup(new InitialContext(),EJBLookup.EJB_NAME_TA_TIERS_SERVICE, ITaTiersServiceRemote.class.getName(),true);

    			return taTiersService.findByCode(submittedValue);
