...
@FacesConverter(forClass=TaTypeConformite.class)
//@FacesConverter(value="taTTiersConverter")
//http://stackoverflow.com/questions/13156671/how-can-i-inject-in-facesconverter
//@Named
//@SessionScoped
public class TaTypeControleConverter implements Converter, Serializable {
	
	@EJB ITaTypeConformiteServiceRemote  taTypeConformiteService;
    ...
    public String getAsString(FacesContext context, UIComponent component, Object valueToRender) {
    	if (valueToRender == null || valueToRender.equals("")) {  
        	...
        	return String.valueOf(((TaTypeConformite) valueToRender).getCode());
        }  
    }
    ...
    public Object getAsObject(FacesContext context, UIComponent component, String submittedValue) {
    	...
    	if (submittedValue!=null && submittedValue.trim().equals("")) {  
    		...
    		try {  
    			...
    			taTypeConformiteService = new EJBLookup<ITaTypeConformiteServiceRemote>().doLookup(new InitialContext(),EJBLookup.EJB_NAME_TA_TYPE_CONFORMITE_SERVICE, ITaTypeConformiteServiceRemote.class.getName());

    			return taTypeConformiteService.findByCode(submittedValue);
