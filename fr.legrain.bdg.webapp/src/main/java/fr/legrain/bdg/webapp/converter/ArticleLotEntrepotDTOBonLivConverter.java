...
import fr.legrain.bdg.webapp.documents.BonLivraisonController;
...
public class ArticleLotEntrepotDTOBonLivConverter implements Converter, Serializable {
	
	@Inject @Named(value="bonLivraisonController")
	private BonLivraisonController controllerConverter;
...
//    			e.printStackTrace();
	...
	public BonLivraisonController getControllerConverter() {
		return controllerConverter;
	}

	public void setControllerConverter(BonLivraisonController controllerConverter) {
