...
import fr.legrain.bdg.webapp.documents.ApporteurController;
...
public class ArticleLotEntrepotDTOApporteurConverter implements Converter, Serializable {
	
	@Inject @Named(value="apporteurController")
	private ApporteurController controllerConverter;
...
//    			e.printStackTrace();
	...
	public ApporteurController getControllerConverter() {
		return controllerConverter;
	}

	public void setControllerConverter(ApporteurController controllerConverter) {
