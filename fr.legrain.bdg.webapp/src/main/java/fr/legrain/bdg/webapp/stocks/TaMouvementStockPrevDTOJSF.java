...
public class TaMouvementStockPrevDTOJSF  implements java.io.Serializable{

	private static final long serialVersionUID = 894328367072057512L;

	private MouvementStocksPrevDTO dto;
	...
	public TaMouvementStockPrevDTOJSF() {
		
	}

	
	// TODO gestion annulation ligne
	public TaMouvementStockPrevDTOJSF copy(TaMouvementStockPrevDTOJSF i) {
		TaMouvementStockPrevDTOJSF ihm = (TaMouvementStockPrevDTOJSF) i;
		TaMouvementStockPrevDTOJSF a = new TaMouvementStockPrevDTOJSF();
		a.setDto(MouvementStocksPrevDTO.copy(ihm.dto));
	...
	public MouvementStocksPrevDTO getDto() {
		return dto;
	}

	public void setDto(MouvementStocksPrevDTO ligne) {
		this.dto = ligne;
	}
