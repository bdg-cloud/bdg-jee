...
@Named
@ViewScoped  
public class PrestashopController extends AbstractController implements Serializable{
	...
	@EJB private ITaPrestashopServiceWebExterneServiceRemote prestashopService;
	...
	public void postConstruct(){
		try {
			serviceWeb = serviceWebExterneService.findByCode("PRESTASHOP");
...
//				dto.setMontantHt(montantHt);
    ...
    public void actEnregistrer() {  	
		...
		FacesContext context = FacesContext.getCurrentInstance();
				...
				paramTmp.setLibelle("Lignes de commande Prestashop séléctionnées");
		if(selectedNodesLignesDTOJSF != null && selectedNodesLignesDTOJSF.length>0) {
...
//		String libelle="Reprise de ";
    ...
    public void onRowSelectLignePrestashopAll(SelectEvent event){
    	System.out.println("onRowSelectLignePrestashopAll a etait cliquéééé");
    }
    public void onRowUnSelectLignePrestashopAll(UnselectEvent event){
    	System.out.println("onRowUnSelectLignePrestashopAll a etait cliquéééé");
    }
    public void onToggleSelectLignePrestashopAll(ToggleSelectEvent event){
    	System.out.println("onToggleSelectLignePrestashopAll a etait cliquéééé");
    }
...
//		}
	...
	public void actImporter(ActionEvent actionEvent) {
		Integer nbLignes;
		try {
			nbLignes = prestashopService.getOrdersREST();
			
			FacesContext context = FacesContext.getCurrentInstance();  
			context.addMessage(null, new FacesMessage(FacesMessage.SEVERITY_INFO, "Import des lignes depuis les fichiers terminé : ", nbLignes+" ligne(s) importée(s)" ));
		} catch ( Exception e) {
			FacesContext context = FacesContext.getCurrentInstance();  
			context.addMessage(null, new FacesMessage(FacesMessage.SEVERITY_WARN, "Attention, Il y a eu une ou plusieurs erreurs pendant l'importation des lignes  : ", e.getMessage() ));
			e.printStackTrace();
		}
		refresh();
	}
...
//				}
	...
	public TaLigneServiceWebExterne getSelectedlignePrestashop() {
		return selectedligneServiceWebExterne;
	}


	public void setSelectedlignePrestashop(TaLigneServiceWebExterne selectedligneServiceWebExterne) {
