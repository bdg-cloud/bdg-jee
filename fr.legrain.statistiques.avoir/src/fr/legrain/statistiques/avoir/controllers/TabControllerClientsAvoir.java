 ...
 *
 */
public class TabControllerClientsAvoir extends TabControllerClients {

	public TabControllerClientsAvoir(
	...
	public void initialiseModelIHM(int nbResult) {
		...
		super.listeClients = taAvoirDAO.findMeilleursClientsParCA(
