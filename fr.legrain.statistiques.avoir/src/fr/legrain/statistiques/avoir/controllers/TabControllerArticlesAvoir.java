 ...
 *
 */
public class TabControllerArticlesAvoir extends TabControllerArticles {

	public TabControllerArticlesAvoir(
	...
	public void initialiseModelIHM(int nbResult) {
		...
		super.listeArticles = taAvoirDAO.findMeilleursArticlesParCA(
