/**
 * PaFormPageAvoir.java						03/05/11
 * ( dernière revision : 19/04/11 )
 */

package fr.legrain.statistiques.avoir.ecrans;
...
public class PaFormPageAvoir extends PaFormPage {
	
	public static String id = "fr.legrain.statistiques.ecrans.PaFormPageOngletAvoir";
	public static String title = "Avoirs";
	
	public PaFormPageAvoir() {
		super(id, title);
	}

	public PaFormPageAvoir(FormEditor editor, String id, String title) {
	...
	public void createSections() {
		...
		sctnMontant.setText("Montant des Factures d'Avoir HT");
		sctnMontant.setLayoutData(new GridData(SWT.FILL,SWT.NONE,true,false,2,1));
		compositeSectionMontant.getInfolabel().setText("Montant des Factures d'avoir HT sur la période");
		
		/* Section documents */
		createSectionDoc(toolkit, form);
		sctnDocuments.setText("Transformation des Factures d'Avoir");
		compositeSectionDoc.getLblNew1().setText("Aucune Transformation pour les factures d'avoir.");
...
//		
		...
		sctnEvolutionDuChiffre.setText("Evolution des factures d'avoir sur la période");
		sctnEvolutionDuChiffre.setLayoutData(gd_evolution);
		
		/* Section Repartition */
		createSectionRepartition(toolkit, form);
		sctnRepartition.setText("Répartition des factures d'avoir sur la période");
		
		/* Section Tableaux */
		createSectionTableauGauche(toolkit, form);
		createSectionTableauDroit(toolkit, form);
		sctnTableauGauche.setText("Tiers classés par montant d'avoirs");
		sctnTableauDroit.setText("Articles classés par montant dans les avoirs");
