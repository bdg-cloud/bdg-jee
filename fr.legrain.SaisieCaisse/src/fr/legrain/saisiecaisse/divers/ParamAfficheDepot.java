...
public class ParamAfficheDepot extends ParamAffiche {
	public static final String C_TITRE_FORMULAIRE = "Fiche dépôt";
	public static final String C_TITRE_GRILLE = "Liste des dépôts";
	public static final String C_SOUS_TITRE = "Gestion des dépôts";
	public String idEtablissement = null;
	
	public ParamAfficheDepot() {
