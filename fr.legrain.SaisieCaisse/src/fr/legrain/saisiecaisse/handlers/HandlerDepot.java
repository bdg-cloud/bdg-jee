...
public class HandlerDepot extends LgrAbstractHandler {
	
	static Logger logger = Logger.getLogger(HandlerDepot.class.getName());
	...
	public Object execute(ExecutionEvent event) throws ExecutionException {
		try {
			...
			openEditor(new EditorInputDepot(), EditorDepot.ID);
