...
/**
 * <p>Classe Java pour taAcompte complex type.
 * 
 * <p>Le fragment de schéma suivant indique le contenu attendu figurant dans cette classe.
 * 
 * <pre>
 * &lt;complexType name="taAcompte"&gt;
 *   &lt;complexContent&gt;
 ...
 *         &lt;element name="creeReglement" type="{http://www.w3.org/2001/XMLSchema}boolean"/&gt;
 ...
 *         &lt;element name="lignes" type="{http://service.bdg.legrain.fr/}taLAcompte" maxOccurs="unbounded" minOccurs="0"/&gt;
 ...
 *         &lt;element name="taInfosDocument" type="{http://service.bdg.legrain.fr/}taInfosAcompte" minOccurs="0"/&gt;
...
@XmlType(name = "taAcompte", propOrder = {
    "codeDocument",
    "commentaire",
    "creeReglement",
    "dateDocument",
...
public class TaAcompte
    extends SwtDocument
{

    protected String codeDocument;
    protected String commentaire;
    protected boolean creeReglement;
    ...
    protected List<TaLAcompte> lignes;
    @XmlElement(nillable = true)
    ...
    protected TaInfosAcompte taInfosDocument;
    ...
    /**
     * Obtient la valeur de la propriété creeReglement.
     * 
     */
    ...
    /**
     * Définit la valeur de la propriété creeReglement.
     * 
     */
    public void setCreeReglement(boolean value) {
        this.creeReglement = value;
    }
    ...
    public List<TaLAcompte> getLignes() {
        if (lignes == null) {
            lignes = new ArrayList<TaLAcompte>();
        }
        return this.lignes;
    }
     ...
     *     
     */
    public void setTaInfosDocument(TaInfosAcompte value) {
