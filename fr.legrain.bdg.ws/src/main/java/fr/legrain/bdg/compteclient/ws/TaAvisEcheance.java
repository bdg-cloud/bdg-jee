...
/**
 * <p>Classe Java pour taAvisEcheance complex type.
 * 
 * <p>Le fragment de schéma suivant indique le contenu attendu figurant dans cette classe.
 * 
 * <pre>
 * &lt;complexType name="taAvisEcheance"&gt;
 *   &lt;complexContent&gt;
 ...
 *         &lt;element name="lignes" type="{http://service.bdg.legrain.fr/}taLAvisEcheance" maxOccurs="unbounded" minOccurs="0"/&gt;
 ...
 *         &lt;element name="taInfosDocument" type="{http://service.bdg.legrain.fr/}taInfosAvisEcheance" minOccurs="0"/&gt;
...
@XmlType(name = "taAvisEcheance", propOrder = {
    "codeDocument",
    "commentaire",
    "dateDocument",
    "dateEchDocument",
    ...
    extends SwtDocument
{
    ...
    protected List<TaLAvisEcheance> lignes;
    @XmlElement(nillable = true)
    ...
    protected TaInfosAvisEcheance taInfosDocument;
     ...
     * {@link TaLAvisEcheance }
     * 
     * 
     */
    public List<TaLAvisEcheance> getLignes() {
        if (lignes == null) {
            lignes = new ArrayList<TaLAvisEcheance>();
        }
        return this.lignes;
    }
     ...
     *     
     */
    public void setTaInfosDocument(TaInfosAvisEcheance value) {
