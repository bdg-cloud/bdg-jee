...
/**
 * <p>Classe Java pour taFacture complex type.
 * 
 * <p>Le fragment de schéma suivant indique le contenu attendu figurant dans cette classe.
 * 
 * <pre>
 * &lt;complexType name="taFacture"&gt;
 *   &lt;complexContent&gt;
 ...
 *         &lt;element name="lignes" type="{http://service.bdg.legrain.fr/}taLFacture" maxOccurs="unbounded" minOccurs="0"/&gt;
 ...
 *         &lt;element name="taInfosDocument" type="{http://service.bdg.legrain.fr/}taInfosFacture" minOccurs="0"/&gt;
...
@XmlType(name = "taFacture", propOrder = {
    "acomptes",
    "codeDocument",
    "commentaire",
    "dateDocument",
    ...
    extends SwtDocument
{
    ...
    protected List<TaLFacture> lignes;
    @XmlElement(nillable = true)
    ...
    protected TaInfosFacture taInfosDocument;
    ...
    public List<TaLFacture> getLignes() {
        if (lignes == null) {
            lignes = new ArrayList<TaLFacture>();
        }
        return this.lignes;
    }
     ...
     *     
     */
    public void setTaInfosDocument(TaInfosFacture value) {
