...
*/
public class CompositePageImportCompta extends org.eclipse.swt.widgets.Composite {
	...
	*/
	public static void showGUI() {
		...
		CompositePageImportCompta inst = new CompositePageImportCompta(shell, SWT.NULL);
	...
	public CompositePageImportCompta(org.eclipse.swt.widgets.Composite parent, int style) {
		super(parent, style);
		initGUI();
	}
	...
	private void initGUI() {
		try {
			...
			this.setSize(444, 336);
			{
				...
				group2.setText("Initialisation des données de la liasse");
			...
			{
				cbEcraser = new Button(this, SWT.CHECK | SWT.LEFT);
				cbEcraser.setText("Ecraser les données dèjà existantes");
				cbEcraser.setSelection(true);
			}
			this.layout();
		} catch (Exception e) {
			e.printStackTrace();
