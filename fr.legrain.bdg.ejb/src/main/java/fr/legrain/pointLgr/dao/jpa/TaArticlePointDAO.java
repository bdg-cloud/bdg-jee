 ...
 */
public class TaArticlePointDAO implements IArticlePointDAO{
...
//	@Override
	...
	public TaArticlePoint findByArticle(Integer idArticle) {
		...
		try {
			...
			Query query = entityManager.createQuery("select count(a) from TaArticlePoint a join a.taArticle t where t.idArticle = :idArticle");
			query.setParameter("idArticle", idArticle);
			Long count= (Long) query.getSingleResult();
			if(count>0){
				query = entityManager.createQuery("select a from TaArticlePoint a join a.taArticle t where t.idArticle = :idArticle");
				query.setParameter("idArticle", idArticle);
