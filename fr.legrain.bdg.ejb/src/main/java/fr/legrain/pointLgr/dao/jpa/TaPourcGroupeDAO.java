...
import fr.legrain.point_Lgr.dao.IPourcGroupeDAO;
 ...
 */
public class TaPourcGroupeDAO implements IPourcGroupeDAO{
...
//	@Override
	...
	@Override
	public TaPourcGroupe findByCode(String code) {
		// TODO Auto-generated method stub
		return null;
	}

	@Override
	public List<TaPourcGroupe> findWithNamedQuery(String queryName) {
		try {
	...
	@Override
	public List<TaPourcGroupe> findWithJPQLQuery(String JPQLquery) {
		try {
	...
	@Override
	public boolean validate(TaPourcGroupe value) throws Exception {
		BeanValidator<TaPourcGroupe> validator = new BeanValidator<TaPourcGroupe>(TaPourcGroupe.class);
		return validator.validate(value);
	}

	@Override
	public boolean validateField(TaPourcGroupe value, String propertyName)
			throws Exception {
		BeanValidator<TaPourcGroupe> validator = new BeanValidator<TaPourcGroupe>(TaPourcGroupe.class);
	...
	@Override
	public void detach(TaPourcGroupe transientInstance) {
		// TODO Auto-generated method stub
