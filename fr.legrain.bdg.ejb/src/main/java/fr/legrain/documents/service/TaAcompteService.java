...
import fr.legrain.bdg.model.mapping.mapper.TaAcompteMapper;
...
/**
 * Session Bean implementation class TaAcompteBean
 */
@Stateless
@DeclareRoles("admin")
@Interceptors(ServerTenantInterceptor.class)
public class TaAcompteService extends AbstractDocumentService<TaAcompte, TaAcompteDTO> implements ITaAcompteServiceRemote {

	static Logger logger = Logger.getLogger(TaAcompteService.class);

	@Inject private IAcompteDAO dao;
	 ...
	 * Default constructor. 
	 */
	public TaAcompteService() {
		super(TaAcompte.class,TaAcompteDTO.class);
		editionDefaut = EditionProgrammeDefaut.EDITION_DEFAUT_ACOMPTE_FICHIER;
	}
	...
	public String genereCode( Map<String, String> params) {
		...
		try {
			return gencode.genereCodeJPA(TaAcompte.class.getSimpleName(),params);
		} catch (Exception e) {
	...
	public void annuleCode(String code) {
		try {
			...
			gencode.annulerCodeGenere(gencode.findByCode(TaAcompte.class.getSimpleName()),code);
		} catch (Exception e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
	...
	public void verrouilleCode(String code) {
		try {
			gencode.rentreCodeGenere(gencode.findByCode(TaAcompte.class.getSimpleName()),code, sessionInfo.getSessionID());
		} catch (Exception e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
...
//	public void calculeTvaEtTotaux(TaAcompte doc){
//		calculTvaTotal(doc);
//		calculTotaux(doc);
//	}
//	
...
//	 */
//	public void calculTotaux(TaAcompte doc) {
//		
////			    MT_TVA Numeric(15,2),
...
//				if(((TaLAcompte)ligne).getTaTLigne().getCodeTLigne().equals(SWTDocument.C_CODE_T_LIGNE_H)) {
//					if(((TaLAcompte)ligne).getMtHtLApresRemiseGlobaleDocument()!=null)
//						doc.setNetHtCalc(doc.getNetHtCalc().add(((TaLAcompte)ligne).getMtHtLApresRemiseGlobaleDocument()));
//					if(((TaLAcompte)ligne).getMtTtcLApresRemiseGlobaleDocument()!=null)
//						doc.setMtTtcCalc(doc.getMtTtcCalc().add(((TaLAcompte)ligne).getMtTtcLApresRemiseGlobaleDocument()));
//					if(((TaLAcompte)ligne).getMtHtLDocument()!=null)
//						doc.setMtHtCalc(doc.getMtHtCalc().add(((TaLAcompte)ligne).getMtHtLDocument()));
//					if(((TaLAcompte)ligne).getMtTtcLDocument()!=null)
//						doc.setMtTtcAvantRemiseGlobaleCalc(doc.getMtTtcAvantRemiseGlobaleCalc().add(((TaLAcompte)ligne).getMtTtcLDocument()));
//				}
//				
//			}
//			
...
//			
//			doc.setResteARegler(doc.getNetTtcCalc().subtract(doc.getRegleDocument()).subtract(doc.calculSommeAcomptes()));
//	}
//
//	/**
//	 * Reparti le total chaque code TVA sur l'ensemble des lignes concernées par ce code. 
//	 */
//	public void dispatcherTva(TaAcompte doc) {
//
...
//		
//		for (TaLAcompte ligne : doc.getLignes()) {
...
//								} else {
//									((TaLAcompte)ligne).setMtHtLApresRemiseGlobaleDocument(((TaLAcompte)ligne).getMtHtLDocument().subtract(((TaLAcompte)ligne).getMtHtLDocument().multiply(doc.getTxRemHtDocument()).divide(new BigDecimal(100),MathContext.DECIMAL128).setScale(2,BigDecimal.ROUND_HALF_UP)));
//									((TaLAcompte)ligne).setMtTtcLApresRemiseGlobaleDocument(((TaLAcompte)ligne).getMtTtcLDocument().subtract(((TaLAcompte)ligne).getMtTtcLDocument().multiply(doc.getTxRemHtDocument()).divide(new BigDecimal(100),MathContext.DECIMAL128).setScale(2,BigDecimal.ROUND_HALF_UP)));
//								}
...
//	 */
//	public void calculMontantLigneDocument(TaAcompte doc) {
//		for (Object ligne : doc.getLignes()) {
...
//	 */
//	public void calculTvaTotal(TaAcompte doc) {
...
//	 * Mise à jour de la propriété <code>lignesTVA</code>
//	 */
//	public void calculLignesTva(TaAcompte doc) {
//
...
//	}
	...
	public void persist(TaAcompte transientInstance) throws CreateException {
		persist(transientInstance, null);
	}

	//@TransactionAttribute(TransactionAttributeType.REQUIRED)
	@WebMethod(operationName = "persistValidationContext")
	public void persist(TaAcompte transientInstance, String validationContext) throws CreateException {
	...
	@Override
	public void remove(TaAcompte persistentInstance, boolean recharger) throws RemoveException {
...
//				//taLigneALigneEcheanceService.removeAllByIdDocumentAndTypeDoc(persistentInstance.getIdDocument(), *.TYPE_DOC);
	...
	public void remove(TaAcompte persistentInstance) throws RemoveException {
	...
	public TaAcompte merge(TaAcompte detachedInstance, String validationContext) {
		validateEntity(detachedInstance, validationContext);
		List<ILigneDocumentTiers> listeLien =null;
		TaAcompte objInitial = detachedInstance;
		try {
	...
	public TaAcompte findById(int id) throws FinderException {
		return dao.findById(id);
	}

	public TaAcompte findByCode(String code) throws FinderException {
...
//	@RolesAllowed("admin")
	public List<TaAcompte> selectAll() {
		...
		for (TaAcompte o : l) {
			o=(TaAcompte) recupSetREtat(o);
			o=(TaAcompte) recupSetHistREtat(o);
			o=(TaAcompte) recupSetLigneALigne(o);
			o=(TaAcompte) recupSetRDocument(o);
			o=(TaAcompte) recupSetREtatLigneDocuments(o);
			o=(TaAcompte) recupSetHistREtatLigneDocuments(o);
		}
		return l;
	}
	...
	public List<TaAcompteDTO> findWithJPQLQueryDTO(String JPQLquery) throws FinderException {
		List<TaAcompte> entityList = dao.findWithJPQLQuery(JPQLquery);
	...
	public TaAcompteDTO entityToDTO(TaAcompte entity) {
//		TaAcompteDTO dto = new TaAcompteDTO();
//		dto.setId(entity.getIdTCivilite());
//		dto.setCodeTCivilite(entity.getCodeTCivilite());
//		return dto;
		TaAcompteMapper mapper = new TaAcompteMapper();
		return mapper.mapEntityToDto(entity, null);
	}

	public List<TaAcompteDTO> listEntityToListDTO(List<TaAcompte> entity) {
		List<TaAcompteDTO> l = new ArrayList<TaAcompteDTO>();

		for (TaAcompte taTCivilite : entity) {
...
//	@RolesAllowed("admin")
	public List<TaAcompteDTO> selectAllDTO() {
		...
		List<TaAcompte> projects = selectAll();
		for(TaAcompte project : projects) {
	...
	public void persistDTO(TaAcompteDTO dto, String validationContext) throws CreateException {
		try {
			TaAcompteMapper mapper = new TaAcompteMapper();
			TaAcompte entity = mapper.mapDtoToEntity(dto,null);
			//dao.persist(entity);
	...
	@Override
	protected TaAcompte refresh(TaAcompte persistentInstance) {
		// TODO Auto-generated method stub
		return null;
	}
	...
	public void validateEntity(TaAcompte value, String validationContext) /*throws ExceptLgr*/ {
		try {
	...
	public void validateEntityProperty(TaAcompte value, String propertyName, String validationContext) {
		try {
			if(validationContext==null) validationContext="";
...
//			validator.validateField(dto,propertyName);
	...
	public void validateEntity(TaAcompte value) {
		validateEntity(value,null);
	}

	@Override
	@WebMethod(operationName = "validateEntityProperty")
	public void validateEntityProperty(TaAcompte value, String propertyName) {
	...
	@Override
	public List<TaAcompte> selectAll(IDocumentTiers taDocument, Date dateDeb,
			Date dateFin) {
		// TODO Auto-generated method stub
		return null;
	}
	...
	@Override
	public List<TaAcompte> findByCodeTiersAndDate(String codeTiers, Date debut,
			Date fin) {
		// TODO Auto-generated method stub
		return null;
	}
	...
	@Override
	public TaAcompte findByIdDocument(int id) throws FinderException {
		// TODO Auto-generated method stub
		return findById(id);
	}
	...
	public TaAcompte mergeAndFindById(TaAcompte detachedInstance, String validationContext) {		
		TaAcompte br = merge(detachedInstance,validationContext);
		try {
	...
	@Override
	public List<TaAcompte> rechercheAcompteNonRemises(String codeTiers, Date dateDeb, Date DateFin, Boolean export,
			String codeTPaiement, String iban, boolean byDate) {
		// TODO Auto-generated method stub
		return dao.rechercheAcompteNonRemises(codeTiers, dateDeb, DateFin, export, codeTPaiement, iban, byDate);
	}
	...
	public TaReglement creeRReglement(TaAcompte doc,String typePaiementDefaut,TaReglement reglement) throws Exception{
		if(reglement!=null){
			...
			reglement.setDateDocument(doc.getDateDocument());
			reglement.setTaTiers(doc.getTaTiers());
			reglement.setDateLivDocument(doc.getDateEchDocument());
			reglement.setTaCompteBanque(taCompteBanqueDAO.findByTiersEntreprise(reglement.getTaTPaiement()));
		}else{
			...
			reglement.setDateDocument(doc.getDateDocument());
			reglement.setDateLivDocument(doc.getDateEchDocument());
			reglement.setNetTtcCalc(doc.getNetTtcCalc());
			if(doc.getTaTPaiement()!=null){
				typePaiement=doc.getTaTPaiement();
				report=doc.getTaTPaiement().getReportTPaiement();
				finDeMois=doc.getTaTPaiement().getFinMoisTPaiement();
			}				
			else
			...
			if(reglement.getNetTtcCalc().signum()>0){	
				reglement.setTaTPaiement(typePaiement);
			if(reglement.getLibelleDocument()==null || 
					reglement.getLibelleDocument().equals(""))
				reglement.setLibelleDocument(typePaiement.getLibTPaiement());
			}
			
			
			reglement.setTaCompteBanque(taCompteBanqueDAO.findByTiersEntreprise(typePaiement));
			reglement.setTaTiers(doc.getTaTiers());
			reglement.setEtatDeSuppression(IHMEtat.insertion);

		}
		
			List<String> listeCodes = new LinkedList<String>();

				listeCodes.add(reglement.getCodeDocument());

			if(reglement.getCodeDocument()==null ||reglement.getCodeDocument().equals("")) {
	...
	public String generePDF(int idDoc, Map<String,Object> mapParametreEdition, List<String> listResourcesPath, String theme, TaActionEdition action) {
		if(action != null) {
			TaEdition edition = taEditionService.rechercheEditionActionDefaut(null, action, TaAcompte.TYPE_DOC);
	...
	public String generePDF(int idDoc, String modeleEdition, Map<String,Object> mapParametreEdition, List<String> listResourcesPath, String theme) {
		try {
			TaAcompte doc = findById(idDoc);
			SchemaResolver sr = new SchemaResolver();
			String localPath = bdgProperties.osTempDirDossier(sr.resolveCurrentTenantIdentifier())+"/"+bdgProperties.tmpFileName(doc.getCodeDocument(), doc.getTaTiers().getCodeTiers(),"acompte.pdf");
			...
			if(listResourcesPath == null) {
				...
				listResourcesPath.add(EditionProgrammeDefaut.LIBRAIRIE_EDITION_DEFAUT_ACOMPTE);
...
//				doc = mergeAndFindById(doc,ITaAcompteServiceRemote.validationContext);
//			}
	...
	@Override
	public List<TaAcompte> rechercheDocument(String codeTiers, Date dateExport, Date dateDeb, Date dateFin) {
		// TODO Auto-generated method stub
		return null;
	}
	...
	public TaAcompte findDocByLDoc(ILigneDocumentTiers lDoc) {
		// TODO Auto-generated method stub
		TaAcompte o= (TaAcompte) dao.findDocByLDoc(lDoc);
		 recupSetREtat(o);
		 recupSetHistREtat(o);
	...
	@Override
	public TaAcompte mergeEtat(IDocumentTiers detachedInstance) {
//		à mettre si gestion des états !!!!
		modifEtatLigne(detachedInstance);		
		TaEtat etat=changeEtatDocument(detachedInstance);
		((TaAcompte) detachedInstance).addREtat(etat);
		
		detachedInstance=dao.merge((TaAcompte) detachedInstance);	
		return (TaAcompte) detachedInstance;
	}
	...
	@Override
	public TaAcompte findByCodeFetch(String code) throws FinderException {
		// TODO Auto-generated method stub
		TaAcompte o= (TaAcompte) dao.findByCodeFetch(code);
		if(o!=null) {
		recupSetREtat(o);
		recupSetHistREtat(o);
		recupSetLigneALigne(o);
	...
	@Override
	public TaAcompte findByIDFetch(int id) throws FinderException {
		// TODO Auto-generated method stub
		TaAcompte o= (TaAcompte) dao.findByIdFetch(id);
		if(o!=null) {
		recupSetREtat(o);
		recupSetHistREtat(o);
		recupSetLigneALigne(o);
...
//	@RolesAllowed("admin")
	public List<TaAcompte> selectAllFetch() {
		List<TaAcompte> l=dao.selectAll();
		for (TaAcompte o : l) {
			o=(TaAcompte) recupSetREtat(o);
			o=(TaAcompte) recupSetHistREtat(o);
