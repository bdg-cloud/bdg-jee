 ...
 */
public class TaInfosAvoirDAO implements IInfosAvoirDAO {
...
//	}
	...
	@Override
	public TaInfosAvoir findByCode(String code) {
		// TODO Auto-generated method stub
		return null;
	}

	@Override
	public List<TaInfosAvoir> findWithNamedQuery(String queryName) {
		try {
	...
	@Override
	public List<TaInfosAvoir> findWithJPQLQuery(String JPQLquery) {
		try {
	...
	@Override
	public boolean validate(TaInfosAvoir value) throws Exception {
		BeanValidator<TaInfosAvoir> validator = new BeanValidator<TaInfosAvoir>(TaInfosAvoir.class);
		return validator.validate(value);
	}

	@Override
	public boolean validateField(TaInfosAvoir value, String propertyName) throws Exception {
		BeanValidator<TaInfosAvoir> validator = new BeanValidator<TaInfosAvoir>(TaInfosAvoir.class);
		return validator.validateField(value,propertyName);
	}

	@Override
	public void detach(TaInfosAvoir transientInstance) {
