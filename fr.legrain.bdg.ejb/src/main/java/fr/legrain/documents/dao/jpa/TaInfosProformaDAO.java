 ...
 */
public class TaInfosProformaDAO /*extends AbstractApplicationDAO<TaInfosProforma>*/ implements IInfosProformaDAO {
...
//	}
	...
	@Override
	public TaInfosProforma findByCode(String code) {
		// TODO Auto-generated method stub
		return findByCodeProforma(code);
	}

	@Override
	public List<TaInfosProforma> findWithNamedQuery(String queryName) {
		try {
	...
	@Override
	public List<TaInfosProforma> findWithJPQLQuery(String JPQLquery) {
		try {
	...
	@Override
	public boolean validate(TaInfosProforma value) throws Exception {
		BeanValidator<TaInfosProforma> validator = new BeanValidator<TaInfosProforma>(TaInfosProforma.class);
		return validator.validate(value);
	}

	@Override
	public boolean validateField(TaInfosProforma value, String propertyName) throws Exception {
		BeanValidator<TaInfosProforma> validator = new BeanValidator<TaInfosProforma>(TaInfosProforma.class);
		return validator.validateField(value,propertyName);
	}

	@Override
	public void detach(TaInfosProforma transientInstance) {
