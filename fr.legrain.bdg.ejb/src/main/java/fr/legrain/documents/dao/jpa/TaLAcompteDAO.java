 ...
 */
public class TaLAcompteDAO /*extends AbstractApplicationDAO<TaLAcompte>*/implements ILAcompteDAO {
...
//		super.annuler(persistentInstance);
	...
	@Override
	public TaLAcompte findByCode(String code) {
		// TODO Auto-generated method stub
		return null;
	}

	@Override
	public List<TaLAcompte> findWithNamedQuery(String queryName) {
		try {
	...
	@Override
	public List<TaLAcompte> findWithJPQLQuery(String JPQLquery) {
		try {
	...
	@Override
	public boolean validate(TaLAcompte value) throws Exception {
		BeanValidator<TaLAcompte> validator = new BeanValidator<TaLAcompte>(TaLAcompte.class);
		return validator.validate(value);
	}

	@Override
	public boolean validateField(TaLAcompte value, String propertyName)
			throws Exception {
		BeanValidator<TaLAcompte> validator = new BeanValidator<TaLAcompte>(TaLAcompte.class);
	...
	@Override
	public void detach(TaLAcompte transientInstance) {
