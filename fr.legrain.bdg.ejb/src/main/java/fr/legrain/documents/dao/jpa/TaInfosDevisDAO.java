 ...
 */
public class TaInfosDevisDAO /*extends AbstractApplicationDAO<TaInfosDevis>*/ implements IInfosDevisDAO {
...
//	}
	...
	@Override
	public List<TaInfosDevis> findWithNamedQuery(String queryName) {
		try {
	...
	@Override
	public List<TaInfosDevis> findWithJPQLQuery(String JPQLquery) {
		try {
	...
	@Override
	public boolean validate(TaInfosDevis value) throws Exception {
		BeanValidator<TaInfosDevis> validator = new BeanValidator<TaInfosDevis>(TaInfosDevis.class);
		return validator.validate(value);
	}

	@Override
	public boolean validateField(TaInfosDevis value, String propertyName)
			throws Exception {
		BeanValidator<TaInfosDevis> validator = new BeanValidator<TaInfosDevis>(TaInfosDevis.class);
	...
	@Override
	public void detach(TaInfosDevis transientInstance) {
		entityManager.detach(transientInstance);
	}

	@Override
	public TaInfosDevis findByCode(String code) {
