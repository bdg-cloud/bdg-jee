...
@Stateless
@SmsLgr(SmsLgr.TYPE_SMS_MAILJET_PROGRAMME)
public class EnvoiSmsViaMailjetProgrammeService extends SmsService implements IEnvoiSMSViaServiceExterneDossierService {
