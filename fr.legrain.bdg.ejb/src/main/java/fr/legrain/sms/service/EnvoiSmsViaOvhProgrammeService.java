...
@Stateless
@SmsLgr(SmsLgr.TYPE_SMS_OVH_PROGRAMME)
public class EnvoiSmsViaOvhProgrammeService extends SmsService implements IEnvoiSMSViaServiceExterneDossierService {
	
	private String APPLICATION_KEY = "lYcWRiDCghiI4CoE";
	private String APPLICATION_SECRET = "0UQhmqlj9CjkZLYNJx1CXsNIcEwfONzT";
	private String CONSUMER_KEY = "CGNAjXpBon6Upf2njkV71bToQhLuY5y2";
	private String SERVICE_NAME = "sms-bp14783-1";
	
	private LgrOvhSms lgrOvhSms = new LgrOvhSms(APPLICATION_KEY,APPLICATION_SECRET,CONSUMER_KEY,SERVICE_NAME);
