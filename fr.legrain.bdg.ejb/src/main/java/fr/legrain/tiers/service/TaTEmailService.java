...
import fr.legrain.bdg.model.mapping.mapper.TaTEmailMapper;
...
transientInstance.setCodeTEmail(transientInstance.getCodeTEmail().toUpperCase());
...
detachedInstance.setCodeTEmail(detachedInstance.getCodeTEmail().toUpperCase());
...
//	@RolesAllowed("admin")
	...
	public List<TaTEmailDTO> listEntityToListDTO(List<TaTEmail> entity) {
		...
		for (TaTEmail TaTEmail : entity) {
			l.add(entityToDTO(TaTEmail));
		}
