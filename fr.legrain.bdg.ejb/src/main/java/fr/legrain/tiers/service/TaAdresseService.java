...
public class TaAdresseService extends AbstractApplicationDAOServer<TaAdresse, TaAdresseDTO> implements ITaAdresseServiceRemote {

	static Logger logger = Logger.getLogger(TaAdresseService.class);
...
//			validator.validateField(dto,propertyName);
	...
	public List<TaAdresse> rechercheParImport(String origineImport, String idImport) {
		// TODO Auto-generated method stub
		return dao.rechercheParImport(origineImport, idImport);
	}

	@Override
	public int rechercheOdrePourType(String codeType,String codeTiers) {
		// TODO Auto-generated method stub
		return dao.rechercheOdrePourType(codeType, codeTiers);
	}
