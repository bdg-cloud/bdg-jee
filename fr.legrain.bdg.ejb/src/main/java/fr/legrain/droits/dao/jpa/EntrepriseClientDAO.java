...
public class EntrepriseClientDAO implements IEntrepriseClientDAO {
	...
	private static final Log logger = LogFactory.getLog(EntrepriseClientDAO.class);
...
//	}
	...
	public void ctrlSaisieSpecifique(TaEntrepriseClient entity,String field) throws ExceptLgr {	
		try {
