...
import fr.legrain.droits.dao.IAuthURLDAO;
...
public class AuthURLDAO implements IAuthURLDAO {
	...
	private static final Log logger = LogFactory.getLog(AuthURLDAO.class);
...
//	}
	...
	public void ctrlSaisieSpecifique(TaAuthURL entity,String field) throws ExceptLgr {	
		try {
