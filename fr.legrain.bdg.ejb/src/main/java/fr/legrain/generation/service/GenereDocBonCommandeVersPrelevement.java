...
public  class GenereDocBonCommandeVersPrelevement extends AbstractGenereDocVersPrelevement implements IGenereDocBonCommandeVersPrelevementServiceRemote{
...
//			((TaPrelevement)dd).setTaTPaiement(((TaBoncde)ds).getTaTPaiement());
			...
			if(multiple)((TaPrelevement)dd).setTxRemHtDocument(BigDecimal.valueOf(0));else((TaPrelevement)dd).setTxRemHtDocument(((TaBoncde)ds).getTxRemHtDocument());
			...
			((TaPrelevement)dd).setDateExport(((TaBoncde)ds).getDateExport());
