...
public abstract class AbstractGenereDocLigneServiceWebExterne {
	
	static Logger logger = Logger.getLogger(AbstractGenereDocLigneServiceWebExterne.class.getName());
...
//			ds.calculeTvaEtTotaux();
	...
	public ILigneDocumentTiers copieLigneDocumentGeneral(TaLFlash ls, ILigneDocumentTiers ld) {
		try {
			...
			if((ls.getTaFlash().getGestionLot()!=null &&!ls.getTaFlash().getGestionLot()) 
