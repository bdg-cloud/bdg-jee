...
public abstract  class AbstractGenereDocVersPanierLEcheance extends AbstractGenereDocLEcheance{
...
//				if(generationModele|| forceMouvement)creationMouvement((TaPanier)dd);
				dd= taTaPanierService.findByIDFetch(((TaPanier)dd).getIdDocument());
