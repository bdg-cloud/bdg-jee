...
public abstract  class AbstractGenereDocVersFactureLEcheance extends AbstractGenereDocLEcheance {
	
	protected @EJB ITaFactureServiceRemote taFactureService;
	protected @EJB ITaRReglementServiceRemote taRReglementService;
	protected @EJB ITaLEcheanceServiceRemote taLEcheanceService;
