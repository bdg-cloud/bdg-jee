...
public  class GenereDocBonLivraisonVersFacture extends AbstractGenereDocVersFacture implements IGenereDocBonLivraisonVersFactureServiceRemote{
//	public GenereDocBonLivraisonVersFacture(ITaFactureServiceRemote taFactureService) {
...
//			((TaFacture)dd).setDateEchDocument(((TaBonliv)ds).getDateEchDocument());
			((TaFacture)dd).setDateLivDocument(((TaBonliv)ds).getDateLivDocument());
			((TaFacture)dd).setRegleDocument(BigDecimal.valueOf(0));
			((TaFacture)dd).setRemHtDocument(((TaBonliv)ds).getRemHtDocument());
			if(multiple)((TaFacture)dd).setTxRemHtDocument(BigDecimal.valueOf(0));else((TaFacture)dd).setTxRemHtDocument(((TaBonliv)ds).getTxRemHtDocument());
...
//			((TaFacture)dd).setExport(((TaBonliv)ds).getExport());
			...
			((TaFacture)dd).setNumeroCommandeFournisseur(((TaBonliv)ds).getNumeroCommandeFournisseur());
	...
	public ILigneDocumentTiers copieLigneDocumentSpecifique(ILigneDocumentTiers ls, ILigneDocumentTiers ld) {
			...
			if(ld.getTaArticle()!=null && ((TaLBonliv)ls).getCodeTitreTransport()!=null) {
				((TaLFacture)ld).setCodeTitreTransport(((TaLBonliv)ls).getCodeTitreTransport());
				((TaLFacture)ld).setQteTitreTransport(((TaLBonliv)ls).getQteTitreTransport());			
			}
			else
	...
	public IDocumentTiers genereDocumentSpecifique(IDocumentTiers ds, IDocumentTiers dd,String codeTiers, boolean generationModele,boolean genereCode) {
		...
		try {
			...
			if(documentInit!=null){
				...
				Date dateExercice =taInfoEntrepriseService.dateDansExercice(getDateDoc());
				...
				((TaFacture)dd).setDateDocument(dateExercice);
				((TaFacture)dd).setDateEchDocument(dateExercice);
				((TaFacture)dd).setDateLivDocument(documentInit.getDateLivDocument());
