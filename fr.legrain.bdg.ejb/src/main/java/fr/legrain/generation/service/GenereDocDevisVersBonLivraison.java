...
public  class GenereDocDevisVersBonLivraison extends AbstractGenereDocVersBonLivraison implements IGenereDocDevisVersBonLivraisonServiceRemote{
	...
	public IDocumentTiers copieDocumentSpecifique(IDocumentTiers ds, IDocumentTiers dd
		...
		try {
			...
			if(multiple)((TaBonliv)dd).setTxRemHtDocument(BigDecimal.valueOf(0));else((TaBonliv)dd).setTxRemHtDocument(((TaDevis)ds).getTxRemHtDocument());
	...
	public ILigneDocumentTiers copieLigneDocumentSpecifique(ILigneDocumentTiers ls, ILigneDocumentTiers ld) {
		...
		if(ld.getTaArticle()!=null && ((TaLDevis)ls).getCodeTitreTransport()!=null ) {
			((TaLBonliv)ld).setCodeTitreTransport(((TaLDevis)ls).getCodeTitreTransport());
			((TaLBonliv)ld).setQteTitreTransport(((TaLDevis)ls).getQteTitreTransport());			
		}
		else
