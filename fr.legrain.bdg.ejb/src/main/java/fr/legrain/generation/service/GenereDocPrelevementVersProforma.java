...
public  class GenereDocPrelevementVersProforma extends AbstractGenereDocVersProforma implements IGenereDocPrelevementVersProformaServiceRemote{
...
//			((TaAvoir)dd).setRegleDocument(BigDecimal.valueOf(0));
			...
			if(multiple)((TaProforma)dd).setTxRemHtDocument(BigDecimal.valueOf(0));else((TaProforma)dd).setTxRemHtDocument(((TaPrelevement)ds).getTxRemHtDocument());
