...
public  class GenereDocAvisEcheanceVersFacture extends AbstractGenereDocVersFacture implements IGenereDocAvisEcheanceVersFactureServiceRemote{
//	public GenereDocAvisEcheanceVersFacture(ITaFactureServiceRemote taFactureService) {
...
//			((TaFacture)dd).setTaTPaiement(((TaAvisEcheance)ds).getTaTPaiement());
			...
			if(multiple)((TaFacture)dd).setTxRemHtDocument(BigDecimal.valueOf(0));else((TaFacture)dd).setTxRemHtDocument(((TaAvisEcheance)ds).getTxRemHtDocument());
			...
			((TaFacture)dd).setDateExport(((TaAvisEcheance)ds).getDateExport());
	...
	public ILigneDocumentTiers copieLigneDocumentSpecifique(ILigneDocumentTiers ls, ILigneDocumentTiers ld) {
		...
		if(ld.getTaArticle()!=null && ((TaLAvisEcheance)ls).getCodeTitreTransport()!=null ) {
			((TaLFacture)ld).setCodeTitreTransport(((TaLAvisEcheance)ls).getCodeTitreTransport());
			((TaLFacture)ld).setQteTitreTransport(((TaLAvisEcheance)ls).getQteTitreTransport());			
		}
		else
