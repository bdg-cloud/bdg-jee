...
public  class GenereDocAvisEcheanceVersPrelevement extends AbstractGenereDocVersPrelevement implements IGenereDocAvisEcheanceVersPrelevementServiceRemote{
...
//			((TaPrelevement)dd).setTaTPaiement(((TaAvisEcheance)ds).getTaTPaiement());
			...
			if(multiple)((TaPrelevement)dd).setTxRemHtDocument(BigDecimal.valueOf(0));else((TaPrelevement)dd).setTxRemHtDocument(((TaAvisEcheance)ds).getTxRemHtDocument());
			...
			((TaPrelevement)dd).setDateExport(((TaAvisEcheance)ds).getDateExport());
