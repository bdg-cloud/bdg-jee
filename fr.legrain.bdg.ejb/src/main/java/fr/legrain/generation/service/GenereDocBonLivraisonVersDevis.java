...
public  class GenereDocBonLivraisonVersDevis extends AbstractGenereDocVersDevis implements IGenereDocBonLivraisonVersDevisServiceRemote{
...
//			((TaDevis)dd).setDateEchDocument(((TaBonliv)ds).getDateEchDocument());
			...
			if(multiple)((TaDevis)dd).setTxRemHtDocument(BigDecimal.valueOf(0));else((TaDevis)dd).setTxRemHtDocument(((TaBonliv)ds).getTxRemHtDocument());
