...
import fr.legrain.supportAbonnement.model.TaROptionAbon;
import fr.legrain.supportAbonnements.dao.IROptionAbonDAO;
 ...
 */
public   class TaROptionAbonDAO implements IROptionAbonDAO{
...
//	@Override
	...
	@Override
	public List<TaROptionAbon> findWithNamedQuery(String queryName) {
		try {
	...
	@Override
	public List<TaROptionAbon> findWithJPQLQuery(String JPQLquery) {
		try {
	...
	@Override
	public boolean validate(TaROptionAbon value) throws Exception {
		BeanValidator<TaROptionAbon> validator = new BeanValidator<TaROptionAbon>(TaROptionAbon.class);
		return validator.validate(value);
	}

	@Override
	public boolean validateField(TaROptionAbon value, String propertyName)
			throws Exception {
		BeanValidator<TaROptionAbon> validator = new BeanValidator<TaROptionAbon>(TaROptionAbon.class);
	...
	@Override
	public void detach(TaROptionAbon transientInstance) {
		// TODO Auto-generated method stub
