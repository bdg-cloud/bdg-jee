...
@Stateless
@EmailLgr(EmailLgr.TYPE_MAILJET_PAR_DEFAUT_BDG)
public class LgrMailjetDefautService extends EmailService implements IEnvoiEmailViaServiceExterneDossierService {
	...
	public ReponseEmailSendService send(String fromEmail, String fromName, String subject, String textPart, String htmlPart, String[] destinataires, String[] cc, String[] bcc, File[] attachment, String replyToEmail) {
		...
		MJ_APIKEY_PUBLIC = paramBdg.getTaParametre().getMailjetApikeyPublicDefautClient();
		MJ_APIKEY_PRIVATE = paramBdg.getTaParametre().getMailjetApikeyPrivateDefautClient();
...
//				}
	...
	@Override
	public ReponseEmailSendService send(TaCompteServiceWebExterne configService, String fromEmail, String fromName, String subject,
			String textPart, String htmlPart, String[] destinataires, String[] cc, String[] bcc, File[] attachment, String replyToEmail)
			throws EJBException {
				return null;
	...
	public TaMessageEmail updateServiceInformation(TaMessageEmail taMessageEmail) {
		taMessageEmail.setTypeServiceExterne(EmailLgr.TYPE_MAILJET_PAR_DEFAUT_BDG);
