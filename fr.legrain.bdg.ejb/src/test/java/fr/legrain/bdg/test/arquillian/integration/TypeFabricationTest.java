...
//    private WebElement logoutLink;
    ...
    @FindBy(id = "idFormMenu:idMenuParamSolstyce")
    private WebElement actionMenuParamSolstyce;
                             
    @FindBy(id = "idFormMenu:idMenuTypeFabrication")
    private WebElement actionMenuTypeFabrication;
    
    //////////////////
    // Panel / DIV
    //////////////////                         
    @FindBy(id = "form:tabView:idTabTypeFabrication:typeFabricationFormPrincipal")
    private WebElement idFormPrincipal;
    
    @FindBy(id = "idDialogTypeFabrication:typeFabricationMessages")
    private WebElement idMessageJSFDialogue;
    
    ///////////////////////////
    // Boutons / Liens actions
    ///////////////////////////
    @FindBy(id = "idDialogTypeFabrication:idEnregistrerTypeFabrication")
    private WebElement idEnregistrer;
    
    @FindBy(id = "idDialogTypeFabrication:typeFabricationAnnulerDialogue")
    private WebElement idAnnuler;
    
    @FindBy(id = "form:tabView:idTabTypeFabrication:idModifierTypeFabrication")
    private WebElement idModifier;
    
    @FindBy(id = "form:tabView:idTabTypeFabrication:typeFabricationSupprimer")
    private WebElement idSupprimer;
    
    @FindBy(id = "form:tabView:idTabTypeFabrication:idInsererTypeFabrication")
    private WebElement idInserer;
    
    @FindBy(id = "form:tabView:idTabTypeFabrication:typeFabricationFermer")
    private WebElement idFermer;
    
    ///////////////////////////
    // Champ de formulaire
    ///////////////////////////
    @FindBy(id = "idDialogTypeFabrication")
    private WebElement idDialogTypeFabrication;
    
    @FindBy(id = "form:tabView:idTabTypeFabrication:typeFabricationDataTable")
    private WebElement idDatatablePrincipale;
    
    @FindBy(id = "idDialogTypeFabrication:idTxtCodeTypeFabrication")
    private WebElement idCode;
    
    @FindBy(id = "idDialogTypeFabrication:idTxtLibelleTypeFabrication")
    private WebElement idLibelle;
    
//    @FindBy(id = "idDialogTypeFabrication:idTxtCompteTypeFabrication")
//    private WebElement idCompte;
    
    //////////////////////////////////////
    // Réponses dialogue de confirmation
    //////////////////////////////////////
//    @FindBy(id = "form:tabView:idTabTypeFabrication:idOuiConfirmFermerFamilleArticle")
//    private WebElement idOuiConfirmFermerFamilleArticle;
//    
//    @FindBy(id = "form:tabView:idTabTypeFabrication:idNonConfirmFermerFamilleArticle")
//    private WebElement idNonConfirmFermerFamilleArticle;
//    
//    @FindBy(id = "form:tabView:idTabTypeFabrication:idOuiConfirmSupprFamilleArticle")
//    private WebElement idOuiConfirmSupprFamilleArticle;
//    
//    @FindBy(id = "form:tabView:idTabTypeFabrication:idNonConfirmSupprFamilleArticle")
...
//    private static final String messageErreurUnique = "unique constraint";
    ...
    public static void oneTimeSetUp() {
    	...
    	TypeFabricationTest test = new TypeFabricationTest();
...
//    	 guardAjax(logoutLink).click();
    ...
    public void ouvrirEcran() {
        ...
        action.moveToElement(actionMenuParamSolstyce).perform();
        waitGui().until().element(actionMenuTypeFabrication).is().visible();
        guardAjax(actionMenuTypeFabrication).click();
...
//        browser.switchTo().window(currentWindow);
    ...
    public void insertionChampsObligatoire() {
        ...
        idLibelle.sendKeys(VALEUR_CODE);
//        idCompte.sendKeys(VALEUR_COMPTE);
