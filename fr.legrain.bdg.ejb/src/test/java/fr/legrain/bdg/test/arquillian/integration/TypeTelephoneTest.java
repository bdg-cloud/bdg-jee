...
public class TypeTelephoneTest {
...
//    private WebElement logoutLink;
    ...
    @FindBy(id = "idFormMenu:idMenuParamTypeTel")
    private WebElement actionMenuTypeTel;
    
    //////////////////
    // Panel / DIV
    //////////////////                         
    @FindBy(id = "form:tabView:idTabTypeTel:typeTelFormPrincipal")
    private WebElement idFormPrincipal;
    
    @FindBy(id = "idDialogTypeTel:typeTelMessages")
    private WebElement idMessageJSFDialogue;
    
    ///////////////////////////
    // Boutons / Liens actions
    ///////////////////////////
    @FindBy(id = "idDialogTypeTel:idEnregistrerTypeTel")
    private WebElement idEnregistrer;
    
    @FindBy(id = "idDialogTypeTel:typeTelAnnulerDialogue")
    private WebElement idAnnuler;
    
    @FindBy(id = "form:tabView:idTabTypeTel:idModifierTypeTel")
    private WebElement idModifier;
    
    @FindBy(id = "form:tabView:idTabTypeTel:typeTelSupprimer")
    private WebElement idSupprimer;
    
    @FindBy(id = "form:tabView:idTabTypeTel:idInsererTypeTel")
    private WebElement idInserer;
    
    @FindBy(id = "form:tabView:idTabTypeTel:typeTelFermer")
    private WebElement idFermer;
    
    ///////////////////////////
    // Champ de formulaire
    ///////////////////////////
    @FindBy(id = "idDialogTypeTel")
    private WebElement idDialogTypeTel;
    
    @FindBy(id = "form:tabView:idTabTypeTel:typeTelDataTable")
    private WebElement idDatatablePrincipale;
    
    @FindBy(id = "idDialogTypeTel:idTxtCodeTypeTel")
    private WebElement idCode;
    
    @FindBy(id = "idDialogTypeTel:idTxtLibelleTypeTel")
    private WebElement idLibelle;
//    
//    @FindBy(id = "idDialogTypeTel:idTxtCommentaireFamilleArticle")
//    private WebElement idCommentaireFamilleArticle;
    
    //////////////////////////////////////
    // Réponses dialogue de confirmation
    //////////////////////////////////////
//    @FindBy(id = "form:tabView:idTabTypeTel:idOuiConfirmFermerFamilleArticle")
//    private WebElement idOuiConfirmFermerFamilleArticle;
//    
//    @FindBy(id = "form:tabView:idTabTypeTel:idNonConfirmFermerFamilleArticle")
//    private WebElement idNonConfirmFermerFamilleArticle;
//    
//    @FindBy(id = "form:tabView:idTabTypeTel:idOuiConfirmSupprFamilleArticle")
//    private WebElement idOuiConfirmSupprFamilleArticle;
//    
//    @FindBy(id = "form:tabView:idTabTypeTel:idNonConfirmSupprFamilleArticle")
...
//    private static final String messageErreurUnique = "unique constraint";
    ...
    public static void oneTimeSetUp() {
    	...
    	TypeTelephoneTest test = new TypeTelephoneTest();
...
//    	 guardAjax(logoutLink).click();
    ...
    public void ouvrirEcran() {
        ...
        waitGui().until().element(actionMenuTypeTel).is().visible();
        guardAjax(actionMenuTypeTel).click();
