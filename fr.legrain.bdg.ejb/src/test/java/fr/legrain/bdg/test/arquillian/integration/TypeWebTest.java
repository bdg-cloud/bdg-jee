...
public class TypeWebTest {
    private static final String WEBAPP_SRC = "src/main/webapp";
    private static final String VALEUR_CODE = "DEMO_TEST";
...
//    private WebElement logoutLink;
    ...
    @FindBy(id = "idFormMenu:idMenuParamTypeWeb")
    private WebElement actionMenuTypeWeb;
    
    //////////////////
    // Panel / DIV
    //////////////////                         
    @FindBy(id = "form:tabView:idTabTypeWeb:typeWebFormPrincipal")
    private WebElement idFormPrincipal;
    
    @FindBy(id = "idDialogTypeWeb:typeWebMessages")
    private WebElement idMessageJSFDialogue;
    
    ///////////////////////////
    // Boutons / Liens actions
    ///////////////////////////
    @FindBy(id = "idDialogTypeWeb:idEnregistrerTypeWeb")
    private WebElement idEnregistrer;
    
    @FindBy(id = "idDialogTypeWeb:typeWebAnnulerDialogue")
    private WebElement idAnnuler;
    
    @FindBy(id = "form:tabView:idTabTypeWeb:idModifierTypeWeb")
    private WebElement idModifier;
    
    @FindBy(id = "form:tabView:idTabTypeWeb:typeWebSupprimer")
    private WebElement idSupprimer;
    
    @FindBy(id = "form:tabView:idTabTypeWeb:idInsererTypeWeb")
    private WebElement idInserer;
    
    @FindBy(id = "form:tabView:idTabTypeWeb:typeWebFermer")
    private WebElement idFermer;
    
    ///////////////////////////
    // Champ de formulaire
    ///////////////////////////
    @FindBy(id = "idDialogTypeWeb")
    private WebElement idDialogTypeWeb;
    
    @FindBy(id = "form:tabView:idTabTypeWeb:typeWebDataTable")
    private WebElement idDatatablePrincipale;
    
    @FindBy(id = "idDialogTypeWeb:idTxtCodeTypeWeb")
    private WebElement idCode;
    
    @FindBy(id = "idDialogTypeWeb:idTxtLibelleTypeWeb")
    private WebElement idLibelle;
//    
//    @FindBy(id = "idDialogTypeWeb:idTxtCommentaireFamilleArticle")
//    private WebElement idCommentaireFamilleArticle;
    
    //////////////////////////////////////
    // Réponses dialogue de confirmation
    //////////////////////////////////////
//    @FindBy(id = "form:tabView:idTabTypeWeb:idOuiConfirmFermerFamilleArticle")
//    private WebElement idOuiConfirmFermerFamilleArticle;
//    
//    @FindBy(id = "form:tabView:idTabTypeWeb:idNonConfirmFermerFamilleArticle")
//    private WebElement idNonConfirmFermerFamilleArticle;
//    
//    @FindBy(id = "form:tabView:idTabTypeWeb:idOuiConfirmSupprFamilleArticle")
//    private WebElement idOuiConfirmSupprFamilleArticle;
//    
//    @FindBy(id = "form:tabView:idTabTypeWeb:idNonConfirmSupprFamilleArticle")
...
//    private static final String messageErreurUnique = "unique constraint";
    ...
    public static void oneTimeSetUp() {
    	...
    	TypeWebTest test = new TypeWebTest();
...
//    	 guardAjax(logoutLink).click();
    ...
    public void ouvrirEcran() {
        ...
        waitGui().until().element(actionMenuTypeWeb).is().visible();
        guardAjax(actionMenuTypeWeb).click();
