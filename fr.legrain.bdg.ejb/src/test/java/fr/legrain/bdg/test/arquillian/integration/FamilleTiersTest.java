...
//
//       	WebArchive war = ear.getAsFamille(WebArchive.class, "/eee-war.war");
...
//    private WebElement logoutLink;
    ...
    @FindBy(id = "idFormMenu:idMenuParamFamilleTiers")
    private WebElement actionMenuFamilleTiers;
    
    //////////////////
    // Panel / DIV
    //////////////////                         
    @FindBy(id = "form:tabView:idTabFamilleTiers:familleTiersFormPrincipal")
    private WebElement idFormPrincipal;
    
    @FindBy(id = "idDialogFamilleTiers:familleTiersMessages")
    private WebElement idMessageJSFDialogue;
    
    ///////////////////////////
    // Boutons / Liens actions
    ///////////////////////////
    @FindBy(id = "idDialogFamilleTiers:idEnregistrerFamilleTiers")
    private WebElement idEnregistrer;
    
    @FindBy(id = "idDialogFamilleTiers:familleTiersAnnulerDialogue")
    private WebElement idAnnuler;
    
    @FindBy(id = "form:tabView:idTabFamilleTiers:idModifierFamilleTiers")
    private WebElement idModifier;
    
    @FindBy(id = "form:tabView:idTabFamilleTiers:familleTiersSupprimer")
    private WebElement idSupprimer;
    
    @FindBy(id = "form:tabView:idTabFamilleTiers:idInsererFamilleTiers")
    private WebElement idInserer;
    
    @FindBy(id = "form:tabView:idTabFamilleTiers:familleTiersFermer")
    private WebElement idFermer;
    
    ///////////////////////////
    // Champ de formulaire
    ///////////////////////////
    @FindBy(id = "idDialogFamilleTiers")
    private WebElement idDialogFamilleTiers;
    
    @FindBy(id = "form:tabView:idTabFamilleTiers:familleTiersDataTable")
    private WebElement idDatatablePrincipale;
    
    @FindBy(id = "idDialogFamilleTiers:idTxtCodeFamilleTiers")
    private WebElement idCode;
    
    @FindBy(id = "idDialogFamilleTiers:idTxtLibelleFamilleTiers")
    private WebElement idLibelle;
    
    @FindBy(id = "idDialogFamilleTiers:idTxtCommentaireFamilleTiers")
    private WebElement idCommentaire;
    
    //////////////////////////////////////
    // Réponses dialogue de confirmation
    //////////////////////////////////////
//    @FindBy(id = "form:tabView:idTabFamilleTiers:idOuiConfirmFermerFamilleArticle")
//    private WebElement idOuiConfirmFermerFamilleArticle;
//    
//    @FindBy(id = "form:tabView:idTabFamilleTiers:idNonConfirmFermerFamilleArticle")
//    private WebElement idNonConfirmFermerFamilleArticle;
//    
//    @FindBy(id = "form:tabView:idTabFamilleTiers:idOuiConfirmSupprFamilleArticle")
//    private WebElement idOuiConfirmSupprFamilleArticle;
//    
//    @FindBy(id = "form:tabView:idTabFamilleTiers:idNonConfirmSupprFamilleArticle")
...
//    private static final String messageErreurUnique = "unique constraint";
    ...
    public static void oneTimeSetUp() {
    	...
    	FamilleTiersTest test = new FamilleTiersTest();
...
//    	 guardAjax(logoutLink).click();
    ...
    public void ouvrirEcran() {
        ...
        waitGui().until().element(actionMenuFamilleTiers).is().visible();
        guardAjax(actionMenuFamilleTiers).click();
...
//        idCommentaire.sendKeys(VALEUR_COMMENTAIRE);
