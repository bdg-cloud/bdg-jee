...
public class TypeAdresseTest {
    private static final String WEBAPP_SRC = "src/main/webapp";
    private static final String VALEUR_CODE = "TEST"; 
    private static final String VALEUR_LIBELLE = "TEST_LIB";
...
//    private WebElement logoutLink;
    ...
    // Menu
    //////////////////
    @FindBy(id = "menuform:idMenuParam")
    private WebElement actionMenuParam;
    
    @FindBy(id = "menuform:idMenuParamTiers")
    private WebElement actionMenuParamTiers;
    
    @FindBy(id = "menuform:idMenuParamTypeAdresse")
    private WebElement actionMenuTypeAdresse;
    
    //////////////////
    // Panel / DIV
    //////////////////                         
    //@FindBy(id = "form:tabView:idTabTypeAdresse:typeAdresseFormPrincipal")
    @FindBy(id = "form:tabView:typeAdresseFormPrincipal")
    private WebElement idFormPrincipal;
    
    @FindBy(id = "idDialogTypeAdresse:typeAdresseMessages")
    private WebElement idMessageJSFDialogue;
    
    ///////////////////////////
    // Boutons / Liens actions
    ///////////////////////////
    @FindBy(id = "idDialogTypeAdresse:idEnregistrerTypeAdresse")
    private WebElement idEnregistrer;
    
    @FindBy(id = "idDialogTypeAdresse:typeAdresseAnnulerDialogue")
    private WebElement idAnnuler;
    
    //@FindBy(id = "form:tabView:idTabTypeAdresse:idModifierTypeAdresse")
    @FindBy(id = "form:tabView:idModifierTypeAdresse")
    private WebElement idModifier;
    
    //@FindBy(id = "form:tabView:idTabTypeAdresse:typeAdresseSupprimer")
    @FindBy(id = "form:tabView:typeAdresseSupprimer")
    private WebElement idSupprimer;
    
    //@FindBy(id = "form:tabView:idTabTypeAdresse:idInsererTypeAdresse")
    @FindBy(id = "form:tabView:idInsererTypeAdresse")
    private WebElement idInserer;
    
    //@FindBy(id = "form:tabView:idTabTypeAdresse:typeAdresseFermer")
    @FindBy(id = "form:tabView:typeAdresseFermer")
    private WebElement idFermer;
    
    ///////////////////////////
    // Champ de formulaire
    ///////////////////////////
    @FindBy(id = "idDialogTypeAdresse")
    private WebElement idDialogTypeAdresse;
    
    //@FindBy(id = "form:tabView:idTabTypeAdresse:typeAdresseDataTable")
    @FindBy(id = "form:tabView:typeAdresseDataTable")
    private WebElement idDatatablePrincipale;
    
    @FindBy(id = "idDialogTypeAdresse:idTxtCodeTypeAdresse")
    private WebElement idCode;
    
    @FindBy(id = "idDialogTypeAdresse:idTxtLibelleTypeAdresse")
    private WebElement idLibelle;
//    
//    @FindBy(id = "idDialogTypeAdresse:idTxtCommentaireFamilleArticle")
//    private WebElement idCommentaireFamilleArticle;
    
    //////////////////////////////////////
    // Réponses dialogue de confirmation
    //////////////////////////////////////
//    @FindBy(id = "form:tabView:idTabTypeAdresse:idOuiConfirmFermerFamilleArticle")
//    private WebElement idOuiConfirmFermerFamilleArticle;
//    
//    @FindBy(id = "form:tabView:idTabTypeAdresse:idNonConfirmFermerFamilleArticle")
//    private WebElement idNonConfirmFermerFamilleArticle;
//    
//    @FindBy(id = "form:tabView:idTabTypeAdresse:idOuiConfirmSupprFamilleArticle")
//    private WebElement idOuiConfirmSupprFamilleArticle;
//    
//    @FindBy(id = "form:tabView:idTabTypeAdresse:idNonConfirmSupprFamilleArticle")
...
//    private static final String messageErreurUnique = "unique constraint";
    ...
    public static void oneTimeSetUp() {
    	...
    	TypeAdresseTest test = new TypeAdresseTest();
...
//    	 guardAjax(logoutLink).click();
    	...
    	loginLogoutPage.getProfileImage().click();
    	waitGui().until().element(loginLogoutPage.getLogoutLink()).is().visible();
    	guardHttp(loginLogoutPage.getLogoutLink()).click();
    	//waitAjax().until().element(loginLogoutPage.getUser()).is().visible();
    	waitModel().until().element(loginLogoutPage.getUser()).is().visible();
    }
    ...
    public void ouvrirEcran() {
        ...
        actionMenuParam.click();
        waitGui().until().element(actionMenuParamTiers).is().visible();
        action.moveToElement(actionMenuParamTiers).perform();
        actionMenuParamTiers.click();
        waitGui().until().element(actionMenuTypeAdresse).is().visible();
        //action.moveToElement(actionMenuTypeAdresse).perform();
        guardAjax(actionMenuTypeAdresse).click();
...
//        browser.switchTo().window(currentWindow);
    ...
    public void insertionChampsObligatoire() {
        ...
        idLibelle.sendKeys(VALEUR_LIBELLE);
        //idCommentaireFamilleArticle.sendKeys(VALEUR_CODE);
