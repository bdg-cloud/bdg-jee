...
public class GroupeControleTest {
...
//    private WebElement logoutLink;
    ...
    @FindBy(id = "idFormMenu:idMenuGroupeControles")
    private WebElement actionMenuGroupeControles;
    
    //////////////////
    // Panel / DIV
    //////////////////                         
    @FindBy(id = "form:tabView:idTabGroupeControle:idGroupeCtrlFormPrincipal")
    private WebElement idFormPrincipal;
    
    @FindBy(id = "idDialogGroupeControle:groupeCtrlMessages")
    private WebElement idMessageJSFDialogue;
    
    ///////////////////////////
    // Boutons / Liens actions
    ///////////////////////////
    @FindBy(id = "idDialogGroupeControle:idEnregistrerGroupeCtrl")
    private WebElement idEnregistrer;
    
    @FindBy(id = "idDialogGroupeControle:groupeCtrlAnnulerDialogue")
    private WebElement idAnnuler;
    
    @FindBy(id = "form:tabView:idTabGroupeControle:idModifierGroupeCtrl")
    private WebElement idModifier;
    
    @FindBy(id = "form:tabView:idTabGroupeControle:groupeCtrlSupprimer")
    private WebElement idSupprimer;
    
    @FindBy(id = "form:tabView:idTabGroupeControle:idInsererGroupeCtrl")
    private WebElement idInserer;
    
    @FindBy(id = "form:tabView:idTabGroupeControle:groupeCtrlFermer")
    private WebElement idFermer;
    
    ///////////////////////////
    // Champ de formulaire
    ///////////////////////////
    @FindBy(id = "idDialogGroupeControle")
    private WebElement idDialogGroupeControle;
    
    @FindBy(id = "form:tabView:idTabGroupeControle:groupeCtrlDataTable")
    private WebElement idDatatablePrincipale;
    
    @FindBy(id = "idDialogGroupeControle:idTxtCodeGroupeCtrl")
    private WebElement idCode;
    
    @FindBy(id = "idDialogGroupeControle:idTxtLibelleGroupeCtrl")
    private WebElement idLibelle;
    
//    @FindBy(id = "idDialogGroupeControle:idTxtCompteTypeFabrication")
//    private WebElement idCompte;
    
    //////////////////////////////////////
    // Réponses dialogue de confirmation
    //////////////////////////////////////
//    @FindBy(id = "form:tabView:idTabGroupeControle:idOuiConfirmFermerFamilleArticle")
//    private WebElement idOuiConfirmFermerFamilleArticle;
//    
//    @FindBy(id = "form:tabView:idTabGroupeControle:idNonConfirmFermerFamilleArticle")
//    private WebElement idNonConfirmFermerFamilleArticle;
//    
//    @FindBy(id = "form:tabView:idTabGroupeControle:idOuiConfirmSupprFamilleArticle")
//    private WebElement idOuiConfirmSupprFamilleArticle;
//    
//    @FindBy(id = "form:tabView:idTabGroupeControle:idNonConfirmSupprFamilleArticle")
...
//    private static final String messageErreurUnique = "unique constraint";
    ...
    public static void oneTimeSetUp() {
    	...
    	GroupeControleTest test = new GroupeControleTest();
...
//    	 guardAjax(logoutLink).click();
    ...
    public void ouvrirEcran() {
        ...
        waitGui().until().element(actionMenuGroupeControles).is().visible();
        guardAjax(actionMenuGroupeControles).click();
