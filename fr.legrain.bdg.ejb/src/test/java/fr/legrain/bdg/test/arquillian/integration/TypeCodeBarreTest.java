...
public class TypeCodeBarreTest {
...
//    private WebElement logoutLink;
    ...
    @FindBy(id = "idFormMenu:idMenuTypeCodeBarre")
    private WebElement actionMenuTypeCodeBarre;
    
    //////////////////
    // Panel / DIV
    //////////////////                         
    @FindBy(id = "form:tabView:idTabTypeCodeBarre:typeCodeBarreFormPrincipal")
    private WebElement idFormPrincipal;
    
    @FindBy(id = "idDialogTypeCodeBarre:typeCodeBarreMessages")
    private WebElement idMessageJSFDialogue;
    
    ///////////////////////////
    // Boutons / Liens actions
    ///////////////////////////
    @FindBy(id = "idDialogTypeCodeBarre:idEnregistrerTypeCodeBarre")
    private WebElement idEnregistrer;
    
    @FindBy(id = "idDialogTypeCodeBarre:typeCodeBarreAnnulerDialogue")
    private WebElement idAnnuler;
    
    @FindBy(id = "form:tabView:idTabTypeCodeBarre:idModifierTypeCodeBarre")
    private WebElement idModifier;
    
    @FindBy(id = "form:tabView:idTabTypeCodeBarre:typeCodeBarreSupprimer")
    private WebElement idSupprimer;
    
    @FindBy(id = "form:tabView:idTabTypeCodeBarre:idInsererTypeCodeBarre")
    private WebElement idInserer;
    
    @FindBy(id = "form:tabView:idTabTypeCodeBarre:typeCodeBarreFermer")
    private WebElement idFermer;
    
    ///////////////////////////
    // Champ de formulaire
    ///////////////////////////
    @FindBy(id = "idDialogTypeCodeBarre")
    private WebElement idDialogTypeCodeBarre;
    
    @FindBy(id = "form:tabView:idTabTypeCodeBarre:typeCodeBarreDataTable")
    private WebElement idDatatablePrincipale;
    
    @FindBy(id = "idDialogTypeCodeBarre:idTxtCodeTypeCodeBarre")
    private WebElement idCode;
    
    @FindBy(id = "idDialogTypeCodeBarre:idTxtLibelleTypeCodeBarre")
    private WebElement idLibelle;
    
//    @FindBy(id = "idDialogTypeCodeBarre:idTxtCompteTypeCodeBarre")
//    private WebElement idCompte;
    
    //////////////////////////////////////
    // Réponses dialogue de confirmation
    //////////////////////////////////////
//    @FindBy(id = "form:tabView:idTabTypeCodeBarre:idOuiConfirmFermerFamilleArticle")
//    private WebElement idOuiConfirmFermerFamilleArticle;
//    
//    @FindBy(id = "form:tabView:idTabTypeCodeBarre:idNonConfirmFermerFamilleArticle")
//    private WebElement idNonConfirmFermerFamilleArticle;
//    
//    @FindBy(id = "form:tabView:idTabTypeCodeBarre:idOuiConfirmSupprFamilleArticle")
//    private WebElement idOuiConfirmSupprFamilleArticle;
//    
//    @FindBy(id = "form:tabView:idTabTypeCodeBarre:idNonConfirmSupprFamilleArticle")
...
//    private static final String messageErreurUnique = "unique constraint";
    ...
    public static void oneTimeSetUp() {
    	...
    	TypeCodeBarreTest test = new TypeCodeBarreTest();
...
//    	 guardAjax(logoutLink).click();
    ...
    public void ouvrirEcran() {
        ...
        waitGui().until().element(actionMenuTypeCodeBarre).is().visible();
        guardAjax(actionMenuTypeCodeBarre).click();
