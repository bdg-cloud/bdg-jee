...
//    private WebElement logoutLink;
    ...
    @FindBy(id = "idFormMenu:idMenuParamTypeEntite")
    private WebElement actionMenuTypeEntite;
    
    //////////////////
    // Panel / DIV
    //////////////////                         
    @FindBy(id = "form:tabView:idTabTypeEntite:typeEntiteFormPrincipal")
    private WebElement idFormPrincipal;
    
    @FindBy(id = "idDialogTypeEntite:typeEntiteMessages")
    private WebElement idMessageJSFDialogue;
    
    ///////////////////////////
    // Boutons / Liens actions
    ///////////////////////////
    @FindBy(id = "idDialogTypeEntite:idEnregistrerTypeEntite")
    private WebElement idEnregistrer;
    
    @FindBy(id = "idDialogTypeEntite:typeEntiteAnnulerDialogue")
    private WebElement idAnnuler;
    
    @FindBy(id = "form:tabView:idTabTypeEntite:idModifierTypeEntite")
    private WebElement idModifier;
    
    @FindBy(id = "form:tabView:idTabTypeEntite:typeEntiteSupprimer")
    private WebElement idSupprimer;
    
    @FindBy(id = "form:tabView:idTabTypeEntite:idInsererTypeEntite")
    private WebElement idInserer;
    
    @FindBy(id = "form:tabView:idTabTypeEntite:typeEntiteFermer")
    private WebElement idFermer;
    
    ///////////////////////////
    // Champ de formulaire
    ///////////////////////////
    @FindBy(id = "idDialogTypeEntite")
    private WebElement idDialogTypeEntite;
    
    @FindBy(id = "form:tabView:idTabTypeEntite:typeEntiteDataTable")
    private WebElement idDatatablePrincipale;
    
    @FindBy(id = "idDialogTypeEntite:idTxtCodeTypeEntite")
    private WebElement idCode;
    
    @FindBy(id = "idDialogTypeEntite:idTxtLibelleTypeEntite")
    private WebElement idLibelle;
//    
//    @FindBy(id = "idDialogTypeEntite:idTxtCommentaireFamilleArticle")
//    private WebElement idCommentaireFamilleArticle;
    
    //////////////////////////////////////
    // Réponses dialogue de confirmation
    //////////////////////////////////////
//    @FindBy(id = "form:tabView:idTabTypeEntite:idOuiConfirmFermerFamilleArticle")
//    private WebElement idOuiConfirmFermerFamilleArticle;
//    
//    @FindBy(id = "form:tabView:idTabTypeEntite:idNonConfirmFermerFamilleArticle")
//    private WebElement idNonConfirmFermerFamilleArticle;
//    
//    @FindBy(id = "form:tabView:idTabTypeEntite:idOuiConfirmSupprFamilleArticle")
//    private WebElement idOuiConfirmSupprFamilleArticle;
//    
//    @FindBy(id = "form:tabView:idTabTypeEntite:idNonConfirmSupprFamilleArticle")
...
//    private static final String messageErreurUnique = "unique constraint";
    ...
    public static void oneTimeSetUp() {
    	...
    	TypeEntiteTest test = new TypeEntiteTest();
...
//    	 guardAjax(logoutLink).click();
    ...
    public void ouvrirEcran() {
        ...
        waitGui().until().element(actionMenuTypeEntite).is().visible();
        guardAjax(actionMenuTypeEntite).click();
