...
//    private WebElement logoutLink;
    ...
    @FindBy(id = "idFormMenu:idMenuParamUniteArticle")
    private WebElement actionMenuUnite;
    
    //////////////////
    // Panel / DIV
    //////////////////                         
    @FindBy(id = "form:tabView:idTabUnite:uniteFormPrincipal")
    private WebElement idFormPrincipal;
    
    @FindBy(id = "idDialogTypeUnite:uniteMessages")
    private WebElement idMessageJSFDialogue;
    
    ///////////////////////////
    // Boutons / Liens actions
    ///////////////////////////
    @FindBy(id = "idDialogTypeUnite:idEnregistrerUnite")
    private WebElement idEnregistrer;
    
    @FindBy(id = "idDialogTypeUnite:uniteAnnulerDialogue")
    private WebElement idAnnuler;
    
    @FindBy(id = "form:tabView:idTabUnite:idModifierUnite")
    private WebElement idModifier;
    
    @FindBy(id = "form:tabView:idTabUnite:uniteSupprimer")
    private WebElement idSupprimer;
    
    @FindBy(id = "form:tabView:idTabUnite:idInsererUnite")
    private WebElement idInserer;
    
    @FindBy(id = "form:tabView:idTabUnite:uniteFermer")
    private WebElement idFermer;
    
    ///////////////////////////
    // Champ de formulaire
    ///////////////////////////
    @FindBy(id = "idDialogTypeUnite")
    private WebElement idDialogTypeUnite;
    
    @FindBy(id = "form:tabView:idTabUnite:uniteDataTable")
    private WebElement idDatatablePrincipale;
    
    @FindBy(id = "idDialogTypeUnite:idTxtCodeUnite")
    private WebElement idCode;
    
    @FindBy(id = "idDialogTypeUnite:idTxtLibelleUnite")
    private WebElement idLibelle;
    
    @FindBy(id = "idDialogTypeUnite:idAcFamilleUnite")
    private WebElement idAcFamilleUnite;
    
    @FindBy(id = "idDialogTypeUnite:idTxtLongueurUnite")
    private WebElement idTxtLongueurUnite;
    
    @FindBy(id = "idDialogTypeUnite:idTxtLargeurUnite")
    private WebElement idTxtLargeurUnite;
    
    @FindBy(id = "idDialogTypeUnite:idTxtHauteurUnite")
    private WebElement idTxtHauteurUnite;
    
    @FindBy(id = "idDialogTypeUnite:idTxtPoidsUnite")
    private WebElement idTxtPoidsUnite;
    
    @FindBy(id = "idDialogTypeUnite:idTxtNbUnite")
    private WebElement idTxtNbUnite;

//    
//    @FindBy(id = "idDialogTypeUnite:idTxtCommentaireFamilleArticle")
//    private WebElement idCommentaireFamilleArticle;
    
    //////////////////////////////////////
    // Réponses dialogue de confirmation
    //////////////////////////////////////
//    @FindBy(id = "form:tabView:idTabUnite:idOuiConfirmFermerFamilleArticle")
//    private WebElement idOuiConfirmFermerFamilleArticle;
//    
//    @FindBy(id = "form:tabView:idTabUnite:idNonConfirmFermerFamilleArticle")
//    private WebElement idNonConfirmFermerFamilleArticle;
//    
//    @FindBy(id = "form:tabView:idTabUnite:idOuiConfirmSupprFamilleArticle")
//    private WebElement idOuiConfirmSupprFamilleArticle;
//    
//    @FindBy(id = "form:tabView:idTabUnite:idNonConfirmSupprFamilleArticle")
...
//    	 guardAjax(logoutLink).click();
    ...
    public void ouvrirEcran() {
        ...
        waitGui().until().element(actionMenuUnite).is().visible();
        guardAjax(actionMenuUnite).click();
