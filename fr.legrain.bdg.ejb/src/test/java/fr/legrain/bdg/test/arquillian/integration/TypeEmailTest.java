...
//    private WebElement logoutLink;
    ...
    @FindBy(id = "idFormMenu:idMenuParamTypeEmail")
    private WebElement actionMenuTypeEmail;
    
    //////////////////
    // Panel / DIV
    //////////////////                         
    @FindBy(id = "form:tabView:idTabTypeEmail:typeEmailFormPrincipal")
    private WebElement idFormPrincipal;
    
    @FindBy(id = "idDialogTypeEmail:typeEmailMessages")
    private WebElement idMessageJSFDialogue;
    
    ///////////////////////////
    // Boutons / Liens actions
    ///////////////////////////
    @FindBy(id = "idDialogTypeEmail:idEnregistrerTypeEmail")
    private WebElement idEnregistrer;
    
    @FindBy(id = "idDialogTypeEmail:typeEmailAnnulerDialogue")
    private WebElement idAnnuler;
    
    @FindBy(id = "form:tabView:idTabTypeEmail:idModifierTypeEmail")
    private WebElement idModifier;
    
    @FindBy(id = "form:tabView:idTabTypeEmail:typeEmailSupprimer")
    private WebElement idSupprimer;
    
    @FindBy(id = "form:tabView:idTabTypeEmail:idInsererTypeEmail")
    private WebElement idInserer;
    
    @FindBy(id = "form:tabView:idTabTypeEmail:typeEmailFermer")
    private WebElement idFermer;
    
    ///////////////////////////
    // Champ de formulaire
    ///////////////////////////
    @FindBy(id = "idDialogTypeEmail")
    private WebElement idDialogTypeEmail;
    
    @FindBy(id = "form:tabView:idTabTypeEmail:typeEmailDataTable")
    private WebElement idDatatablePrincipale;
    
    @FindBy(id = "idDialogTypeEmail:idTxtCodeTypeEmail")
    private WebElement idCode;
    
    @FindBy(id = "idDialogTypeEmail:idTxtLibelleTypeEmail")
    private WebElement idLibelle;
//    
//    @FindBy(id = "idDialogTypeEmail:idTxtCommentaireFamilleArticle")
//    private WebElement idCommentaireFamilleArticle;
    
    //////////////////////////////////////
    // Réponses dialogue de confirmation
    //////////////////////////////////////
//    @FindBy(id = "form:tabView:idTabTypeEmail:idOuiConfirmFermerFamilleArticle")
//    private WebElement idOuiConfirmFermerFamilleArticle;
//    
//    @FindBy(id = "form:tabView:idTabTypeEmail:idNonConfirmFermerFamilleArticle")
//    private WebElement idNonConfirmFermerFamilleArticle;
//    
//    @FindBy(id = "form:tabView:idTabTypeEmail:idOuiConfirmSupprFamilleArticle")
//    private WebElement idOuiConfirmSupprFamilleArticle;
//    
//    @FindBy(id = "form:tabView:idTabTypeEmail:idNonConfirmSupprFamilleArticle")
...
//    private static final String messageErreurUnique = "unique constraint";
    ...
    public static void oneTimeSetUp() {
    	...
    	TypeEmailTest test = new TypeEmailTest();
...
//    	 guardAjax(logoutLink).click();
    ...
    public void ouvrirEcran() {
        ...
        waitGui().until().element(actionMenuTypeEmail).is().visible();
        guardAjax(actionMenuTypeEmail).click();
...
//        idCommentaireFamilleArticle.sendKeys(VALEUR_CODE);
        ...
        waitAjax().until().element(idCode).is().not().present();
