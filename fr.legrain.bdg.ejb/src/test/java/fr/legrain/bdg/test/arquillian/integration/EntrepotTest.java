...
//    private WebElement logoutLink;
    ...
    @FindBy(id = "idFormMenu:idMenuEntrepot")
    private WebElement actionMenuEntrepot;
    
    //////////////////
    // Panel / DIV
    //////////////////                         
    @FindBy(id = "form:tabView:idTabEntrepot:entrepotFormPrincipal")
    private WebElement idFormPrincipal;
    
    @FindBy(id = "idDialogEntrepot:entrepotMessages")
    private WebElement idMessageJSFDialogue;
    
    ///////////////////////////
    // Boutons / Liens actions
    ///////////////////////////
    @FindBy(id = "idDialogEntrepot:idEnregistrerEntrepot")
    private WebElement idEnregistrer;
    
    @FindBy(id = "idDialogEntrepot:entrepotAnnulerDialogue")
    private WebElement idAnnuler;
    
    @FindBy(id = "form:tabView:idTabEntrepot:idModifierEntrepot")
    private WebElement idModifier;
    
    @FindBy(id = "form:tabView:idTabEntrepot:entrepotSupprimer")
    private WebElement idSupprimer;
    
    @FindBy(id = "form:tabView:idTabEntrepot:idInsererEntrepot")
    private WebElement idInserer;
    
    @FindBy(id = "form:tabView:idTabEntrepot:entrepotFermer")
    private WebElement idFermer;
    
    ///////////////////////////
    // Champ de formulaire
    ///////////////////////////
    @FindBy(id = "idDialogEntrepot")
    private WebElement idDialogEntrepot;
    
    @FindBy(id = "form:tabView:idTabEntrepot:entrepotDataTable")
    private WebElement idDatatablePrincipale;
    
    @FindBy(id = "idDialogEntrepot:idTxtCodeEntrepot")
    private WebElement idCode;
    
    @FindBy(id = "idDialogEntrepot:idTxtLibelleEntrepot")
    private WebElement idLibelle;
    
//    @FindBy(id = "idDialogEntrepot:idTxtCompteEntrepot")
//    private WebElement idCompte;
    
    //////////////////////////////////////
    // Réponses dialogue de confirmation
    //////////////////////////////////////
//    @FindBy(id = "form:tabView:idTabEntrepot:idOuiConfirmFermerFamilleArticle")
//    private WebElement idOuiConfirmFermerFamilleArticle;
//    
//    @FindBy(id = "form:tabView:idTabEntrepot:idNonConfirmFermerFamilleArticle")
//    private WebElement idNonConfirmFermerFamilleArticle;
//    
//    @FindBy(id = "form:tabView:idTabEntrepot:idOuiConfirmSupprFamilleArticle")
//    private WebElement idOuiConfirmSupprFamilleArticle;
//    
//    @FindBy(id = "form:tabView:idTabEntrepot:idNonConfirmSupprFamilleArticle")
...
//    private static final String messageErreurUnique = "unique constraint";
    ...
    public static void oneTimeSetUp() {
    	...
    	EntrepotTest test = new EntrepotTest();
...
//    	 guardAjax(logoutLink).click();
    ...
    public void ouvrirEcran() {
        ...
        waitGui().until().element(actionMenuEntrepot).is().visible();
        guardAjax(actionMenuEntrepot).click();
