...
public class TypeReceptionTest {
...
//    private WebElement logoutLink;
    ...
    @FindBy(id = "idFormMenu:idMenuTypeReception")
    private WebElement actionMenuTypeReception;
    
    //////////////////
    // Panel / DIV
    //////////////////                         
    @FindBy(id = "form:tabView:idTabTypeReception:typeReceptionFormPrincipal")
    private WebElement idFormPrincipal;
    
    @FindBy(id = "idDialogTypeReception:typeReceptionMessages")
    private WebElement idMessageJSFDialogue;
    
    ///////////////////////////
    // Boutons / Liens actions
    ///////////////////////////
    @FindBy(id = "idDialogTypeReception:idEnregistrerTypeReception")
    private WebElement idEnregistrer;
    
    @FindBy(id = "idDialogTypeReception:typeReceptionAnnulerDialogue")
    private WebElement idAnnuler;
    
    @FindBy(id = "form:tabView:idTabTypeReception:idModifierTypeReception")
    private WebElement idModifier;
    
    @FindBy(id = "form:tabView:idTabTypeReception:typeReceptionSupprimer")
    private WebElement idSupprimer;
    
    @FindBy(id = "form:tabView:idTabTypeReception:idInsererTypeReception")
    private WebElement idInserer;
    
    @FindBy(id = "form:tabView:idTabTypeReception:typeReceptionFermer")
    private WebElement idFermer;
    
    ///////////////////////////
    // Champ de formulaire
    ///////////////////////////
    @FindBy(id = "idDialogTypeReception")
    private WebElement idDialogTypeReception;
    
    @FindBy(id = "form:tabView:idTabTypeReception:typeReceptionDataTable")
    private WebElement idDatatablePrincipale;
    
    @FindBy(id = "idDialogTypeReception:idTxtCodeTypeReception")
    private WebElement idCode;
    
    @FindBy(id = "idDialogTypeReception:idTxtLibelleTypeReception")
    private WebElement idLibelle;
    
//    @FindBy(id = "idDialogTypeReception:idTxtCompteTypeReception")
//    private WebElement idCompte;
    
    //////////////////////////////////////
    // Réponses dialogue de confirmation
    //////////////////////////////////////
//    @FindBy(id = "form:tabView:idTabTypeReception:idOuiConfirmFermerFamilleArticle")
//    private WebElement idOuiConfirmFermerFamilleArticle;
//    
//    @FindBy(id = "form:tabView:idTabTypeReception:idNonConfirmFermerFamilleArticle")
//    private WebElement idNonConfirmFermerFamilleArticle;
//    
//    @FindBy(id = "form:tabView:idTabTypeReception:idOuiConfirmSupprFamilleArticle")
//    private WebElement idOuiConfirmSupprFamilleArticle;
//    
//    @FindBy(id = "form:tabView:idTabTypeReception:idNonConfirmSupprFamilleArticle")
...
//    private static final String messageErreurUnique = "unique constraint";
    ...
    public static void oneTimeSetUp() {
    	...
    	TypeReceptionTest test = new TypeReceptionTest();
...
//    	 guardAjax(logoutLink).click();
    ...
    public void ouvrirEcran() {
        ...
        waitGui().until().element(actionMenuTypeReception).is().visible();
        guardAjax(actionMenuTypeReception).click();
