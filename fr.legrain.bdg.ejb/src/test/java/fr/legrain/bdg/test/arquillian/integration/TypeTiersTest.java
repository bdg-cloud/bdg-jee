...
//    private WebElement logoutLink;
    ...
    @FindBy(id = "idFormMenu:idMenuParamTypeTiers")
    private WebElement actionMenuTypeTiers;
    
    //////////////////
    // Panel / DIV
    //////////////////                         
    @FindBy(id = "form:tabView:idTabTypeTiers:typeTiersFormPrincipal")
    private WebElement idFormPrincipal;
    
    @FindBy(id = "idDialogTypeTiers:typeTiersMessages")
    private WebElement idMessageJSFDialogue;
    
    ///////////////////////////
    // Boutons / Liens actions
    ///////////////////////////
    @FindBy(id = "idDialogTypeTiers:idEnregistrerTypeTiers")
    private WebElement idEnregistrer;
    
    @FindBy(id = "idDialogTypeTiers:typeTiersAnnulerDialogue")
    private WebElement idAnnuler;
    
    @FindBy(id = "form:tabView:idTabTypeTiers:idModifierTypeTiers")
    private WebElement idModifier;
    
    @FindBy(id = "form:tabView:idTabTypeTiers:typeTiersSupprimer")
    private WebElement idSupprimer;
    
    @FindBy(id = "form:tabView:idTabTypeTiers:idInsererTypeTiers")
    private WebElement idInserer;
    
    @FindBy(id = "form:tabView:idTabTypeTiers:typeTiersFermer")
    private WebElement idFermer;
    
    ///////////////////////////
    // Champ de formulaire
    ///////////////////////////
    @FindBy(id = "idDialogTypeTiers")
    private WebElement idDialogTypeTiers;
    
    @FindBy(id = "form:tabView:idTabTypeTiers:typeTiersDataTable")
    private WebElement idDatatablePrincipale;
    
    @FindBy(id = "idDialogTypeTiers:idTxtCodeTypeTiers")
    private WebElement idCode;
    
    @FindBy(id = "idDialogTypeTiers:idTxtLibelleTypeTiers")
    private WebElement idLibelle;
    
    @FindBy(id = "idDialogTypeTiers:idTxtCompteTypeTiers")
    private WebElement idCompte;
    
    //////////////////////////////////////
    // Réponses dialogue de confirmation
    //////////////////////////////////////
//    @FindBy(id = "form:tabView:idTabTypeTiers:idOuiConfirmFermerFamilleArticle")
//    private WebElement idOuiConfirmFermerFamilleArticle;
//    
//    @FindBy(id = "form:tabView:idTabTypeTiers:idNonConfirmFermerFamilleArticle")
//    private WebElement idNonConfirmFermerFamilleArticle;
//    
//    @FindBy(id = "form:tabView:idTabTypeTiers:idOuiConfirmSupprFamilleArticle")
//    private WebElement idOuiConfirmSupprFamilleArticle;
//    
//    @FindBy(id = "form:tabView:idTabTypeTiers:idNonConfirmSupprFamilleArticle")
...
//    private static final String messageErreurUnique = "unique constraint";
    ...
    public static void oneTimeSetUp() {
    	...
    	TypeTiersTest test = new TypeTiersTest();
...
//    	 guardAjax(logoutLink).click();
    ...
    public void ouvrirEcran() {
        ...
        waitGui().until().element(actionMenuTypeTiers).is().visible();
        guardAjax(actionMenuTypeTiers).click();
...
//        fail("Test à finir : Vérifier les messages d'erreurs");
    ...
    @Test
    public void insertionCompteObligatoire() {
