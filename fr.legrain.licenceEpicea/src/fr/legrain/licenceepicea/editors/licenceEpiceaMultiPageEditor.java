...
import fr.legrain.licenceepicea.pluginLicenceEpicea;
 ...
 * </ul>
 */
public class licenceEpiceaMultiPageEditor extends AbstractLgrMultiPageEditorSupport implements 
ILgrRetourEditeur, IChangementDePageListener,IChangementMasterEntityListener , IChangementDeSelectionListener,
IAnnuleToutListener{

	
	public static final String ID_EDITOR = "fr.legrain.licenceEpicea.multi"; //$NON-NLS-1$
	static Logger logger = Logger.getLogger(licenceEpiceaMultiPageEditor.class.getName());
	...
	protected EditorLicenceEpicea editorLicenceEpicea = null;

	/**
	 * Creates a multi-page editor example.
	 */
	public licenceEpiceaMultiPageEditor() {
		super();
	...
	protected void createPageQueEditeur() {
		try {
			editorLicenceEpicea = new EditorLicenceEpicea(this,em);
			...
			setPageImage(index, pluginLicenceEpicea.getImageDescriptor(iconPage1).createImage());
			...
			ParamAfficheLicenceEpicea paramAfficheRelanceFacture = new ParamAfficheLicenceEpicea();
