package fr.legrain.licenceepicea.ecrans;
...
*/
public class PaEpiceaSWT extends PaLicenceSWT {

	public PaEpiceaSWT(Composite parent, int style) {
		super(parent, style);
...
//		PaEpiceaSWT inst = new PaEpiceaSWT(shell, SWT.NULL);
...
//
//
//	public PaEpiceaSWT(org.eclipse.swt.widgets.Composite parent, int style) {
//		super(parent, style);
//		initGUI();
//	}
//
