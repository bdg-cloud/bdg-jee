...
import fr.legrain.statistiques.controllers.TabControllerClients.BestClientsIHM;
import fr.legrain.statistiques.controllers.TabControllerClients.MapperBestClientsIHMBestClients;
 ...
 *
 */
public class TabControllerClientsApporteur extends TabControllerClients {

	public TabControllerClientsApporteur(
	...
	public void initialiseModelIHM(int nbResult) {
		...
		super.listeClients = taApporteurDAO.findMeilleursClientsParCA(
