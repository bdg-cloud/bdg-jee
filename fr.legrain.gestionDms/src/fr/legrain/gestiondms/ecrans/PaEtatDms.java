package fr.legrain.gestiondms.ecrans;
...
*/
public class PaEtatDms extends org.eclipse.swt.widgets.Composite {
	...
	*/
	public static void showGUI() {
		...
		PaEtatDms inst = new PaEtatDms(shell, SWT.NULL);
	...
	public PaEtatDms(org.eclipse.swt.widgets.Composite parent, int style) {
		super(parent, style);
		initGUI();
	}
		...
		try {
			...
			this.setSize(705, 411);
			{
				...
				group1.setLayoutData(group1LData);
				{
					...
					laDATEDEB.setText("Mois");
				}
				{
					tfMOIS = new Text(group1,  SWT.BORDER);
					...
					//tfDATEDEBLData.heightHint = 9;
					tfMOIS.setLayoutData(tfDATEDEBLData);
					//tfMOIS.setSize(120, 19);
				}
				{
	...
	public Text getTfMOIS() {
		return tfMOIS;
	}

	public Text getTfANNEE() {
		return tfANNEE;
	}
