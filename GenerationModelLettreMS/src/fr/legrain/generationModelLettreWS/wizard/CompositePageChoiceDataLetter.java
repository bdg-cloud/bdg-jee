		...
		try {
			...
			this.setSize(428, 465);
			{
				...
				}
				{
					...
					comboChoixParamPublipostageData.heightHint = 16;
...
//				}
			}
			{
				...
				grpFileSeparateur.setText("Option séparateur donnée");
				...
				grpFileSeparateur.setFont(SWTResourceManager.getFont("Sans", 8, 1, false, false));
				{
					...
					labelChoixFileSeparateur.setText("Choix de Séparateur :");
				...
				}
				{
					...
					btOptionFileSeparateur.setText("Choix séparateur");
