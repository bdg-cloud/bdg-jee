...
;"Constantes"
!define REPERTOIRE_EXPORT_RCP "C:\Projet\Java\Eclipse\GestionCommerciale\installeurNSIS\install\Build_GestionCommercialeCogere\"
...
!define INSTALLEUR_SHOWMYPC "ShowMyPC2941.exe"
...
XPStyle on
OutFile "Setups\setup_cogere\a_tester\setup_BdG_Cogere_a_tester.exe"
...
Section -AdditionalIcons
  ...
  CreateDirectory "$SMPROGRAMS\Legrain\Utilitaire"
  ...
  CreateShortCut "$SMPROGRAMS\Legrain\Utilitaire\ShowMyPC.lnk" "$INSTDIR\${INSTALLEUR_SHOWMYPC}"
...
Function desinstallBDG
  ...
  Delete "$SMPROGRAMS\Legrain\Utilitaire\ShowMyPC.lnk" 
  Delete "$DESKTOP\ShowMyPC.lnk" 
  

  RMDir "$SMPROGRAMS\Legrain\Bureau de gestion"
  
  RMDir "$SMPROGRAMS\Legrain\Utilitaire"
  RMDir /r "$INSTDIR"
  ;RMDir "$INSTDIR"
