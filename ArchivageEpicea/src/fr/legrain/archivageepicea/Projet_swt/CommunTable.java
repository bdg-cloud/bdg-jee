...
*/
public class CommunTable extends org.eclipse.swt.widgets.Composite {
	...
	*/
	public static void showGUI() {
		...
		CommunTable inst = new CommunTable(shell, SWT.NULL);
	...
	public CommunTable(org.eclipse.swt.widgets.Composite parent, int style) {
		super(parent, style);
		initGUI();
	}
	...
	private void initGUI() {
		try {
			...
			this.setSize(919, 549);
			{
				...
				table = new Table(this, SWT.SINGLE | SWT.FULL_SELECTION | SWT.H_SCROLL | SWT.V_SCROLL | SWT.BORDER);
