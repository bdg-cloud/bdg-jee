...
#sed -i s#"HUDSON"#"r$SVN_REVISION *** $BUILD_ID *** $BUILD_TAG ($BRANCHE)"#g $BASE_SCM/GestionCommerciale/plugin.properties
sed -i s#"HUDSON"#"r$SVN_REVISION *** $BUILD_ID *** $BUILD_TAG ($BRANCHE)"#g $WORKSPACE/svn/fr.legrain.bdg.webapp/src/main/webapp/about.xhtml

sed -i s#"HUDSON"#"r$SVN_REVISION *** $BUILD_ID *** $BUILD_TAG ($BRANCHE)"#g $WORKSPACE/svn/fr.legrain.bdg.webapp/src/main/resources/message_bundles/messages.properties
...
sed -i s#"BUILD_DATE_MILLIS"#"$(date +%s)"#g $WORKSPACE/svn/fr.legrain.bdg.webapp/src/main/resources/message_bundles/messages.properties
