...
BUILD_FILE="./db.build_MAJ_login_db.xml"
...
echo "==========================================="
echo "Mise à jour de la base de donnée 'login_db'";
echo "==========================================="
	
echo "==================================================="
version=$(psql -U $PGUSER -h localhost -d login_db -t -c "SELECT old_version from ta_version")
