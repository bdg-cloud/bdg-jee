...
public class ParamAfficheChampSuppArticle extends ParamAffiche {
	public static final String C_TITRE_FORMULAIRE = "Fiche ";
	public static final String C_TITRE_GRILLE = "Liste des ";
	public static final String C_SOUS_TITRE = "Gestion des ";
	private JComponent focusDefaut = null;
	private String idArticle = null;
	private Control focusDefautSWT = null;

	public ParamAfficheChampSuppArticle() {
