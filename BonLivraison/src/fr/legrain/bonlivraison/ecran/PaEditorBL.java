 ...
 */
public class PaEditorBL extends org.eclipse.swt.widgets.Composite {
...
//	}
	...
	//private Text tfDATE_LIV_BONLIV;
//	private Text tfDATE_ECH_BONLIV;
//	private Label laDATE_ECH_BONLIV;
	//private Text tfDATE_BONLIV;
...
//	private cdatetimeLgr dateTimeDATE_ECH_BONLIV;
...
//	private DecoratedField fieldDATE_ECH_BONLIV;
	...
	public static void showGUI() {
		...
		PaEditorBL inst = new PaEditorBL(shell, SWT.NULL);
	...
	public PaEditorBL(org.eclipse.swt.widgets.Composite parent, int style) {
		super(parent, style);
		initGUI();
	}
	...
	private void initGUI() {
		try {
			...
			this.setSize(1059, 715);
			{
				...
				paEntete.setText("Entête du bon de livraison");
				{
					laCODE_DOCUMENT = new Label(paEntete, SWT.NONE);
					laCODE_DOCUMENT.setText("Code bon livraison");
				}
				{
					...
					if(!decore) {
						...
						tfCODE_DOCUMENT.setText("CODE_BONLIV");
					} else {
				...
				}
				{
					...
					laDATE_DOCUMENT.setText("Date bon livraison");
				}
				{
					GridData dateTimeDATE_BONLIVLData = new GridData();
					dateTimeDATE_BONLIVLData.widthHint = 90;
					dateTimeDATE_BONLIVLData.verticalAlignment = GridData.FILL;

				if(!decore) {
					dateTimeDATE_DOCUMENT = new DateTime(paEntete, SWT.BORDER | SWT.DROP_DOWN);
					dateTimeDATE_DOCUMENT.setLayoutData(dateTimeDATE_BONLIVLData);
					} else {
					...
					fieldDATE_DOCUMENT.getLayoutControl().setLayoutData(dateTimeDATE_BONLIVLData);
					}
//					dateTimeDATE_DOCUMENT.setPattern("dd/MM/yyyy");
				...
				}
				{
					...
					if(!decore) {
						...
						tfLIBELLE_DOCUMENT.setText("LIBELLE_BONLIV");
					} else {
...
//				{
//					laDATE_ECH_BONLIV = new Label(paEntete, SWT.NONE);
//					laDATE_ECH_BONLIV.setText("date échéance");
//				}
//				{
////					if(!decore) {
//					dateTimeDATE_ECH_BONLIV = new cdatetimeLgr(paEntete, CDT.BORDER
//							| CDT.DROP_DOWN);
////					} else {
////					fieldDATE_ECH_FACTURE = new DecoratedField(paEntete, CDT.BORDER | CDT.DROP_DOWN, new CDateTimeControlCreator());
////					dateTimeDATE_ECH_FACTURE = (CDateTime)fieldDATE_ECH_FACTURE.getControl();
////					}
//					dateTimeDATE_ECH_BONLIV.setPattern("dd/MM/yy  ");
//					GridData dateTimeDATE_ECH_FACTURELData = new GridData();
//					dateTimeDATE_ECH_FACTURELData.widthHint = 90;
//					dateTimeDATE_ECH_FACTURELData.verticalAlignment = GridData.FILL;
//					dateTimeDATE_ECH_BONLIV.setLayoutData(dateTimeDATE_ECH_FACTURELData);
//					dateTimeDATE_ECH_BONLIV.setSize(90, 20);
//				}
				{
				...
				{
					GridData dateTimeDATE_LIV_BONLIVLData = new GridData();
					dateTimeDATE_LIV_BONLIVLData.widthHint = 90;
					dateTimeDATE_LIV_BONLIVLData.verticalAlignment = GridData.FILL;

				if(!decore) {
					dateTimeDATE_LIV_DOCUMENT = new DateTime(paEntete, SWT.BORDER | SWT.DROP_DOWN);
					dateTimeDATE_LIV_DOCUMENT.setLayoutData(dateTimeDATE_LIV_BONLIVLData);
					} else {
					...
					fieldDATE_LIV_DOCUMENT.getLayoutControl().setLayoutData(dateTimeDATE_LIV_BONLIVLData);
					}
...
//	public Label getLaDATE_ECH_BONLIV() {
//		return laDATE_ECH_BONLIV;
//	}
//
//	public Text getTfDATE_ECH_BONLIV() {
//		return tfDATE_ECH_BONLIV;
//	}
...
//	public cdatetimeLgr getDateTimeDATE_ECH_BONLIV() {
//		return dateTimeDATE_ECH_BONLIV;
//	}
...
//	public DecoratedField getFieldDATE_ECH_BONLIV() {
//		return fieldDATE_ECH_BONLIV;
//	}
