 ...
 */
public class PaTotauxBL extends org.eclipse.swt.widgets.Composite {
	private Table tableTVA;
	private Composite paTotaux;
	private Label laTX_REM_HT_BONLIV;
	private Text tfCODE_T_PAIEMENT;
	private Label laCODE_T_PAIEMENT;
	//private Text tfREGLE_DEVIS;
	//private Label laREGLE_DEVIS;
	...
	private Text tfTX_REM_TTC_BONLIV;
	private Label laTX_REM_TTC_BONLIV;
	private Text tfTX_REM_HT_BONLIV;

	private DecoratedField fieldMT_TTC_CALC;
	private DecoratedField fieldTTC;
	private DecoratedField fieldTX_REM_TTC_BONLIV;
	private DecoratedField fieldMT_HT_CALC;
	private DecoratedField fieldTX_REM_HT_BONLIV;
	private DecoratedField fieldREGLE_BONLIV;
	...
	public static void showGUI() {
		...
		PaTotauxBL inst = new PaTotauxBL(shell, SWT.NULL);
	...
	public PaTotauxBL(org.eclipse.swt.widgets.Composite parent, int style) {
		super(parent, style);
		initGUI();
	}
	...
	private void initGUI() {
		try {
			...
			}
			{
				...
				{
					laTX_REM_HT_BONLIV = new Label(paTotaux, SWT.NONE);
					laTX_REM_HT_BONLIV.setText("Remise globale %");
				}
				{
					GridData tfTX_REM_HT_FACTURELData = new GridData();
					tfTX_REM_HT_FACTURELData.widthHint = 127;
					if(!decore) {
						tfTX_REM_HT_BONLIV = new Text(paTotaux, SWT.BORDER);
						tfTX_REM_HT_BONLIV.setLayoutData(tfTX_REM_HT_FACTURELData);
						tfTX_REM_HT_BONLIV.setText("TX_REM_HT_BONLIV");
					} else {
						fieldTX_REM_HT_BONLIV = new DecoratedField(paTotaux, SWT.BORDER, new TextControlCreator());
						tfTX_REM_HT_BONLIV = (Text)fieldTX_REM_HT_BONLIV.getControl();
						fieldTX_REM_HT_BONLIV.getLayoutControl().setLayoutData(tfTX_REM_HT_FACTURELData);
					}
				}
				{
					laTX_REM_TTC_BONLIV = new Label(paTotaux, SWT.NONE);
					laTX_REM_TTC_BONLIV.setText("Escompte accordé %");
				}
				{
					...
					if(!decore) {
						tfTX_REM_TTC_BONLIV = new Text(paTotaux, SWT.BORDER);
						tfTX_REM_TTC_BONLIV.setLayoutData(tfTX_REM_TTC_FACTURELData);
						tfTX_REM_TTC_BONLIV.setText("TX_REM_TTC_FACTURE");
					} else {
						fieldTX_REM_TTC_BONLIV = new DecoratedField(paTotaux, SWT.BORDER, new TextControlCreator());
						tfTX_REM_TTC_BONLIV = (Text)fieldTX_REM_TTC_BONLIV.getControl();
						fieldTX_REM_TTC_BONLIV.getLayoutControl().setLayoutData(tfTX_REM_TTC_FACTURELData);
					}
				}
				{
...
//				{
//					laREGLE_DEVIS = new Label(paTotaux, SWT.NONE);
//					laREGLE_DEVIS.setText("Réglé");
//				}
//				{
//					GridData tfREGLE_FACTURELData = new GridData();
//					tfREGLE_FACTURELData.widthHint = 125;
//					if(!decore) {
//						tfREGLE_DEVIS = new Text(paTotaux, SWT.BORDER);
//						tfREGLE_DEVIS.setLayoutData(tfREGLE_FACTURELData);
//						tfREGLE_DEVIS.setText("REGLE_FACTURE");
//					} else {
//						fieldREGLE_DEVIS = new DecoratedField(paTotaux, SWT.BORDER, new TextControlCreator());
//						tfREGLE_DEVIS = (Text)fieldREGLE_DEVIS.getControl();
//						fieldREGLE_DEVIS.getLayoutControl().setLayoutData(tfREGLE_FACTURELData);
//					}
//				}
				{
...
//	}
	...
	public Label getLaTX_REM_HT_BONLIV() {
		return laTX_REM_HT_BONLIV;
	}
...
//	}
	...
	public Text getTfTX_REM_TTC_BONLIV() {
		return tfTX_REM_TTC_BONLIV;
	}

	public Label getLaTX_REM_TTC_BONLIV() {
		return laTX_REM_TTC_BONLIV;
	}

	public Text getTfTX_REM_HT_BONLIV() {
		return tfTX_REM_HT_BONLIV;
	}
	...
	public DecoratedField getFieldTX_REM_TTC_BONLIV() {
		return fieldTX_REM_TTC_BONLIV;
	}
	...
	public DecoratedField getFieldTX_REM_HT_BONLIV() {
		return fieldTX_REM_HT_BONLIV;
	}

	public DecoratedField getFieldREGLE_BONLIV() {
		return fieldREGLE_BONLIV;
	}
