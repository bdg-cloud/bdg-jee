...
public class EditorTotaux extends JPALgrEditorPart implements ILgrEditor, ILgrRetourEditeur {
	...
	public static final String ID = "fr.legrain.editor.bonliv.EditorTotaux";
	
	private boolean enabled = true;
	private PaTotauxBL composite = null;
	...
	public void createPartControl(Composite parent) {
		composite = new PaTotauxBL(parent,SWT.NONE);
		if(getController()==null) {
			setController(new PaEditorTotauxBLController(composite,em));
		} else {
	...
	public PaTotauxBL getComposite() {
		return composite;
	}
