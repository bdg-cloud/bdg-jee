...
public class EditorLigne extends JPALgrEditorPart implements ILgrEditor, ILgrRetourEditeur {
	...
	public static final String ID = "fr.legrain.editor.bonliv.EditorLigne";
	
	private boolean enabled = true;
	private PaSaisieLigneBL composite = null;
	...
	public void createPartControl(Composite parent) {
		composite = new PaSaisieLigneBL(parent,SWT.NONE);
		if(getController()==null) {
			setController(new PaLigneBLController(composite,em));
		} else {
	...
	public PaSaisieLigneBL getComposite() {
		return composite;
	}
