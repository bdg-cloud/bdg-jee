 ...
 */
public class pluginAcompte extends AbstractUIPlugin {
	static Logger logger = Logger.getLogger(pluginAcompte.class.getName());

	// The shared instance
	private static pluginAcompte plugin;
	// The plug-in ID
	//public static final String PLUGIN_ID = "fr.legrain.acompte";
	public static final String PLUGIN_ID = "Acompte";
	 ...
	 */
	public static pluginAcompte getDefault() {
		return plugin;
	}
	/**
