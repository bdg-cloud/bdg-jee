...
*/
public class PaImpressionAcompteSWT extends org.eclipse.swt.widgets.Composite {
	...
	*/
	public static void showGUI() {
		...
		PaImpressionAcompteSWT inst = new PaImpressionAcompteSWT(shell, SWT.NULL);
	...
	public PaImpressionAcompteSWT(org.eclipse.swt.widgets.Composite parent, int style) {
		super(parent, style);
		initGUI();
	}
