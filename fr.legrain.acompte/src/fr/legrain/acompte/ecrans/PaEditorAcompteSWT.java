 ...
 */
public class PaEditorAcompteSWT extends org.eclipse.swt.widgets.Composite {
...
//	private cdatetimeLgr dateTimeDATE_LIV_FACTURE;
//	private cdatetimeLgr dateTimeDATE_ECH_FACTURE;
	...
	public static void showGUI() {
		...
		PaEditorAcompteSWT inst = new PaEditorAcompteSWT(shell, SWT.NULL);
	...
	public PaEditorAcompteSWT(org.eclipse.swt.widgets.Composite parent, int style) {
		super(parent, style);
		initGUI();
	}
		...
		try {
			...
			this.setSize(1059, 715);
			{
				...
				}
				{
					...
					dateTimeDATE_FACTURELData.widthHint = 90;
...
//
//				if(!decore) {
//					dateTimeDATE_ECH_FACTURE = new cdatetimeLgr(paEntete, CDT.BORDER | CDT.DROP_DOWN);
//					dateTimeDATE_ECH_FACTURE.setLayoutData(dateTimeDATE_ECH_FACTURELData);
//					} else {
//						fieldDATE_ECH_DOCUMENT = new DecoratedField(paEntete, CDT.BORDER | CDT.DROP_DOWN, new CDateTimeControlCreator());
//					dateTimeDATE_ECH_FACTURE = (cdatetimeLgr)fieldDATE_ECH_DOCUMENT.getControl();
//					fieldDATE_ECH_DOCUMENT.getLayoutControl().setLayoutData(dateTimeDATE_ECH_FACTURELData);
//					}
//				dateTimeDATE_ECH_FACTURE.setPattern("dd/MM/yy  ");
//				}
//				{
...
//					dateTimeDATE_LIV_FACTURELData.widthHint = 90;
//					dateTimeDATE_LIV_FACTURELData.verticalAlignment = GridData.FILL;
//
//				if(!decore) {
//					dateTimeDATE_LIV_FACTURE = new cdatetimeLgr(paEntete, CDT.BORDER | CDT.DROP_DOWN);
//					dateTimeDATE_LIV_FACTURE.setLayoutData(dateTimeDATE_LIV_FACTURELData);
//					} else {
//						fieldDATE_LIV_DOCUMENT = new DecoratedField(paEntete, CDT.BORDER | CDT.DROP_DOWN, new CDateTimeControlCreator());
//						dateTimeDATE_LIV_FACTURE = (cdatetimeLgr)fieldDATE_LIV_DOCUMENT.getControl();
//					fieldDATE_LIV_DOCUMENT.getLayoutControl().setLayoutData(dateTimeDATE_LIV_FACTURELData);
//					}
//				dateTimeDATE_LIV_FACTURE.setPattern("dd/MM/yy  ");					
//				}
			}
...
//	public cdatetimeLgr getDateTimeDATE_ECH_FACTURE() {
...
//	public cdatetimeLgr getDateTimeDATE_LIV_FACTURE() {
//		return dateTimeDATE_LIV_FACTURE;
//	}
