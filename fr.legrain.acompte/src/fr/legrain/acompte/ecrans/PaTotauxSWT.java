...
//	private Label laREGLE_FACTURE;
	private Text tfCOMPTEBANQUE;
	private Label laCOMPTEBANQUE;
	...
	private DecoratedField fieldTX_REM_TTC_FACTURE;
	private DecoratedField fieldMT_HT_CALC;
	private DecoratedField fieldTX_REM_HT_FACTURE;
//	private DecoratedField fieldREGLE_FACTURE;
	private DecoratedField fieldCODE_T_PAIEMENT;
	private DecoratedField fieldCOMPTEBANQUE;
...
//				}
				{
					laCOMPTEBANQUE = new Label(paTotaux, SWT.NONE);
					GridData laCOMPTEBANQUELData = new GridData();
					laCOMPTEBANQUE.setLayoutData(laCOMPTEBANQUELData);
					laCOMPTEBANQUE.setText("Compte bancaire");
				}
				{
					GridData tfCOMPTEBANQUELData = new GridData();
					tfCOMPTEBANQUELData.widthHint = 125;
					tfCOMPTEBANQUELData.heightHint = 19;
					if(!decore) {
						tfCOMPTEBANQUE = new Text(paTotaux, SWT.BORDER);
						tfCOMPTEBANQUE.setLayoutData(tfCOMPTEBANQUELData);
						tfCOMPTEBANQUE.setText("COMPTEBANQUE");
					} else {
						fieldCOMPTEBANQUE = new DecoratedField(paTotaux, SWT.BORDER, new TextControlCreator());
						tfCOMPTEBANQUE = (Text)fieldCOMPTEBANQUE.getControl();
						fieldCOMPTEBANQUE.getLayoutControl().setLayoutData(tfCOMPTEBANQUELData);
					}
				}				
				...
				}
				{
					...
					tfCODE_T_PAIEMENTLData.widthHint = 41;
					tfCODE_T_PAIEMENTLData.heightHint = 19;
					if(!decore) {
...
//	}
//
//	public Label getLaREGLE_FACTURE() {
//		return laREGLE_FACTURE;
//	}
	...
	public DecoratedField getFieldTX_REM_TTC_FACTURE() {
	...
	public DecoratedField getFieldTX_REM_HT_FACTURE() {
		return fieldTX_REM_HT_FACTURE;
	}

//	public DecoratedField getFieldREGLE_FACTURE() {
...
//	}
	...
	public Text getTfCOMPTEBANQUE() {
		return tfCOMPTEBANQUE;
	}

	public Label getLaCOMPTEBANQUE() {
		return laCOMPTEBANQUE;
	}

	public DecoratedField getFieldCOMPTEBANQUE() {
		return fieldCOMPTEBANQUE;
	}
