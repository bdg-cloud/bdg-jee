 ...
 * </ul>
 */
public class EtatMultiPageEditor extends AbstractLgrMultiPageEditor implements ILgrRetourEditeur, IChangementDePageListener, IChangementDeSelectionListener{
//public class MultiPageEditor extends FormEditor {
//public class MultiPageEditor extends SharedHeaderFormEditor {
	
	public static final String ID_EDITOR = "fr.legrain.editor.etat.multi"; //$NON-NLS-1$
	static Logger logger = Logger.getLogger(EtatMultiPageEditor.class.getName());
	...
	private EditorEtatFamille editorDms = null;
	...
	void createPageQueEditeur() {
		try {
			...
			editorDms = new EditorEtatFamille(this,em);
