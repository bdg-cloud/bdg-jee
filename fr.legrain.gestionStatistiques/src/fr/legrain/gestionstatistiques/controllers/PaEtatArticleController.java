...
public class PaEtatArticleController extends JPABaseControllerSWTStandard implements
RetourEcranListener {
	
	static Logger logger = Logger.getLogger(PaEtatArticleController.class.getName());		
	...
	public PaEtatArticleController(PaEtat vue) {
		this(vue,null);
	}

	public PaEtatArticleController(PaEtat vue,EntityManager em) {
		if(em!=null) {
			setEm(em);
		}
...
//			Branchement action annuler : empeche la fermeture automatique de la
			...
			vue.getTfCODE_FAMILLE().setVisible(false);
			vue.getLaLIBELLE_STOCK().setVisible(false);
			initController();
...
//	}
	...
	public PaEtatArticleController getThis(){
		return this;
	}
	...
	protected void actAide(String message) throws Exception {
		...
		setActiveAide(true);
			try {
				...
				switch ((PaEtatArticleController.this.dao.getModeObjet().getMode())) {
				case C_MO_CONSULTATION:					
				case C_MO_EDITION:
				case C_MO_INSERTION:
				...
				if (paramAfficheAideRecherche.getJPQLQuery() != null) {
					...
					paAideController.addRetourEcranListener(PaEtatArticleController.this);
