package fr.legrain.relancefacture.editors;
...
import fr.legrain.relancefacture.controllers.PaCritereRelanceController;
 ...
 * </ul>
 */
public class RelanceFactureMultiPageEditor extends AbstractLgrMultiPageEditor implements 
...
//public class MultiPageEditor extends SharedHeaderFormEditor {
	...
	public static final String ID_EDITOR = "fr.legrain.relanceFacture.multi"; //$NON-NLS-1$
	static Logger logger = Logger.getLogger(RelanceFactureMultiPageEditor.class.getName());
	...
	protected EditorCritereRelance editorCritereRelance = null;
	protected EditorCritereRemonterRelance editorCritereRemonterRelance = null;
	/**
	 * Creates a multi-page editor example.
	 */
	public RelanceFactureMultiPageEditor() {
		super();
	...
	protected void createPageQueEditeur() {
		try {
			...
			editorCritereRelance = new EditorCritereRelance(this,em);
			...
			setPageText(index, editorCritereRelance.getTitle());
...
//			((SWTPaReglementMultipleController)editorCritereRelance.getController()).addChangementMasterEntityListener(this);
			...
			((PaCritereRelanceController)editorCritereRelance.getController()).
				getPaSelectionLigneRelanceControlleur().addDeclencheCommandeControllerListener(editorCritereRelance.getController());
			...
			((PaCritereRelanceController)editorCritereRelance.getController()).getPaSelectionLigneRelanceControlleur().addChangementDePageListener(this);
