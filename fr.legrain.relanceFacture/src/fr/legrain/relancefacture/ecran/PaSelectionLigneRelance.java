...
*/
public class PaSelectionLigneRelance extends fr.legrain.lib.gui.DefaultFrameFormulaireSWTSimpleBtnCote {
...
//	final private boolean decore = false;
	...
	*/
	public static void showGUI() {
		...
		PaSelectionLigneRelance inst = new PaSelectionLigneRelance(shell, SWT.NULL);
	...
	public PaSelectionLigneRelance(Composite parent, int style,
			int ordreComposite, int tableStyle) {
		super(parent, style, ordreComposite, tableStyle);
		initGUI();
	}

	public PaSelectionLigneRelance(org.eclipse.swt.widgets.Composite parent, int style) {
		super(parent, style);
		initGUI();
	}
...
//				}
				...
				
				{
					...
					laMT_HT_CALC.setText("Total à relancer");
				}
				{
