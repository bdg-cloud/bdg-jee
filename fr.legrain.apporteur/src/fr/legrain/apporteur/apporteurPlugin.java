 ...
 */
public class apporteurPlugin extends AbstractUIPlugin {
	static Logger logger = Logger.getLogger(apporteurPlugin.class.getName());	

	// The plug-in ID
	public static final String PLUGIN_ID = "Apporteur";

	// The shared instance
	private static apporteurPlugin plugin;
	private IPreferenceStore projectPreferenceStore; 
	private IPreferenceStore programmePreferenceStore;
	/**
	 * The constructor
	 */
	public apporteurPlugin() {
		plugin = this;
	}
	 ...
	 */
	public static apporteurPlugin getDefault() {
		return plugin;
	}
	/**
