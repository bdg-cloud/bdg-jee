...
import fr.legrain.apporteur.divers.ParamImpressionApporteur;
import fr.legrain.apporteur.ecran.PaImpressionApporteur;
import fr.legrain.gestCom.librairiesEcran.swt.LgrAbstractHandler;
import fr.legrain.gestCom.librairiesEcran.swt.LgrShellUtil;
import fr.legrain.lib.gui.ParamAfficheSWT;


public class HandlerImpressionApporteur extends LgrAbstractHandler {

	static Logger logger = Logger.getLogger(HandlerImpressionApporteur.class.getName());
...
//			PaImpressionApporteur paImpressionFacture = new PaImpressionApporteur(s,SWT.NULL);
//			SWTPaImpressionFactureController paImpressionFactureController = new SWTPaImpressionFactureController(paImpressionFacture);
//			ParamImpressionApporteur paramImpressionFacture= new ParamImpressionApporteur();
