...
*/
public class PaImpressionApporteur extends org.eclipse.swt.widgets.Composite {
	...
	*/
	public static void showGUI() {
		...
		PaImpressionApporteur inst = new PaImpressionApporteur(shell, SWT.NULL);
	...
	public PaImpressionApporteur(org.eclipse.swt.widgets.Composite parent, int style) {
		super(parent, style);
		initGUI();
	}
