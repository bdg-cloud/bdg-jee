...
public class EditorTotaux extends JPALgrEditorPart implements ILgrEditor, ILgrRetourEditeur {
	...
	public static final String ID = "fr.legrain.editor.apporteur.EditorTotaux";
	
	private boolean enabled = true;
	private PaTotauxApporteur composite = null;
	...
	public void createPartControl(Composite parent) {
		composite = new PaTotauxApporteur(parent,SWT.NONE);
		if(getController()==null) {
			setController(new PaEditorApporteurTotauxController(composite,em));
		} else {
	...
	public PaTotauxApporteur getComposite() {
		return composite;
	}
