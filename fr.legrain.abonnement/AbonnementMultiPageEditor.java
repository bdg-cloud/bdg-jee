 ...
 * </ul>
 */
public class AbonnementMultiPageEditor extends fr.legrain.licence.editors.AbstractLgrMultiPageEditorSupport implements 
ILgrRetourEditeur, IChangementDePageListener,IChangementMasterEntityListener , IChangementDeSelectionListener,
IAnnuleToutListener{

	
	public static final String ID_EDITOR = "fr.legrain.abonnement.multi"; //$NON-NLS-1$
	static Logger logger = Logger.getLogger(AbonnementMultiPageEditor.class.getName());
	...
	protected EditorAbonnement editorAbonnement = null;

	/**
	 * Creates a multi-page editor example.
	 */
	public AbonnementMultiPageEditor() {
		super();
	...
	protected void createPageQueEditeur() {
		try {
			editorAbonnement = new EditorAbonnement(this,em);
