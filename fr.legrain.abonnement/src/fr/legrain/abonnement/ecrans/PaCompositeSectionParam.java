...
//	private DateTime cdateFinCalcul = null;
	...
	private Button btnNonTransforme = null;
	...
	public PaCompositeSectionParam(Composite compo,FormToolkit toolkit) {
		...
		toolkit.createLabel(compo, "Type abonnement"); 
...
//		toolkit.createLabel(compo, "Date fin calcul"); 
//		cdateFinCalcul = new DateTime(compo,  SWT.BORDER | SWT.DROP_DOWN);
//		cdateFinCalcul.setLayoutData(new GridData(SWT.BEGINNING,SWT.NONE,false,false,1,1));
		...
		toolkit.createLabel(compo, "Montant départ"); 
		tfMontantDepart = toolkit.createText(compo, "", SWT.BORDER); 
		tfMontantDepart.setLayoutData(new GridData(SWT.FILL,SWT.NONE,false,false,2,1));
		
		btnNonTransforme = toolkit.createButton(compo, "Non transformé", SWT.CHECK); //$NON-NLS-1$
		GridData btnNonTransformeGridData = new GridData(SWT.BEGINNING,SWT.NONE,true,false,1,1);
		btnNonTransforme.setLayoutData(btnNonTransformeGridData);		
...
//
//	public DateTime getCdateFinCalcul() {
//		return cdateFinCalcul;
//	}

	public Button getBtnNonTransforme() {
		return btnNonTransforme;
	}

	public Text getTfMontantDepart() {
		return tfMontantDepart;
	}
}
