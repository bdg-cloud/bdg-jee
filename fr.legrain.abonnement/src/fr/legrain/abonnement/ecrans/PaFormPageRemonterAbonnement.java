...
public class PaFormPageRemonterAbonnement extends org.eclipse.ui.forms.editor.FormPage {

	// -- Id et titre du formulaire --
	public static String id = "fr.legrain.document.etat.facture.ecrans.PaFormPage";
	public static String title = "Abonnements existants";
	// -- Chemins des icônes --
	...
	// -- Composites --
	protected PaCompositeSectionParamRenouvellement compositeSectionParam = null;
	...
	protected FormPageControllerPrincipalFinalisation controllerPage = null;
	 ...
	 * @param title
	 */
	public PaFormPageRemonterAbonnement(String id, String title) {
		super(id, title);
	}
	...
	public PaFormPageRemonterAbonnement(FormEditor editor, String id, String title) {
	...
	protected void createSectionParam(FormToolkit toolkit, final ScrolledForm form) {
		...
		compositeSectionParam = new PaCompositeSectionParamRenouvellement(toolkit.createComposite(sctnParamtresDuTableau),toolkit);
	...
	public void createSectionResultats (FormToolkit toolkit, final ScrolledForm form){
		...
		sctnTableauGauche.setText("Liste des abonnements existants");
	...
	public PaCompositeSectionParamRenouvellement getCompositeSectionParam() {
	...
	public FormPageControllerPrincipalFinalisation getControllerPage() {
		return controllerPage;
	}

	public void setControllerPage(FormPageControllerPrincipalFinalisation controllerPage) {
