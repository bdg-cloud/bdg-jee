 ...
 *
 */
public class PaCompositeSectionDocEcheanceRenouvellement  {
	// Composite
	...
	private DefaultFrameFormulaireSWTSimpleBtnCote compoEcranDetail;
...
//	private Table tableDetail = null;
	...
	public PaCompositeSectionDocEcheanceRenouvellement(Composite compo,FormToolkit toolkit) {
		this.compo = compo;
...
//		sc.setExpandHorizontal(true);
		...
		compoEcran.setSize(SWT.DEFAULT, 300);

		compoEcranDetail = new DefaultFrameFormulaireSWTSimpleBtnCote(compo,SWT.PUSH,1,SWT.FULL_SELECTION
				| SWT.H_SCROLL
				| SWT.V_SCROLL
				| SWT.BORDER
				| SWT.CHECK ) ;
		compoEcranDetail.getPaFomulaire().setVisible(false);
		compoEcranDetail.setSize(SWT.DEFAULT, 150);
...
//		table.setLayoutData(gridDataTab);
		...
		}
		{
			...
			laMT_TTC_CALC.setText("Nombre de documents");
		}
		{
...
//		sc.setContent(compoEcran);
		...
		ld2.horizontalAlignment = GridData.FILL;
		ld2.grabExcessHorizontalSpace = true;
//		ld2.verticalAlignment = GridData.FILL;
		ld2.grabExcessVerticalSpace = true;
		ld2.horizontalSpan = 2;
		ld2.minimumHeight=150;
		compoEcranDetail.setLayoutData(ld);
...
//	}
	...
	public DefaultFrameFormulaireSWTSimpleBtnCote getCompoEcranDetail() {
		return compoEcranDetail;
	}
}
