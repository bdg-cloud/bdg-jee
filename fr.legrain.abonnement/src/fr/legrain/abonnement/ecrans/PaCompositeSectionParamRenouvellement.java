 ...
 *
 */
public class PaCompositeSectionParamRenouvellement {
	// icons
	...
	// Consutrcteur
	public PaCompositeSectionParamRenouvellement(Composite compo,FormToolkit toolkit) {
		// Init du composite
		this.compo = compo;
		...
		cbEtat.setLayoutData(new GridData(SWT.BEGINNING,SWT.NONE,true,false,4,1));
		...
		cdateFin.setLayoutData(new GridData(SWT.BEGINNING,SWT.NONE,false,false,2,1));
		
		
		cbReglee = toolkit.createButton(compo, "Réglée", SWT.CHECK); //$NON-NLS-1$
		GridData cbRegleeGridData = new GridData(SWT.NONE,SWT.NONE,false,false,1,1);
		cbRegleeGridData.horizontalAlignment = SWT.FILL;
		cbReglee.setLayoutData(cbRegleeGridData);
		cbReglee.setSelection(true);
		
		toolkit.createLabel(compo, "Code tiers"); 
		tfCodeTiers = toolkit.createText(compo, "", SWT.BORDER); 
		tfCodeTiers.setLayoutData(new GridData(SWT.FILL,SWT.NONE,false,false,1,1));
