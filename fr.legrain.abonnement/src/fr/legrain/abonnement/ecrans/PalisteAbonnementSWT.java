...
*/
public class PalisteAbonnementSWT extends fr.legrain.lib.gui.DefaultFrameFormulaireSWT {
...
//	private DecoratedField fieldCodeAbonnement;
	...
	*/
	public static void showGUI() {
		...
		PalisteAbonnementSWT inst = new PalisteAbonnementSWT(shell, SWT.NULL);
	...
	public PalisteAbonnementSWT(org.eclipse.swt.widgets.Composite parent, int style) {
		super(parent, style);
		initGUI();
	}
