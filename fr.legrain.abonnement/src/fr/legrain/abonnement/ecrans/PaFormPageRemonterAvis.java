...
public class PaFormPageRemonterAvis extends org.eclipse.ui.forms.editor.FormPage {

	// -- Id et titre du formulaire --
	public static String id = "fr.legrain.document.etat.facture.ecrans.PaFormPage";
	public static String title = "Avis d'échéance existants";
	// -- Chemins des icônes --
	 ...
	 * @param title
	 */
	public PaFormPageRemonterAvis(String id, String title) {
		super(id, title);
	}
	...
	public PaFormPageRemonterAvis(FormEditor editor, String id, String title) {
