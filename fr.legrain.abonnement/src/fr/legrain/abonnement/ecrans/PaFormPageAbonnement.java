...
public class PaFormPageAbonnement extends org.eclipse.ui.forms.editor.FormPage {

	// -- Id et titre du formulaire --
	public static String id = "fr.legrain.document.etat.facture.ecrans.PaFormPage";
	public static String title = "Abonnement à renouveler";
	public static String titleRemonter = "Abonnements existants";
	// -- Chemins des icônes --
	 ...
	 * @param title
	 */
	public PaFormPageAbonnement(String id, String title) {
		super(id, title);
	...
	public PaFormPageAbonnement(FormEditor editor, String id, String title) {
