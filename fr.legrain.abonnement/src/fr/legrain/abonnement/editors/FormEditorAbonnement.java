...
import fr.legrain.abonnement.ecrans.PaFormPageRemonterAvis;
...
public class FormEditorAbonnement extends LgrFormEditor implements ILgrEditor, ILgrRetourEditeur, /*IEditorArticlesExtension,*/IPartListener{

	static Logger logger = Logger.getLogger(FormEditorAbonnement.class.getName());
	...
	// FormPage principal
	private PaFormPageAvis defaultFormPage = null;
	private PaFormPageAvis remonterFormPage = null;
	
	private Map<PaFormPageAvis,FormPageControllerPrincipal> listeController = new HashMap<PaFormPageAvis,FormPageControllerPrincipal>();
			
	// Constructeur par défaut
	public FormEditorAbonnement() {
		super();
	}
	...
	protected void addPages() {
		try {
			...
			defaultFormPage = new PaFormPageAvis(this, PaFormPageAvis.id, PaFormPageAvis.title);
			remonterFormPage = new PaFormPageAvis(this, PaFormPageAvis.id, PaFormPageAvis.titleRemonter);
			// Création du Controller
			FormPageControllerPrincipal defautController = new FormPageControllerPrincipal(defaultFormPage);
			FormPageControllerPrincipal remonterController = new FormPageControllerPrincipal(remonterFormPage);
			// Liaison entre le controller et le formPage et ajout à la liste
						...
						defautController.setSuppressionUniquement(false);
	 ...
	 */
	private void liaisonControllerFormPage(FormPageControllerPrincipal leController, PaFormPageAvis leFormPage) {
...
//	}
	...
	private void addEditor(PaFormPageAvis e, FormPageControllerPrincipal c, String label) {
		 addEditor(e,c,label,null);
	}
	
	private void addEditor(PaFormPageAvis e, FormPageControllerPrincipal controllerPrincipal, String label, ImageDescriptor icon) {
...
//		}
	...
	public String getTitle() {
		return "Gestion des avis d'échéance";
	}
