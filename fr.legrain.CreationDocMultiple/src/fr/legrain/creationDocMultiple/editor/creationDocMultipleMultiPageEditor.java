 ...
 * </ul>
 */
public class creationDocMultipleMultiPageEditor extends AbstractLgrMultiPageEditor implements 
...
//public class MultiPageEditor extends SharedHeaderFormEditor {
	...
	public static final String ID_EDITOR = "fr.legrain.creationDocMultiple.multi"; //$NON-NLS-1$
	static Logger logger = Logger.getLogger(creationDocMultipleMultiPageEditor.class.getName());
	...
	protected EditorCriterecreationDocMultiple editorCritereRelance = null;

	/**
	 * Creates a multi-page editor example.
	 */
	public creationDocMultipleMultiPageEditor() {
		super();
	...
	protected void createPageQueEditeur() {
		try {
			...
			editorCritereRelance = new EditorCriterecreationDocMultiple(this,em);
			...
			setPageImage(index, CreationDocMultiplePlugin.getImageDescriptor(iconPageRelance).createImage());
