...
//	private int lockType = LOCK_TYPE_JPA;
	...
	protected abstract void validateEntity(Entity value);
	protected abstract void validateEntityProperty(Entity value, String propertyName);
	protected abstract void validateDTO(DTO dto);
	protected abstract void validateDTOProperty(DTO dto, String propertyName);
