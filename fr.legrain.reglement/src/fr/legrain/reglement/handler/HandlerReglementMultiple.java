...
import fr.legrain.reglement.editor.ReglementMultipleMultiPageEditor;


public class HandlerReglementMultiple extends LgrAbstractHandler {
	
	static Logger logger = Logger.getLogger(HandlerReglementMultiple.class.getName());
	...
	public Object execute(ExecutionEvent event) throws ExecutionException {
		...
		try {
			IEditorPart editor = AbstractLgrMultiPageEditor.chercheEditeurDocumentOuvert(ReglementMultipleMultiPageEditor.ID_EDITOR);
			if(editor==null){
			IEditorPart e = PlatformUI.getWorkbench().getActiveWorkbenchWindow().getActivePage().openEditor(new EditorInputReglementMultiple(), ReglementMultipleMultiPageEditor.ID_EDITOR);
