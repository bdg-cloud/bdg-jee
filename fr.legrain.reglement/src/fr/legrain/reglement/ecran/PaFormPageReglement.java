...
public class PaFormPageReglement extends org.eclipse.ui.forms.editor.FormPage {

	// -- Id et titre du formulaire --
	public static String id = "fr.legrain.document.etat.facture.ecrans.PaFormPage";
	public static String title = "Gestion des règlements";
	public static String titleRemonter = "Règlements existants";
	// -- Chemins des icônes --
	...
	// -- Composites --
	protected PaCompositeSectionParamReglement compositeSectionParam = null;
	protected PaCompositeSectionDocReglement compositeSectionResultats = null;
	protected PaCompositeSectionComplementaireReglement compositeSectionComplementaire = null;

	// -- Form Général --
	protected ScrolledForm form = null;
	protected FormToolkit toolkit;

	protected FormPageControllerPrincipalReglement controllerPage = null;
	 ...
	 * @param title
	 */
	public PaFormPageReglement(String id, String title) {
		super(id, title);
	}
	...
	public PaFormPageReglement(FormEditor editor, String id, String title) {
	...
	protected void createSectionParam(FormToolkit toolkit, final ScrolledForm form) {
		...
		compositeSectionParam = new PaCompositeSectionParamReglement(toolkit.createComposite(sctnParamtresDuTableau),toolkit);
	...
	public void createSectionResultats (FormToolkit toolkit, final ScrolledForm form){
		...
		sctnTableauGauche.setText("Liste des documents à règler");
		

		compositeSectionResultats = new PaCompositeSectionDocReglement(toolkit.createComposite(sctnTableauGauche),toolkit);
	...
	public void createSectionComplementaire (FormToolkit toolkit, final ScrolledForm form){
		...
		compositeSectionComplementaire = new PaCompositeSectionComplementaireReglement(toolkit.createComposite(sctnDocuments),toolkit);
		compositeSectionComplementaire.getLaGrille().setText("Liste des documents à règler");
	...
	public PaCompositeSectionParamReglement getCompositeSectionParam() {
		return compositeSectionParam;
	}

	public PaCompositeSectionDocReglement getCompositeSectionResultats() {
		return compositeSectionResultats;
	}

	public FormPageControllerPrincipalReglement getControllerPage() {
		return controllerPage;
	}

	public void setControllerPage(FormPageControllerPrincipalReglement controllerPage) {
	...
	public PaCompositeSectionComplementaireReglement getCompositeSectionComplementaire() {
