...
package fr.legrain.document.etat.boncde.ecrans;
...
public class PaFormPageBoncde extends PaFormPage {
...
//	public static String title = "Echéance";
	 ...
	 * @param title
	 */
	public PaFormPageBoncde(String id, String title) {
		super(id, title);
	}
	 ...
	 * @param title
	 */
	public PaFormPageBoncde(FormEditor editor, String id, String title) {
