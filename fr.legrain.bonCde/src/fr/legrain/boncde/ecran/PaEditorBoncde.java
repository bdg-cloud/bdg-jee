 ...
 */
public class PaEditorBoncde extends org.eclipse.swt.widgets.Composite {
...
//	}
	...
	private DecoratedField fieldCODE_BONCDE;
	...
	public static void showGUI() {
		...
		PaEditorBoncde inst = new PaEditorBoncde(shell, SWT.NULL);
	...
	public PaEditorBoncde(org.eclipse.swt.widgets.Composite parent, int style) {
		super(parent, style);
		initGUI();
	}
	...
	private void initGUI() {
		try {
			...
			this.setSize(1059, 715);
			{
				...
				paEntete.setText("Entête du bon de commande");
				{
					laCODE_DOCUMENT = new Label(paEntete, SWT.NONE);
					laCODE_DOCUMENT.setText("Code Bon commande");
				}
				{
					...
					if(!decore) {
						...
						tfCODE_DOCUMENT.setText("CODE_BONCDE");
					} else {
						fieldCODE_BONCDE = new DecoratedField(paEntete, SWT.BORDER, new TextControlCreator());
						tfCODE_DOCUMENT = (Text)fieldCODE_BONCDE.getControl();
						fieldCODE_BONCDE.getLayoutControl().setLayoutData(tfCODE_FACTURELData);
					}
				...
				}
				{
					...
					laDATE_DOCUMENT.setText("Date bon");
				}
				{
...
//					dateTimeDATE_DOCUMENT.setPattern("dd/MM/yyyy");	
				...
				}
				{
					...
					if(!decore) {
						...
						tfLIBELLE_DOCUMENT.setText("LIBELLE_BONCDE");
					} else {
...
//					}
	...
	public DecoratedField getFieldCODE_BONCDE() {
		return fieldCODE_BONCDE;
	}
