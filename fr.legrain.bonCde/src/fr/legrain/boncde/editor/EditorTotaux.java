...
public class EditorTotaux extends JPALgrEditorPart implements ILgrEditor, ILgrRetourEditeur {
	...
	public static final String ID = "fr.legrain.editor.boncde.EditorTotaux";
	
	private boolean enabled = true;
	private PaTotauxBoncde composite = null;
	...
	public void createPartControl(Composite parent) {
		composite = new PaTotauxBoncde(parent,SWT.NONE);
		if(getController()==null) {
			setController(new PaEditorTotauxBoncdeController(composite,em));
		} else {
	...
	public PaTotauxBoncde getComposite() {
		return composite;
	}
