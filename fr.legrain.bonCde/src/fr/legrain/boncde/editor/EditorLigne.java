...
public class EditorLigne extends JPALgrEditorPart implements ILgrEditor, ILgrRetourEditeur {
	...
	public static final String ID = "fr.legrain.editor.boncde.EditorLigne";
	
	private boolean enabled = true;
	private PaSaisieLigneBoncde composite = null;
	...
	public void createPartControl(Composite parent) {
		composite = new PaSaisieLigneBoncde(parent,SWT.NONE);
		if(getController()==null) {
			setController(new PaLigneBoncdeController(composite,em));
		} else {
	...
	public PaSaisieLigneBoncde getComposite() {
		return composite;
	}
