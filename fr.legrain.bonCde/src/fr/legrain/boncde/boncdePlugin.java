 ...
 */
public class boncdePlugin extends AbstractUIPlugin {
	static Logger logger = Logger.getLogger(boncdePlugin.class.getName());	

	// The plug-in ID
	public static final String PLUGIN_ID = "Boncde";

	// The shared instance
	private static boncdePlugin plugin;
	 ...
	 */
	public static boncdePlugin getDefault() {
		return plugin;
	}
