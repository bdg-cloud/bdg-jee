...
import fr.legrain.document.etat.prelevement.preferences.PreferenceConstants;
...
public class ParamControllerMini extends AbstractControllerMini implements RetourEcranListener {
	...
	private FormPageControllerPrelevement masterController = null;
	...
	public ParamControllerMini(FormPageControllerPrelevement masterContoller, PaFormPage vue, EntityManager em) {
		this.vue = vue;
