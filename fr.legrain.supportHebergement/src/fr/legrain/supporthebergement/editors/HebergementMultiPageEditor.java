...
import fr.legrain.supporthebergement.pluginSupportHebergement;
 ...
 * </ul>
 */
public class HebergementMultiPageEditor extends AbstractLgrMultiPageEditorSupport implements 
ILgrRetourEditeur, IChangementDePageListener,IChangementMasterEntityListener , IChangementDeSelectionListener,
IAnnuleToutListener{

	
	public static final String ID_EDITOR = "fr.legrain.supportHebergement.multi"; //$NON-NLS-1$
	static Logger logger = Logger.getLogger(HebergementMultiPageEditor.class.getName());
	...
	protected EditorLicenceHebergement editorLicenceEpicea = null;

	/**
	 * Creates a multi-page editor example.
	 */
	public HebergementMultiPageEditor() {
		super();
	...
	protected void createPageQueEditeur() {
		try {
			editorLicenceEpicea = new EditorLicenceHebergement(this,em);
			...
			setPageImage(index, pluginSupportHebergement.getImageDescriptor(iconPage1).createImage());
			...
			ParamAfficheLicenceHebergement paramAfficheRelanceFacture = new ParamAfficheLicenceHebergement();
...
//					getTableViewer().getSelection());
			...
			if(documentSelection!=null && documentSelection.getCodeArticle()!=null){
				SWTSupportAbonHerbergement support = new SWTSupportAbonHerbergement();
