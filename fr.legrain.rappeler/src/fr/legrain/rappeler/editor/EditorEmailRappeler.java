...
import fr.legrain.rappeler.ecran.PaEmailRappeler;
...
public class EditorEmailRappeler extends JPALgrEditorPart implements ILgrEditor, ILgrRetourEditeur {
	
	static Logger logger = Logger.getLogger(EditorEmailRappeler.class.getName());
	
	public static final String ID = "fr.legrain.rappeler.newMail";
	
	private boolean enabled = true;
	private PaEmailRappeler composite = null;
	//private SWTPaArticlesController controller = null;

	public EditorEmailRappeler() {
		super();
	}
	
	public EditorEmailRappeler(EditorPart parent) {
		super(parent);
	}
	...
	public void createPartControl(Composite parent) {
		composite = new PaEmailRappeler(parent,SWT.NONE);
		if(getController()==null) {
			setController(new SWTPaEmailRappelerController(composite));
		}
	}
	...
	public PaEmailRappeler getComposite() {
		return composite;
	}
