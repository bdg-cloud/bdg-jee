...
public class PaFormPage extends org.eclipse.ui.forms.editor.FormPage {
	...
	public static String title = "Création des supports d'abonnement";
	// -- Chemins des icônes --
	...
	Action myAction = new Action("Action 1",pluginLicence.getImageDescriptor(iconPath)) { 
		@Override 
		public void run() { 
...
//		gridData.minimumHeight = 150;
//		gridData.heightHint = 150;
//		sctnDocuments.setLayoutData(gridData);
