package fr.legrain.licencesara.ecrans;
...
*/
public class PaSaraSWT extends PaLicenceSWT {

	public PaSaraSWT(Composite parent, int style) {
		super(parent, style);
...
//		PaSaraSWT inst = new PaSaraSWT(shell, SWT.NULL);
...
//
//
//	public PaSaraSWT(org.eclipse.swt.widgets.Composite parent, int style) {
//		super(parent, style);
//		initGUI();
//	}
//
