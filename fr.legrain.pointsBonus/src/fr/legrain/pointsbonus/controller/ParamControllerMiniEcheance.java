...
import fr.legrain.pointsbonus.ecran.PaCompositeSectionParamEcheance;
...
//		}
	...
	private Action refreshAction = new Action("Rechercher",PluginPointBonus.getImageDescriptor(PaCompositeSectionParamEcheance.iconPath)) { 
		@Override 
		public void run() { 
			datedeb = LibDateTime.getDate(vue.getCompositeSectionParam().getCdateDeb());
...
//						String contributorName = confElements[jj].getContributor().getName();
	...
	protected void initActions() {	
		if(!toolBarInitialise) {
			...
			vue.getCompositeSectionParam().getBtnRefesh().setImage(PluginPointBonus.getImageDescriptor(PaCompositeSectionParamEcheance.iconRefreshPath).createImage());
			...
			vue.getCompositeSectionResultats().getBtnCreer().setImage(PluginPointBonus.getImageDescriptor(PaCompositeSectionParamEcheance.iconRefreshPath).createImage());
...
//					}				
			...
			vue.getCompositeSectionParam().getBtnAideTiers().setImage(PluginPointBonus.getImageDescriptor(PaCompositeSectionParamEcheance.iconFindPath).createImage());
