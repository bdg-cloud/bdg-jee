 ...
 * </ul>
 */
public class comptePointMultiPageEditor extends AbstractLgrMultiPageEditor implements 
ILgrRetourEditeur, IChangementDePageListener,IChangementMasterEntityListener , IChangementDeSelectionListener,
IAnnuleToutListener{

	
	public static final String ID_EDITOR = "fr.legrain.pointsBonus.editor.multi"; //$NON-NLS-1$
	static Logger logger = Logger.getLogger(comptePointMultiPageEditor.class.getName());
	...
	protected EditorComptePoint editorComptePoint = null;

	/**
	 * Creates a multi-page editor example.
	 */
	public comptePointMultiPageEditor() {
		super();
	...
	protected void createPageQueEditeur() {
		try {
			editorComptePoint = new EditorComptePoint(this,em);
			//Initialisation des pages/editeurs composant le multipage editor
			String labelPage1 = editorComptePoint.getTitle();
			...
			listePageEditeur.add(editorComptePoint);
			
			
			int index = addPage(editorComptePoint, getEditorInput());
			setPageText(index, labelPage1);
			setPageImage(index, PluginPointBonus.getImageDescriptor(iconPage1).createImage());
			//liaison entre la selection du controller principal et le multipage editor
			editorComptePoint.getController().addChangementDeSelectionListener(this);
			
			mapEditorController.put(editorComptePoint, editorComptePoint.getController());
			
			editorComptePoint.getController().addChangementDePageListener(this);

			editorComptePoint.getController().addAnnuleToutListener(this);

			editeurCourant = editorComptePoint;
			ParamAfficheComptePoint paramAfficheComptePoint = new ParamAfficheComptePoint();
			editorComptePoint.getController().configPanel(paramAfficheComptePoint);
