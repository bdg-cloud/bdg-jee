	...
	private void initGUI() {
		try {
			...
			thisLayout.numColumns = 4;
			{
				...
				{
					groupType = new Group(composite1, SWT.NONE);
					...
					groupTypeLData.horizontalSpan = 4;
					groupTypeLData.horizontalAlignment = GridData.FILL;
					groupTypeLData.verticalAlignment = GridData.FILL;
					groupTypeLData.grabExcessVerticalSpace = true;
					groupTypeLData.grabExcessHorizontalSpace = true;
					groupType.setLayoutData(groupTypeLData);
					groupType.setText("Sélection type de document");
					{
						comboTypeDoc = new Combo(groupType, SWT.NONE);
						GridData comboTypeDocLData = new GridData();
						comboTypeDocLData.verticalAlignment = GridData.FILL;
