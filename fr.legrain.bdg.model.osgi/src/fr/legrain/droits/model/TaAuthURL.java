...
@Entity
@Table(name = "ta_auth_url")
@NamedQueries(value = { 
		@NamedQuery(name=TaAuthURL.QN.FIND_BY_ROLEID, query="select f from TaAuthURL f where f.role.id= :roleID")
		})
public class TaAuthURL implements Serializable {
	
	public static class QN {
		public static final String FIND_BY_ROLEID = "AuthURL.findByRoleID";
	}
	
	private static final long serialVersionUID = 5240190370757237068L;
