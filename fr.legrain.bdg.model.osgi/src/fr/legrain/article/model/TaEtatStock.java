...
public class TaEtatStock implements java.io.Serializable {

	private static final long serialVersionUID = 7860415113762455578L;
...
//	}
	...
	public boolean equalsPartiel(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		TaEtatStock other = (TaEtatStock) obj;
		if (codeArticle == null) {
			if (other.getCodeArticle() != null)
				return false;
		} else if (!codeArticle.equals(other.getCodeArticle()))
			return false;
		if (mouvStock == null) {
	...
	public TaEtatStock(String codeArticle, String mouvStock, Date dateStock,
