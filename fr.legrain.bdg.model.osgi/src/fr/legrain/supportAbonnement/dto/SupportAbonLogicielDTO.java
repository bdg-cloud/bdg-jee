 ...
 */
public class SupportAbonLogicielDTO extends SupportAbonDTO  implements java.io.Serializable {
	
	/**
	 * 
	 */
	private static final long serialVersionUID = 4683846685612532877L;
	...
	public SupportAbonLogicielDTO() {
	}




	public SupportAbonLogicielDTO(Integer idUtilisateur, String nom,
	...
	public void setSWTEpicea(SupportAbonLogicielDTO swtEpicea) {
		this.setId(swtEpicea.getId());		
	...
	public static SupportAbonLogicielDTO copy(SupportAbonLogicielDTO swtEpicea) {
		SupportAbonLogicielDTO swtEpiceaLoc = new SupportAbonLogicielDTO();
		...
		swtEpiceaLoc.setId(swtEpicea.getId());
