...
public class TaContactMessagePushDTO extends ModelObject implements java.io.Serializable {
	...
	public TaContactMessagePushDTO() {
	}
	
	public TaContactMessagePushDTO(Integer id, String adresseEmail, int idTiers, String codeTiers, String nomTiers,
			String prenomTiers) {
		super();
		this.id = id;
	...
	public void setTaAgendaDTO(TaContactMessagePushDTO taAgendaDTO) {
	...
	public static TaContactMessagePushDTO copy(TaContactMessagePushDTO taAgendaDTO){
		TaContactMessagePushDTO taAgendaDTOLoc = new TaContactMessagePushDTO();
