 ...
 */
public class IdentiteTiersDTO extends ModelObject  implements java.io.Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = 3439750349142758073L;
	...
	public IdentiteTiersDTO() {
	}

	public void setIdentiteTiersDTO(IdentiteTiersDTO swtInfosTiers) {
	...
	public static IdentiteTiersDTO copy(IdentiteTiersDTO ihmIdentiteTiers){
		IdentiteTiersDTO ihmIdentiteTiersLoc = new IdentiteTiersDTO();
