 ...
 */
public class MouvementStocksPrevDTO extends ModelObject implements java.io.Serializable {
	...
	public MouvementStocksPrevDTO() {	
	}


	public MouvementStocksPrevDTO(Integer idGrMouvStock, String codeGrMouvStock,
	...
	@LgrHibernateValidated(champBd = "date_stock",table = "ta_mouvement_stock_prev_prev", champEntite="dateStock", clazz = MouvementStocksPrevDTO.class)
	...
	@LgrHibernateValidated(champBd = "libelle_stock",table = "ta_mouvement_stock_prev_prev", champEntite="libelleStock", clazz = MouvementStocksPrevDTO.class)
	...
	@LgrHibernateValidated(champBd = "qte1_stock",table = "ta_mouvement_stock_prev_prev", champEntite="qte1Stock", clazz = MouvementStocksPrevDTO.class)
	...
	@LgrHibernateValidated(champBd = "un1_stock",table = "ta_mouvement_stock_prev_prev", champEntite="un1Stock", clazz = MouvementStocksPrevDTO.class)
	...
	@LgrHibernateValidated(champBd = "qte2_stock",table = "ta_mouvement_stock_prev", champEntite="qte2Stock", clazz = MouvementStocksPrevDTO.class)
	...
	@LgrHibernateValidated(champBd = "un2_stock",table = "ta_mouvement_stock_prev", champEntite="un2Stock", clazz = MouvementStocksPrevDTO.class)
	...
	@NotNull
	@Size(min=1, max=20)
	@LgrHibernateValidated(champBd = "code_article",table = "ta_article", champEntite="codeArticle", clazz = MouvementStocksPrevDTO.class)
	...
	@LgrHibernateValidated(champBd = "code_entrepot",table = "ta_entrepot", champEntite="codeEntrepot", clazz = MouvementStocksPrevDTO.class)
	...
	@LgrHibernateValidated(champBd = "emplacement",table = "ta_mouvement_stock_prev", champEntite="emplacement", clazz = MouvementStocksPrevDTO.class)
	...
	@LgrHibernateValidated(champBd = "emplacement",table = "ta_mouvement_stock_prev", champEntite="emplacementDest", clazz = MouvementStocksPrevDTO.class)
	...
	@NotNull
	@Size(min=1, max=20)
	@LgrHibernateValidated(champBd = "num_lot",table = "ta_lot", champEntite="numLot", clazz = MouvementStocksPrevDTO.class)
	...
	public static MouvementStocksPrevDTO copy(MouvementStocksPrevDTO mouvementStockDTO){
		MouvementStocksPrevDTO mouvementStockDTOLoc = new MouvementStocksPrevDTO();
	...
	public MouvementStocksPrevDTO(Integer id, Integer idGrMouvStock,
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		MouvementStocksPrevDTO other = (MouvementStocksPrevDTO) obj;
		if (codeArticle == null) {
