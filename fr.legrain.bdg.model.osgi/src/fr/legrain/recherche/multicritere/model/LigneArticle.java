...
public class LigneArticle extends LigneCritere  implements Serializable {

	private static final long serialVersionUID = 2992281647155537176L;
	...
	public LigneArticle(GroupeLigne g) {
		super(g);
		type = TYPE_LIGNE_CRITERE_ARTICLE;
		initChamps();
	}
	...
	public Map<String, String> getListeCorrespondance() {
		return listeCorrespondanceArticles;
	}

	@Override
	public Map<String, String> getListeTitreChamps() {
		return listeTitreChampsArticles;
	}

	@Override
	public Map<String, Object> getListeObjet() {
		return listeObjetArticles;
	}
