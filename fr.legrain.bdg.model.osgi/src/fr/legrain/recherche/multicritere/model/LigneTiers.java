...
public class LigneTiers extends LigneCritere  implements Serializable{

	private static final long serialVersionUID = 1347855848042926902L;
	...
	public LigneTiers(GroupeLigne g) {
		super(g);
		type = TYPE_LIGNE_CRITERE_TIERS;
		initChamps();
	}
