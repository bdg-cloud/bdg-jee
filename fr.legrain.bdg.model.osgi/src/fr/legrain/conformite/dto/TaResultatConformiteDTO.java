...
public class TaResultatConformiteDTO extends ModelObject implements java.io.Serializable {
...
//	private TaBareme taBareme;
	...
	public TaResultatConformiteDTO() {
		
	}
	
	@LgrHibernateValidated(champBd = "code_groupe",table = "ta_groupe", champEntite="codeGroupe", clazz = TaResultatConformiteDTO.class)
	...
	public TaResultatConformiteDTO(Integer id, Integer versionObj, String codeGroupe,
			String libelle) {
		super();
		this.id = id;
		this.versionObj = versionObj;
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		TaResultatConformiteDTO other = (TaResultatConformiteDTO) obj;
		if (codeGroupe == null) {
