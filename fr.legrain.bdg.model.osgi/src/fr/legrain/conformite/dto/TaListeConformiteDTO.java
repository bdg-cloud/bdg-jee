...
public class TaListeConformiteDTO extends ModelObject implements java.io.Serializable {


	private static final long serialVersionUID = -4745878235923399071L;
...
//	private TaBareme taBareme;	
	...
	public TaListeConformiteDTO() {
		
	}
	
	@LgrHibernateValidated(champBd = "code_groupe",table = "ta_groupe", champEntite="codeGroupe", clazz = TaListeConformiteDTO.class)
	...
	public TaListeConformiteDTO(Integer id, Integer versionObj, String codeGroupe,
			String libelle) {
		super();
		this.id = id;
		this.versionObj = versionObj;
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		TaListeConformiteDTO other = (TaListeConformiteDTO) obj;
		if (codeGroupe == null) {
