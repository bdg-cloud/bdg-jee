...
public class TaResultatCorrectionDTO extends ModelObject implements java.io.Serializable {


	private static final long serialVersionUID = -7154246212719987897L;
...
//	private String observation;	
	...
	public TaResultatCorrectionDTO() {
		
	}
	
	@LgrHibernateValidated(champBd = "code_groupe",table = "ta_groupe", champEntite="codeGroupe", clazz = TaResultatCorrectionDTO.class)
	...
	public TaResultatCorrectionDTO(Integer id, Integer versionObj, String codeGroupe,
			String libelle) {
		super();
		this.id = id;
		this.versionObj = versionObj;
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		TaResultatCorrectionDTO other = (TaResultatCorrectionDTO) obj;
		if (codeGroupe == null) {
