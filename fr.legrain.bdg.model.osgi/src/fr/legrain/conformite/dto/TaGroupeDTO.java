...
public class TaGroupeDTO extends ModelObject implements java.io.Serializable {
	...
	@LgrHibernateValidated(champBd = "code_groupe",table = "ta_groupe", champEntite="codeGroupe", clazz = TaGroupeDTO.class)
	...
	public TaGroupeDTO(Integer id, Integer versionObj, String codeGroupe,
			String libelle) {
		super();
		this.id = id;
		this.versionObj = versionObj;
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		TaGroupeDTO other = (TaGroupeDTO) obj;
		if (codeGroupe == null) {
