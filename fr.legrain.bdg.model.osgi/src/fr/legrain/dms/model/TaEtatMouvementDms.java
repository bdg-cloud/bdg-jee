...
public class TaEtatMouvementDms   implements ITaEtatDms, java.io.Serializable {
	...
	private static final long serialVersionUID = -7570974254453049593L;
	...
	private Boolean mouvementEntree = false;
	...
	//sert pour le calcul complet de la DMS (sans les montants
	public TaEtatMouvementDms( String codeFamille,String codeArticle,
			String mouvement, Integer mois, Integer annee, BigDecimal qte1,
			String un1, BigDecimal qte2, String un2) {
		super();
		this.codeArticle= codeArticle;
		this.codeFamille=codeFamille;
		this.mouvement = mouvement;
	...
	public TaEtatMouvementDms(String codeTiers, String nomTiers, String codeDocument,
			Date dateDocument, String codeArticle, String codeFamille,
			String mouvement, Integer mois, Integer annee, String qte1,
			String un1, String qte2, String un2, BigDecimal ht,
			BigDecimal tva, BigDecimal ttc) {
		super();
		this.codeTiers = codeTiers;
		this.nomTiers = nomTiers;
		...
		this.mois = mois;
		this.annee = annee;
		this.qte1 = LibConversion.stringToBigDecimal(qte1);
		this.un1  = un1;
		this.qte2 = LibConversion.stringToBigDecimal(qte2);
		this.un2 = un2;
		this.ht = ht;
		this.tva = tva;
		this.ttc = ttc;
	...
	public TaEtatMouvementDms(String codeTiers, String nomTiers, String codeDocument,
			Date dateDocument, String codeArticle, String codeFamille,
			String mouvement, Integer mois, Integer annee, String qte1,
			String un1, String qte2, String un2) {
		super();
		this.codeTiers = codeTiers;
		this.nomTiers = nomTiers;
		this.codeDocument = codeDocument;
...
//			return false;	
	...
	public Boolean getMouvementEntree() {
		return mouvementEntree;
	}

	public void setMouvementEntree(Boolean mouvementEntree) {
