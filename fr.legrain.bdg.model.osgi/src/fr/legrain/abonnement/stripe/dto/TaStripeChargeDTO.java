...
public class TaStripeChargeDTO extends ModelObject implements java.io.Serializable {
	...
	public TaStripeChargeDTO() {
	}
	
	
	public TaStripeChargeDTO(Integer id, String idExterne, 
	...
	public static TaStripeChargeDTO copy(TaStripeChargeDTO taEntrepot){
		TaStripeChargeDTO taEntrepotLoc = new TaStripeChargeDTO();
