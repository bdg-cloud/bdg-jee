 ...
 */
public class TaBonReceptionDTO extends ModelObject implements java.io.Serializable, IDocumentDTO {
	...
	private Date heureDocument=new Date();
...
//	private Boolean export=false;
	...
	private Integer idTReception=0;
	private String codeTReception=LgrConstantes.C_STR_VIDE;
	private String liblTReception=LgrConstantes.C_STR_VIDE;
	...
	public TaBonReceptionDTO() {
	}

	public TaBonReceptionDTO(Integer ID_BONLIV, String CODE_BONLIV,
	...
	public TaBonReceptionDTO(Integer id, String codeDocument,
			Date dateDocument, String libelleDocument, String codeTiers, String nomTiers) {
		super();
		this.id = id;
	...
	public TaBonReceptionDTO(Integer id, String codeDocument,
			Date dateDocument, String libelleDocument, String codeTiers, String nomTiers, String codeTReception, String liblTReception) {
		super();
		this.id = id;
		this.codeDocument = codeDocument;
		this.dateDocument = dateDocument;
	...
	public void setIHMEnteteBonliv(TaBonReceptionDTO ihmEnteteBonliv){
	...
	public static TaBonReceptionDTO copy(TaBonReceptionDTO ihmEnteteBonliv){
		TaBonReceptionDTO ihmEnteteBonlivLoc = new TaBonReceptionDTO();
...
//				(LibDate.compareTo(getDateLivDocument(), dateExemple)==0)))return false;
	...
	@LgrHibernateValidated(champBd = "code_document",table = "ta_bon_reception",champEntite="codeDocument",clazz = TaBonReceptionDTO.class)
	@NotNull
	@Size(min=1, max=20)
	...
	@LgrHibernateValidated(champBd = "date_document",table = "ta_bon_reception",champEntite="dateDocument",clazz = TaBonReceptionDTO.class)
	...
	@LgrHibernateValidated(champBd = "date_liv_document",table = "ta_bon_reception",champEntite="dateLivDocument",clazz = TaBonReceptionDTO.class)
	...
	@LgrHibernateValidated(champBd = "libelle_document",table = "ta_bon_reception",champEntite="libelleDocument",clazz = TaBonReceptionDTO.class)
	@NotNull
	@Size(min=1, max=255)
	...
	@LgrHibernateValidated(champBd = "code_tiers",table = "ta_tiers",champEntite="codeTiers",clazz = TaBonReceptionDTO.class)
	@NotNull
	@Size(min=1, max=20)
	...
	@LgrHibernateValidated(champBd = "nom_tiers",table = "ta_tiers",champEntite="nomTiers",clazz = TaBonReceptionDTO.class)
	...
	@LgrHibernateValidated(champBd = "code_compta",table = "ta_tiers",champEntite="codeCompta",clazz = TaBonReceptionDTO.class)
	...
	@LgrHibernateValidated(champBd = "compte",table = "ta_tiers",champEntite="compte",clazz = TaBonReceptionDTO.class)
	...
	@LgrHibernateValidated(champBd = "code_t_paiement",table = "ta_t_paiement",champEntite="codeTPaiement",clazz = TaBonReceptionDTO.class)
...
//	}
	...
	@LgrHibernateValidated(champBd = "rem_ht_document",table = "ta_bon_reception",champEntite="remHtDocument",clazz = TaBonReceptionDTO.class)
	...
	@LgrHibernateValidated(champBd = "tx_rem_ht_document",table = "ta_bon_reception",champEntite="txRemHtDocument",clazz = TaBonReceptionDTO.class)
	...
	@LgrHibernateValidated(champBd = "rem_ttc_document",table = "ta_bon_reception",champEntite="remTtcDocument",clazz = TaBonReceptionDTO.class)
	...
	@LgrHibernateValidated(champBd = "tx_rem_ttc_document",table = "ta_bon_reception",champEntite="txRemTtcDocument",clazz = TaBonReceptionDTO.class)
	...
	@LgrHibernateValidated(champBd = "mt_ttc_calc",table = "ta_bon_reception",champEntite="mtTtcCalc",clazz = TaBonReceptionDTO.class)
	...
	@LgrHibernateValidated(champBd = "mt_ht_calc",table = "ta_bon_reception",champEntite="mtHtCalc",clazz = TaBonReceptionDTO.class)
	...
	@LgrHibernateValidated(champBd = "mt_tva_calc",table = "ta_bon_reception",champEntite="mtTvaCalc",clazz = TaBonReceptionDTO.class)
	...
	@LgrHibernateValidated(champBd = "net_ttc_calc",table = "ta_bon_reception",champEntite="netTtcCalc",clazz = TaBonReceptionDTO.class)
	...
	@LgrHibernateValidated(champBd = "net_ht_calc",table = "ta_bon_reception",champEntite="netHtCalc",clazz = TaBonReceptionDTO.class)
	...
	@LgrHibernateValidated(champBd = "net_tva_calc",table = "ta_bon_reception",champEntite="netTvaCalc",clazz = TaBonReceptionDTO.class)
...
//	}
	...
	@LgrHibernateValidated(champBd = "commentaire",table = "ta_bon_reception",champEntite="commentaire",clazz = TaBonReceptionDTO.class)
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TaBonReceptionDTO))
			return false;
		TaBonReceptionDTO castOther = (TaBonReceptionDTO) other;
...
//						.hashCode());
	...
	public Integer getIdTReception() {
		return idTReception;
	}

	public void setIdTReception(Integer idTReception) {
		this.idTReception = idTReception;
	}

	@LgrHibernateValidated(champBd = "code_t_reception",table = "ta_t_reception",champEntite="codeTReception", clazz = TaBonReceptionDTO.class)
