 ...
 */
public class TotauxAbonnementDTO extends ModelObject implements java.io.Serializable {

	private static final long serialVersionUID = -7935095361533249182L;
	...
	public TotauxAbonnementDTO() {
	}

	public TotauxAbonnementDTO(Integer ID_DEVIS, Integer ID_T_PAIEMENT, String CODE_T_PAIEMENT,
	...
	public void setIHMTotauxDEVIS(TotauxAbonnementDTO ihmTotauxDEVIS){
		setId(ihmTotauxDEVIS.id);
	...
	public static TotauxAbonnementDTO copy(TotauxAbonnementDTO ihmTotauxDEVIS){
		TotauxAbonnementDTO ihmEnteteDEVISLoc = new TotauxAbonnementDTO();
		ihmEnteteDEVISLoc.setId(ihmTotauxDEVIS.id);
