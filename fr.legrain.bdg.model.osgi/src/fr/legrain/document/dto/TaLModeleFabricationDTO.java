 ...
 */
public class TaLModeleFabricationDTO extends ModelObject implements PropertyChangeListener, java.io.Serializable{
	...
	public TaLModeleFabricationDTO() {
	}

	public TaLModeleFabricationDTO(Integer ID_L_DEVIS, Integer ID_DEVIS,
	...
	public void setIHMLDEVIS(TaLModeleFabricationDTO ihmLDEVIS) {
	...
	static public TaLModeleFabricationDTO copy(TaLModeleFabricationDTO ihmLDEVIS) {
		TaLModeleFabricationDTO swtLDEVISLoc = new TaLModeleFabricationDTO();
	...
	@Size(min=0, max=20)
	@LgrHibernateValidated(champBd = "code_article",table = "ta_article",champEntite="codeArticle",clazz = TaLModeleFabricationDTO.class)
	...
	@LgrHibernateValidated(champBd = "lib_l_document",table = "ta_l_bon_reception",champEntite="libLDocument",clazz = TaLModeleFabricationDTO.class)
	...
	@LgrHibernateValidated(champBd = "qte_l_document",table = "ta_l_bon_reception",champEntite="qteLDocument",clazz = TaLModeleFabricationDTO.class)
	...
	@LgrHibernateValidated(champBd = "u1_l_document",table = "ta_l_bon_reception",champEntite="u1LDocument",clazz = TaLModeleFabricationDTO.class)
	...
	@LgrHibernateValidated(champBd = "u2_l_document",table = "ta_l_bon_reception",champEntite="u2LDocument",clazz = TaLModeleFabricationDTO.class)
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TaLModeleFabricationDTO))
			return false;
		TaLModeleFabricationDTO castOther = (TaLModeleFabricationDTO) other;
...
//		}		
	...
	@LgrHibernateValidated(champBd = "qte2_l_document",table = "ta_l_bon_reception",champEntite="qte2LDocument",clazz = TaLModeleFabricationDTO.class)
	...
	@Size(min=0, max=20)
	@LgrHibernateValidated(champBd = "code_entrepot",table = "ta_entrepot",champEntite="codeEntrepot",clazz = TaLModeleFabricationDTO.class)
	...
	@LgrHibernateValidated(champBd = "emplacement_l_document",table = "ta_l_bon_reception",champEntite="emplacement",clazz = TaLModeleFabricationDTO.class)
	...
	@LgrHibernateValidated(champBd = "num_lot",table = "ta_lot",champEntite="numLot", clazz = TaLModeleFabricationDTO.class)
