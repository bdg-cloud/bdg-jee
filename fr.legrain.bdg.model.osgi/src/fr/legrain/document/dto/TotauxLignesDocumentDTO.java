 ...
 */
public class TotauxLignesDocumentDTO extends ModelObject implements PropertyChangeListener, java.io.Serializable{

	private static final long serialVersionUID = -6794036598996566971L;
	...
	public TotauxLignesDocumentDTO() {
	}

	public TotauxLignesDocumentDTO(Integer ID_FACTURE, BigDecimal NET_TTC_CALC, BigDecimal NET_HT_CALC,
	...
	public void setIHMTotauxDocument(TotauxLignesDocumentDTO ihmTotauxDocument){
		setId(ihmTotauxDocument.id);

		setNetTtcCalc(ihmTotauxDocument.netTtcCalc);
		setNetHtCalc(ihmTotauxDocument.netHtCalc);
		setNetTvaCalc(ihmTotauxDocument.netTvaCalc);
		setMtHtCalc(ihmTotauxDocument.mtHtCalc);
		setMtTtcCalc(ihmTotauxDocument.mtTtcCalc);
		setMtTvaCalc(ihmTotauxDocument.mtTvaCalc);
	}
	

	
	public static TotauxLignesFactureDTO copy(TotauxLignesDocumentDTO ihmTotauxDocument){
		TotauxLignesFactureDTO ihmEnteteFactureLoc = new TotauxLignesFactureDTO();
		ihmEnteteFactureLoc.setIdDocument(ihmTotauxDocument.id);
		ihmEnteteFactureLoc.setNetTtcCalc(ihmTotauxDocument.netTtcCalc);
		ihmEnteteFactureLoc.setNetHtCalc(ihmTotauxDocument.netHtCalc);
		ihmEnteteFactureLoc.setNetTvaCalc(ihmTotauxDocument.netTvaCalc);
		ihmEnteteFactureLoc.setMtHtCalc(ihmTotauxDocument.mtHtCalc);
		ihmEnteteFactureLoc.setMtTvaCalc(ihmTotauxDocument.mtTvaCalc);
		ihmEnteteFactureLoc.setMtTtcCalc(ihmTotauxDocument.mtTtcCalc);
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		TotauxLignesDocumentDTO other = (TotauxLignesDocumentDTO) obj;
		if (id == null) {
			if (other.id != null)
				return false;
