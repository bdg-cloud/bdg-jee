...
public class TDocDTO extends ModelObject {
	...
	public TDocDTO(String codeTDoc, String libTDoc) {
		super();
		this.codeTDoc = codeTDoc;
		this.libTDoc = libTDoc;
	}

	public static TDocDTO copy(TDocDTO swtTDoc){
		TDocDTO swtTDocLoc = new TDocDTO();
