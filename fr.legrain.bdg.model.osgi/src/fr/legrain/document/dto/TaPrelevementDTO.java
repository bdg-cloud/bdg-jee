 ...
 */
public class TaPrelevementDTO extends ModelObject implements java.io.Serializable, IDocumentDTO {

	/**
	 * 
	 */
	private static final long serialVersionUID = 8150522708274237647L;
...
//	private Boolean export=false;
	...
	public TaPrelevementDTO() {
	}

	public TaPrelevementDTO(Integer idDocument, 
			String codeDocument, 
			Date dateDocument, 
...
this.netTtcCalc = netTtcCalc;
	...
	public TaPrelevementDTO(Integer ID_Prelevement, String CODE_Prelevement,
			Date DATE_Prelevement, Date DATE_ECH_Prelevement, Date DATE_LIV_Prelevement,
			String LIBELLE_Prelevement, Integer ID_ADRESSE, Integer ID_ADRESSE_LIV,
			...
			Integer ID_C_PAIEMENT, BigDecimal REGLE_Prelevement,
			BigDecimal REM_HT_Prelevement, BigDecimal TX_REM_HT_Prelevement,
			BigDecimal REM_TTC_Prelevement, BigDecimal TX_REM_TTC_Prelevement,
			Integer NB_E_Prelevement, BigDecimal MT_TTC_CALC, BigDecimal MT_HT_CALC,
		...
		this.id = ID_Prelevement;
		this.codeDocument = CODE_Prelevement;
		this.dateDocument = DATE_Prelevement;
		this.dateEchDocument = DATE_ECH_Prelevement;
		this.dateLivDocument = DATE_LIV_Prelevement;
		this.libelleDocument = LIBELLE_Prelevement;
		...
		this.regleDocument = REGLE_Prelevement;
		this.remHtDocument = REM_HT_Prelevement;
		this.txRemHtDocument = TX_REM_HT_Prelevement;
		this.remTtcDocument = REM_TTC_Prelevement;
		this.txRemTtcDocument = TX_REM_TTC_Prelevement;
		this.nbEDocument = NB_E_Prelevement;
	...
	public void setIHMEntetePrelevement(TaPrelevementDTO ihmEntetePrelevement){
		setId(ihmEntetePrelevement.id);
		setCodeDocument(ihmEntetePrelevement.codeDocument);
		setDateDocument(ihmEntetePrelevement.dateDocument);
		setDateEchDocument(ihmEntetePrelevement.dateEchDocument);
		setDateLivDocument(ihmEntetePrelevement.dateLivDocument);
		setLibelleDocument(ihmEntetePrelevement.libelleDocument);
		setIdAdresse(ihmEntetePrelevement.idAdresse);
		setIdAdresseLiv(ihmEntetePrelevement.idAdresseLiv);
		setIdTiers(ihmEntetePrelevement.idTiers);
		setCodeTiers(ihmEntetePrelevement.codeTiers);
		setNomTiers(ihmEntetePrelevement.nomTiers);
		setPrenomTiers(ihmEntetePrelevement.prenomTiers);
		setSurnomTiers(ihmEntetePrelevement.surnomTiers);
		setCodeCompta(ihmEntetePrelevement.codeCompta);
		setCompte(ihmEntetePrelevement.compte);
		setIdTPaiement(ihmEntetePrelevement.idTPaiement);
		setCodeTPaiement(ihmEntetePrelevement.codeTPaiement);
		setIdCPaiement(ihmEntetePrelevement.idCPaiement);
		setRegleDocument(ihmEntetePrelevement.regleDocument);
		setRemHtDocument(ihmEntetePrelevement.remHtDocument);
		setTxRemHtDocument(ihmEntetePrelevement.txRemHtDocument);
		setRemTtcDocument(ihmEntetePrelevement.remTtcDocument);
		setTxRemTtcDocument(ihmEntetePrelevement.txRemTtcDocument);
		setNbEDocument(ihmEntetePrelevement.nbEDocument);
		setMtTtcCalc(ihmEntetePrelevement.mtTtcCalc);
		setMtHtCalc(ihmEntetePrelevement.mtHtCalc);
		setMtTvaCalc(ihmEntetePrelevement.mtTvaCalc);
		setNetTtcCalc(ihmEntetePrelevement.netTtcCalc);
		setNetHtCalc(ihmEntetePrelevement.netHtCalc);
		setNetTvaCalc(ihmEntetePrelevement.netTvaCalc);
		setIpAcces(ihmEntetePrelevement.ipAcces);
		setTtc(ihmEntetePrelevement.ttc);
		setDateExport(ihmEntetePrelevement.dateExport);
		setCommentaire(ihmEntetePrelevement.commentaire);
	}
	

	public static TaPrelevementDTO copy(TaPrelevementDTO ihmEntetePrelevement){
		TaPrelevementDTO ihmEntetePrelevementLoc = new TaPrelevementDTO();
		ihmEntetePrelevementLoc.setId(ihmEntetePrelevement.id);
		ihmEntetePrelevementLoc.setCodeDocument(ihmEntetePrelevement.codeDocument);
		ihmEntetePrelevementLoc.setDateDocument(ihmEntetePrelevement.dateDocument);
		ihmEntetePrelevementLoc.setDateEchDocument(ihmEntetePrelevement.dateEchDocument);
		ihmEntetePrelevementLoc.setDateLivDocument(ihmEntetePrelevement.dateLivDocument);
		ihmEntetePrelevementLoc.setLibelleDocument(ihmEntetePrelevement.libelleDocument);
		ihmEntetePrelevementLoc.setIdAdresse(ihmEntetePrelevement.idAdresse);
		ihmEntetePrelevementLoc.setIdAdresseLiv(ihmEntetePrelevement.idAdresseLiv);
		ihmEntetePrelevementLoc.setIdTiers(ihmEntetePrelevement.idTiers);
		ihmEntetePrelevementLoc.setCodeTiers(ihmEntetePrelevement.codeTiers);
		ihmEntetePrelevementLoc.setNomTiers(ihmEntetePrelevement.nomTiers);
		ihmEntetePrelevementLoc.setPrenomTiers(ihmEntetePrelevement.prenomTiers);
		ihmEntetePrelevementLoc.setSurnomTiers(ihmEntetePrelevement.surnomTiers);
		ihmEntetePrelevementLoc.setCodeCompta(ihmEntetePrelevement.codeCompta);
		ihmEntetePrelevementLoc.setCompte(ihmEntetePrelevement.compte);
		ihmEntetePrelevementLoc.setIdTPaiement(ihmEntetePrelevement.idTPaiement);
		ihmEntetePrelevementLoc.setCodeTPaiement(ihmEntetePrelevement.codeTPaiement);
		ihmEntetePrelevementLoc.setIdCPaiement(ihmEntetePrelevement.idCPaiement);
		ihmEntetePrelevementLoc.setRegleDocument(ihmEntetePrelevement.regleDocument);
		ihmEntetePrelevementLoc.setRemHtDocument(ihmEntetePrelevement.remHtDocument);
		ihmEntetePrelevementLoc.setTxRemHtDocument(ihmEntetePrelevement.txRemHtDocument);
		ihmEntetePrelevementLoc.setRemTtcDocument(ihmEntetePrelevement.remTtcDocument);
		ihmEntetePrelevementLoc.setTxRemTtcDocument(ihmEntetePrelevement.txRemTtcDocument);
		ihmEntetePrelevementLoc.setNbEDocument(ihmEntetePrelevement.nbEDocument);
		ihmEntetePrelevementLoc.setMtTtcCalc(ihmEntetePrelevement.mtTtcCalc);
		ihmEntetePrelevementLoc.setMtHtCalc(ihmEntetePrelevement.mtHtCalc);
		ihmEntetePrelevementLoc.setMtTvaCalc(ihmEntetePrelevement.mtTvaCalc);
		ihmEntetePrelevementLoc.setNetTtcCalc(ihmEntetePrelevement.netTtcCalc);
		ihmEntetePrelevementLoc.setNetHtCalc(ihmEntetePrelevement.netHtCalc);
		ihmEntetePrelevementLoc.setNetTvaCalc(ihmEntetePrelevement.netTvaCalc);
		ihmEntetePrelevementLoc.setIpAcces(ihmEntetePrelevement.ipAcces);
		ihmEntetePrelevementLoc.setTtc(ihmEntetePrelevement.ttc);
		ihmEntetePrelevementLoc.setDateExport(ihmEntetePrelevement.dateExport);
		ihmEntetePrelevementLoc.setCommentaire(ihmEntetePrelevement.commentaire);
		return ihmEntetePrelevementLoc;
	}
	
	public boolean PrelevementEstVide(){
		Date dateExemple = new Date();
//		if(!getCODE_Prelevement().equals(LgrConstantes.C_STR_VIDE))return true;
	...
	public boolean PrelevementEstVide(Date dateDansExercice){
		Date dateExemple = new Date();
//		if(!getCODE_Prelevement().equals(LgrConstantes.C_STR_VIDE))return true;
...
//				(LibDate.compareTo(getDateLivDocument(), dateExemple)==0)))return false;
	...
	public void setId(Integer ID_Prelevement) {
		firePropertyChange("idDocument", this.id, this.id = ID_Prelevement);
	}
	...
	public void setCodeDocument(String CODE_Prelevement) {
		firePropertyChange("codeDocument", this.codeDocument, this.codeDocument = CODE_Prelevement);
	}
	...
	public void setDateDocument(Date DATE_Prelevement) {
		firePropertyChange("dateDocument", this.dateDocument, this.dateDocument = DATE_Prelevement);
	}
	...
	public void setDateEchDocument(Date DATE_ECH_Prelevement) {
		firePropertyChange("dateEchDocument", this.dateEchDocument, this.dateEchDocument = DATE_ECH_Prelevement);
	}
	...
	public void setDateLivDocument(Date DATE_LIV_Prelevement) {
		firePropertyChange("dateLivDocument", this.dateLivDocument, this.dateLivDocument = DATE_LIV_Prelevement);
	}
	...
	public void setLibelleDocument(String LIBELLE_Prelevement) {
		firePropertyChange("libelleDocument", this.libelleDocument, this.libelleDocument = LIBELLE_Prelevement);
	}
	...
	public void setRemHtDocument(BigDecimal REM_HT_Prelevement) {
		firePropertyChange("remHtDocument", this.remHtDocument, this.remHtDocument = REM_HT_Prelevement);
	}
	...
	public void setTxRemHtDocument(BigDecimal TX_REM_HT_Prelevement) {
		firePropertyChange("txRemHtDocument", this.txRemHtDocument, this.txRemHtDocument = TX_REM_HT_Prelevement);
	}
	...
	public void setRemTtcDocument(BigDecimal REM_TTC_Prelevement) {
		firePropertyChange("remTtcDocument", this.remTtcDocument, this.remTtcDocument = REM_TTC_Prelevement);
	}
	...
	public void setTxRemTtcDocument(BigDecimal TX_REM_TTC_Prelevement) {
		firePropertyChange("txRemTtcDocument", this.txRemTtcDocument, this.txRemTtcDocument = TX_REM_TTC_Prelevement);
	}
	...
	public void setNbEDocument(Integer NB_E_Prelevement) {
		firePropertyChange("nbEDocument", this.nbEDocument, this.nbEDocument = NB_E_Prelevement);
	}
...
//	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		TaPrelevementDTO other = (TaPrelevementDTO) obj;
		if (codeCompta == null) {
