 ...
 */
public class AideBonlivDTO extends AideDocumentCommunDTO {

	

	public AideBonlivDTO() {
	}

	public AideBonlivDTO(Integer idDocument, String codeDocument,
	...
	public void setIHMEnteteBONLIV(AideBonlivDTO ihmEnteteDocument){
	...
	public static AideBonlivDTO copy(AideBonlivDTO ihmEnteteDocument){
		AideBonlivDTO ihmEnteteDocumentLoc = new AideBonlivDTO();
