 ...
 */
public class TotauxAvisEcheanceDTO extends ModelObject  implements java.io.Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = 896455195073714904L;
	...
	public TotauxAvisEcheanceDTO() {
	}

	public TotauxAvisEcheanceDTO(Integer ID_Proforma, Integer ID_T_PAIEMENT, String CODE_T_PAIEMENT,
	...
	public void setIHMTotauxProforma(TotauxAvisEcheanceDTO ihmTotauxProforma){
		setId(ihmTotauxProforma.id);
	...
	public static TotauxAvisEcheanceDTO copy(TotauxAvisEcheanceDTO ihmTotauxProforma){
		TotauxAvisEcheanceDTO ihmEnteteProformaLoc = new TotauxAvisEcheanceDTO();
		ihmEnteteProformaLoc.setId(ihmTotauxProforma.id);
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		TotauxAvisEcheanceDTO other = (TotauxAvisEcheanceDTO) obj;
