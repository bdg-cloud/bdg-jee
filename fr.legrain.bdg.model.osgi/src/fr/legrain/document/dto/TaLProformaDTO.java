 ...
 */
public class TaLProformaDTO extends ModelObject implements PropertyChangeListener, java.io.Serializable, ILigneDocumentDTO{

	/**
	 * 
	 */
	private static final long serialVersionUID = -1698154559573221899L;
	private Integer id;
	...
	public TaLProformaDTO() {
	}

	public TaLProformaDTO(Integer ID_L_Proforma, Integer ID_Proforma,
	...
	public void setIHMLProforma(TaLProformaDTO ihmLProforma) {
		setIdLDocument(ihmLProforma.id);
	...
	static public TaLProformaDTO copy(TaLProformaDTO ihmLProforma) {
		TaLProformaDTO swtLProformaLoc = new TaLProformaDTO();
		swtLProformaLoc.setIdLDocument(ihmLProforma.id);
		...
		swtLProformaLoc.setQte2LDocument(ihmLProforma.qte2LDocument);
		...
		swtLProformaLoc.setVersionObj(ihmLProforma.versionObj);
		swtLProformaLoc.setQteSaisieLDocument(ihmLProforma.getQteSaisieLDocument());
		swtLProformaLoc.setUSaisieLDocument(ihmLProforma.uSaisieLDocument);
		swtLProformaLoc.setCodeTitreTransport(ihmLProforma.codeTitreTransport);
		swtLProformaLoc.setQteTitreTransport(ihmLProforma.qteTitreTransport);
	...
	public void setIdLDocument(Integer ID_L_Proforma) {
		firePropertyChange("idLDocument", this.id, this.id = ID_L_Proforma);
	}
	...
	@LgrHibernateValidated(champBd = "code_article",table = "ta_article",champEntite="codeArticle",clazz = TaLProformaDTO.class)
	...
	@LgrHibernateValidated(champBd = "lib_l_document",table = "ta_l_proforma",champEntite="libLDocument",clazz = TaLProformaDTO.class)
	...
	@LgrHibernateValidated(champBd = "qte_l_document",table = "ta_l_proforma",champEntite="qteLDocument",clazz = TaLProformaDTO.class)
	...
	@LgrHibernateValidated(champBd = "u1_l_document",table = "ta_l_proforma",champEntite="u1LDocument",clazz = TaLProformaDTO.class)
	...
	@LgrHibernateValidated(champBd = "u2_l_document",table = "ta_l_proforma",champEntite="u2LDocument",clazz = TaLProformaDTO.class)
	...
	@LgrHibernateValidated(champBd = "prix_u_l_document",table = "ta_l_proforma",champEntite="prixULDocument",clazz = TaLProformaDTO.class)
	...
	@LgrHibernateValidated(champBd = "taux_tva_l_document",table = "ta_l_proforma",champEntite="tauxTvaLDocument",clazz = TaLProformaDTO.class)
	...
	@LgrHibernateValidated(champBd = "code_tva_l_document",table = "ta_l_proforma",champEntite="codeTvaLDocument",clazz = TaLProformaDTO.class)
	...
	@LgrHibernateValidated(champBd = "code_t_tva_l_document",table = "ta_l_proforma",champEntite="codeTTvaLDocument",clazz = TaLProformaDTO.class)
	...
	@LgrHibernateValidated(champBd = "mt_ht_l_document",table = "ta_l_proforma",champEntite="mtHtLDocument",clazz = TaLProformaDTO.class)
	...
	@LgrHibernateValidated(champBd = "mt_ttc_l_document",table = "ta_l_proforma",champEntite="mtTtcLDocument",clazz = TaLProformaDTO.class)
	...
	@LgrHibernateValidated(champBd = "rem_tx_l_document",table = "ta_l_proforma",champEntite="remTxLDocument",clazz = TaLProformaDTO.class)
	...
	@LgrHibernateValidated(champBd = "rem_ht_l_document",table = "ta_l_proforma",champEntite="remHtLDocument",clazz = TaLProformaDTO.class)
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TaLProformaDTO))
			return false;
		TaLProformaDTO castOther = (TaLProformaDTO) other;
...
//		}		
	...
	@LgrHibernateValidated(champBd = "qte2_l_document",table = "ta_l_proforma",champEntite="qte2LDocument", clazz = TaLProformaDTO.class)
