 ...
 */
public class TaLFabricationDTO extends ModelObject implements PropertyChangeListener, java.io.Serializable, ILigneDocumentDTO, ILigneDocumentLotDTO{
	...
	public TaLFabricationDTO() {
	}

	public TaLFabricationDTO(Integer ID_L_DEVIS, Integer ID_DEVIS,
	...
	public void setIHMLDEVIS(TaLFabricationDTO ihmLDEVIS) {
	...
	static public TaLFabricationDTO copy(TaLFabricationDTO ihmLDEVIS) {
		TaLFabricationDTO swtLDEVISLoc = new TaLFabricationDTO();
	...
	@Size(min=0, max=20)
	@LgrHibernateValidated(champBd = "code_article",table = "ta_article",champEntite="codeArticle",clazz = TaLFabricationDTO.class)
	...
	@LgrHibernateValidated(champBd = "lib_l_document",table = "ta_l_bon_reception",champEntite="libLDocument",clazz = TaLFabricationDTO.class)
	...
	@LgrHibernateValidated(champBd = "qte_l_document",table = "ta_l_bon_reception",champEntite="qteLDocument",clazz = TaLFabricationDTO.class)
	...
	@LgrHibernateValidated(champBd = "u1_l_document",table = "ta_l_bon_reception",champEntite="u1LDocument",clazz = TaLFabricationDTO.class)
	...
	@LgrHibernateValidated(champBd = "u2_l_document",table = "ta_l_bon_reception",champEntite="u2LDocument",clazz = TaLFabricationDTO.class)
	...
	@Size(min=0, max=20)
	@LgrHibernateValidated(champBd = "code_tva_l_document",table = "ta_l_bon_reception",champEntite="codeTvaLDocument",clazz = TaLFabricationDTO.class)
	...
	@Size(min=0, max=20)
	@LgrHibernateValidated(champBd = "code_t_tva_l_document",table = "ta_l_bon_reception",champEntite="codeTTvaLDocument",clazz = TaLFabricationDTO.class)
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TaLFabricationDTO))
			return false;
		TaLFabricationDTO castOther = (TaLFabricationDTO) other;
...
//		}		
	...
	@LgrHibernateValidated(champBd = "qte2_l_document",table = "ta_l_bon_reception",champEntite="qte2LDocument",clazz = TaLFabricationDTO.class)
	...
	@Size(min=0, max=20)
	@LgrHibernateValidated(champBd = "code_entrepot",table = "ta_entrepot",champEntite="codeEntrepot",clazz = TaLFabricationDTO.class)
	...
	@LgrHibernateValidated(champBd = "emplacement_l_document",table = "ta_l_bon_reception",champEntite="emplacement",clazz = TaLFabricationDTO.class)
	...
	@LgrHibernateValidated(champBd = "num_lot",table = "ta_lot",champEntite="numLot", clazz = TaLFabricationDTO.class)
	@Valid
