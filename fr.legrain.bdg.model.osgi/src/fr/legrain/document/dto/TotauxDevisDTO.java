 ...
 */
public class TotauxDevisDTO extends ModelObject implements java.io.Serializable {
	...
	public TotauxDevisDTO() {
	}

	public TotauxDevisDTO(Integer ID_DEVIS, Integer ID_T_PAIEMENT, String CODE_T_PAIEMENT,
	...
	public void setIHMTotauxDEVIS(TotauxDevisDTO ihmTotauxDEVIS){
	...
	public static TotauxDevisDTO copy(TotauxDevisDTO ihmTotauxDEVIS){
		TotauxDevisDTO ihmEnteteDEVISLoc = new TotauxDevisDTO();
