 ...
 */
public class AideAvisEcheanceDTO extends AideDocumentCommunDTO {


	public AideAvisEcheanceDTO() {
	}

	public AideAvisEcheanceDTO(Integer idDocument, String codeDocument,
	...
	public void setIHMEnteteAvisEcheance(AideAvisEcheanceDTO ihmEnteteDocument){
	...
	public static AideAvisEcheanceDTO copy(AideAvisEcheanceDTO ihmEnteteDocument){
		AideAvisEcheanceDTO ihmEnteteDocumentLoc = new AideAvisEcheanceDTO();
