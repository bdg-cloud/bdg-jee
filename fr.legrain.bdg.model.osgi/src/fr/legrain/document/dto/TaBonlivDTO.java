...
public class TaBonlivDTO extends ModelObject implements java.io.Serializable, IDocumentDTO {
...
//	private Boolean export=false;
	...
	private List<TaLBonlivDTO> lignesDTO;
	private TaInfosBonliv infos;
	
	public TaBonlivDTO() {
	}
	
	public TaBonlivDTO(Integer idDocument, 
			String codeDocument, 
			Date dateDocument, 
	...
	public TaBonlivDTO(  String codeTransporteur,String codeTiers, String nomTiers,String villeLiv,String paysLiv ,String codeDocument, Date dateDocument, Date dateLivDocument, 
	...
	public TaBonlivDTO(Integer ID_BONLIV, String CODE_BONLIV,
	...
	@JsonIgnore
	public void setIHMEnteteBonliv(TaBonlivDTO ihmEnteteBonliv){
	...
	public static TaBonlivDTO copy(TaBonlivDTO ihmEnteteBonliv){
		TaBonlivDTO ihmEnteteBonlivLoc = new TaBonlivDTO();
...
//				(LibDate.compareTo(getDateLivDocument(), dateExemple)==0)))return false;
	...
	@NotNull
	@Size(min=1, max=20)
	@LgrHibernateValidated(champBd = "code_document",table = "ta_bonliv",champEntite="codeDocument", clazz = TaBonlivDTO.class)
	...
	@LgrHibernateValidated(champBd = "date_document",table = "ta_bonliv",champEntite="dateDocument",clazz = TaBonlivDTO.class)
	...
	@LgrHibernateValidated(champBd = "date_liv_document",table = "ta_bonliv",champEntite="dateLivDocument",clazz = TaBonlivDTO.class)
	...
	@LgrHibernateValidated(champBd = "libelle_document",table = "ta_bonliv",champEntite="libelleDocument",clazz = TaBonlivDTO.class)
	...
	@NotNull
	@Size(min=1, max=20)
	@LgrHibernateValidated(champBd = "code_tiers",table = "ta_tiers",champEntite="codeTiers",clazz = TaBonlivDTO.class)
	...
	@LgrHibernateValidated(champBd = "nom_tiers",table = "ta_tiers",champEntite="nomTiers",clazz = TaBonlivDTO.class)
	...
	@Size(min=0, max=8)
	@LgrHibernateValidated(champBd = "code_compta",table = "ta_tiers",champEntite="codeCompta",clazz = TaBonlivDTO.class)
	...
	@Size(min=0, max=8)
	@LgrHibernateValidated(champBd = "compte",table = "ta_tiers",champEntite="compte",clazz = TaBonlivDTO.class)
	...
	@Size(min=0, max=20)
	@LgrHibernateValidated(champBd = "code_t_paiement",table = "ta_t_paiement",champEntite="codeTPaiement",clazz = TaBonlivDTO.class)
...
//	}
	...
	@LgrHibernateValidated(champBd = "rem_ht_document",table = "ta_bonliv",champEntite="remHtDocument",clazz = TaBonlivDTO.class)
	...
	@LgrHibernateValidated(champBd = "tx_rem_ht_document",table = "ta_bonliv",champEntite="txRemHtDocument",clazz = TaBonlivDTO.class)
	...
	@LgrHibernateValidated(champBd = "rem_ttc_document",table = "ta_bonliv",champEntite="remTtcDocument",clazz = TaBonlivDTO.class)
	...
	@LgrHibernateValidated(champBd = "tx_rem_ttc_document",table = "ta_bonliv",champEntite="txRemTtcDocument",clazz = TaBonlivDTO.class)
	...
	@LgrHibernateValidated(champBd = "mt_ttc_calc",table = "ta_bonliv",champEntite="mtTtcCalc",clazz = TaBonlivDTO.class)
	...
	@LgrHibernateValidated(champBd = "mt_ht_calc",table = "ta_bonliv",champEntite="mtHtCalc",clazz = TaBonlivDTO.class)
	...
	@LgrHibernateValidated(champBd = "mt_tva_calc",table = "ta_bonliv",champEntite="mtTvaCalc",clazz = TaBonlivDTO.class)
	...
	@LgrHibernateValidated(champBd = "net_ttc_calc",table = "ta_bonliv",champEntite="netTtcCalc",clazz = TaBonlivDTO.class)
	...
	@LgrHibernateValidated(champBd = "net_ht_calc",table = "ta_bonliv",champEntite="netHtCalc",clazz = TaBonlivDTO.class)
	...
	@LgrHibernateValidated(champBd = "net_tva_calc",table = "ta_bonliv",champEntite="netTvaCalc",clazz = TaBonlivDTO.class)
...
//	}
	...
	@LgrHibernateValidated(champBd = "commentaire",table = "ta_bonliv",champEntite="commentaire",clazz = TaBonlivDTO.class)
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TaBonlivDTO))
			return false;
		TaBonlivDTO castOther = (TaBonlivDTO) other;
...
//						.hashCode());
	...
	public List<TaLBonlivDTO> getLignesDTO() {
		return lignesDTO;
	}

	public void setLignesDTO(List<TaLBonlivDTO> lignesDTO) {
	...
	@LgrHibernateValidated(champBd = "id_transporteur",table = "ta_transporteur",champEntite="idTransporteur",clazz = TaBonlivDTO.class)
	...
	@LgrHibernateValidated(champBd = "code_transporteur",table = "ta_transporteur",champEntite="codeTransporteur",clazz = TaBonlivDTO.class)
	...
	public TaInfosBonliv getInfos() {
		return infos;
	}

	public void setInfos(TaInfosBonliv infosDTO) {
		this.infos = infosDTO;
	}
