 ...
 */
public class TaLFactureDTO extends ModelObject implements PropertyChangeListener, java.io.Serializable, ILigneDocumentDTO{
	...
	public TaLFactureDTO() {
	}

	public TaLFactureDTO(Integer ID_L_FACTURE, Integer ID_FACTURE,
	...
	@JsonIgnore
	public void setIHMLFacture(TaLFactureDTO ihmLFacture) {
	...
	static public TaLFactureDTO copy(TaLFactureDTO ihmLFacture) {
		TaLFactureDTO swtLFactureLoc = new TaLFactureDTO();
	...
	@Size(min=0, max=20)
	@LgrHibernateValidated(champBd = "code_article",table = "ta_article",champEntite="codeArticle",clazz = TaLFactureDTO.class)
	...
	@LgrHibernateValidated(champBd = "lib_l_document",table = "ta_l_facture",champEntite="libLDocument",clazz = TaLFactureDTO.class)
	...
	@LgrHibernateValidated(champBd = "qte_l_document",table = "ta_l_facture",champEntite="qteLDocument",clazz = TaLFactureDTO.class)
	...
	@LgrHibernateValidated(champBd = "u1_l_document",table = "ta_l_facture",champEntite="u1LDocument",clazz = TaLFactureDTO.class)
	...
	@LgrHibernateValidated(champBd = "u2_l_document",table = "ta_l_facture",champEntite="u2LDocument",clazz = TaLFactureDTO.class)
	...
	@LgrHibernateValidated(champBd = "prix_u_l_document",table = "ta_l_facture",champEntite="prixULDocument",clazz = TaLFactureDTO.class)
	...
	@LgrHibernateValidated(champBd = "taux_tva_l_document",table = "ta_l_facture",champEntite="tauxTvaLDocument",clazz = TaLFactureDTO.class)
	...
	@Size(min=0, max=20)
	@LgrHibernateValidated(champBd = "code_tva_l_document",table = "ta_l_facture",champEntite="codeTvaLDocument",clazz = TaLFactureDTO.class)
	...
	@Size(min=0, max=20)
	@LgrHibernateValidated(champBd = "code_t_tva_l_document",table = "ta_l_facture",champEntite="codeTTvaLDocument",clazz = TaLFactureDTO.class)
	...
	@LgrHibernateValidated(champBd = "mt_ht_l_document",table = "ta_l_facture",champEntite="mtHtLDocument",clazz = TaLFactureDTO.class)
	...
	@LgrHibernateValidated(champBd = "mt_ttc_l_document",table = "ta_l_facture",champEntite="mtTtcLDocument",clazz = TaLFactureDTO.class)
	...
	@LgrHibernateValidated(champBd = "rem_tx_l_document",table = "ta_l_facture",champEntite="remTxLDocument",clazz = TaLFactureDTO.class)
	...
	@LgrHibernateValidated(champBd = "rem_ht_l_document",table = "ta_l_facture",champEntite="remHtLDocument",clazz = TaLFactureDTO.class)
	...
	@Size(min=0, max=20)
	@LgrHibernateValidated(champBd = "titre_transport_l_document",table = "ta_l_facture",champEntite="codeTitreTransport",clazz = TaLFactureDTO.class)
	...
	@LgrHibernateValidated(champBd = "qte_titre_transport_l_document",table = "ta_l_facture",champEntite="qteTitreTransport",clazz = TaLFactureDTO.class)
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TaLFactureDTO))
			return false;
		TaLFactureDTO castOther = (TaLFactureDTO) other;
...
//		}		
	...
	@LgrHibernateValidated(champBd = "qte2_l_document",table = "ta_l_facture",champEntite="qte2LDocument",clazz = TaLFactureDTO.class)
	...
	@LgrHibernateValidated(champBd = "mt_apr_rem_globale",table = "ta_l_facture",champEntite="mtHtLApresRemiseGlobaleDocument",clazz = TaLFactureDTO.class)
	...
	@LgrHibernateValidated(champBd = "mt_ttc_apr_rem_globale",table = "ta_l_facture",champEntite="mtTtcLApresRemiseGlobaleDocument", clazz = TaLFactureDTO.class)
