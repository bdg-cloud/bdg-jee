 ...
 */
public class TotauxBonReceptionDTO extends ModelObject  implements java.io.Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = -6256314492768068857L;
	...
	public TotauxBonReceptionDTO() {
	}

	public TotauxBonReceptionDTO(Integer ID_BONLIV, Integer ID_T_PAIEMENT, String CODE_T_PAIEMENT,
	...
	public void setIHMTotauxBONLIV(TotauxBonReceptionDTO ihmTotauxBONLIV){
		setId(ihmTotauxBONLIV.id);
	...
	public static TotauxBonReceptionDTO copy(TotauxBonReceptionDTO ihmTotauxBONLIV){
		TotauxBonReceptionDTO ihmEnteteBONLIVLoc = new TotauxBonReceptionDTO();
		ihmEnteteBONLIVLoc.setId(ihmTotauxBONLIV.id);
...
//	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TotauxBonReceptionDTO))
			return false;
		TotauxBonReceptionDTO castOther = (TotauxBonReceptionDTO) other;
