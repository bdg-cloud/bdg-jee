 ...
 */
public class EnteteBonlivDTO extends ModelObject  implements java.io.Serializable {
	...
	public EnteteBonlivDTO() {
	}

	public EnteteBonlivDTO(Integer ID_BONLIV, String CODE_BONLIV,
	...
	public void setIHMEnteteBonliv(EnteteBonlivDTO ihmEnteteBonliv){
	...
	public static EnteteBonlivDTO copy(EnteteBonlivDTO ihmEnteteBonliv){
		EnteteBonlivDTO ihmEnteteBonlivLoc = new EnteteBonlivDTO();
...
//	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof EnteteBonlivDTO))
			return false;
		EnteteBonlivDTO castOther = (EnteteBonlivDTO) other;
