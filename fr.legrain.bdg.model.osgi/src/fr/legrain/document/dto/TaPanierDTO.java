 ...
 */
public class TaPanierDTO extends ModelObject implements java.io.Serializable, IDocumentDTO {
	...
	private String codeTTiers=LgrConstantes.C_STR_VIDE;
	private String libelleTTiers=LgrConstantes.C_STR_VIDE;
...
//	private Boolean export=false;
	...
	private List<TaLPanierDTO> lignesDTO;
	private TaInfosPanier infos;
	
	public TaPanierDTO() {
	}
	
	public TaPanierDTO(Integer idDocument, 
			String codeDocument, 
			Date dateDocument, 
	...
	public TaPanierDTO(Integer ID_BONLIV, String CODE_BONLIV,
	...
	public void setIHMEntetePanier(TaPanierDTO ihmEntetePanier){
		setId(ihmEntetePanier.id);
		setCodeDocument(ihmEntetePanier.codeDocument);
		setDateDocument(ihmEntetePanier.dateDocument);
		setDateEchDocument(ihmEntetePanier.dateEchDocument);
		setDateLivDocument(ihmEntetePanier.dateLivDocument);
		setLibelleDocument(ihmEntetePanier.libelleDocument);
		setIdAdresse(ihmEntetePanier.idAdresse);
		setIdAdresseLiv(ihmEntetePanier.idAdresseLiv);
		setIdTiers(ihmEntetePanier.idTiers);
		setCodeTiers(ihmEntetePanier.codeTiers);
		setNomTiers(ihmEntetePanier.nomTiers);
		setPrenomTiers(ihmEntetePanier.prenomTiers);
		setSurnomTiers(ihmEntetePanier.surnomTiers);
		setCodeCompta(ihmEntetePanier.codeCompta);
		setCompte(ihmEntetePanier.compte);
		setIdTPaiement(ihmEntetePanier.idTPaiement);
		setCodeTPaiement(ihmEntetePanier.codeTPaiement);
		setIdCPaiement(ihmEntetePanier.idCPaiement);
		//setREGLE_BONLIV(ihmEntetePanier.REGLE_BONLIV);
		setRemHtDocument(ihmEntetePanier.remHtDocument);
		setTxRemHtDocument(ihmEntetePanier.txRemHtDocument);
		setRemTtcDocument(ihmEntetePanier.remTtcDocument);
		setTxRemTtcDocument(ihmEntetePanier.txRemTtcDocument);
		setNbEDocument(ihmEntetePanier.nbEDocument);
		setMtTtcCalc(ihmEntetePanier.mtTtcCalc);
		setMtHtCalc(ihmEntetePanier.mtHtCalc);
		setMtTvaCalc(ihmEntetePanier.mtTvaCalc);
		setNetTtcCalc(ihmEntetePanier.netTtcCalc);
		setNetHtCalc(ihmEntetePanier.netHtCalc);
		setNetTvaCalc(ihmEntetePanier.netTvaCalc);
		setIpAcces(ihmEntetePanier.ipAcces);
		setTtc(ihmEntetePanier.ttc);
		setDateExport(ihmEntetePanier.dateExport);
		setCommentaire(ihmEntetePanier.commentaire);
	}
	
	public static TaPanierDTO copy(TaPanierDTO ihmEntetePanier){
		TaPanierDTO ihmEntetePanierLoc = new TaPanierDTO();
		ihmEntetePanierLoc.setId(ihmEntetePanier.id);
		ihmEntetePanierLoc.setCodeDocument(ihmEntetePanier.codeDocument);
		ihmEntetePanierLoc.setDateDocument(ihmEntetePanier.dateDocument);
		ihmEntetePanierLoc.setDateEchDocument(ihmEntetePanier.dateEchDocument);
		ihmEntetePanierLoc.setDateLivDocument(ihmEntetePanier.dateLivDocument);
		ihmEntetePanierLoc.setLibelleDocument(ihmEntetePanier.libelleDocument);
		ihmEntetePanierLoc.setIdAdresse(ihmEntetePanier.idAdresse);
		ihmEntetePanierLoc.setIdAdresseLiv(ihmEntetePanier.idAdresseLiv);
		ihmEntetePanierLoc.setIdTiers(ihmEntetePanier.idTiers);
		ihmEntetePanierLoc.setCodeTiers(ihmEntetePanier.codeTiers);
		ihmEntetePanierLoc.setNomTiers(ihmEntetePanier.nomTiers);
		ihmEntetePanierLoc.setPrenomTiers(ihmEntetePanier.prenomTiers);
		ihmEntetePanierLoc.setSurnomTiers(ihmEntetePanier.surnomTiers);
		ihmEntetePanierLoc.setCodeCompta(ihmEntetePanier.codeCompta);
		ihmEntetePanierLoc.setCompte(ihmEntetePanier.compte);
		ihmEntetePanierLoc.setIdTPaiement(ihmEntetePanier.idTPaiement);
		ihmEntetePanierLoc.setCodeTPaiement(ihmEntetePanier.codeTPaiement);
		ihmEntetePanierLoc.setIdCPaiement(ihmEntetePanier.idCPaiement);
		//ihmEntetePanierLoc.setREGLE_BONLIV(ihmEntetePanier.REGLE_BONLIV);
		ihmEntetePanierLoc.setRemHtDocument(ihmEntetePanier.remHtDocument);
		ihmEntetePanierLoc.setTxRemHtDocument(ihmEntetePanier.txRemHtDocument);
		ihmEntetePanierLoc.setRemTtcDocument(ihmEntetePanier.remTtcDocument);
		ihmEntetePanierLoc.setTxRemTtcDocument(ihmEntetePanier.txRemTtcDocument);
		ihmEntetePanierLoc.setNbEDocument(ihmEntetePanier.nbEDocument);
		ihmEntetePanierLoc.setMtTtcCalc(ihmEntetePanier.mtTtcCalc);
		ihmEntetePanierLoc.setMtHtCalc(ihmEntetePanier.mtHtCalc);
		ihmEntetePanierLoc.setMtTvaCalc(ihmEntetePanier.mtTvaCalc);
		ihmEntetePanierLoc.setNetTtcCalc(ihmEntetePanier.netTtcCalc);
		ihmEntetePanierLoc.setNetHtCalc(ihmEntetePanier.netHtCalc);
		ihmEntetePanierLoc.setNetTvaCalc(ihmEntetePanier.netTvaCalc);
		ihmEntetePanierLoc.setIpAcces(ihmEntetePanier.ipAcces);
		ihmEntetePanierLoc.setTtc(ihmEntetePanier.ttc);
		ihmEntetePanierLoc.setDateExport(ihmEntetePanier.dateExport);
		ihmEntetePanierLoc.setCommentaire(ihmEntetePanier.commentaire);
		return ihmEntetePanierLoc;
	}
	
	public boolean PanierEstVide(){
...
//		if(!getCODE_BONLIV().equals(LgrConstantes.C_STR_VIDE))return true;
	...
	public boolean PanierEstVide(Date dateDansExercice){
		Date dateExemple = new Date();
//		if(!getCODE_BONLIV().equals(LgrConstantes.C_STR_VIDE))return true;
...
//				(LibDate.compareTo(getDateLivDocument(), dateExemple)==0)))return false;
	...
	@NotNull
	@Size(min=1, max=20)
	@LgrHibernateValidated(champBd = "code_document",table = "ta_panier",champEntite="codeDocument", clazz = TaPanierDTO.class)
	...
	@LgrHibernateValidated(champBd = "date_document",table = "ta_panier",champEntite="dateDocument",clazz = TaPanierDTO.class)
	...
	@LgrHibernateValidated(champBd = "date_liv_document",table = "ta_panier",champEntite="dateLivDocument",clazz = TaPanierDTO.class)
	...
	@LgrHibernateValidated(champBd = "libelle_document",table = "ta_panier",champEntite="libelleDocument",clazz = TaPanierDTO.class)
	...
	@NotNull
	@Size(min=1, max=20)
	@LgrHibernateValidated(champBd = "code_tiers",table = "ta_tiers",champEntite="codeTiers",clazz = TaPanierDTO.class)
	...
	@LgrHibernateValidated(champBd = "nom_tiers",table = "ta_tiers",champEntite="nomTiers",clazz = TaPanierDTO.class)
	...
	@Size(min=0, max=8)
	@LgrHibernateValidated(champBd = "code_compta",table = "ta_tiers",champEntite="codeCompta",clazz = TaPanierDTO.class)
	...
	@Size(min=0, max=8)
	@LgrHibernateValidated(champBd = "compte",table = "ta_tiers",champEntite="compte",clazz = TaPanierDTO.class)
	...
	@Size(min=0, max=20)
	@LgrHibernateValidated(champBd = "code_t_paiement",table = "ta_t_paiement",champEntite="codeTPaiement",clazz = TaPanierDTO.class)
...
//	}
	...
	@LgrHibernateValidated(champBd = "rem_ht_document",table = "ta_panier",champEntite="remHtDocument",clazz = TaPanierDTO.class)
	...
	@LgrHibernateValidated(champBd = "tx_rem_ht_document",table = "ta_panier",champEntite="txRemHtDocument",clazz = TaPanierDTO.class)
	...
	@LgrHibernateValidated(champBd = "rem_ttc_document",table = "ta_panier",champEntite="remTtcDocument",clazz = TaPanierDTO.class)
	...
	@LgrHibernateValidated(champBd = "tx_rem_ttc_document",table = "ta_panier",champEntite="txRemTtcDocument",clazz = TaPanierDTO.class)
	...
	@LgrHibernateValidated(champBd = "mt_ttc_calc",table = "ta_panier",champEntite="mtTtcCalc",clazz = TaPanierDTO.class)
	...
	@LgrHibernateValidated(champBd = "mt_ht_calc",table = "ta_panier",champEntite="mtHtCalc",clazz = TaPanierDTO.class)
	...
	@LgrHibernateValidated(champBd = "mt_tva_calc",table = "ta_panier",champEntite="mtTvaCalc",clazz = TaPanierDTO.class)
	...
	@LgrHibernateValidated(champBd = "net_ttc_calc",table = "ta_panier",champEntite="netTtcCalc",clazz = TaPanierDTO.class)
	...
	@LgrHibernateValidated(champBd = "net_ht_calc",table = "ta_panier",champEntite="netHtCalc",clazz = TaPanierDTO.class)
	...
	@LgrHibernateValidated(champBd = "net_tva_calc",table = "ta_panier",champEntite="netTvaCalc",clazz = TaPanierDTO.class)
...
//	}
	...
	@LgrHibernateValidated(champBd = "commentaire",table = "ta_panier",champEntite="commentaire",clazz = TaPanierDTO.class)
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TaPanierDTO))
			return false;
		TaPanierDTO castOther = (TaPanierDTO) other;
...
//						.hashCode());
	...
	@JsonProperty("lignes")
	public List<TaLPanierDTO> getLignesDTO() {
		return lignesDTO;
	}

	public void setLignesDTO(List<TaLPanierDTO> lignesDTO) {
	...
	public TaInfosPanier getInfos() {
		return infos;
	}

	public void setInfos(TaInfosPanier infos) {
		this.infos = infos;
	}
