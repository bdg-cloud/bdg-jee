 ...
 */
public class TaDevisDTO extends ModelObject implements java.io.Serializable, IDocumentDTO {
...
//	private Boolean export=false;
	...
	public TaDevisDTO(Integer idDocument, 
			String codeDocument, 
			Date dateDocument, 
...
public TaDevisDTO(Integer ID_DEVIS, String CODE_DEVIS,
	...
	public void setIHMEnteteDevis(TaDevisDTO ihmEnteteDevis){
		setId(ihmEnteteDevis.id);
		...
		setDateExport(ihmEnteteDevis.dateExport);
		setCommentaire(ihmEnteteDevis.commentaire);
	}
	
	public static TaDevisDTO copy(TaDevisDTO ihmEnteteDevis){
		TaDevisDTO ihmEnteteDevisLoc = new TaDevisDTO();
		ihmEnteteDevisLoc.setId(ihmEnteteDevis.id);
		...
		ihmEnteteDevisLoc.setDateExport(ihmEnteteDevis.dateExport);
...
//				(LibDate.compareTo(getDateLivDocument(), dateExemple)==0)))return false;
	...
	@NotNull
	@Size(min=1, max=20)
	@LgrHibernateValidated(champBd = "code_document",table = "ta_devis",champEntite="codeDocument", clazz = TaDevisDTO.class)
	...
	@LgrHibernateValidated(champBd = "date_document",table = "ta_devis",champEntite="dateDocument",clazz = TaDevisDTO.class)
	...
	@LgrHibernateValidated(champBd = "date_ech_document",table = "ta_devis",champEntite="dateEchDocument",clazz = TaDevisDTO.class)
	...
	@LgrHibernateValidated(champBd = "date_liv_document",table = "ta_devis",champEntite="dateLivDocument",clazz = TaDevisDTO.class)
	...
	@LgrHibernateValidated(champBd = "libelle_document",table = "ta_devis",champEntite="libelleDocument",clazz = TaDevisDTO.class)
	...
	@NotNull
	@Size(min=1, max=20)
	@LgrHibernateValidated(champBd = "code_tiers",table = "ta_tiers",champEntite="codeTiers",clazz = TaDevisDTO.class)
	...
	@LgrHibernateValidated(champBd = "nom_tiers",table = "ta_tiers",champEntite="nomTiers",clazz = TaDevisDTO.class)
	...
	@LgrHibernateValidated(champBd = "code_compta",table = "ta_tiers",champEntite="codeCompta",clazz = TaDevisDTO.class)
	...
	@Size(min=0, max=8)
	@LgrHibernateValidated(champBd = "compte",table = "ta_tiers",champEntite="compte",clazz = TaDevisDTO.class)
	...
	@Size(min=0, max=20)
	@LgrHibernateValidated(champBd = "code_t_paiement",table = "ta_t_paiement",champEntite="codeTPaiement",clazz = TaDevisDTO.class)
	...
	@LgrHibernateValidated(champBd = "rem_ht_document",table = "ta_devis",champEntite="remHtDocument",clazz = TaDevisDTO.class)
	...
	@LgrHibernateValidated(champBd = "tx_rem_ht_document",table = "ta_devis",champEntite="txRemHtDocument",clazz = TaDevisDTO.class)
	...
	@LgrHibernateValidated(champBd = "rem_ttc_document",table = "ta_devis",champEntite="remTtcDocument",clazz = TaDevisDTO.class)
	...
	@LgrHibernateValidated(champBd = "tx_rem_ttc_document",table = "ta_devis",champEntite="txRemTtcDocument",clazz = TaDevisDTO.class)
	...
	@LgrHibernateValidated(champBd = "mt_ttc_calc",table = "ta_devis",champEntite="mtTtcCalc",clazz = TaDevisDTO.class)
	...
	@LgrHibernateValidated(champBd = "mt_ht_calc",table = "ta_devis",champEntite="mtHtCalc",clazz = TaDevisDTO.class)
	...
	@LgrHibernateValidated(champBd = "mt_tva_calc",table = "ta_devis",champEntite="mtTvaCalc",clazz = TaDevisDTO.class)
	...
	@LgrHibernateValidated(champBd = "net_ttc_calc",table = "ta_devis",champEntite="netTtcCalc",clazz = TaDevisDTO.class)
	...
	@LgrHibernateValidated(champBd = "net_ht_calc",table = "ta_devis",champEntite="netHtCalc",clazz = TaDevisDTO.class)
	...
	@LgrHibernateValidated(champBd = "net_tva_calc",table = "ta_devis",champEntite="netTvaCalc",clazz = TaDevisDTO.class)
...
//	@LgrHibernateValidated(champBd = "export",table = "ta_devis",champEntite="export",clazz = TaDevisDTO.class)
...
//	}
	...
	@LgrHibernateValidated(champBd = "commentaire",table = "ta_devis",champEntite="commentaire",clazz = TaDevisDTO.class)
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		TaDevisDTO other = (TaDevisDTO) obj;
		if (codeCompta == null) {
