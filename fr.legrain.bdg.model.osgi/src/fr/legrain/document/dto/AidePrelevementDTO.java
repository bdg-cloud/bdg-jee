 ...
 */
public class AidePrelevementDTO extends AideDocumentCommunDTO implements java.io.Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -2972222212598176888L;


	public AidePrelevementDTO() {
	}

	public AidePrelevementDTO(Integer idDocument, String codeDocument,
	...
	public void setIHMEnteteProforma(AidePrelevementDTO ihmEnteteDocument){
	...
	public static AidePrelevementDTO copy(AidePrelevementDTO ihmEnteteDocument){
		AidePrelevementDTO ihmEnteteDocumentLoc = new AidePrelevementDTO();
