 ...
 */
public class TaLAvisEcheanceDTO extends ModelObject implements PropertyChangeListener, java.io.Serializable, ILigneDocumentDTO{

	/**
	 * 
	 */
	private static final long serialVersionUID = -1248877366268392103L;
	private Integer id;
	...
	public TaLAvisEcheanceDTO() {
	}

	
	
	public TaLAvisEcheanceDTO(Integer idLDocument, Integer idDocument,
	...
	public void setIHMLDEVIS(TaLAvisEcheanceDTO ihmLDEVIS) {
		setIdLDocument(ihmLDEVIS.id);
	...
	static public TaLAvisEcheanceDTO copy(TaLAvisEcheanceDTO ihmLDEVIS) {
		TaLAvisEcheanceDTO swtLDEVISLoc = new TaLAvisEcheanceDTO();
		swtLDEVISLoc.setIdLDocument(ihmLDEVIS.id);
	...
	public void setIdLDocument(Integer ID_L_DEVIS) {
		firePropertyChange("idLDocument", this.id, this.id = ID_L_DEVIS);
	}
...
//		}		
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		TaLAvisEcheanceDTO other = (TaLAvisEcheanceDTO) obj;
		if (accepte == null) {
