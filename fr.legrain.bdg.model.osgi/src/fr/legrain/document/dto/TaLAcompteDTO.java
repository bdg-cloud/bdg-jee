 ...
 */
public class TaLAcompteDTO extends ModelObject implements PropertyChangeListener,java.io.Serializable, ILigneDocumentDTO {

	/**
	 * 
	 */
	private static final long serialVersionUID = -1782317422104310258L;
	private Integer id;
	...
	public TaLAcompteDTO() {
	}

	public TaLAcompteDTO(Integer ID_L_FACTURE, Integer ID_FACTURE,
	...
	public void setIHMLFacture(TaLAcompteDTO ihmLFacture) {
	...
	static public TaLAcompteDTO copy(TaLAcompteDTO ihmLFacture) {
		TaLAcompteDTO swtLFactureLoc = new TaLAcompteDTO();
	...
	public void setIdLDocument(Integer ID_L_FACTURE) {
		firePropertyChange("ID_L_FACTURE", this.id, this.id = ID_L_FACTURE);
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TaLAcompteDTO))
			return false;
		TaLAcompteDTO castOther = (TaLAcompteDTO) other;
