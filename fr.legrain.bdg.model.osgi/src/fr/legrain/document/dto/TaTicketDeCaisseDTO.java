 ...
 */
public class TaTicketDeCaisseDTO extends ModelObject implements java.io.Serializable, IDocumentDTO,IDocumentTiersDTO {
...
//	private String libellePaiement ;
	...
	public TaTicketDeCaisseDTO() {
	}
	public TaTicketDeCaisseDTO(Integer idDocument, 
			String codeDocument, 
			Date dateDocument, 
	...
	public TaTicketDeCaisseDTO(Integer ID_FACTURE, String CODE_FACTURE,
	...
	public void setIHMEnteteFacture(TaTicketDeCaisseDTO ihmEnteteFacture){
	...
	public static IDocumentDTO copy(TaTicketDeCaisseDTO ihmEnteteFacture){
		TaTicketDeCaisseDTO ihmEnteteFactureLoc = new TaTicketDeCaisseDTO();
...
//				(LibDate.compareTo(getDateLivDocument(), dateExemple)==0)))return false;
	...
	@NotNull
	@Size(min=1, max=20)
	@LgrHibernateValidated(champBd = "code_document",table = "ta_facture",champEntite="codeDocument", clazz = TaTicketDeCaisseDTO.class)
	...
	@LgrHibernateValidated(champBd = "date_document",table = "ta_facture",champEntite="dateDocument",clazz = TaTicketDeCaisseDTO.class)
...
//	}
	...
	@LgrHibernateValidated(champBd = "date_liv_document",table = "ta_facture",champEntite="dateLivDocument",clazz = TaTicketDeCaisseDTO.class)
	...
	@NotNull
	@Size(min=1, max=20)
	@LgrHibernateValidated(champBd = "code_tiers",table = "ta_tiers",champEntite="codeTiers",clazz = TaTicketDeCaisseDTO.class)
	...
	@LgrHibernateValidated(champBd = "nom_tiers",table = "ta_tiers",champEntite="nomTiers",clazz = TaTicketDeCaisseDTO.class)
	...
	@Size(min=0, max=8)
	@LgrHibernateValidated(champBd = "code_compta",table = "ta_tiers",champEntite="codeCompta",clazz = TaTicketDeCaisseDTO.class)
	...
	@Size(min=0, max=8)
	@LgrHibernateValidated(champBd = "compte",table = "ta_tiers",champEntite="compte",clazz = TaTicketDeCaisseDTO.class)
	...
	@Size(min=0, max=20)
	@LgrHibernateValidated(champBd = "code_t_paiement",table = "ta_t_paiement",champEntite="codeTPaiement",clazz = TaTicketDeCaisseDTO.class)
	...
	@LgrHibernateValidated(champBd = "rem_ht_document",table = "ta_facture",champEntite="remHtDocument",clazz = TaTicketDeCaisseDTO.class)
	...
	@LgrHibernateValidated(champBd = "tx_rem_ht_document",table = "ta_facture",champEntite="txRemHtDocument",clazz = TaTicketDeCaisseDTO.class)
	...
	@LgrHibernateValidated(champBd = "rem_ttc_document",table = "ta_facture",champEntite="remTtcDocument",clazz = TaTicketDeCaisseDTO.class)
	...
	@LgrHibernateValidated(champBd = "tx_rem_ttc_document",table = "ta_facture",champEntite="txRemTtcDocument",clazz = TaTicketDeCaisseDTO.class)
	...
	@LgrHibernateValidated(champBd = "mt_ttc_calc",table = "ta_facture",champEntite="mtTtcCalc",clazz = TaTicketDeCaisseDTO.class)
	...
	@LgrHibernateValidated(champBd = "mt_ht_calc",table = "ta_facture",champEntite="mtHtCalc",clazz = TaTicketDeCaisseDTO.class)
	...
	@LgrHibernateValidated(champBd = "mt_tva_calc",table = "ta_facture",champEntite="mtTvaCalc",clazz = TaTicketDeCaisseDTO.class)
	...
	@LgrHibernateValidated(champBd = "net_ttc_calc",table = "ta_facture",champEntite="netTtcCalc",clazz = TaTicketDeCaisseDTO.class)
	...
	@LgrHibernateValidated(champBd = "net_ht_calc",table = "ta_facture",champEntite="netHtCalc",clazz = TaTicketDeCaisseDTO.class)
	...
	@LgrHibernateValidated(champBd = "net_tva_calc",table = "ta_facture",champEntite="netTvaCalc",clazz = TaTicketDeCaisseDTO.class)
...
//	}
	...
	@LgrHibernateValidated(champBd = "commentaire",table = "ta_facture",champEntite="commentaire",clazz = TaTicketDeCaisseDTO.class)
	...
	@LgrHibernateValidated(champBd = "mt_ttc_avt_rem_globale_calc",table = "ta_facture",champEntite="mtTtcAvantRemiseGlobaleCalc",clazz = TaTicketDeCaisseDTO.class)
	...
	@LgrHibernateValidated(champBd = "net_a_payer",table = "ta_facture",champEntite="netAPayer",clazz = TaTicketDeCaisseDTO.class)
...
//		+ ((libellePaiement == null) ? 0 : libellePaiement.hashCode());	
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		TaTicketDeCaisseDTO other = (TaTicketDeCaisseDTO) obj;
		if (IP_ACCES == null) {
