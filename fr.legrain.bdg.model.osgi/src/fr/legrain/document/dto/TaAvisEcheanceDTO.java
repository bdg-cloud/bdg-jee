 ...
 */
public class TaAvisEcheanceDTO extends ModelObject implements java.io.Serializable,IDocumentDTO {

	private static final long serialVersionUID = -8826642311706261512L;
...
//	private List<IHMLAvisEcheance> lignesAvis = null;
	
	private List<TaLAvisEcheanceDTO> lignesDTO;
	
	private Integer versionObj;

	public TaAvisEcheanceDTO() {
	}


	public TaAvisEcheanceDTO(Integer idDocument, 
			String codeDocument, 
			Date dateDocument, 
	...
	public TaAvisEcheanceDTO(Integer idDocument, String codeDocument,
			...
			String commentaire, Boolean accepte/*, List<IHMLAvisEcheance> lignes*/) {
		super();
		this.id = idDocument;
		this.codeDocument = codeDocument;
		this.dateDocument = dateDocument;
...
//		this.lignesAvis = lignesAvis;
	...
	public void setIHMEnteteDevis(TaAvisEcheanceDTO ihmEnteteDevis){
...
//		setLignesAvis(ihmEnteteDevis.lignesAvis);
	...
	public static TaAvisEcheanceDTO copy(TaAvisEcheanceDTO ihmEnteteDevis){
		TaAvisEcheanceDTO ihmEnteteDevisLoc = new TaAvisEcheanceDTO();
...
//				(LibDate.compareTo(getDateLivDocument(), dateExemple)==0)))return false;
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		TaAvisEcheanceDTO other = (TaAvisEcheanceDTO) obj;
		if (accepte == null) {
...
//	public List<IHMLAvisEcheance> getLignesAvis() {
//		return lignesAvis;
//	}
//
//	public void setLignesAvis(List<IHMLAvisEcheance> lignesAvis) {
//		this.lignesAvis = lignesAvis;
//	}
	...
	public boolean AvisEcheanceEstVide(){
		Date dateExemple = new Date();
...
//		if(!(LibDate.compareTo(getDateEchDocument(), dateExemple)==0))return false;
	...
	public boolean AvisEcheanceEstVide(Date dateDansExercice){
		Date dateExemple = new Date();
//		if(!getCodeFacture().equals(LgrConstantes.C_STR_VIDE))return true;
		if(!((LibDate.compareTo(getDateDocument(), dateDansExercice)==0) || 
				(LibDate.compareTo(getDateDocument(), dateExemple)==0)))return false;
...
//				(LibDate.compareTo(getDateLivDocument(), dateExemple)==0)))return false;
	...
	public void setMtTtcAvantRemiseGlobaleCalc(BigDecimal mtTtcAvantRemiseGlobaleCalc) {
	...
	public List<TaLAvisEcheanceDTO> getLignesDTO() {
		return lignesDTO;
	}


	public void setLignesDTO(List<TaLAvisEcheanceDTO> lignesDTO) {
