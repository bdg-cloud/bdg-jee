 ...
 */
public class TaLRemiseDTO extends ModelObject implements java.io.Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = -6590815181000982856L;
	private Integer id;
...
//	private Boolean export = false;
	...
	public TaLRemiseDTO(int idDocument,String codeReglement, String libelleReglement, Date dateReglement, String codeTiers,
			String nomTiers, String codeTPaiement, BigDecimal netTTC, String nomBanque, String compte,Integer idCompteBanque,
			String iban,String codeBic) {
		super();
		this.id=idDocument;
	...
	public void setIHMLRemise(TaLRemiseDTO ihmLRemise) {
		setIdLRemise(ihmLRemise.id);
	...
	static public TaLRemiseDTO copy(TaLRemiseDTO ihmLRemise) {
		TaLRemiseDTO swtLRemiseLoc = new TaLRemiseDTO();
		swtLRemiseLoc.setIdLRemise(ihmLRemise.id);
	...
	public void setIdLRemise(Integer idLRemise) {
		firePropertyChange("idLRemise", this.id, this.id = idLRemise);
	}
...
//		result = prime * result + ((export == null) ? 0 : export.hashCode());
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		TaLRemiseDTO other = (TaLRemiseDTO) obj;
		if (accepte == null) {
