 ...
 */
public class TaLBonReceptionDTO extends ModelObject implements PropertyChangeListener, java.io.Serializable, ILigneDocumentDTO, ILigneDocumentLotDTO{
	...
	public TaLBonReceptionDTO() {
	}

	
	public TaLBonReceptionDTO(Integer idDocument, String codeArticle, String libLDocument, BigDecimal qteLDocument,
			BigDecimal qte2lDocument, String u1lDocument, String u2lDocument, String numLot) {
		super();
	...
	public TaLBonReceptionDTO(Integer ID_L_DEVIS, Integer ID_DEVIS,
	...
	public void setIHMLDEVIS(TaLBonReceptionDTO ihmLDEVIS) {
	...
	static public TaLBonReceptionDTO copy(TaLBonReceptionDTO ihmLDEVIS) {
		TaLBonReceptionDTO swtLDEVISLoc = new TaLBonReceptionDTO();
		...
		swtLDEVISLoc.setEmplacement(ihmLDEVIS.emplacement);
		swtLDEVISLoc.setLibelleLot(ihmLDEVIS.libelleLot);
		swtLDEVISLoc.setNumLot(ihmLDEVIS.numLot);
	...
	@Size(min=0, max=20)
	@LgrHibernateValidated(champBd = "code_article",table = "ta_article",champEntite="codeArticle",clazz = TaLBonReceptionDTO.class)
	...
	@LgrHibernateValidated(champBd = "lib_l_document",table = "ta_l_bon_reception",champEntite="libLDocument",clazz = TaLBonReceptionDTO.class)
	...
	@LgrHibernateValidated(champBd = "qte_l_document",table = "ta_l_bon_reception",champEntite="qteLDocument",clazz = TaLBonReceptionDTO.class)
	...
	@LgrHibernateValidated(champBd = "u1_l_document",table = "ta_l_bon_reception",champEntite="u1LDocument",clazz = TaLBonReceptionDTO.class)
	...
	@LgrHibernateValidated(champBd = "u2_l_document",table = "ta_l_bon_reception",champEntite="u2LDocument",clazz = TaLBonReceptionDTO.class)
	...
	@Size(min=0, max=20)
	@LgrHibernateValidated(champBd = "code_tva_l_document",table = "ta_l_devis",champEntite="codeTvaLDocument",clazz = TaLBonReceptionDTO.class)
	...
	@Size(min=0, max=20)
	@LgrHibernateValidated(champBd = "code_t_tva_l_document",table = "ta_l_devis",champEntite="codeTTvaLDocument",clazz = TaLBonReceptionDTO.class)
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TaLBonReceptionDTO))
			return false;
		TaLBonReceptionDTO castOther = (TaLBonReceptionDTO) other;
...
//		}		
	...
	@LgrHibernateValidated(champBd = "qte2_l_document",table = "ta_l_bon_reception",champEntite="qte2LDocument",clazz = TaLBonReceptionDTO.class)
	...
	public void setLibelleStatusConformite(String libelleStatusConformite) {
