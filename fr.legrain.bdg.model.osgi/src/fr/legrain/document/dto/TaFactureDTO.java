 ...
 */
public class TaFactureDTO extends ModelObject implements java.io.Serializable, IDocumentDTO,IDocumentTiersDTO {
...
//	private Boolean export=false;
	...
	private Integer nbDecimalesQte;
...
//	private String libellePaiement ;
	...
	private List<TaLFactureDTO> lignesDTO;
	
	public TaFactureDTO() {
	}
	
	
	public TaFactureDTO(String codeDocument,int num) {
		this.codeDocument = codeDocument;
	}


	public TaFactureDTO(Integer idDocument, 
			String codeDocument, 
			Date dateDocument, 
	...
	// Ajouté par PB le 19/12/2017 pour utilisation dans la liste écran factures
	public TaFactureDTO(Integer idDocument, 
			String codeDocument, 
			Date dateDocument, 
			String libelleDocument, 
	...
	/* Utilisée dans la gestion des réglements*/
	public TaFactureDTO(String codeFamille,
			Integer idDocument, 
			String codeDocument, 
			Date dateDocument,  
			String libelleDocument, 
			...
			BigDecimal netHtCalc,
			BigDecimal netTtcCalc,
			BigDecimal sumRAvoir,
			BigDecimal sumRReglement) {
		...
		this.netHtCalc = netHtCalc;
		this.netTtcCalc = netTtcCalc;
		this.montantReglement = sumRReglement;
		this.regleCompletDocument = sumRAvoir.add(sumRReglement);
		this.resteAReglerComplet = this.netTtcCalc.subtract(this.regleCompletDocument);
	}
	...
	public TaFactureDTO(String type,
	...
	// Utilisé par la requete préparée FIND_ALL_LIGHT_PERIODE, FIND_TRANSFORME_LIGHT_PERIODE
		...
		// Utilisé par la requete préparée SUM_CA_TOTAL_LIGHT_PERIODE_PAYE
		public TaFactureDTO(
				BigDecimal netHtCalc,
				BigDecimal netTvaCalc,
				BigDecimal netTtcCalc ) {
	...
	public TaFactureDTO(Integer ID_FACTURE, String CODE_FACTURE,
	...
	@JsonIgnore
	public void setIHMEnteteFacture(TaFactureDTO ihmEnteteFacture){
	...
	public static IDocumentDTO copy(TaFactureDTO ihmEnteteFacture){
		TaFactureDTO ihmEnteteFactureLoc = new TaFactureDTO();
...
//				(LibDate.compareTo(getDateLivDocument(), dateExemple)==0)))return false;
	...
	/* (non-Javadoc)
	 * @see fr.legrain.document.dto.IDocumentDTO#getId()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see fr.legrain.document.dto.IDocumentDTO#getCodeDocument()
	 */
	@Override
	@NotNull
	@Size(min=1, max=20)
	@LgrHibernateValidated(champBd = "code_document",table = "ta_facture",champEntite="codeDocument", clazz = TaFactureDTO.class)
	...
	@LgrHibernateValidated(champBd = "date_document",table = "ta_facture",champEntite="dateDocument",clazz = TaFactureDTO.class)
...
//	}
	...
	@LgrHibernateValidated(champBd = "date_liv_document",table = "ta_facture",champEntite="dateLivDocument",clazz = TaFactureDTO.class)
	...
	/* (non-Javadoc)
	 * @see fr.legrain.document.dto.IDocumentDTO#getIdTiers()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see fr.legrain.document.dto.IDocumentDTO#getCodeTiers()
	 */
	@Override
	@NotNull
	@Size(min=1, max=20)
	@LgrHibernateValidated(champBd = "code_tiers",table = "ta_tiers",champEntite="codeTiers",clazz = TaFactureDTO.class)
	...
	@LgrHibernateValidated(champBd = "nom_tiers",table = "ta_tiers",champEntite="nomTiers",clazz = TaFactureDTO.class)
	...
	@Size(min=0, max=8)
	@LgrHibernateValidated(champBd = "code_compta",table = "ta_tiers",champEntite="codeCompta",clazz = TaFactureDTO.class)
	...
	@Size(min=0, max=8)
	@LgrHibernateValidated(champBd = "compte",table = "ta_tiers",champEntite="compte",clazz = TaFactureDTO.class)
	...
	@Size(min=0, max=20)
	@LgrHibernateValidated(champBd = "code_t_paiement",table = "ta_t_paiement",champEntite="codeTPaiement",clazz = TaFactureDTO.class)
	...
	@LgrHibernateValidated(champBd = "rem_ht_document",table = "ta_facture",champEntite="remHtDocument",clazz = TaFactureDTO.class)
	...
	@LgrHibernateValidated(champBd = "tx_rem_ht_document",table = "ta_facture",champEntite="txRemHtDocument",clazz = TaFactureDTO.class)
	...
	@LgrHibernateValidated(champBd = "rem_ttc_document",table = "ta_facture",champEntite="remTtcDocument",clazz = TaFactureDTO.class)
	...
	@LgrHibernateValidated(champBd = "tx_rem_ttc_document",table = "ta_facture",champEntite="txRemTtcDocument",clazz = TaFactureDTO.class)
	...
	@LgrHibernateValidated(champBd = "mt_ttc_calc",table = "ta_facture",champEntite="mtTtcCalc",clazz = TaFactureDTO.class)
	...
	@LgrHibernateValidated(champBd = "mt_ht_calc",table = "ta_facture",champEntite="mtHtCalc",clazz = TaFactureDTO.class)
	...
	@LgrHibernateValidated(champBd = "mt_tva_calc",table = "ta_facture",champEntite="mtTvaCalc",clazz = TaFactureDTO.class)
	...
	@LgrHibernateValidated(champBd = "net_ttc_calc",table = "ta_facture",champEntite="netTtcCalc",clazz = TaFactureDTO.class)
	...
	@LgrHibernateValidated(champBd = "net_ht_calc",table = "ta_facture",champEntite="netHtCalc",clazz = TaFactureDTO.class)
	...
	@LgrHibernateValidated(champBd = "net_tva_calc",table = "ta_facture",champEntite="netTvaCalc",clazz = TaFactureDTO.class)
...
//	}
	...
	@LgrHibernateValidated(champBd = "commentaire",table = "ta_facture",champEntite="commentaire",clazz = TaFactureDTO.class)
	...
	@LgrHibernateValidated(champBd = "net_a_payer",table = "ta_facture",champEntite="netAPayer",clazz = TaFactureDTO.class)
...
//		+ ((libellePaiement == null) ? 0 : libellePaiement.hashCode());	
		...
		result = prime * result
		+ ((montantReglement == null) ? 0 : montantReglement.hashCode());			
		result = prime * result
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		TaFactureDTO other = (TaFactureDTO) obj;
		if (IP_ACCES == null) {
...
//		return false;
		...
		if (montantReglement == null) {
			if (other.montantReglement != null)
				return false;
		} else if (!montantReglement
				.equals(other.montantReglement))
			return false;		
		if (mtTtcCalc == null) {
	...
	/* (non-Javadoc)
	 * @see fr.legrain.document.dto.IDocumentDTO#getCodeTTvaDoc()
	 */
	@Override
	...
	public List<TaLFactureDTO> getLignesDTO() {
		return lignesDTO;
	}


	public void setLignesDTO(List<TaLFactureDTO> lignesDTO) {
