 ...
 */
public class LigneDocumentDTO extends ModelObject implements PropertyChangeListener, java.io.Serializable, ILigneDocumentDTO{
	 ...
	 * 
	 */
	private static final long serialVersionUID = -1029648020864364777L;
	...
	public LigneDocumentDTO(Integer idDocument, String codeDocument, String typeDocument) {
		super();
	...
	public LigneDocumentDTO(Integer id, Integer idDocument, String codeDocument, String codeTLigne, Integer idArticle,
			Integer numLigneLDocument, String codeArticle, String libLDocument, BigDecimal qteLDocument,
			BigDecimal qte2lDocument, BigDecimal prixULDocument, BigDecimal tauxTvaLDocument, String codeTvaLDocument,
			String codeTTvaLDocument, BigDecimal mtHtLDocument, BigDecimal mtTtcLDocument,
			BigDecimal mtHtLApresRemiseGlobaleDocument, BigDecimal mtTtcLApresRemiseGlobaleDocument,
			BigDecimal remTxLDocument, BigDecimal remHtLDocument, String iP_ACCES, String u1lDocument,
			String u2lDocument, BigDecimal txRemHtDocument, String codeTitreTransport, BigDecimal qteTitreTransport,
			Date datePrevue, String codeEntrepot, String emplacement, Date dluo, String numLot, String libelleLot,
			Integer versionObj) {
		super();
		this.id = id;
		this.idDocument = idDocument;
	...
	public void setIHMLFacture(LigneDocumentDTO ihmLFacture) {
	...
	static public LigneDocumentDTO copy(LigneDocumentDTO ihmLFacture) {
		LigneDocumentDTO swtLFactureLoc = new LigneDocumentDTO();
	...
	@Size(min=0, max=20)
	@LgrHibernateValidated(champBd = "code_article",table = "ta_article",champEntite="codeArticle",clazz = LigneDocumentDTO.class)
	...
	@LgrHibernateValidated(champBd = "lib_l_document",table = "ta_l_facture",champEntite="libLDocument",clazz = LigneDocumentDTO.class)
	...
	@LgrHibernateValidated(champBd = "qte_l_document",table = "ta_l_facture",champEntite="qteLDocument",clazz = LigneDocumentDTO.class)
	...
	@LgrHibernateValidated(champBd = "u1_l_document",table = "ta_l_facture",champEntite="u1LDocument",clazz = LigneDocumentDTO.class)
	...
	@LgrHibernateValidated(champBd = "u2_l_document",table = "ta_l_facture",champEntite="u2LDocument",clazz = LigneDocumentDTO.class)
	...
	@LgrHibernateValidated(champBd = "prix_u_l_document",table = "ta_l_facture",champEntite="prixULDocument",clazz = LigneDocumentDTO.class)
	...
	@LgrHibernateValidated(champBd = "taux_tva_l_document",table = "ta_l_facture",champEntite="tauxTvaLDocument",clazz = LigneDocumentDTO.class)
	...
	@Size(min=0, max=20)
	@LgrHibernateValidated(champBd = "code_tva_l_document",table = "ta_l_facture",champEntite="codeTvaLDocument",clazz = LigneDocumentDTO.class)
	...
	@Size(min=0, max=20)
	@LgrHibernateValidated(champBd = "code_t_tva_l_document",table = "ta_l_facture",champEntite="codeTTvaLDocument",clazz = LigneDocumentDTO.class)
	...
	@LgrHibernateValidated(champBd = "mt_ht_l_document",table = "ta_l_facture",champEntite="mtHtLDocument",clazz = LigneDocumentDTO.class)
	...
	@LgrHibernateValidated(champBd = "mt_ttc_l_document",table = "ta_l_facture",champEntite="mtTtcLDocument",clazz = LigneDocumentDTO.class)
	...
	@LgrHibernateValidated(champBd = "rem_tx_l_document",table = "ta_l_facture",champEntite="remTxLDocument",clazz = LigneDocumentDTO.class)
	...
	@LgrHibernateValidated(champBd = "rem_ht_l_document",table = "ta_l_facture",champEntite="remHtLDocument",clazz = LigneDocumentDTO.class)
	...
	@Size(min=0, max=20)
	@LgrHibernateValidated(champBd = "titre_transport_l_document",table = "ta_l_facture",champEntite="codeTitreTransport",clazz = LigneDocumentDTO.class)
	...
	@LgrHibernateValidated(champBd = "qte_titre_transport_l_document",table = "ta_l_facture",champEntite="qteTitreTransport",clazz = LigneDocumentDTO.class)
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof LigneDocumentDTO))
			return false;
		LigneDocumentDTO castOther = (LigneDocumentDTO) other;
...
//		}		
	...
	@LgrHibernateValidated(champBd = "qte2_l_document",table = "ta_l_facture",champEntite="qte2LDocument",clazz = LigneDocumentDTO.class)
	...
	@LgrHibernateValidated(champBd = "mt_apr_rem_globale",table = "ta_l_facture",champEntite="mtHtLApresRemiseGlobaleDocument",clazz = LigneDocumentDTO.class)
	...
	@LgrHibernateValidated(champBd = "mt_ttc_apr_rem_globale",table = "ta_l_facture",champEntite="mtTtcLApresRemiseGlobaleDocument", clazz = LigneDocumentDTO.class)
