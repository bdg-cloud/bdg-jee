...
@SqlResultSetMappings({
	@SqlResultSetMapping(name="TaFactureDTO",
			classes = {
					@ConstructorResult(
	...
	@SqlResultSetMapping(name="TaFactureDTORegroupementParFamille",
	classes = {
			@ConstructorResult(
					targetClass = TaFactureDTO.class,
					columns = {
	...
	@SqlResultSetMapping(name="TaFactureDTORegroupementParFamilleSynthese",
	classes = {
			@ConstructorResult(
					targetClass = TaFactureDTO.class,
					columns = {
	...
	@SqlResultSetMapping(name="TaFactureDTORegroupementParTauxTva",
	classes = {
			@ConstructorResult(
					targetClass = TaFactureDTO.class,
					columns = {
	...
	@SqlResultSetMapping(name="TaFactureDTORegroupementParTauxTvaSynthese",
	classes = {
			@ConstructorResult(
					targetClass = TaFactureDTO.class,
					columns = {
	...
	@SqlResultSetMapping(name="TaFactureDTORegroupementParTypePaiement",
	classes = {
			@ConstructorResult(
					targetClass = TaFactureDTO.class,
					columns = {
	...
	@SqlResultSetMapping(name="TaFactureDTORegroupementParTypePaiementSynthese",
	classes = {
			@ConstructorResult(
					targetClass = TaFactureDTO.class,
					columns = {
...
@NamedQueries(value = { 
		@NamedQuery(name=TaFacture.QN.FIND_BY_DATE, query="select a from TaFacture a where a.taTiers.codeTiers like codeTiers and a.dateDocument between :dateDeb and :dateFin order by a.codeDocument"),
		@NamedQuery(name=TaFacture.QN.FIND_BY_DATE_LIGHT, query="select f.idDocument, f.codeDocument, f.dateDocument, f.libelleDocument, tiers.codeTiers, infos.nomTiers,f.dateEchDocument,f.dateExport,f.netHtCalc,f.netTtcCalc from TaFacture f join f.taInfosDocument infos join f.taTiers tiers where tiers.codeTiers like :codeTiers and f.dateDocument between :dateDeb and :dateFin order by f.codeDocument"),
		@NamedQuery(name=TaFacture.QN.FIND_BY_DATE_DTO, query="select new fr.legrain.document.dto.TaFactureDTO(f.idDocument, f.codeDocument, f.dateDocument, f.libelleDocument, tiers.codeTiers, infos.nomTiers,f.dateEchDocument,f.dateExport,f.netHtCalc,f.netTtcCalc) from TaFacture f join f.taInfosDocument infos join f.taTiers tiers where tiers.codeTiers like :codeTiers and f.dateDocument between :dateDeb and :dateFin order by f.dateDocument"),
		@NamedQuery(name=TaFacture.QN.FIND_BY_TIERS_AND_CODE_LIGHT, query="select f.idDocument, f.codeDocument, f.dateDocument, f.libelleDocument, tiers.codeTiers, infos.nomTiers,f.dateEchDocument,f.dateExport,f.netHtCalc,f.netTtcCalc from TaFacture f join f.taInfosDocument infos join f.taTiers tiers where tiers.codeTiers like :codeTiers and f.codeDocument like :codeDocument order by f.codeDocument"),
		@NamedQuery(name=TaFacture.QN.FIND_BY_DATE_EXPORT_LIGHT, query="select new fr.legrain.document.dto.TaFactureDTO(f.idDocument, f.codeDocument, f.dateDocument, f.libelleDocument, tiers.codeTiers, infos.nomTiers,f.dateEchDocument,f.dateExport,f.netHtCalc,f.netTtcCalc) from TaFacture f join f.taInfosDocument infos join f.taTiers tiers where f.taTiers.codeTiers like :codeTiers and f.dateDocument between :dateDeb and :dateFin  and f.dateExport is not null order by f.codeDocument"), 
		@NamedQuery(name=TaFacture.QN.FIND_BY_TIERS_AND_CODE, query="select a from TaFacture a where a.taTiers.codeTiers like :codeTiers and a.codeDocument between :codeDeb and :codeFin order by a.codeDocument"),
		@NamedQuery(name=TaFacture.QN.FIND_BY_DATE_PARDATE, query="select a from TaFacture a where a.taTiers.codeTiers like :codeTiers and a.dateDocument between :dateDeb and :dateFin order by a.dateDocument"),
		@NamedQuery(name=TaFacture.QN.FIND_BY_CODE, query="select a from TaFacture a where a.taTiers.codeTiers like :codeTiers and a.codeDocument between :codeDeb and :codeFin order by a.codeDocument"),
		@NamedQuery(name=TaFacture.QN.FIND_BY_CODE_LIGHT, query="select new fr.legrain.document.dto.TaFactureDTO(f.idDocument, f.codeDocument, f.dateDocument, f.libelleDocument, tiers.codeTiers, infos.nomTiers,f.dateEchDocument,f.dateExport,f.netHtCalc,f.netTtcCalc) from TaFacture f join f.taInfosDocument infos join f.taTiers tiers where tiers.codeTiers like :codeTiers and f.codeDocument between :codeDeb and :codeFin  order by f.codeDocument"),
		@NamedQuery(name=TaFacture.QN.FIND_BY_DATE_NON_EXPORT, query="select a from TaFacture a where a.taTiers.codeTiers like :codeTiers and a.dateDocument between :dateDeb and :dateFin  and a.dateExport is null order by a.codeDocument"),
		@NamedQuery(name=TaFacture.QN.FIND_BY_CODE_NON_EXPORT, query="select a from TaFacture a where a.taTiers.codeTiers like :codeTiers and a.codeDocument between :dateDeb and :dateFin and a.dateVerrouillage is null  order by a.codeDocument"),
		@NamedQuery(name=TaFacture.QN.FIND_BY_DATE_NON_EXPORT_PARDATE, query="select a from TaFacture a where a.taTiers.codeTiers like :codeTiers and a.dateDocument between :dateDeb and :dateFin  and a.dateExport is null order by a.dateDocument"), 
		@NamedQuery(name=TaFacture.QN.FIND_BY_DATE_NON_EXPORT_LIGHT, query="select new fr.legrain.document.dto.TaFactureDTO(f.idDocument, f.codeDocument, f.dateDocument, f.libelleDocument, tiers.codeTiers, infos.nomTiers,f.dateEchDocument,f.dateExport,f.netHtCalc,f.netTtcCalc) from TaFacture f join f.taInfosDocument infos join f.taTiers tiers where f.taTiers.codeTiers like :codeTiers and f.dateDocument between :dateDeb and :dateFin  and f.dateExport is null order by f.codeDocument"),
		@NamedQuery(name=TaFacture.QN.FIND_BY_CODE_NON_EXPORT_LIGHT, query="select new fr.legrain.document.dto.TaFactureDTO(f.idDocument, f.codeDocument, f.dateDocument, f.libelleDocument, tiers.codeTiers, infos.nomTiers,f.dateEchDocument,f.dateExport,f.netHtCalc,f.netTtcCalc) from TaFacture f join f.taInfosDocument infos join f.taTiers tiers where f.taTiers.codeTiers like :codeTiers and f.codeDocument between :codeDeb and :codeFin and f.dateExport is null order by f.codeDocument"),
		@NamedQuery(name=TaFacture.QN.FIND_BY_DATEEXPORT, query="select a from TaFacture a where a.taTiers.codeTiers like :codeTiers and a.dateExport =:date order by a.codeDocument"), 
		@NamedQuery(name=TaFacture.QN.FIND_BY_DATEEXPORT_LIGHT, query="select new fr.legrain.document.dto.TaFactureDTO(f.idDocument, f.codeDocument, f.dateDocument, f.libelleDocument, tiers.codeTiers, infos.nomTiers,f.dateEchDocument,f.dateExport,f.netHtCalc,f.netTtcCalc) from TaFacture f join f.taInfosDocument infos join f.taTiers tiers where f.taTiers.codeTiers like :codeTiers and  f.dateExport =:date order by f.dateDocument"), 
		
		@NamedQuery(name=TaFacture.QN.FIND_BY_DATE_NON_EXPORT_PARDATE_LIGHT, query="select new fr.legrain.document.dto.TaFactureDTO(f.idDocument, f.codeDocument, f.dateDocument, f.libelleDocument, tiers.codeTiers, infos.nomTiers,f.dateEchDocument,f.dateExport,f.netHtCalc,f.netTtcCalc) from TaFacture f join f.taInfosDocument infos join f.taTiers tiers where f.taTiers.codeTiers like :codeTiers and f.dateDocument between :dateDeb and :dateFin  and f.dateExport is null order by f.dateDocument"), 
		@NamedQuery(name=TaFacture.QN.FIND_BY_DATE_EXPORT, query="select a from TaFacture a where a.taTiers.codeTiers like :codeTiers and a.dateDocument between :dateDeb and :dateFin  and a.dateExport is not null order by a.codeDocument"),
		@NamedQuery(name=TaFacture.QN.FIND_BY_CODE_EXPORT, query="select a from TaFacture a where a.taTiers.codeTiers like :codeTiers and a.codeDocument between :codeDeb and :codeFin and a.dateExport is not null order by a.codeDocument"),
		@NamedQuery(name=TaFacture.QN.FIND_BY_TIERS, query="select a from TaFacture a where a.taTiers.codeTiers like :codeTiers"),
		@NamedQuery(name=TaFacture.QN.FIND_BY_TIERS_AND_DATE, query="select a from TaFacture a where a.taTiers.codeTiers like :codeTiers and a.dateDocument between :dateDeb and :dateFin order by a.codeDocument"),
		@NamedQuery(name=TaFacture.QN.FIND_BY_TIERS_AND_DATE_LIGHT, query="select new fr.legrain.document.dto.TaFactureDTO(f.idDocument, f.codeDocument, f.dateDocument, f.libelleDocument, tiers.codeTiers, infos.nomTiers,f.dateEchDocument,f.dateExport,f.netHtCalc,f.netTtcCalc) from TaFacture f join f.taInfosDocument infos join f.taTiers tiers  where f.taTiers.codeTiers like :codeTiers and f.dateDocument between :dateDeb and :dateFin order by f.codeDocument"),
		@NamedQuery(name=TaFacture.QN.FIND_BY_TIERS_AND_DATE_POUR_COMPTE_CLIENT, query="select a from TaFacture a join a.taMiseADisposition mad where mad.accessibleSurCompteClient is not null and a.taTiers.codeTiers like :codeTiers and a.dateDocument between :dateDeb and :dateFin order by a.codeDocument"),
		@NamedQuery(name=TaFacture.QN.FIND_BY_ETAT_DATE, query="select a from TaFacture a where a.dateDocument between :dateDeb and :dateFin and a.taEtat.codeEtat = :codeEtat order by a.codeDocument"),
		@NamedQuery(name=TaFacture.QN.FIND_BY_ETAT_TIERS_DATE, query="select a from TaFacture a where a.taTiers.codeTiers like :codeTiers and a.dateDocument between :dateDeb and :dateFin and a.taEtat.codeEtat = :codeEtat order by a.codeDocument"),
		@NamedQuery(name=TaFacture.QN.FIND_BY_DATE_NON_VERROUILLE, query="select a from TaFacture a where a.taTiers.codeTiers like :codeTiers and a.dateDocument between :dateDeb and :dateFin  and a.dateVerrouillage is null order by a.codeDocument"),		
		@NamedQuery(name=TaFacture.QN.FIND_BY_CODE_NON_VERROUILLE, query="select a from TaFacture a where a.taTiers.codeTiers like :codeTiers and a.codeDocument between :codeDeb and :codeFin and a.dateVerrouillage is null  order by a.codeDocument"),
		@NamedQuery(name=TaFacture.QN.FIND_BY_DATE_VERROUILLE, query="select a from TaFacture a where a.taTiers.codeTiers like :codeTiers and a.dateDocument between :dateDeb and :dateFin  and a.dateVerrouillage is not null order by a.codeDocument"),
		@NamedQuery(name=TaFacture.QN.FIND_BY_CODE_VERROUILLE, query="select a from TaFacture a where a.taTiers.codeTiers like :codeTiers and a.codeDocument between :codeDeb and :codeFin and a.dateVerrouillage is not null order by a.codeDocument"),
//		@NamedQuery(name=TaFacture.QN.FIND_ALL_LIGHT, query="select new fr.legrain.document.dto.TaFactureDTO(f.idDocument, f.codeDocument, f.dateDocument, f.libelleDocument, tiers.codeTiers, infos.nomTiers,f.dateEchDocument,f.dateExport,f.netHtCalc,f.netTtcCalc) from TaFacture f join f.taInfosDocument infos join f.taTiers tiers order by f.codeDocument"),

		@NamedQuery(name=TaFacture.QN.FIND_ALL_LIGHT, query="select new fr.legrain.document.dto.TaFactureDTO(f.idDocument, f.codeDocument, f.dateDocument, f.libelleDocument, tiers.codeTiers, infos.nomTiers,infos.prenomTiers, "
				+ " infos.nomEntreprise,f.dateEchDocument,f.netHtCalc,f.netTvaCalc,f.netTtcCalc,f.dateExport,f.dateVerrouillage, mad.accessibleSurCompteClient, mad.envoyeParEmail, mad.imprimePourClient) from TaFacture f join f.taInfosDocument infos join f.taTiers tiers left join f.taMiseADisposition mad order by  f.dateDocument DESC, f.codeDocument DESC"),
		// Vérifiez toutes les requêtes ci-dessous qui ont été copiés depuis devis
//		@NamedQuery(name=TaFacture.QN.FIND_ALL_LIGHT_PERIODE, query="select new fr.legrain.document.dto.TaFactureDTO("
...
//				+ " from TaFacture f join f.taInfosDocument infos join f.taTiers tiers "
//				+ " where f.dateDocument between :dateDebut and :dateFin   and f.taTiers.codeTiers like :codeTiers"
//				+ " order by f.codeDocument"),
//
//		@NamedQuery(name=TaFacture.QN.FIND_PAYE_LIGHT_PERIODE, 
//		query="select new fr.legrain.document.dto.TaFactureDTO("
//				+ " f.idDocument, f.codeDocument, f.dateDocument, f.libelleDocument, tiers.codeTiers, infos.nomTiers,f.dateEchDocument,f.dateExport,f.netHtCalc,f.netTvaCalc,f.netTtcCalc) "
//				+ " from TaFacture f join f.taInfosDocument infos join f.taTiers tiers   "
...
//				+"	select coalesce(sum(ra.affectation),0)+coalesce(sum(rr.affectation),0) from TaFacture f3  left join f3.taRReglements rr left join f3.taRAvoirs ra   "  
//				+"	where f3.idDocument=f.idDocument group by f3.idDocument )"
//				+ " order by f.codeDocument"),		
//		@NamedQuery(name=TaFacture.QN.FIND_NON_PAYE_LIGHT_PERIODE, 
//			query="select new fr.legrain.document.dto.TaFactureDTO("
//					+ " f.idDocument, f.codeDocument, f.dateDocument, f.libelleDocument, tiers.codeTiers, infos.nomTiers,f.dateEchDocument,f.dateExport,f.netHtCalc,f.netTvaCalc,f.netTtcCalc) "
//					+ " from TaFacture f join f.taInfosDocument infos join f.taTiers tiers  "
//					+ " where f.dateDocument between :dateDebut and :dateFin "
...
//					+"	where f3.idDocument=f.idDocument group by f3.idDocument )"
//					+ " order by f.codeDocument"),
//		@NamedQuery(name=TaFacture.QN.FIND_NON_PAYE_ARELANCER_LIGHT_PERIODE, 
//			query="select new fr.legrain.document.dto.TaFactureDTO("
//					+ " f.idDocument, f.codeDocument, f.dateDocument, f.libelleDocument, tiers.codeTiers, infos.nomTiers,f.dateEchDocument,f.dateExport,f.netHtCalc,f.netTvaCalc,f.netTtcCalc) "
//					+ " from TaFacture f join f.taInfosDocument infos join f.taTiers tiers  "
...
//		// Renvoi les totaux de l'ensemble des devis groupé par jour sur la période dateDebut à dateFin
		@NamedQuery(name=TaFacture.QN.SUM_CA_JOUR_LIGTH_PERIODE, 
...
//		// Renvoi les totaux de l'ensemble des devis groupé par mois sur la période dateDebut à dateFin
		@NamedQuery(name=TaFacture.QN.SUM_CA_MOIS_LIGTH_PERIODE, 
			query="select new fr.legrain.document.dto.DocumentChiffreAffaireDTO("
...
//		// Renvoi les totaux de l'ensemble des devis groupé par année sur la période dateDebut à dateFin
		@NamedQuery(name=TaFacture.QN.SUM_CA_ANNEE_LIGTH_PERIODE, 
			query="select new fr.legrain.document.dto.DocumentChiffreAffaireDTO("
...
//		@NamedQuery(name=TaFacture.QN.SUM_CA_TOTAL_LIGTH_PERIODE, 
//			query="select new fr.legrain.document.dto.DocumentChiffreAffaireDTO("
//					+ " coalesce(sum(f.netHtCalc),0),coalesce(sum(f.netTvaCalc),0),coalesce(sum(f.netTtcCalc),0)) "
//					+ " from TaFacture f  "
//					+ " where f.dateDocument between :dateDebut and :dateFin and f.taTiers.codeTiers like :codeTiers"),
//		// Renvoi les totaux de l'ensemble des factures sur la période dateDebut à dateFin
		@NamedQuery(name=TaFacture.QN.SUM_CA_TOTAL_LIGTH_PERIODE, 
			query="select  coalesce(sum(f.netHtCalc),0) as mtHtCalc ,coalesce(sum(f.netTvaCalc),0) as mtTvaCalc ,coalesce(sum(f.netTtcCalc),0) as mtTtcCalc "
					+ " from TaFacture f  "
					+ " where f.dateDocument between :dateDebut and :dateFin and f.taTiers.codeTiers like :codeTiers"),		
		@NamedQuery(name=TaFacture.QN.SUM_CA_TOTAL_SANS_AVOIR_LIGTH_PERIODE, 
		query="select new fr.legrain.document.dto.DocumentChiffreAffaireDTO("
		...
		@NamedQuery(name=TaFacture.QN.SUM_CA_TOTAL_LIGHT_PERIODE_PAYE, 
			query="select new fr.legrain.document.dto.DocumentChiffreAffaireDTO("
					+ " coalesce(sum(f.netHtCalc),0),coalesce(sum(f.netTvaCalc),0),coalesce(sum(f.netTtcCalc),0)) "
					+ " from TaFacture f  left join f.taRReglements rr    left join f.taRAvoirs ra "
					+ " where f.dateDocument between :dateDebut and :dateFin and f.taTiers.codeTiers like :codeTiers"
					+" group by true"
...
//		// Renvoi les totaux de l'ensemble des factures pour un tiers sur la période dateDebut à dateFin
		@NamedQuery(name=TaFacture.QN.SUM_CA_TOTAL_LIGTH_PERIODE_PAR_TIERS, 
			query="select new fr.legrain.document.dto.DocumentChiffreAffaireDTO("
					+ " coalesce(sum(f.netHtCalc),0),coalesce(sum(f.netTvaCalc),0),coalesce(sum(f.netTtcCalc),0)) "
					+ " from TaFacture f  "
					+ " where f.dateDocument between :dateDebut and :dateFin and f.taTiers.codeTiers like :codeTiers "),
//		// Renvoi les totaux de l'ensemble des factures pour un article sur la période dateDebut à dateFin
		@NamedQuery(name=TaFacture.QN.SUM_CA_TOTAL_LIGTH_PERIODE_PAR_ARTICLE, 
			query="select new fr.legrain.document.dto.DocumentChiffreAffaireDTO("
					+ " coalesce(sum(f.netHtCalc),0),coalesce(sum(f.netTvaCalc),0),coalesce(sum(f.netTtcCalc),0)) "
					+ "  from TaFacture f left join f.taTiers t left join f.lignes lf left join lf.taArticle art  "
					+ " where art.codeArticle = :codearticle and f.dateDocument between :dateDebut and :dateFin group by art.codeArticle"),
		
		
		
		@NamedQuery(name=TaFacture.QN.SUM_REGLE_JOUR_LIGTH_PERIODE_TOTALEMENTPAYE, 
		query="select new fr.legrain.document.dto.DocumentChiffreAffaireDTO("
				+ " extract(day from f.dateDocument),extract(month from f.dateDocument),extract(year from f.dateDocument), "
				+ " coalesce(sum(f.netHtCalc),0),coalesce(sum(f.netTvaCalc),0), coalesce(sum(f.netTtcCalc),0)) "
				+ " from TaFacture f  "
				...
				+ " group by extract(day from f.dateDocument),extract(month from f.dateDocument),extract(year from f.dateDocument)"
				+ " order by extract(day from f.dateDocument),extract(month from f.dateDocument),extract(year from f.dateDocument)"),		
		@NamedQuery(name=TaFacture.QN.SUM_REGLE_MOIS_LIGTH_PERIODE_TOTALEMENTPAYE, 
		query="select new fr.legrain.document.dto.DocumentChiffreAffaireDTO("
				+ " extract(month from f.dateDocument),extract(year from f.dateDocument), "
				+ " coalesce(sum(f.netHtCalc),0),coalesce(sum(f.netTvaCalc),0), coalesce(sum(f.netTtcCalc),0)) "
				+ " from TaFacture f  "
				...
				+ " group by extract(month from f.dateDocument),extract(year from f.dateDocument)"
				+ " order by extract(month from f.dateDocument),extract(year from f.dateDocument)"),
		@NamedQuery(name=TaFacture.QN.SUM_REGLE_ANNEE_LIGTH_PERIODE_TOTALEMENTPAYE, 
			query="select new fr.legrain.document.dto.DocumentChiffreAffaireDTO("
		...
		@NamedQuery(name=TaFacture.QN.SUM_REGLE_TOTAL_LIGTH_PERIODE_TOTALEMENTPAYE, 
			query="select new fr.legrain.document.dto.DocumentChiffreAffaireDTO("
					+ " coalesce(sum(f.netHtCalc),0),coalesce(sum(f.netTvaCalc),0), coalesce(sum(f.netTtcCalc),0)) "
					+ " from TaFacture f  "
					+ " where f.dateDocument between :dateDebut and :dateFin  "
					...
					+"	where f3.idDocument=f.idDocument group by f3.idDocument )"
					+ " group by true"),
		// Renvoi les articles de l'ensemble des Facture sur la période datedebut à datefin
		@NamedQuery(name=TaFacture.QN.FIND_ARTICLES_PAR_TIERS_PAR_MOIS, 
		...
		@NamedQuery(name=TaFacture.QN.FIND_ARTICLES_PAR_TIERS_TRANSFORME, 
			query="select new fr.legrain.document.dashboard.dto.TaArticlesParTiersDTO("
					+ "c.codeTiers, c.nomTiers,d.nomEntreprise,a.codeDocument,a.dateDocument,e.codeArticle,e.libellecArticle,b.mtHtLDocument,b.mtTtcLDocument) "
					...
					+ "	having coalesce(sum(ra.affectation),0)+coalesce(sum(rr.affectation),0)>=f2.netTtcCalc ) order by a.codeDocument"),
		
		// Renvoi les articles de l'ensemble des Facture non transformé sur la période datedebut à datefin
		@NamedQuery(name=TaFacture.QN.FIND_ARTICLES_PAR_TIERS_NON_TRANSFORME, 
			query="select new fr.legrain.document.dashboard.dto.TaArticlesParTiersDTO("
					+ "c.codeTiers, c.nomTiers,d.nomEntreprise,a.codeDocument,a.dateDocument,e.codeArticle,e.libellecArticle,b.mtHtLDocument,b.mtTtcLDocument) "
					+ "from TaFacture a join a.lignes b join a.taTiers c join a.taInfosDocument f left join c.taEntreprise d join b.taArticle e  "
					+ "where a.dateDocument between :dateDebut and :dateFin "
		...
		// Renvoi les articles de l'ensemble des Facture non transformé sur la période datedebut à datefin
		@NamedQuery(name=TaFacture.QN.FIND_ARTICLES_PAR_TIERS_NON_TRANSFORME_ARELANCER, 
			query="select new fr.legrain.document.dashboard.dto.TaArticlesParTiersDTO("
					+ " c.codeTiers, c.nomTiers,d.nomEntreprise,a.codeDocument,a.dateDocument,e.codeArticle,e.libellecArticle,b.mtHtLDocument,b.mtTtcLDocument) "
					+ " from TaFacture a join a.lignes b join a.taTiers c join a.taInfosDocument f left join c.taEntreprise d join b.taArticle e  "
...
@NamedNativeQueries({
	@NamedNativeQuery(name=TaFacture.QN.FIND_ALL_LIGHT_PERIODE, 
			query="select res.code_Famille, res.id_Document, res.code_Document, res.date_Document, res.libelle_Document, res.code_Tiers, res.nom_Tiers,res.date_Ech_Document,res.date_export,res.mt_Ht_Calc,res.mt_Tva_Calc,res.mt_Ttc_Calc,res.affectationTotale,res.resteARegler from( "+
					" select '' as code_Famille,f.id_Document, f.code_Document, f.date_Document, f.libelle_Document, tiers.code_Tiers, infos.nom_Tiers,f.date_Ech_Document,f.date_Export,coalesce(f.net_Ht_Calc,0)as mt_Ht_Calc,coalesce(f.net_Tva_Calc,0)as mt_Tva_Calc,coalesce(f.net_Ttc_Calc,0)as mt_Ttc_Calc,"+
					...
					" from ta_facture f join ta_tiers tiers on tiers.id_tiers=f.id_tiers " +
					...
					" order by f.code_Document)as res ", resultSetMapping = "TaFactureDTO"),
	@NamedNativeQuery(name=TaFacture.QN.FIND_PAYE_LIGHT_PERIODE, 
			query="select res.code_Famille,res.id_Document, res.code_Document, res.date_Document, res.libelle_Document, res.code_Tiers, res.nom_Tiers,res.date_Ech_Document,res.date_export,res.mt_Ht_Calc,res.mt_Tva_Calc,res.mt_Ttc_Calc,res.affectationTotale,res.resteARegler from( "+
					" select '' as code_Famille, f.id_Document, f.code_Document, f.date_Document, f.libelle_Document, tiers.code_Tiers, infos.nom_Tiers,f.date_Ech_Document,f.date_Export,coalesce(f.net_Ht_Calc,0)as mt_Ht_Calc,coalesce(f.net_Tva_Calc,0)as mt_Tva_Calc,coalesce(f.net_Ttc_Calc,0)as mt_Ttc_Calc,"+
					" coalesce(f.net_Ttc_Calc,0)-(s1.affectation+s2.affectationAvoir)as affectationTotale,(coalesce(f.net_Ttc_Calc,0)-(s1.affectation+s2.affectationAvoir))as resteARegler " + 
					" from ta_facture f join ta_tiers tiers on tiers.id_tiers=f.id_tiers " +
	...
	@NamedNativeQuery(name=TaFacture.QN.FIND_NON_PAYE_LIGHT_PERIODE, 
			query="select res.code_Famille,res.id_Document, res.code_Document, res.date_Document, res.libelle_Document, res.code_Tiers, res.nom_Tiers,res.date_Ech_Document,res.date_export,res.mt_Ht_Calc,res.mt_Tva_Calc,res.mt_Ttc_Calc,res.affectationTotale,res.resteARegler from( "+
					" select '' as code_Famille, f.id_Document, f.code_Document, f.date_Document, f.libelle_Document, tiers.code_Tiers, infos.nom_Tiers,f.date_Ech_Document,f.date_Export,coalesce(f.net_Ht_Calc,0)as mt_Ht_Calc,coalesce(f.net_Tva_Calc,0)as mt_Tva_Calc,coalesce(f.net_Ttc_Calc,0)as mt_Ttc_Calc,"+
					" coalesce(f.net_Ttc_Calc,0)-(s1.affectation+s2.affectationAvoir)as affectationTotale,(coalesce(f.net_Ttc_Calc,0)-(s1.affectation+s2.affectationAvoir))as resteARegler " + 
					" from ta_facture f join ta_tiers tiers on tiers.id_tiers=f.id_tiers " +
					...
					" group by f.id_Document, f.code_Document, f.date_Document, f.libelle_Document, tiers.code_Tiers, infos.nom_Tiers,f.date_Ech_Document,f.date_Export,coalesce(f.net_Ht_Calc,0),coalesce(f.net_Tva_Calc,0),coalesce(f.net_Ttc_Calc,0),s1.affectation,s2.affectationAvoir" + 
					" order by f.code_Document)as res ", resultSetMapping = "TaFactureDTO"),
	@NamedNativeQuery(name=TaFacture.QN.FIND_NON_PAYE_ARELANCER_LIGHT_PERIODE, 
			query="select res.code_Famille,res.id_Document, res.code_Document, res.date_Document, res.libelle_Document, res.code_Tiers, res.nom_Tiers,res.date_Ech_Document,res.date_export,res.mt_Ht_Calc,res.mt_Tva_Calc,res.mt_Ttc_Calc,res.affectationTotale,res.resteARegler from( "+
					" select '' as code_Famille, f.id_Document, f.code_Document, f.date_Document, f.libelle_Document, tiers.code_Tiers, infos.nom_Tiers,f.date_Ech_Document,f.date_Export,coalesce(f.net_Ht_Calc,0)as mt_Ht_Calc,coalesce(f.net_Tva_Calc,0)as mt_Tva_Calc,coalesce(f.net_Ttc_Calc,0)as mt_Ttc_Calc,"+
					" coalesce(f.net_Ttc_Calc,0)-(s1.affectation+s2.affectationAvoir)as affectationTotale,(coalesce(f.net_Ttc_Calc,0)-(s1.affectation+s2.affectationAvoir))as resteARegler " + 
					" from ta_facture f join ta_tiers tiers on tiers.id_tiers=f.id_tiers " +
				...
				" group by f.id_Document, f.code_Document, f.date_Document, f.libelle_Document, tiers.code_Tiers, infos.nom_Tiers,f.date_Ech_Document,f.date_Export,coalesce(f.net_Ht_Calc,0),coalesce(f.net_Tva_Calc,0),coalesce(f.net_Ttc_Calc,0),s1.affectation,s2.affectationAvoir" + 
				" order by f.code_Document)as res ", resultSetMapping = "TaFactureDTO"),
	@NamedNativeQuery(name=TaFacture.QN.SUM_RESTE_A_REGLER_ANNEE_LIGTH_PERIODE_A_RELANCER, 
			query = "select res.jour,res.mois,res.annee,true as typeReglement,sum(res.mtHtCalc)as mtHtCalc ,sum(res.mtTvaCalc)as mtTvaCalc, sum(res.mtTtcCalc)as mtTtcCalc,sum(res.affectationTotale)as affectationTotale,sum(res.resteARegler)as resteARegler from("+
					...
					" (s1.affectation+s2.affectationAvoir)as affectationTotale,(coalesce(sum(f.net_Ttc_Calc),0)-(s1.affectation+s2.affectationAvoir))as resteARegler from ta_facture f " + 
	...
	@NamedNativeQuery(name = TaFacture.QN.SUM_RESTE_A_REGLER_MOIS_LIGTH_PERIODE_A_RELANCER, 
			query = "select res.jour,res.mois,res.annee,true as typeReglement,sum(res.mtHtCalc)as mtHtCalc ,sum(res.mtTvaCalc)as mtTvaCalc, sum(res.mtTtcCalc)as mtTtcCalc,sum(res.affectationTotale)as affectationTotale,sum(res.resteARegler)as resteARegler from("+
	...
	@NamedNativeQuery(name=TaFacture.QN.SUM_RESTE_A_REGLER_JOUR_LIGTH_PERIODE_A_RELANCER, 
	query = "select res.jour,res.mois,res.annee,true as typeReglement,sum(res.mtHtCalc)as mtHtCalc ,sum(res.mtTvaCalc)as mtTvaCalc, sum(res.mtTtcCalc)as mtTtcCalc,sum(res.affectationTotale)as affectationTotale,sum(res.resteARegler)as resteARegler from("+
	...
	@NamedNativeQuery(name=TaFacture.QN.SUM_RESTE_A_REGLER_TOTAL_LIGTH_PERIODE_A_RELANCER, 
			query = "select res.jour,res.mois,res.annee,true as typeReglement,sum(res.mtHtCalc)as mtHtCalc ,sum(res.mtTvaCalc)as mtTvaCalc, sum(res.mtTtcCalc)as mtTtcCalc,sum(res.affectationTotale)as affectationTotale,sum(res.resteARegler)as resteARegler from("+
	...
	@NamedNativeQuery(name=TaFacture.QN.SUM_RESTE_A_REGLER_JOUR_LIGTH_PERIODE, 
			query = "select res.jour,res.mois,res.annee,true as typeReglement,sum(res.mtHtCalc)as mtHtCalc ,sum(res.mtTvaCalc)as mtTvaCalc, sum(res.mtTtcCalc)as mtTtcCalc,sum(res.affectationTotale)as affectationTotale,sum(res.resteARegler)as resteARegler from("+
					" select extract(day from f.date_Document)as jour,extract(month from f.date_Document)as mois,extract(year from f.date_Document)as annee,"+
					" true as typeReglement,coalesce(sum(f.net_Ht_Calc),0)as mtHtCalc ,coalesce(sum(f.net_Tva_Calc),0)as mtTvaCalc, coalesce(sum(f.net_Ttc_Calc),0)as mtTtcCalc," + 
					" (s1.affectation+s2.affectationAvoir)as affectationTotale,(coalesce(sum(f.net_Ttc_Calc),0)-(s1.affectation+s2.affectationAvoir))as resteARegler from ta_facture f " + 
					...
					" group by extract(day from f.date_Document),extract(month from f.date_Document),extract(year from f.date_Document),s1.affectation,s2.affectationAvoir" + 
					" order by extract(day from f.date_Document),extract(month from f.date_Document),extract(year from f.date_Document))as res group by res.jour,res.mois,res.annee", resultSetMapping = "DocumentChiffreAffaireDTO"),
	@NamedNativeQuery(name=TaFacture.QN.SUM_RESTE_A_REGLER_MOIS_LIGTH_PERIODE, 
			query = "select res.jour,res.mois,res.annee,true as typeReglement,sum(res.mtHtCalc)as mtHtCalc ,sum(res.mtTvaCalc)as mtTvaCalc, sum(res.mtTtcCalc)as mtTtcCalc,sum(res.affectationTotale)as affectationTotale,sum(res.resteARegler)as resteARegler from("+
			" select (0)as jour,extract(month from f.date_Document)as mois,extract(year from f.date_Document)as annee,"+
			" true as typeReglement,coalesce(sum(f.net_Ht_Calc),0)as mtHtCalc ,coalesce(sum(f.net_Tva_Calc),0)as mtTvaCalc, coalesce(sum(f.net_Ttc_Calc),0)as mtTtcCalc," + 
			" (s1.affectation+s2.affectationAvoir)as affectationTotale,(coalesce(sum(f.net_Ttc_Calc),0)-(s1.affectation+s2.affectationAvoir))as resteARegler from ta_facture f " + 
			...
			" group by extract(month from f.date_Document),extract(year from f.date_Document),s1.affectation,s2.affectationAvoir" + 
			" order by extract(month from f.date_Document),extract(year from f.date_Document))as res group by res.jour,res.mois,res.annee", resultSetMapping = "DocumentChiffreAffaireDTO"),
	@NamedNativeQuery(name=TaFacture.QN.SUM_RESTE_A_REGLER_ANNEE_LIGTH_PERIODE, 
			query = "select res.jour,res.mois,res.annee,true as typeReglement,sum(res.mtHtCalc)as mtHtCalc ,sum(res.mtTvaCalc)as mtTvaCalc, sum(res.mtTtcCalc)as mtTtcCalc,sum(res.affectationTotale)as affectationTotale,sum(res.resteARegler)as resteARegler from("+
					" select (0)as jour,(0)as mois,extract(year from f.date_Document)as annee,"+
					" true as typeReglement,coalesce(sum(f.net_Ht_Calc),0)as mtHtCalc ,coalesce(sum(f.net_Tva_Calc),0)as mtTvaCalc, coalesce(sum(f.net_Ttc_Calc),0)as mtTtcCalc," + 
					" (s1.affectation+s2.affectationAvoir)as affectationTotale,(coalesce(sum(f.net_Ttc_Calc),0)-(s1.affectation+s2.affectationAvoir))as resteARegler from ta_facture f " + 
					...
					" group by extract(year from f.date_Document),s1.affectation,s2.affectationAvoir" + 
					" order by extract(year from f.date_Document))as res group by res.jour,res.mois,res.annee", resultSetMapping = "DocumentChiffreAffaireDTO"),
	@NamedNativeQuery(name=TaFacture.QN.SUM_RESTE_A_REGLER_TOTAL_LIGTH_PERIODE, 
	query = 
	"select res.jour,res.mois,res.annee,true as typeReglement,sum(res.mtHtCalc)as mtHtCalc ,sum(res.mtTvaCalc)as mtTvaCalc, sum(res.mtTtcCalc)as mtTtcCalc,sum(res.affectationTotale)as affectationTotale,sum(res.resteARegler)as resteARegler from("+
	" select (0)as jour,(0)as mois,(0)as annee,true as typeReglement,coalesce(sum(f.net_Ht_Calc),0)as mtHtCalc ,coalesce(sum(f.net_Tva_Calc),0)as mtTvaCalc, coalesce(sum(f.net_Ttc_Calc),0)as mtTtcCalc," + 
	" (s1.affectation+s2.affectationAvoir)as affectationTotale,(coalesce(sum(f.net_Ttc_Calc),0)-(s1.affectation+s2.affectationAvoir))as resteARegler from ta_facture f " + 
	" join ta_tiers t on t.id_tiers=f.id_tiers " + 
	" join (" + 
...
Cloneable,IDocumentTiers,IDocumentTiersComplet, IDocumentCalcul, IDocumentPayableCB {
	...
	public static class QN {
		...
		public static final String FIND_BY_DATE_DTO = "TaFacture.findEntre2DateDTO";
		public static final String FIND_BY_DATE_EXPORT_LIGHT = "TaFacture.findEntre2DateExporteLight";
		...
		public static final String FIND_BY_CODE_LIGHT = "TaFacture.findEntre2CodeLight";
		...
		public static final String FIND_BY_DATE_NON_VERROUILLE = "TaFacture.findEntre2DateNonVerrouille";
		public static final String FIND_BY_CODE_NON_VERROUILLE = "TaFacture.findEntre2CodeNonVerrouille";
		public static final String FIND_BY_DATE_VERROUILLE = "TaFacture.findEntre2DateVerrouille";
		public static final String FIND_BY_CODE_VERROUILLE = "TaFacture.findEntre2CodeVerrouille";
		...
		public static final String FIND_BY_TIERS_AND_DATE_LIGHT = "TaFacture.findTiersEntre2DateLight";
		
		public static final String FIND_BY_TIERS_AND_DATE_POUR_COMPTE_CLIENT = "TaFacture.findTiersEntre2DateCompteClient";
		...
		public static final String FIND_ALL_LIGHT = "TaFacture.findAllLight";
		public static final String FIND_ALL_LIGHT_LISTE = "TaFacture.findAllLightListe";
		public static final String FIND_BY_DATE_NON_EXPORT_LIGHT = "TaFacture.findEntre2DateNonExporteLight";
		public static final String FIND_BY_CODE_NON_EXPORT_LIGHT = "TaFacture.findEntre2CodeNonExporteLight";
		public static final String FIND_BY_DATE_NON_EXPORT_PARDATE_LIGHT="TaFacture.findEntre2DateNonExporteParDateLight";
		public static final String FIND_BY_DATEEXPORT = "TaFacture.findDateExporte";
		public static final String FIND_BY_DATEEXPORT_LIGHT = "TaFacture.findDateExporteLight";
//		public static final String FIND_BY_DATE_NON_VERROULLE_LIGHT = "TaFacture.findEntre2DateNonVerrouilleLight";
//		public static final String FIND_BY_CODE_NON_VERROUILLE_LIGHT = "TaFacture.findEntre2CodeNonVerrouilleLight";

		
		public static final String FIND_ALL_LIGHT_PERIODE = "TaFacture.findAllLightPeriode";
		public static final String FIND_PAYE_LIGHT_PERIODE = "TaFacture.findFacturePayePeriodeDTO";
		public static final String FIND_NON_PAYE_LIGHT_PERIODE = "TaFacture.findFactureNonPayeDTO";		
		public static final String FIND_NON_PAYE_ARELANCER_LIGHT_PERIODE = "TaFacture.findFactureNonPayeARelancerDTO";

		/*Isa*/
		public static final String SUM_CA_JOUR_LIGTH_PERIODE = "TaFacture.caFactureJourPeriodeDTO";
		public static final String SUM_CA_MOIS_LIGTH_PERIODE = "TaFacture.caFactureMoisPeriodeDTO";
		public static final String SUM_CA_ANNEE_LIGTH_PERIODE = "TaFacture.caFactureAnneePeriodeDTO";
		public static final String SUM_CA_TOTAL_LIGTH_PERIODE = "TaFacture.caFactureTotalPeriodeDTO";
		public static final String SUM_CA_TOTAL_SANS_AVOIR_LIGTH_PERIODE = "TaFacture.caFactureTotalSansAvoirPeriodeDTO";

		public static final String SUM_RESTE_A_REGLER_JOUR_LIGTH_PERIODE = "TaFacture.resteAReglerFactureJourPeriodeDTO";
		public static final String SUM_RESTE_A_REGLER_MOIS_LIGTH_PERIODE = "TaFacture.resteAReglerFactureMoisPeriodeDTO";
		public static final String SUM_RESTE_A_REGLER_ANNEE_LIGTH_PERIODE = "TaFacture.resteAReglerFactureAnneePeriodeDTO";
		public static final String SUM_RESTE_A_REGLER_TOTAL_LIGTH_PERIODE = "TaFacture.resteAReglerFactureTotalPeriodeDTO";
//
		public static final String SUM_RESTE_A_REGLER_JOUR_LIGTH_PERIODE_A_RELANCER = "TaFacture.resteAReglerFactureJourPeriodeDTOARelancer";
		public static final String SUM_RESTE_A_REGLER_MOIS_LIGTH_PERIODE_A_RELANCER = "TaFacture.resteAReglerFactureMoisPeriodeDTOARelancer";
		public static final String SUM_RESTE_A_REGLER_ANNEE_LIGTH_PERIODE_A_RELANCER = "TaFacture.resteAReglerFactureAnneePeriodeDTOARelancer";
		public static final String SUM_RESTE_A_REGLER_TOTAL_LIGTH_PERIODE_A_RELANCER = "TaFacture.resteAReglerFactureTotalPeriodeDTOARelancer";
		public static final String SUM_RESTE_A_REGLER_MOIS_LIGTH_PERIODE_A_RELANCER2 = "1";
		
		public static final String SUM_REGLE_JOUR_LIGTH_PERIODE_TOTALEMENTPAYE = "TaFacture.caFactureJourPeriodeDTOTotalementPaye";
		public static final String SUM_REGLE_MOIS_LIGTH_PERIODE_TOTALEMENTPAYE = "TaFacture.caFactureMoisPeriodeDTOTotalementPaye";
		public static final String SUM_REGLE_ANNEE_LIGTH_PERIODE_TOTALEMENTPAYE = "TaFacture.caFactureAnneePeriodeDTOTotalementPaye";
		public static final String SUM_REGLE_TOTAL_LIGTH_PERIODE_TOTALEMENTPAYE = "TaFacture.caFactureTotalPeriodeDTOTotalementPaye";
		/*fin Isa*/
		
		public static final String SUM_CA_TOTAL_LIGHT_PERIODE_PAYE = "TaFacture.caFactureTotalPeriodeDTOPaye";
		public static final String SUM_CA_TOTAL_LIGTH_PERIODE_PAR_TIERS = "TaFacture.caTotalLightPeriodeParTiers";
		public static final String SUM_CA_TOTAL_LIGTH_PERIODE_PAR_ARTICLE = "TaFacture.caTotalLightPeriodeParArticle";
		
		public static final String FIND_ARTICLES_PAR_TIERS_PAR_MOIS = "TaFacture.articlesFactureMoisPeriode";
		public static final String FIND_ARTICLES_PAR_TIERS_TRANSFORME = "TaFacture.articlesFacturePeriodeDTOTransforme";
		public static final String FIND_ARTICLES_PAR_TIERS_NON_TRANSFORME = "TaFacture.articlesFacturePeriodeDTONonTransforme";
		public static final String FIND_ARTICLES_PAR_TIERS_NON_TRANSFORME_ARELANCER = "TaFacture.articlesFacturePeriodeDTONonTransformeARelancer";
	}
...
//	@LgrHibernateValidated(champ = "id_document",table = "ta_facture",clazz = TaFacture.class)
...
//	}
	...
	@LgrHibernateValidated(champBd = "code_document",table = "ta_facture",champEntite="codeDocument", clazz = TaFacture.class)
	...
	@LgrHibernateValidated(champBd = "date_document",table = "ta_facture",champEntite="dateDocument", clazz = TaFacture.class)
	...
	@LgrHibernateValidated(champBd = "date_ech_document",table = "ta_facture",champEntite="dateEchDocument", clazz = TaFacture.class)
	...
	@LgrHibernateValidated(champBd = "date_liv_document",table = "ta_facture",champEntite="dateLivDocument", clazz = TaFacture.class)
	...
	@LgrHibernateValidated(champBd = "libelle_document",table = "ta_facture",champEntite="libelleDocument", clazz = TaFacture.class)
	...
	@LgrHibernateValidated(champBd = "regle_document",table = "ta_facture",champEntite="regleDocument", clazz = TaFacture.class)
	@Transient
	...
	public void setRegleDocument(BigDecimal regleFacture) {
		//if(regleFacture!=null && this.regleDocument.compareTo(regleFacture)!=0){
				...
				System.out.println("===**setRegleDocument**=== Transfert de code metier des entites vers les services, à bien vérifier Facture "+this.codeDocument);
...
//		}
	...
	@LgrHibernateValidated(champBd = "rem_ht_document",table = "ta_facture",champEntite="remHtDocument", clazz = TaFacture.class)
...
//		}
	...
	@LgrHibernateValidated(champBd = "tx_rem_ht_document",table = "ta_facture",champEntite="txRemHtDocument", clazz = TaFacture.class)
	...
	public void setTxRemHtDocument(BigDecimal txRemHtFacture) {
		...
		if(this.txRemHtDocument!=null && this.txRemHtDocument.compareTo(txRemHtFacture)!=0){
			...
			if(legrain) {
				...
				System.out.println("===**setTxRemHtDocument**=== Transfert de code metier des entites vers les services, à bien vérifier Facture "+this.codeDocument);
				//passage ejb => dans TaFactureService
				calculeTvaEtTotaux();
...
//	@AccessType(value="field")
	...
	@LgrHibernateValidated(champBd = "rem_ttc_document",table = "ta_facture",champEntite="remTtcDocument", clazz = TaFacture.class)
...
//	@AccessType(value="field")
	...
	@LgrHibernateValidated(champBd = "tx_rem_ttc_document",table = "ta_facture",champEntite="txRemTtcDocument", clazz = TaFacture.class)
	...
	public void setTxRemTtcDocument(BigDecimal txRemTtcFacture) {
		...
		if(this.txRemTtcDocument!=null && this.txRemTtcDocument.compareTo(txRemTtcFacture)!=0){		
			...
			if(legrain) {
				...
				System.out.println("===**setTxRemTtcDocument**=== Transfert de code metier des entites vers les services, à bien vérifier Facture "+this.codeDocument);
				//passage ejb => dans TaFactureService
				calculeTvaEtTotaux();
	...
	@LgrHibernateValidated(champBd = "nb_e_document",table = "ta_facture",champEntite="nbEDocument", clazz = TaFacture.class)
	...
	@Column(name = "ttc")
	@LgrHibernateValidated(champBd = "ttc",table = "ta_facture",champEntite="ttc", clazz = TaFacture.class)
...
//	@Column(name = "export")
//	@LgrHibernateValidated(champBd = "export",table = "ta_facture",champEntite="export", clazz = TaFacture.class)
...
//	}
	...
	@LgrHibernateValidated(champBd = "commentaire",table = "ta_facture",champEntite="commentaire", clazz = TaFacture.class)
...
//	@OneToOne(cascade = CascadeType.ALL, fetch = FetchType.EAGER, mappedBy = "taDocument",  orphanRemoval=true, optional=false)
	...
	@OneToMany(cascade = CascadeType.ALL,fetch = FetchType.LAZY, mappedBy = "taFacture", orphanRemoval=true)
	@XmlTransient
	...
	@OneToMany( fetch = FetchType.EAGER, mappedBy = "taFacture", orphanRemoval=true)
...
//	}
	...
	protected void afterAjoutLigne(SWTLigneDocument ligne) throws ExceptLgr {
		...
		System.out.println("===**afterAjoutLigne**=== Transfert de code metier des entites vers les services, à bien vérifier Facture "+this.codeDocument);
		//passage ejb => dans TaFactureService
		calculeTvaEtTotaux();
	...
	protected void afterRemoveLigne(SWTLigneDocument ligne) throws ExceptLgr {
		...
		System.out.println("===**afterRemoveLigne**=== Transfert de code metier des entites vers les services, à bien vérifier Facture "+this.codeDocument);
		//passage ejb => dans TaFactureService
		calculeTvaEtTotaux();
...
//			S'il n'existe pas déjà, charger un objet swtArticle pour la ligne
	...
	@LgrHibernateValidated(champBd = "mt_ttc_calc",table = "ta_facture",champEntite="mtTtcCalc", clazz = TaFacture.class)
	...
	@LgrHibernateValidated(champBd = "mt_ht_calc",table = "ta_facture",champEntite="mtHtCalc", clazz = TaFacture.class)
	...
	@LgrHibernateValidated(champBd = "mt_tva_calc",table = "ta_facture",champEntite="mtTvaCalc", clazz = TaFacture.class)
	...
	@LgrHibernateValidated(champBd = "net_ttc_calc",table = "ta_facture",champEntite="netTtcCalc", clazz = TaFacture.class)
	...
	@LgrHibernateValidated(champBd = "net_ht_calc",table = "ta_facture",champEntite="netHtCalc", clazz = TaFacture.class)
	...
	@LgrHibernateValidated(champBd = "net_tva_calc",table = "ta_facture",champEntite="netTvaCalc", clazz = TaFacture.class)
	...
	@LgrHibernateValidated(champBd = "net_a_payer",table = "ta_facture",champEntite="netTtcCalc", clazz = TaFacture.class)
	...
	@LgrHibernateValidated(champBd = "mt_ttc_avt_rem_globale_calc",table = "ta_facture",champEntite="mtTtcAvantRemiseGlobaleCalc", clazz = TaFacture.class)
	...
	@LgrHibernateValidated(champBd = "reste_a_regler",table = "ta_facture",champEntite="resteARegler", clazz = TaFacture.class)
	@Transient
	@XmlTransient
	public BigDecimal getResteAReglerEcran() {
		
		System.out.println("===**getResteAReglerEcran**=== Transfert de code metier des entites vers les services, à bien vérifier Facture "+this.codeDocument);
		//passage ejb => dans TaFactureService
	...
	@LgrHibernateValidated(champBd = "acomptes",table = "ta_facture",champEntite="", clazz = TaFacture.class)
	public BigDecimal getAcomptes() {
		
		System.out.println("===**getAcomptes**=== Transfert de code metier des entites vers les services, à bien vérifier Facture "+this.codeDocument);
//		//passage ejb => dans TaFactureService
//		calculSommeAcomptes();
...
//			if(legrain) {
//				
//				System.out.println("===*setAcomptes**=== Transfert de code metier des entites vers les services, à bien vérifier Facture "+this.codeDocument);
//				//passage ejb => dans TaFactureService
//				calculTotaux();
//				
//				try {
...
//	@LgrHibernateValidated(champ = "avoirs",table = "ta_facture",clazz = TaFacture.class)
	@Transient
	@XmlTransient
	public BigDecimal getAvoirs() {
		
		System.out.println("===**getAvoirs**=== Transfert de code metier des entites vers les services, à bien vérifier Facture "+this.codeDocument);
		//passage ejb => dans TaFactureService
...
//		if(this.acomptes.compareTo(acomptes)!=0){
			...
			if(legrain) {
				...
				System.out.println("===**setAvoirs**=== Transfert de code metier des entites vers les services, à bien vérifier Facture "+this.codeDocument);
				//passage ejb => dans TaFactureService
				calculTotaux();
...
//	@Column(name = "libelle_paiement", precision = 15)
	@LgrHibernateValidated(champBd = "libelle_paiement",table = "ta_facture",champEntite="libellePaiement", clazz = TaFacture.class)
	@Transient
	@XmlTransient
...
//			}
	...
	public BigDecimal resteTVA(LigneTva ligneTva) {
		...
		for (Object ligne : lignes) {
			//si c'est une ligne "normale" (ligne HT et non une ligne de commentaire ou autre)
			if(((TaLFacture)ligne).getTaTLigne().getCodeTLigne().equals(SWTDocument.C_CODE_T_LIGNE_H) 
					&& ((TaLFacture)ligne).getMtHtLDocument()!=null && ((TaLFacture)ligne).getMtHtLDocument().signum()!=0) {
				//si le code TVA de la ligne correspond à celui traite (boucle superieure)
				if(((TaLFacture)ligne).getCodeTvaLDocument()!=null&&((TaLFacture)ligne).getCodeTvaLDocument().equals(ligneTva.getCodeTva())){
	...
	public void dispatcherTvaAvantRemise() {
		...
		for (LigneTva ligneTva : lignesTVA) {
			if (ligneTva.getMtTvaAvantRemise()!=null) {
				...
				for (Object ligne : lignes) {
					if(((TaLFacture)ligne).getTaTLigne().getCodeTLigne().equals(SWTDocument.C_CODE_T_LIGNE_H) && ((TaLFacture)ligne).getMtHtLDocument()!=null 
							&& ((TaLFacture)ligne).getMtHtLDocument().signum()!=0 ) {
						if(((TaLFacture)ligne).getCodeTvaLDocument()!=null&&((TaLFacture)ligne).getCodeTvaLDocument().equals(ligneTva.getCodeTva())){
//							if (ligneTva.getMontantTotalHt().signum()==0) 
//								tvaLigne = ((TaLFacture)ligne).getMtHtLDocument().multiply(ligneTva.getTauxTva()).divide(new BigDecimal(100));
//							else {
		...
		for (Object ligne : lignes) {
			...
			if(codeTVA!=null && !codeTVA.equals("")) {
				...
				if(montantTotalHt.containsKey(codeTVA)) {
					...
					libelleLignesTVA.put(codeTVA, ((TaLFacture)ligne).getLibTvaLDocument());
...
//			ligneTva.setLibelle(taTvaDAO.findByCode(codeTva).getLibelleTva());
	...
	public BigDecimal calculSommeReglementsIntegres(){
		...
		if(this.getTaReglement()!=null){
			...
			for (TaRReglement taRReglement : getTaRReglements()) {
				if(taRReglement.getTaFacture()!=null && taRReglement.getEtat()!=null && (taRReglement.getEtat()&IHMEtat.integre)!=0 
						&& ((taRReglement.getEtatDeSuppression()&IHMEtat.suppression)==0))
					sommeReglements=sommeReglements.add(taRReglement.getAffectation());
				nbReglement++;
			}
...
//	}
	...
	public void calculTotaux() {
		System.out.println("===**calculTotaux**=== Transfert de code metier des entites vers les services, à bien vérifier Facture "+this.codeDocument);
//			    MT_TVA Numeric(15,2),
			...
			for (Object ligne : lignes) {
				if(((TaLFacture)ligne).getTaTLigne().getCodeTLigne().equals(SWTDocument.C_CODE_T_LIGNE_H) && ((TaLFacture)ligne).getTaArticle()!=null) {
					if(((TaLFacture)ligne).getMtHtLApresRemiseGlobaleDocument()!=null) {
...
//	}
	public void propertyChange(PropertyChangeEvent evt) {
		if(evt.getPropertyName().equals("qteLFacture")
			...
			System.out.println("===**propertyChange**=== Transfert de code metier des entites vers les services, à bien vérifier Facture "+this.codeDocument);
			//passage ejb => dans TaFactureService
			calculeTvaEtTotaux();
...
//	}
	...
	public void setTaInfosDocument(IInfosDocumentTiers infosDocumentTiers) {
		this.taInfosDocument = (TaInfosFacture) infosDocumentTiers;
	}
	...
	@OneToOne(fetch = FetchType.LAZY, cascade = CascadeType.ALL, orphanRemoval=true , mappedBy ="taFacture")
...
////					System.out.println("===****=== Transfert de code metier des entites vers les services, à bien vérifier Facture "+this.codeDocument);
////			//passage ejb => dans TaFactureService
...
//	}
	...
	public Object cloneCentralisation() throws CloneNotSupportedException {
		TaFacture doc = new TaFacture(false);
		try {
			doc.setIdDocument(0);
			doc.setVersion(version);
			//doc.setTaTPaiement(taTPaiement);
...
//			doc.setExport(export);
  	...
  	public TaLFacture contientMemeParametreCompte(TaLFacture ligneCompare){
		for (TaLFacture obj : getLignes()) {
...
//	}
	...
	@LgrHibernateValidated(champBd = "date_export",table = "ta_facture",champEntite="dateExport", clazz = TaFacture.class)
