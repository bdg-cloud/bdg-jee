...
public class TaActionInterneProgDTO extends ModelObject implements java.io.Serializable {
	...
	public TaActionInterneProgDTO() {
	}

	public TaActionInterneProgDTO(Integer id, String idAction,
	...
	public void setTaActionInterneProgDTO(TaActionInterneProgDTO taActionInterneDTO) {
	...
	public static TaActionInterneProgDTO copy(TaActionInterneProgDTO taActionInterneDTO){
		TaActionInterneProgDTO taActionInterneDTOLoc = new TaActionInterneProgDTO();
