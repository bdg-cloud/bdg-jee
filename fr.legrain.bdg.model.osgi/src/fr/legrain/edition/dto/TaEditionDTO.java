...
public class TaEditionDTO extends ModelObject implements java.io.Serializable {
...
//	private TaTEdition taTEdition;
	...
	public TaEditionDTO(Integer id, String codeEdition, String libelleEdition, String descriptionEdition,
	...
	public void setTaCompteServiceWebExterneDTO(TaEditionDTO taEditionDTO) {
	...
	public static TaEditionDTO copy(TaEditionDTO taEditionDTO){
		TaEditionDTO taEditionDTOLoc = new TaEditionDTO();
...
//	}
	...
	public Set<TaActionEditionDTO> getTaActionEditionDTO() {
		return taActionEditionDTO;
	}



	public void setTaActionEditionDTO(Set<TaActionEditionDTO> taActionEditionDTO) {
		this.taActionEditionDTO = taActionEditionDTO;
	}
