...
public class TaTEditionCatalogueDTO extends ModelObject implements java.io.Serializable {
	...
	public TaTEditionCatalogueDTO() {
	}

	public TaTEditionCatalogueDTO(Integer id, String codeTEdition,
	...
	public void setTaTServiceWebExterneDTO(TaTEditionCatalogueDTO taTServiceWebExterneDTO) {
	...
	public static TaTEditionCatalogueDTO copy(TaTEditionCatalogueDTO taTServiceWebExterneDTO){
		TaTEditionCatalogueDTO taTServiceWebExterneDTOLoc = new TaTEditionCatalogueDTO();
