...
@Entity
@Table(name = "ta_t_edition_catalogue")
@NamedQueries(value = { 
		@NamedQuery(name=TaTEditionCatalogue.QN.FIND_BY_CODE_LIGHT, query="select new fr.legrain.edition.dto.TaTEditionCatalogueDTO(f.id,f.codeTEdition,f.libelle,f.description,f.systeme) from TaTEditionCatalogue f where f.codeTEdition like :code order by f.codeTEdition"),
		@NamedQuery(name=TaTEditionCatalogue.QN.FIND_ALL_LIGHT, query="select new fr.legrain.edition.dto.TaTEditionCatalogueDTO(f.id,f.codeTEdition,f.libelle,f.description,f.systeme) from TaTEditionCatalogue f order by f.codeTEdition")	
})
public class TaTEditionCatalogue implements java.io.Serializable {

	private static final long serialVersionUID = 2048125031384449396L;
	
	public static class QN {
		public static final String FIND_BY_CODE_LIGHT = "TaTEditionCatalogue.findByCodeLight";
		public static final String FIND_ALL_LIGHT = "TaTEditionCatalogue.findAllLight";
	}
...
//	public static final String TYPE_EMAIL = "EMAIL";
	...
	@Column(name = "id_t_edition_catalogue", unique = true, nullable = false)
	...
	@Column(name = "code_t_edition_catalogue")
