...
@Entity
@Table(name = "ta_t_niveau")
public class TaTNiveau implements java.io.Serializable {
	...
	@Column(name="id_t_niveau")
	public Integer getIdTNiveau() {
		return idTNiveau;
	}

	public void setIdTNiveau(Integer idTNiveau) {
		this.idTNiveau = idTNiveau;
	}
