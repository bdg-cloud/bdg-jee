...
@Entity
@Table(name = "ta_type_partenaire")
public class TaTypePartenaire implements java.io.Serializable {

	private static final long serialVersionUID = -2669063955321054443L;
	
	public static final String TYPE_PART_REVENDEUR_CODE	= "PREVPRE";
	public static final String TYPE_PART_PARRAIN_CODE 	= "PPARRAIN";
	public static final String TYPE_PART_GROUPEMENT_CODE = "PGROUPEMENT";
	public static final String TYPE_PART_SALARIE_CODE 	 = "PSALARIE";
