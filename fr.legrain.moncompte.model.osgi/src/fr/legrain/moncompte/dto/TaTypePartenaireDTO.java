 ...
 */
public class TaTypePartenaireDTO extends ModelObject implements java.io.Serializable {
	
	private static final long serialVersionUID = 3745253400027354947L;
	...
	public TaTypePartenaireDTO() {
	}


	public TaTypePartenaireDTO(Integer id, String code, String libelle, Integer versionObj) {
		super();
		this.id = id;
		this.code = code;
	...
	public void setSWTInfoEntreprise(TaTypePartenaireDTO taProduitDTO) {
	...
	public static TaTypePartenaireDTO copy(TaTypePartenaireDTO taProduitDTO){
		TaTypePartenaireDTO taProduitDTOLoc = new TaTypePartenaireDTO();
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		TaTypePartenaireDTO other = (TaTypePartenaireDTO) obj;
		if (code == null) {
			if (other.code != null)
				return false;
