 ...
 */
public class TaTNiveauDTO extends ModelObject implements java.io.Serializable {
	...
	public TaTNiveauDTO(Integer id, String code, String libelle, Integer versionObj) {
		super();
		this.id = id;
		this.code = code;
	...
	public void setSWTInfoEntreprise(TaTNiveauDTO taProduitDTO) {
	...
	public static TaTNiveauDTO copy(TaTNiveauDTO taProduitDTO){
		TaTNiveauDTO taProduitDTOLoc = new TaTNiveauDTO();
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		TaTNiveauDTO other = (TaTNiveauDTO) obj;
		if (code == null) {
			if (other.code != null)
				return false;
