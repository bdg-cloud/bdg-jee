 ...
 */
public class PaEditorProforma extends org.eclipse.swt.widgets.Composite {
...
//	}
	...
	public static void showGUI() {
		...
		PaEditorProforma inst = new PaEditorProforma(shell, SWT.NULL);
	...
	public PaEditorProforma(org.eclipse.swt.widgets.Composite parent, int style) {
		super(parent, style);
		initGUI();
	}
	...
	private void initGUI() {
		try {
			...
			this.setSize(1059, 715);
			{
				...
				paEntete.setText("Entête du proforma");
				{
					laCODE_DOCUMENT = new Label(paEntete, SWT.NONE);
					laCODE_DOCUMENT.setText("Code Proforma");
				}
				{
					...
					if(!decore) {
						...
						tfCODE_DOCUMENT.setText("CODE_PROFORMA");
					} else {
				...
				}
				{
					...
					laDATE_DOCUMENT.setText("Date proforma");
				}
				{
...
//					dateTimeDATE_DOCUMENT.setPattern("dd/MM/yyyy");	
				...
				}
				{
					...
					if(!decore) {
						...
						tfLIBELLE_DOCUMENT.setText("LIBELLE_PROFORMA");
					} else {
