 ...
 */
public class PaTotauxProforma extends org.eclipse.swt.widgets.Composite {
	...
	public static void showGUI() {
		...
		PaTotauxProforma inst = new PaTotauxProforma(shell, SWT.NULL);
	...
	public PaTotauxProforma(org.eclipse.swt.widgets.Composite parent, int style) {
		super(parent, style);
		initGUI();
	}
