...
public class ConstEditionProforma extends ConstEditionDocument {
	
	public static String COMMENTAIRE_EDITION_DEFAUT = "Edition Proforma";
	...
	/**
	 * parametre of edition (Proforma)
	 */
	public static final String PARAM_ID_PROFORMA= "paramID_DOC";
