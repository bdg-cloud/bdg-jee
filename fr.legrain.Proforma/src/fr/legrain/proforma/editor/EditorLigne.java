...
public class EditorLigne extends JPALgrEditorPart implements ILgrEditor, ILgrRetourEditeur {
	...
	public static final String ID = "fr.legrain.editor.proforma.EditorLigne";
	
	private boolean enabled = true;
	private PaSaisieLigneProforma composite = null;
	...
	public void createPartControl(Composite parent) {
		composite = new PaSaisieLigneProforma(parent,SWT.NONE);
		if(getController()==null) {
			setController(new PaLigneProformaController(composite,em));
		} else {
	...
	public PaSaisieLigneProforma getComposite() {
		return composite;
	}
