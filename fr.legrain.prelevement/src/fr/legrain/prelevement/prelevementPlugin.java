package fr.legrain.prelevement;
 ...
 */
public class prelevementPlugin extends AbstractUIPlugin {
	static Logger logger = Logger.getLogger(prelevementPlugin.class.getName());
	// The plug-in ID
	public static final String PLUGIN_ID = "Prelevement";

	// The shared instance
	private static prelevementPlugin plugin;
	 ...
	 */
	public static prelevementPlugin getDefault() {
		return plugin;
	}
	/**
