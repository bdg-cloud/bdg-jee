 ...
 */
public class PaTotauxPrelevement extends org.eclipse.swt.widgets.Composite {
	private Table tableTVA;
	private Composite paTotaux;
	private Label laTX_REM_HT_PRELEVEMENT;
	...
	private Text tfTX_REM_TTC_PRELEVEMENT;
	private Label laTX_REM_TTC_PRELEVEMENT;
	private Text tfTX_REM_HT_PRELEVEMENT;
	...
	private DecoratedField fieldTX_REM_TTC_PRELEVEMENT;
	private DecoratedField fieldMT_HT_CALC;
	private DecoratedField fieldTX_REM_HT_PRELEVEMENT;
	...
	public static void showGUI() {
		...
		PaTotauxPrelevement inst = new PaTotauxPrelevement(shell, SWT.NULL);
	...
	public PaTotauxPrelevement(org.eclipse.swt.widgets.Composite parent, int style) {
		super(parent, style);
		initGUI();
	}
	...
	private void initGUI() {
		try {
			...
			}
			{
				...
				{
					laTX_REM_HT_PRELEVEMENT = new Label(paTotaux, SWT.NONE);
					laTX_REM_HT_PRELEVEMENT.setText("Remise globale %");
				}
				{
					GridData tfTX_REM_HT_FACTURELData = new GridData();
					tfTX_REM_HT_FACTURELData.widthHint = 127;
					if(!decore) {
						tfTX_REM_HT_PRELEVEMENT = new Text(paTotaux, SWT.BORDER);
						tfTX_REM_HT_PRELEVEMENT.setLayoutData(tfTX_REM_HT_FACTURELData);
						tfTX_REM_HT_PRELEVEMENT.setText("");
					} else {
						fieldTX_REM_HT_PRELEVEMENT = new DecoratedField(paTotaux, SWT.BORDER, new TextControlCreator());
						tfTX_REM_HT_PRELEVEMENT = (Text)fieldTX_REM_HT_PRELEVEMENT.getControl();
						fieldTX_REM_HT_PRELEVEMENT.getLayoutControl().setLayoutData(tfTX_REM_HT_FACTURELData);
					}
				}
				{
					laTX_REM_TTC_PRELEVEMENT = new Label(paTotaux, SWT.NONE);
					laTX_REM_TTC_PRELEVEMENT.setText("Escompte accordé %");
				}
				{
					...
					if(!decore) {
						tfTX_REM_TTC_PRELEVEMENT = new Text(paTotaux, SWT.BORDER);
						tfTX_REM_TTC_PRELEVEMENT.setLayoutData(tfTX_REM_TTC_FACTURELData);
						tfTX_REM_TTC_PRELEVEMENT.setText("");
					} else {
						fieldTX_REM_TTC_PRELEVEMENT = new DecoratedField(paTotaux, SWT.BORDER, new TextControlCreator());
						tfTX_REM_TTC_PRELEVEMENT = (Text)fieldTX_REM_TTC_PRELEVEMENT.getControl();
						fieldTX_REM_TTC_PRELEVEMENT.getLayoutControl().setLayoutData(tfTX_REM_TTC_FACTURELData);
					}
				}
				{
...
//	}
	...
	public Label getLaTX_REM_HT_PRELEVEMENT() {
		return laTX_REM_HT_PRELEVEMENT;
	}
...
//	}
	...
	public Text getTfTX_REM_TTC_PRELEVEMENT() {
		return tfTX_REM_TTC_PRELEVEMENT;
	}

	public Label getLaTX_REM_TTC_PRELEVEMENT() {
		return laTX_REM_TTC_PRELEVEMENT;
	}

	public Text getTfTX_REM_HT_PRELEVEMENT() {
		return tfTX_REM_HT_PRELEVEMENT;
	}
	...
	public DecoratedField getFieldTX_REM_TTC_PRELEVEMENT() {
		return fieldTX_REM_TTC_PRELEVEMENT;
	}
	...
	public DecoratedField getFieldTX_REM_HT_PRELEVEMENT() {
		return fieldTX_REM_HT_PRELEVEMENT;
	}
