...
public class LgrPrelevementPreferencePage extends FieldEditorPreferencePageLGR{
	...
	static private PropertiesConfiguration listeGestCode = new PropertiesConfiguration();
	 static Logger logger = Logger.getLogger(LgrPrelevementPreferencePage.class.getName());
	  
	public LgrPrelevementPreferencePage() {
		super(GRID);
		String idPlugin = prelevementPlugin.getDefault().getBundle().getSymbolicName();
		...
		this.setFolderEditionReportPlugin(constEdition.FICHE_FILE_REPORT_PRELEVEMENT);
		this.setNamePlugin(idPlugin);
		
		reportPlugin =ConstEdition.pathRepertoireEditionsSpecifiques()+ConstEdition.SEPARATOR+idPlugin+
		ConstEdition.SEPARATOR+TaPrelevement.class.getSimpleName();
		
		reportPluginClients=ConstEdition.pathRepertoireEditionsSpecifiquesClient()+ConstEdition.SEPARATOR+idPlugin+
		ConstEdition.SEPARATOR+TaPrelevement.class.getSimpleName();
		
		setPreferenceStore(prelevementPlugin.getDefault().getPreferenceStore());
		setDescription("Paramètres de codification des prélèvements");
	...
	public void createFieldEditors() {
		...
		String PathEditionDefaut = ConstEdition.pathFichierEditionsSpecifiques(ConstEdition.FICHE_FILE_REPORT_PRELEVEMENT,
				   namePlugin);
		...
		constEdition.valuePropertiePathEditionDefaut = ConstEdition.FICHE_FILE_REPORT_PRELEVEMENT;
		...
		boolean flag = constEdition.getAllInfosEdition(filePathEditionDefaut,null,namePlugin,
				  fileEditionSpecifiquesClient,fileEditionSpecifiques,TaPrelevement.class.getSimpleName(),
		...
		addField(
				new StringFieldEditor(PreferenceConstants.TYPE_PRELEVEMENT, "Type prélèvement", getFieldEditorParent()));
	}
