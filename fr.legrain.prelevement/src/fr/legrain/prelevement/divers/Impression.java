...
public class Impression implements IImpressionDocumentTiers {
	...
	public void imprimerSelection(int idDoc,final String codeDoc,boolean preview,String fileEditionDefaut,String namePlugin, String nomEntity){
		...
		reportParam.put(ConstEditionPrelevement.PARAM_CHOIX_DEST,choix);
...
//				constEdition.addValues(idSWTTiers,oneIDSWTTiers);
				constEdition.setPARAM_ID_TABLE(ConstEditionPrelevement.PARAM_ID_PROFORMA);
				constEdition.paramId = ConstEditionPrelevement.PARAM_ID_PROFORMA;
...
//		affichageChoixEdition.setAppContextEdition(new EditionAppContext().getExtensionMap());
		...
		if(!affiche_en_liste){
			...
			reportFileLocation = ConstEdition.pathFichierEditionsSpecifiques(reportFileLocation,prelevementPlugin.PLUGIN_ID);
