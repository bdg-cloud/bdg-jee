...
public class EditorTypeCivilite extends EJBLgrEditorPart implements ILgrEditor, ILgrRetourEditeur {
	
	static Logger logger = Logger.getLogger(EditorTypeCivilite.class.getName());

	public static final String ID = "fr.legrain.tiers.editor.EditorTypeCivilite";
	
	private boolean enabled = true;
	private PaTypeCiviliteSWT composite = null;
	//private SWTPaArticlesController controller = null;
	private EntityManager em = null;

	public EditorTypeCivilite() {
		super();
	}
	
	public EditorTypeCivilite(EditorPart parent) {
		super(parent);
	}
	
	public EditorTypeCivilite(EditorPart parent,EntityManager em) {
		super(parent);
		this.em=em;
	}
...
//	}
	...
	public void createPartControl(Composite parent) {
		composite = new PaTypeCiviliteSWT(parent,SWT.NONE);
		if(getController()==null) {
			setController(new SWTPaTypeCiviliteController(composite,em));
		} else {
...
//	}
	...
	public PaTypeCiviliteSWT getComposite() {
		return composite;
	}
