...
public class EditorBanque extends EJBLgrEditorPart implements ILgrEditor, ILgrRetourEditeur {
	
	static Logger logger = Logger.getLogger(EditorBanque.class.getName());
	
	public static final String ID = "fr.legrain.tiers.editor.EditorBanque";
	
	private boolean enabled = true;
	private PaBanqueSWT composite = null;
	...
	public EditorBanque(EditorPart parent) {
		super(parent);
	}
	
	public EditorBanque(EditorPart parent,EntityManager em) {
		super(parent);
		this.em=em;
	}
...
//	}
	...
	public void createPartControl(Composite parent) {
		composite = new PaBanqueSWT(parent,SWT.NONE);
		if(getController()==null) {
			setController(new SWTPaBanqueController(composite,em));
		} else {
...
//	}
	...
	public PaBanqueSWT getComposite() {
		return composite;
	}
