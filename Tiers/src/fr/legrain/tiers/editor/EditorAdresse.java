...
public class EditorAdresse extends EJBLgrEditorPart implements ILgrEditor, ILgrRetourEditeur {
	
	static Logger logger = Logger.getLogger(EditorAdresse.class.getName());
	
	public static final String ID = "fr.legrain.tiers.editor.EditorAdresse";
	
	private boolean enabled = true;
	private PaAdresseSWT composite = null;
	//private SWTPaArticlesController controller = null;
	private EntityManager em = null;

	public EditorAdresse() {
		super();
	}
	
	public EditorAdresse(EditorPart parent) {
		super(parent);
	}
	
	public EditorAdresse(EditorPart parent,EntityManager em) {
		super(parent);
		this.em=em;
	}
...
//	}
	...
	public void createPartControl(Composite parent) {
		composite = new PaAdresseSWT(parent,SWT.NONE);
		if(getController()==null) {
			setController(new SWTPaAdresseController(composite,em));
		} else {
...
//	}
	...
	public PaAdresseSWT getComposite() {
		return composite;
	}
