...
*/
public class PaTAdrSWT extends fr.legrain.lib.gui.DefaultFrameFormulaireSWT {
	...
	private ControlDecoration fieldLIBL_T_ADR;
	...
	*/
	public static void showGUI() {
		...
		PaTAdrSWT inst = new PaTAdrSWT(shell, SWT.NULL);
	...
	public PaTAdrSWT(org.eclipse.swt.widgets.Composite parent, int style) {
		super(parent, style);
		initGUI();
	}
...
//					if(!decore) {
						...
						fieldLIBL_T_ADR = new ControlDecoration(tfLIBL_T_ADR, SWT.TOP | SWT.RIGHT);
//					} else {					
...
//							tfLIBL_COMMENTAIRE, tfCODE_BANQUE, tfEntite, composite3 });
	...
	public ControlDecoration getFieldLIBL_T_ADR() {
