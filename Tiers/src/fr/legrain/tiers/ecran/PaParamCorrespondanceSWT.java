...
*/
public class PaParamCorrespondanceSWT extends fr.legrain.lib.gui.DefaultFrameFormulaireSWTTree {
...
//	final private boolean decore = false;
	...
	*/
	public static void showGUI() {
		...
		PaParamCorrespondanceSWT inst = new PaParamCorrespondanceSWT(shell, SWT.NULL);
	...
	public PaParamCorrespondanceSWT(org.eclipse.swt.widgets.Composite parent, int style) {
		super(parent, style);
		initGUI();
	}
...
//							tfLIBL_COMMENTAIRE, tfADRESSE1_ADRESSE, tfEntite, composite3 });
			...
			super.getTree().setLayoutData(grilleLData);
			this.layout();
		} catch (Exception e) {
			e.printStackTrace();
		}
