...
public class HandlerFamilleTiers extends LgrAbstractHandler {
	
	static Logger logger = Logger.getLogger(HandlerFamilleTiers.class.getName());
	...
	public Object execute(ExecutionEvent event) throws ExecutionException {
		...
		try {
			IEditorPart editor = EJBLgrEditorPart.verifEditeurOuvert(EditorFamilleTiers.ID);
			if(editor==null){
			IEditorPart e = PlatformUI.getWorkbench().getActiveWorkbenchWindow().
			getActivePage().openEditor(new EditorInputFamilleTiers(), EditorFamilleTiers.ID);
