...
public class HandlerAdresse extends LgrAbstractHandler {
	
	static Logger logger = Logger.getLogger(HandlerAdresse.class.getName());
	...
	public Object execute(ExecutionEvent event) throws ExecutionException {
		...
		try {
			IEditorPart editor = EJBLgrEditorPart.verifEditeurOuvert(EditorAdresse.ID);
			if(editor==null){
			IEditorPart e = PlatformUI.getWorkbench().getActiveWorkbenchWindow().getActivePage().openEditor(new EditorInputAdresse(), EditorAdresse.ID);
