...
public class HandlerListeTiersViewSupprimer extends LgrAbstractHandler {
	
	static Logger logger = Logger.getLogger(HandlerListeTiersViewSupprimer.class.getName());
