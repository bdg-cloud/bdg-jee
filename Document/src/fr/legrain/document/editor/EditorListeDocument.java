...
public class EditorListeDocument extends EJBLgrEditorPart implements ILgrEditor, ILgrRetourEditeur {
	
	static Logger logger = Logger.getLogger(EditorListeDocument.class.getName());
	
	public static final String ID = "fr.legrain.document.editor.EditorListeDocument";
	
	private boolean enabled = true;
	private PaCritereListeDocumentCochable composite = null;
...
//	}
	...
	public void createPartControl(Composite parent) {
		composite = new PaCritereListeDocumentCochable(parent,SWT.NONE);
		if(getController()==null) {
			setController(new PaCritereListeDocumentCochableController(composite,em));
		} else {
...
//	}
	...
	public PaCritereListeDocumentCochable getComposite() {
		return composite;
	}
