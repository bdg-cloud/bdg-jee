...
public class ParamAfficheListeExporte extends ParamAffiche {
	private String titreFormulaire = "Document exporté";
	private String titreGrille = "Liste des documents exportés";
	private String sousTitre = "Gestion documents exportés";
