...
public class ParamAfficheCreationDoc extends ParamAffiche {
	public static final String C_TITRE_FORMULAIRE = "Fiche document";
	public static final String C_TITRE_GRILLE = "Liste des documents";
	public static final String C_SOUS_TITRE = "Liste des documents";
	
	
	public ParamAfficheCreationDoc() {
