...
public class ParamAfficheDocumentEditable extends ParamAffiche {
	public static final String C_TITRE_FORMULAIRE = "Fiche courrier";
	public static final String C_TITRE_GRILLE = "Liste des courriers";
	public static final String C_SOUS_TITRE = "Liste des courriers";
	
	
	public ParamAfficheDocumentEditable() {
