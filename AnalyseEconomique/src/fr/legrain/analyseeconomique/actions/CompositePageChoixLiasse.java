...
*/
public class CompositePageChoixLiasse extends org.eclipse.swt.widgets.Composite {
	...
	*/
	public static void showGUI() {
		...
		CompositePageChoixLiasse inst = new CompositePageChoixLiasse(shell, SWT.NULL);
	...
	public CompositePageChoixLiasse(org.eclipse.swt.widgets.Composite parent, int style) {
		super(parent, style);
		initGUI();
	}
	...
	private void initGUI() {
		try {
			...
			this.setSize(428, 465);
			{
				...
				group1.setText("Choix de la liasse");
				{
				...
				}
				{
					...
					composite1LData.heightHint = 105;
