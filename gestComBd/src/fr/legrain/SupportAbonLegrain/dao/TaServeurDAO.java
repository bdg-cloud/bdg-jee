 ...
 */
public class TaServeurDAO /*extends AbstractApplicationDAO<TaServeur>*/{

	static Logger logger = Logger.getLogger(TaServeurDAO.class);
...
//	public TaServeurDAO(EntityManager em){
//		if(em!=null) {
//			setEm(em);
//		}
