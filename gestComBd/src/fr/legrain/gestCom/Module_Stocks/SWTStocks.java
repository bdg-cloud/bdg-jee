package fr.legrain.gestCom.Module_Stocks;
 ...
 */
public class SWTStocks extends ModelObject {
	...
	public SWTStocks(Integer ID_STOCK,
	...
	public void setSWTStocks(SWTStocks swtStocks) {
		this.idStock = swtStocks.idStock;
		this.idArticleStock = swtStocks.idArticleStock;
		this.codeArticle = swtStocks.codeArticle;
	...
	public static SWTStocks copy(SWTStocks swtStocks){
		SWTStocks swtStocksLoc = new SWTStocks();
		swtStocksLoc.setIdStock(swtStocks.idStock);
		swtStocksLoc.setIdArticleStock(swtStocks.idArticleStock);
		swtStocksLoc.setCodeArticle(swtStocks.codeArticle);
