 ...
 */
public class IHMEnteteApporteur extends ModelObject {
	...
	public IHMEnteteApporteur() {
	}

	public IHMEnteteApporteur(Integer ID_APPORTEUR, String CODE_APPORTEUR,
	...
	public void setIHMEnteteApporteur(IHMEnteteApporteur ihmEnteteApporteur){
		setIdDocument(ihmEnteteApporteur.idDocument);
...
//	}
	...
	public static IHMEnteteApporteur copy(IHMEnteteApporteur ihmEnteteApporteur){
		IHMEnteteApporteur ihmEnteteApporteurLoc = new IHMEnteteApporteur();
		ihmEnteteApporteurLoc.setIdDocument(ihmEnteteApporteur.idDocument);
...
//		if(!getCommentaire().equals(""))return false;
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof IHMEnteteApporteur))
			return false;
		IHMEnteteApporteur castOther = (IHMEnteteApporteur) other;
