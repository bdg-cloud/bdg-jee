 ...
 */
public class IHMAideApporteur extends IHMAideDocumentCommun {


	private BigDecimal regleDocument=new BigDecimal(0);

	public IHMAideApporteur() {
	}

	public IHMAideApporteur(Integer idDocument, String codeDocument,
	...
	public void setIHMEnteteApporteur(IHMAideApporteur ihmEnteteDocument){
	...
	public static IHMAideApporteur copy(IHMAideApporteur ihmEnteteDocument){
		IHMAideApporteur ihmEnteteDocumentLoc = new IHMAideApporteur();
