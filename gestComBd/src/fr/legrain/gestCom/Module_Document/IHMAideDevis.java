 ...
 */
public class IHMAideDevis extends IHMAideDocumentCommun {


	public IHMAideDevis() {
	}

	public IHMAideDevis(Integer idDocument, String codeDocument,
	...
	public void setIHMEnteteDEVIS(IHMAideDevis ihmEnteteDocument){
	...
	public static IHMAideDevis copy(IHMAideDevis ihmEnteteDocument){
		IHMAideDevis ihmEnteteDocumentLoc = new IHMAideDevis();
