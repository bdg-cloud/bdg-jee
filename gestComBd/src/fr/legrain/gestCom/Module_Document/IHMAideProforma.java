 ...
 */
public class IHMAideProforma extends IHMAideDocumentCommun {


	public IHMAideProforma() {
	}



	public IHMAideProforma(Integer idDocument, String codeDocument,
	...
	public void setIHMEnteteProforma(IHMAideProforma ihmEnteteDocument){
	...
	public static IHMAideProforma copy(IHMAideProforma ihmEnteteDocument){
		IHMAideProforma ihmEnteteDocumentLoc = new IHMAideProforma();
