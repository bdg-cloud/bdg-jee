 ...
 */
public class IHMEnteteAcompte extends ModelObject {
	...
	public IHMEnteteAcompte() {
	}

	public IHMEnteteAcompte(Integer ID_FACTURE, String CODE_FACTURE,
	...
	public void setIHMEnteteFacture(IHMEnteteAcompte ihmEnteteFacture){
	...
	public static IHMEnteteAcompte copy(IHMEnteteAcompte ihmEnteteFacture){
		IHMEnteteAcompte ihmEnteteFactureLoc = new IHMEnteteAcompte();
...
//		if(!getCommentaire().equals(""))return false;
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof IHMEnteteAcompte))
			return false;
		IHMEnteteAcompte castOther = (IHMEnteteAcompte) other;
