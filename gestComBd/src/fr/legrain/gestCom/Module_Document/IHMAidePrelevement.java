 ...
 */
public class IHMAidePrelevement extends IHMAideDocumentCommun {



	public IHMAidePrelevement() {
	}

	public IHMAidePrelevement(Integer idDocument, String codeDocument,
	...
	public void setIHMEnteteProforma(IHMAidePrelevement ihmEnteteDocument){
	...
	public static IHMAidePrelevement copy(IHMAidePrelevement ihmEnteteDocument){
		IHMAidePrelevement ihmEnteteDocumentLoc = new IHMAidePrelevement();
