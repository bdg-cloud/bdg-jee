 ...
 */
public class IHMAideBoncde extends IHMAideDocumentCommun {


	public IHMAideBoncde() {
	}

	public IHMAideBoncde(Integer idDocument, String codeDocument,
	...
	public void setIHMEnteteBoncde(IHMAideBoncde ihmEnteteDocument){
	...
	public static IHMAideBoncde copy(IHMAideBoncde ihmEnteteDocument){
		IHMAideBoncde ihmEnteteDocumentLoc = new IHMAideBoncde();
