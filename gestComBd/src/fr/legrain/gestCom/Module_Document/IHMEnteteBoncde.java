 ...
 */
public class IHMEnteteBoncde extends ModelObject {
	...
	public IHMEnteteBoncde() {
	}

	public IHMEnteteBoncde(Integer ID_Boncde, String CODE_Boncde,
	...
	public void setIHMEnteteBoncde(IHMEnteteBoncde ihmEnteteBoncde){
		setIdDocument(ihmEnteteBoncde.idDocument);
		...
		setExport(ihmEnteteBoncde.export);
		setCommentaire(ihmEnteteBoncde.commentaire);
	}
	
	
	public static IHMEnteteBoncde copy(IHMEnteteBoncde ihmEnteteBoncde){
		IHMEnteteBoncde ihmEnteteBoncdeLoc = new IHMEnteteBoncde();
		ihmEnteteBoncdeLoc.setIdDocument(ihmEnteteBoncde.idDocument);
		...
		ihmEnteteBoncdeLoc.setExport(ihmEnteteBoncde.export);
...
//		//if(!LibChaine.emptyNumeric(getREGLE_Boncde()))return false;
//		if(!LibChaine.emptyNumeric(getREM_HT_Boncde()))return false;
//		if(!LibChaine.emptyNumeric(getTX_REM_HT_Boncde()))return false;
//		if(!LibChaine.emptyNumeric(getREM_TTC_Boncde()))return false;
//		if(!LibChaine.emptyNumeric(getTX_REM_TTC_Boncde()))return false;
//		if(!getNB_E_Boncde().equals(0))return false;
...
//	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		IHMEnteteBoncde other = (IHMEnteteBoncde) obj;
		if (codeCompta == null) {
