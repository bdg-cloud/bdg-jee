 ...
 */
public class IHMLProforma extends ModelObject implements PropertyChangeListener{
	...
	public IHMLProforma(Integer ID_L_Proforma, Integer ID_Proforma,
	...
	public void setIHMLProforma(IHMLProforma ihmLProforma) {
	...
	static public IHMLProforma copy(IHMLProforma ihmLProforma) {
		IHMLProforma swtLProformaLoc = new IHMLProforma();
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof IHMLProforma))
			return false;
		IHMLProforma castOther = (IHMLProforma) other;
