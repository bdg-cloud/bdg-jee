 ...
 */
public class IHMLRelance extends ModelObject{

	private Integer idLRelance;
	...
	public void setIHMLRelance(IHMLRelance ihmLRelance) {
		setIdLRelance(ihmLRelance.idLRelance);
	...
	static public IHMLRelance copy(IHMLRelance ihmLRelance) {
		IHMLRelance swtLRelanceLoc = new IHMLRelance();
		swtLRelanceLoc.setIdLRelance(ihmLRelance.idLRelance);
	...
	public void setIdLRelance(Integer idLRelance) {
		firePropertyChange("idLRelance", this.idLRelance, this.idLRelance = idLRelance);
	}
	...
	public int hashCode() {
		...
		result = prime * result
				+ ((idLRelance == null) ? 0 : idLRelance.hashCode());
		result = prime * result
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		IHMLRelance other = (IHMLRelance) obj;
		if (accepte == null) {
		...
		if (etat == null) {
			...
			return false;
		if (idLRelance == null) {
			if (other.idLRelance != null)
				return false;
		} else if (!idLRelance.equals(other.idLRelance))
			return false;
		if (idRelance == null) {
