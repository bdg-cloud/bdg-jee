 ...
 */
public class IHMAideAvisEcheance extends IHMAideDocumentCommun {


	public IHMAideAvisEcheance() {
	}

	public IHMAideAvisEcheance(Integer idDocument, String codeDocument,
	...
	public void setIHMEnteteAvisEcheance(IHMAideAvisEcheance ihmEnteteDocument){
	...
	public static IHMAideAvisEcheance copy(IHMAideAvisEcheance ihmEnteteDocument){
		IHMAideAvisEcheance ihmEnteteDocumentLoc = new IHMAideAvisEcheance();
