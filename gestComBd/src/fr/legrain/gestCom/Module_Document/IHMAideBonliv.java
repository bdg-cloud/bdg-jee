 ...
 */
public class IHMAideBonliv extends IHMAideDocumentCommun {

	

	public IHMAideBonliv() {
	}

	public IHMAideBonliv(Integer idDocument, String codeDocument,
	...
	public void setIHMEnteteBONLIV(IHMAideBonliv ihmEnteteDocument){
	...
	public static IHMAideBonliv copy(IHMAideBonliv ihmEnteteDocument){
		IHMAideBonliv ihmEnteteDocumentLoc = new IHMAideBonliv();
