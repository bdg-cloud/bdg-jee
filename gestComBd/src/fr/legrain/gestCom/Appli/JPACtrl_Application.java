...
//import fr.legrain.lib.data.JPACtrlChamp;
...
// * @version 1.0
// */
//public class JPACtrl_Application extends JPACtrlChamp{
//
...
//					throw new ExceptLgr("TTestSpecifiqueCtrl : Code de controle inconnu :["+String.valueOf(codeCtrl) + "]");
////				break;
//				}
//			}
//
...
//			logger.error("TTestSpecifiqueCtrl : Champ ou Table inconnu : "+key);
//			throw new ExceptLgr("TTestSpecifiqueCtrl : Champ ou Table inconnu : ["+message.getNomTable() + "].["+message.getNomChamp() +"]");
//		}
//		//} catch(Exception e){
//		//  e.printStackTrace();
//		//abort;
