...
public class ModelSara /*extends AbstractConcurrentModel*/ implements IModelGeneral, ILgrListModel<TaLicenceSara>  {
	static Logger logger = Logger.getLogger(ModelSara.class.getName());
	LinkedList<SWTSupportAbonLogiciel> listeObjet = new LinkedList<SWTSupportAbonLogiciel>();
	private Collection<TaLicenceSara> listeEntity = null;
	private String JPQLQuery = null;
	private Class<SWTSupportAbonLogiciel> typeObjet;
	private LgrDozerMapper<TaLicenceSara,SWTSupportAbonLogiciel> mapperModelToUI = null;
	private IlgrMapper<SWTSupportAbonLogiciel, TaLicenceSara> lgrMapper = null;
//	private AbstractLgrDAO<TaLicenceSara> dao;
...
//		initCPThread(viewer,v,bar, barContainer,lgrviewer);
	...
	@Override
	public void addToModel(TableViewer viewer, TaLicenceSara t) {
		// TODO Auto-generated method stub
		
	}

	@Override
	public void refreshModel(TableViewer viewer, TaLicenceSara t) {
		// TODO Auto-generated method stub
		
	}

	@Override
	public void removeFromModel(TableViewer viewer, TaLicenceSara t) {
		// TODO Auto-generated method stub
...
//	public SWTSupportAbonLogiciel mapping(TaLicenceSara licence, SWTSupportAbonLogiciel swtEpicea) {
//		if(daoAbonnement==null)
//			daoAbonnement= new TaAbonnementDAO();
//		if(swtEpicea==null)
//			swtEpicea = new SWTSupportAbonLogiciel();
//		if(licence==null)licence=new TaLicenceSara();
...
//		if(licence.getTaRAbonnements().size()>0){
...
//	}
//	
//	public TaLicenceSara mapping( SWTSupportAbonLogiciel swtEpicea,TaLicenceSara licence) {
//		if(licence==null)
//			licence = new TaLicenceSara();
...
//	}
//	
//	public void addToModel(final TableViewer viewer, TaLicenceSara licence) {
...
//	}
//	
//	public void refreshModel(final TableViewer viewer, TaLicenceSara licence) {
...
//	}
//	
//	public void removeFromModel(final TableViewer viewer, TaLicenceSara licence) {
//		SWTSupportAbonLogiciel swtEpicea = recherche(Const.C_ID_SUPPORT_ABON, licence.getIdSupportAbon());
...
//		Thread t = new Thread() {
//			public void run() {
//				TaLicenceSaraDAO dao =new TaLicenceSaraDAO();
//				Collection<TaLicenceSara> l = null;
...
//				}
//				if(l != null) {
//					final Collection<TaLicenceSara> lfinal = l;
...
//					
//					
//					for(TaLicenceSara ti : l){
//						final TaLicenceSara licence = ti;
...
//		TaLicenceSaraDAO dao =new TaLicenceSaraDAO(em);
//		SWTSupportAbonLogiciel swtEpicea = null;
//		Date dateDeb = new Date();
//		Collection<TaLicenceSara> l = new ArrayList<TaLicenceSara>();
//		if(listeEntity==null) {
//			listeEntity = new LinkedList<TaLicenceSara>();
//		}
//		TaLicenceSara t = dao.findById(id);
//		if(t!=null) {
//			listeEntity.add(t);
//
//			TaLicenceSara tiers = t;
//			swtEpicea = new SWTSupportAbonLogiciel();
...
//	}
//
//	public Collection<TaLicenceSara> getListeEntity() {
//		return listeEntity;
//	}
//
//	public void setListeEntity(Collection<TaLicenceSara> listeEntity) {
...
//		if(mapperModelToUI==null)mapperModelToUI=new LgrDozerMapper<TaLicenceSara, SWTSupportAbonLogiciel>();
//		mapperModelToUI.getMapper().setCustomFieldMapper(custom);
//	}
//
//	public LgrDozerMapper<TaLicenceSara, SWTSupportAbonLogiciel> getMapperModelToUI() {
//		return mapperModelToUI;
//	}
//
//	public void setMapperModelToUI(LgrDozerMapper<TaLicenceSara, SWTSupportAbonLogiciel> mapperModelToUI) {
