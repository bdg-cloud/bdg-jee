...
public class ModelEpicea /*extends AbstractConcurrentModelimplements IModelGeneral, ILgrListModel<TaLicenceEpicea> */  {
	static Logger logger = Logger.getLogger(ModelEpicea.class.getName());
	...
	private Collection<TaLicenceEpicea> listeEntity = null;
	private String JPQLQuery = null;
	
	public SWTSupportAbonLogiciel mapping(TaLicenceEpicea licence, SWTSupportAbonLogiciel swtEpicea) {
//		if(daoAbonnement==null)
			daoAbonnement= new TaAbonnementDAO();
		if(swtEpicea==null)
			swtEpicea = new SWTSupportAbonLogiciel();
		if(licence==null)licence=new TaLicenceEpicea();
...
public TaLicenceEpicea mapping( SWTSupportAbonLogiciel swtEpicea,TaLicenceEpicea licence) {
		if(licence==null)
			licence = new TaLicenceEpicea();
	...
	public TaLicenceEpicea initialisation( SWTSupportAbonLogiciel swtEpicea,TaLicenceEpicea licence) {
		if(licence==null)
			licence = new TaLicenceEpicea();
		TaTiersDAO daoTiers=new TaTiersDAO();
		TaFamilleTiersDAO daoFamille = new TaFamilleTiersDAO();
		...
		try {
			if(tiers!=null)
				commercial=tiers.getTaCommercial();
			if(commercial!=null)
			swtEpicea.setCommercial(commercial.getCodeTiers());
		} catch (Exception e) {}
		try {
			
			if(tiers!=null)
				for (TaFamilleTiers famille : tiers.getTaFamilleTierses()) {
					groupe=famille;
					if(famille!=null)
						swtEpicea.setCodeFamille(famille.getCodeFamille());
					break;
				}				
		} catch (Exception e) {}
		try {
	...
	public Collection<TaLicenceEpicea> getListeEntity() {
		return listeEntity;
	}
	public void setListeEntity(Collection<TaLicenceEpicea> listeEntity) {
	...
	public LinkedList<SWTSupportAbonLogiciel> remplirListe(EntityManager em) {
		TaLicenceEpiceaDAO dao =new TaLicenceEpiceaDAO();
		SWTSupportAbonLogiciel swtEpicea = null;
		Date dateDeb = new Date();
		Collection<TaLicenceEpicea> l = null;
...
//	private LgrDozerMapper<TaLicenceEpicea,SWTSupportAbonLogiciel> mapperModelToUI = null;
//	private IlgrMapper<SWTSupportAbonLogiciel, TaLicenceEpicea> lgrMapper = null;
//	private AbstractLgrDAO<TaLicenceEpicea> dao;
//	private TaAbonnementDAO daoAbonnement=null;
//
...
//	public SWTSupportAbonLogiciel mapping(TaLicenceEpicea licence, SWTSupportAbonLogiciel swtEpicea) {
////		if(daoAbonnement==null)
//			daoAbonnement= new TaAbonnementDAO(entityManager);
//		if(swtEpicea==null)
//			swtEpicea = new SWTSupportAbonLogiciel();
//		if(licence==null)licence=new TaLicenceEpicea();
//		if(licence.getTaArticle()!=null){
...
//	}
//	
//	public void addToModel(final TableViewer viewer, TaLicenceEpicea licence) {
...
//	}
//	
//	public void refreshModel(final TableViewer viewer, TaLicenceEpicea licence) {
...
//	}
//	
//	public void removeFromModel(final TableViewer viewer, TaLicenceEpicea licence) {
//		SWTSupportAbonLogiciel swtEpicea = recherche(Const.C_ID_SUPPORT_ABON, licence.getIdSupportAbon());
...
//				}
//				if(l != null) {
//					final Collection<TaLicenceEpicea> lfinal = l;
...
//					
//					
//					for(TaLicenceEpicea ti : l){
//						final TaLicenceEpicea licence = ti;
...
//		TaLicenceEpiceaDAO dao =new TaLicenceEpiceaDAO(em);
//		SWTSupportAbonLogiciel swtEpicea = null;
//		Date dateDeb = new Date();
//		Collection<TaLicenceEpicea> l = new ArrayList<TaLicenceEpicea>();
//		if(listeEntity==null) {
//			listeEntity = new LinkedList<TaLicenceEpicea>();
//		}
//		TaLicenceEpicea t = dao.findById(id);
//		if(t!=null) {
//			listeEntity.add(t);
//
//			TaLicenceEpicea tiers = t;
//			swtEpicea = new SWTSupportAbonLogiciel();
...
//		if(mapperModelToUI==null)mapperModelToUI=new LgrDozerMapper<TaLicenceEpicea, SWTSupportAbonLogiciel>();
//		mapperModelToUI.getMapper().setCustomFieldMapper(custom);
//	}
//
//	public LgrDozerMapper<TaLicenceEpicea, SWTSupportAbonLogiciel> getMapperModelToUI() {
//		return mapperModelToUI;
//	}
//
//	public void setMapperModelToUI(LgrDozerMapper<TaLicenceEpicea, SWTSupportAbonLogiciel> mapperModelToUI) {
