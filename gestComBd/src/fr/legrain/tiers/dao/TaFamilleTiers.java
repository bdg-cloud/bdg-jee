...
public class TaFamilleTiers implements java.io.Serializable {
	...
	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "GEN_FAMILLE_TIERS")
	...
	@LgrHibernateValidated(champEntite = "", champBd = "CODE_FAMILLE",table = "TA_FAMILLE_TIERS",clazz = TaFamilleTiers.class)
	...
	@LgrHibernateValidated(champEntite = "", champBd = "LIBC_FAMILLE",table = "TA_FAMILLE_TIERS",clazz = TaFamilleTiers.class)
	...
	@LgrHibernateValidated(champEntite = "", champBd = "LIBL_FAMILLE",table = "TA_FAMILLE_TIERS",clazz = TaFamilleTiers.class)
