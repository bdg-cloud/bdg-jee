...
import fr.legrain.articles.importation.controllers.FormPageControllerPrincipal;
...
public class FormEditorImport extends FormEditor implements ILgrEditor, ILgrRetourEditeur, /*IEditorArticlesExtension,*/IPartListener{

	static Logger logger = Logger.getLogger(FormEditorImport.class.getName());
	
	public static final String ID = "fr.legrain.articles.importation.editors.FormEditorImport";
