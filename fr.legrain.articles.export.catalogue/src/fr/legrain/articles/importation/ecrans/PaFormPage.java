...
package fr.legrain.articles.importation.ecrans;
...
import fr.legrain.articles.export.catalogue.prestashop.Activator;
...
public class PaFormPage extends org.eclipse.ui.forms.editor.FormPage {
	...
	public static String title = "Importation des commandes";
	// -- Chemins des icônes --
...
//	};
	...
	protected void createSectionParam(FormToolkit toolkit, final ScrolledForm form) {
		...
		GridData gd_sctnParamtresDuTableau = new GridData(SWT.FILL, SWT.FILL, true, false, 6, 1);
