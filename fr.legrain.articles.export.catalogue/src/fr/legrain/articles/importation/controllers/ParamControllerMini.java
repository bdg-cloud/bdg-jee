...
import fr.legrain.articles.importation.ecrans.PaCompositeSectionParam;
import fr.legrain.articles.importation.ecrans.PaFormPage;
import fr.legrain.articles.importation.preferences.PreferenceConstants;
...
//			mapEtatCodeLibelle.put(etatEnCoursLibelle, null);
...
//		if(v.equals(etatEnCoursLibelle)) {
...
//				, 0, 0);
		...
		if(taSynchroBoutique!=null && taSynchroBoutique.getDerniereSynchro()!=null) {
			vue.getCompositeSectionParam().getCdateDeb().setEnabled(true);
			vue.getCompositeSectionParam().getCdateFin().setEnabled(true);
			LibDateTime.setDate(vue.getCompositeSectionParam().getCdateDeb(),taSynchroBoutique.getDerniereSynchro());
		} else {
			vue.getCompositeSectionParam().getCdateDeb().setEnabled(false);
			vue.getCompositeSectionParam().getCdateFin().setEnabled(true);
		}
