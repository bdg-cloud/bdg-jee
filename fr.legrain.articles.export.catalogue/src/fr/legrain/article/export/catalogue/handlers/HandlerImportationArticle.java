...
public class HandlerImportationArticle extends LgrAbstractHandler {
	
	static Logger logger = Logger.getLogger(HandlerImportationArticle.class.getName());
	...
	public Object execute(ExecutionEvent event) throws ExecutionException {
		try {
			...
			ImportationArticle imp = new ImportationArticle();
			...
			if(chemin!=null) {
				...
				imp.imporArticleProgress(chemin);
