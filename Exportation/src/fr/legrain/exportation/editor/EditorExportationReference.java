...
public class EditorExportationReference extends JPALgrEditorPart implements ILgrEditor, ILgrRetourEditeur {
	
	static Logger logger = Logger.getLogger(EditorExportationReference.class.getName());
	
	public static final String ID = "fr.legrain.exportation.editor.EditorExportationReference";
	
	private boolean enabled = true;
	private PaExportationFactureReference composite = null;
	private EntityManager em = null;

	public EditorExportationReference() {
		super();
	}
	
	public EditorExportationReference(EditorPart parent) {
		super(parent);
	}
	
	public EditorExportationReference(EditorPart parent,EntityManager em) {
		super(parent);
		this.em=em;
	}
...
//	}
	...
	public void createPartControl(Composite parent) {
		composite = new PaExportationFactureReference(parent,SWT.NONE);
		if(getController()==null) {
			setController(new PaExportationFactureControllerReference(composite,em));
		} else {
...
//	}
	...
	public PaExportationFactureReference getComposite() {
		return composite;
	}
