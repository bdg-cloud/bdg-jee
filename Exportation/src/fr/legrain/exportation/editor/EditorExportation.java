...
public class EditorExportation extends JPALgrEditorPart implements ILgrEditor, ILgrRetourEditeur {
	
	static Logger logger = Logger.getLogger(EditorExportation.class.getName());
	
	public static final String ID = "fr.legrain.exportation.editor.EditorExportation";
	
	private boolean enabled = true;
	private PaExportationFactureTous composite = null;
	private EntityManager em = null;

	public EditorExportation() {
		super();
	}
	
	public EditorExportation(EditorPart parent) {
		super(parent);
	}
	
	public EditorExportation(EditorPart parent,EntityManager em) {
		super(parent);
		this.em=em;
	}
...
//	}
	...
	public void createPartControl(Composite parent) {
		composite = new PaExportationFactureTous(parent,SWT.NONE);
		if(getController()==null) {
			setController(new PaExportationFactureControllerTous(composite,em));
		} else {
...
//	}
	...
	public PaExportationFactureTous getComposite() {
		return composite;
	}
