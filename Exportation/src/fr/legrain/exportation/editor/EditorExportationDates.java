...
public class EditorExportationDates extends JPALgrEditorPart implements ILgrEditor, ILgrRetourEditeur {
	
	static Logger logger = Logger.getLogger(EditorExportationDates.class.getName());
	
	public static final String ID = "fr.legrain.exportation.editor.EditorExportationDates";
	
	private boolean enabled = true;
	private PaExportationFactureDates composite = null;
	private EntityManager em = null;

	public EditorExportationDates() {
		super();
	}
	
	public EditorExportationDates(EditorPart parent) {
		super(parent);
	}
	
	public EditorExportationDates(EditorPart parent,EntityManager em) {
		super(parent);
		this.em=em;
	}
...
//	}
	...
	public void createPartControl(Composite parent) {
		composite = new PaExportationFactureDates(parent,SWT.NONE);
		if(getController()==null) {
			setController(new PaExportationFactureControllerDates(composite,em));
		} else {
...
//	}
	...
	public PaExportationFactureDates getComposite() {
		return composite;
	}
