...
public class RRoleUtilisateurDAO implements IRRoleUtilisateurDAO {
	...
	private static final Logger logger = Logger.getLogger(RRoleUtilisateurDAO.class);
...
//	}
	...
	public void ctrlSaisieSpecifique(TaRRoleUtilisateur entity,String field) throws Exception {	
		try {
