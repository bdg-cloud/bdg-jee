...
public class ClientLegrainDAO implements IClientLegrainDAO {
	...
	private static final Logger logger = Logger.getLogger(ClientLegrainDAO.class);
...
//	}
	...
	public void ctrlSaisieSpecifique(TaClientLegrain entity,String field) throws Exception {	
		try {
