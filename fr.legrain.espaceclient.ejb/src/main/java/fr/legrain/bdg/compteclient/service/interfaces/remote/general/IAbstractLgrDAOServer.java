...
public interface IAbstractLgrDAOServer<Entity> {
	...
	public abstract void enregistrerPersist(Entity transientInstance, String validationContext) throws Exception;

	public abstract Entity enregistrerMerge(Entity persistentInstance, String validationContext) throws Exception;
