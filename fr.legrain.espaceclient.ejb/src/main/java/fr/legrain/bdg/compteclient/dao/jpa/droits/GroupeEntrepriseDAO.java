...
public class GroupeEntrepriseDAO implements IGroupeEntrepriseDAO {
	...
	private static final Logger logger = Logger.getLogger(GroupeEntrepriseDAO.class);
...
//	}
	...
	public void ctrlSaisieSpecifique(TaGroupeEntreprise entity,String field) throws Exception {	
		try {
