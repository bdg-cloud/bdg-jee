 ...
 *
 */
public class RepartitionControllerLivraisons extends RepartitionControllerMini{
	static Logger logger = Logger.getLogger(RepartitionControllerLivraisons.class.getName());	
	...
	public RepartitionControllerLivraisons(FormPageControllerPrincipal masterContoller,
	...
	public void initialiseModelIHM() {
		...
		if (Outils.isInternetReachable()){	// Connexion internet active
			...
			List<Object> listeRegions = taDepartementsDAO.chiffreDocParRegions("TaBonliv",
			...
			mapChart.setLabel("Montant Bons Livraison");
			...
			" carte des bons de livraison requiert une connexion internet active.");
		}
