...
@Remote
public interface IExportationServiceRemote {
	...
	boolean centralisation,boolean memeFichier,String typeClient) throws Exception ;
	...
	public ExportationEpicea exportJPA(List<TaFacture> idFactureAExporter,List<TaAvoir> idAvoirAExporter,List<TaApporteur> idApporteurAExporter,List<TaAcompte> idAcompteAExporter,
			...
			int reExportFacture,int reExportAvoir,int reExportAcpporteur,int reExportAcompte,int reExportReglement,
			int reExportRemise,boolean gererPointages,boolean centralisation,boolean memeFichier,String typeClient) throws Exception;

	public List<Date> selectionListeDateExportation(Date dateDebut, Date dateFin);
