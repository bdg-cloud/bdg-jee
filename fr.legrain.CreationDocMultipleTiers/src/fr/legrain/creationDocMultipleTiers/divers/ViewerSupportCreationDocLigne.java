...
public class ViewerSupportCreationDocLigne extends LgrViewerSupport {
...
//			}
		...
		public Font getFont(Object element) {
			if(element instanceof SWTCreationDocLigne){
				if(((SWTCreationDocLigne)element).getCodeTiers()!=null)
					return f;
				else
					return null;
			}
...
//			if(columnIndex==0) {
//	    		if(element instanceof SWTCreationDocLigne){
//					if(((SWTCreationDocLigne)element).getCodeTypeDoc()==null)
//						if(((SWTCreationDocLigne)element).getCheminModelDocumentDoc()!=null
//								&& !new File(((SWTCreationDocLigne)element).getCheminModelDocumentDoc()).exists())
