...
*/
public class PaSelectionLigneRemise extends fr.legrain.lib.gui.DefaultFrameFormulaireSWTSimpleBtnCote {
...
//	final private boolean decore = false;
	...
	*/
	...
	public PaSelectionLigneRemise(Composite parent, int style,
			int ordreComposite, int tableStyle) {
		super(parent, style, ordreComposite, tableStyle);
		initGUI();
	}

	public PaSelectionLigneRemise(org.eclipse.swt.widgets.Composite parent, int style) {
		super(parent, style);
		initGUI();
	}
