 ...
 */
public class PaEditorAvisEcheance extends org.eclipse.swt.widgets.Composite {
...
//	}
	...
	public static void showGUI() {
		...
		PaEditorAvisEcheance inst = new PaEditorAvisEcheance(shell, SWT.NULL);
	...
	public PaEditorAvisEcheance(org.eclipse.swt.widgets.Composite parent, int style) {
		super(parent, style);
		initGUI();
	}
	...
	private void initGUI() {
		try {
			...
			this.setSize(1059, 715);
			{
				...
				paEntete.setText("Entête de l'avis d'échéance");
				{
					laCODE_DOCUMENT = new Label(paEntete, SWT.NONE);
					laCODE_DOCUMENT.setText("Code avis d'échéance");
				}
				{
					...
					if(!decore) {
						...
						tfCODE_DOCUMENT.setText("CODE_AVIS_ECHEANCE");
					} else {
				...
				}
				{
					...
					laDATE_DOCUMENT.setText("Date avis d'échéance");
				}
				{
					GridData dateTimeDATE_AVIS_ECHEANCELData = new GridData();
					dateTimeDATE_AVIS_ECHEANCELData.widthHint = 90;
					dateTimeDATE_AVIS_ECHEANCELData.verticalAlignment = GridData.FILL;

				if(!decore) {
					dateTimeDATE_DOCUMENT = new DateTime(paEntete, SWT.BORDER | SWT.DROP_DOWN);
					dateTimeDATE_DOCUMENT.setLayoutData(dateTimeDATE_AVIS_ECHEANCELData);
					} else {
					...
					fieldDATE_DOCUMENT.getLayoutControl().setLayoutData(dateTimeDATE_AVIS_ECHEANCELData);
					}
...
//					dateTimeDATE_DOCUMENT.setPattern("dd/MM/yyyy");	
				...
				}
				{
					...
					if(!decore) {
						...
						tfLIBELLE_DOCUMENT.setText("LIBELLE_AVIS_ECHEANCE");
					} else {
				...
				{
					GridData dateTimeDATE_ECH_AVIS_ECHEANCELData = new GridData();
					dateTimeDATE_ECH_AVIS_ECHEANCELData.widthHint = 90;
					dateTimeDATE_ECH_AVIS_ECHEANCELData.verticalAlignment = GridData.FILL;

				if(!decore) {
					dateTimeDATE_ECH_DOCUMENT = new DateTime(paEntete, SWT.BORDER | SWT.DROP_DOWN);
					dateTimeDATE_ECH_DOCUMENT.setLayoutData(dateTimeDATE_ECH_AVIS_ECHEANCELData);
					} else {
					...
					fieldDATE_ECH_DOCUMENT.getLayoutControl().setLayoutData(dateTimeDATE_ECH_AVIS_ECHEANCELData);
					}
...
//					dateTimeDATE_ECH_DOCUMENT.setPattern("dd/MM/yyyy");	
				...
				{
					GridData dateTimeDATE_LIV_AVIS_ECHEANCELData = new GridData();
					dateTimeDATE_LIV_AVIS_ECHEANCELData.widthHint = 90;
					dateTimeDATE_LIV_AVIS_ECHEANCELData.verticalAlignment = GridData.FILL;

				if(!decore) {
					dateTimeDATE_LIV_DOCUMENT = new DateTime(paEntete, SWT.BORDER | SWT.DROP_DOWN);
					dateTimeDATE_LIV_DOCUMENT.setLayoutData(dateTimeDATE_LIV_AVIS_ECHEANCELData);
					} else {
					...
					fieldDATE_LIV_DOCUMENT.getLayoutControl().setLayoutData(dateTimeDATE_LIV_AVIS_ECHEANCELData);
					}
