 ...
 */
public class PaSaisieLigneAvisEcheance extends org.eclipse.swt.widgets.Composite {
	...
	public static void showGUI() {
		...
		PaSaisieLigneAvisEcheance inst = new PaSaisieLigneAvisEcheance(shell, SWT.NULL);
	...
	public PaSaisieLigneAvisEcheance(org.eclipse.swt.widgets.Composite parent, int style) {
		super(parent, style);
		initGUI();
	}
