package fr.legrain.avisecheance.ecrans;
 ...
 */
public class PaTotauxAvisEcheance extends org.eclipse.swt.widgets.Composite {
	private Table tableTVA;
	private Composite paTotaux;
	private Label laTX_REM_HT_PROFORMA;
	...
	private Text tfTX_REM_TTC_PROFORMA;
	private Label laTX_REM_TTC_PROFORMA;
	private Text tfTX_REM_HT_PROFORMA;
	...
	private DecoratedField fieldTX_REM_TTC_PROFORMA;
	private DecoratedField fieldMT_HT_CALC;
	private DecoratedField fieldTX_REM_HT_PROFORMA;
	...
	public static void showGUI() {
		...
		PaTotauxAvisEcheance inst = new PaTotauxAvisEcheance(shell, SWT.NULL);
	...
	public PaTotauxAvisEcheance(org.eclipse.swt.widgets.Composite parent, int style) {
		super(parent, style);
		initGUI();
	}
	...
	private void initGUI() {
		try {
			...
			}
			{
				...
				{
					laTX_REM_HT_PROFORMA = new Label(paTotaux, SWT.NONE);
					laTX_REM_HT_PROFORMA.setText("Remise globale %");
				}
				{
					GridData tfTX_REM_HT_FACTURELData = new GridData();
					tfTX_REM_HT_FACTURELData.widthHint = 127;
					if(!decore) {
						tfTX_REM_HT_PROFORMA = new Text(paTotaux, SWT.BORDER);
						tfTX_REM_HT_PROFORMA.setLayoutData(tfTX_REM_HT_FACTURELData);
						tfTX_REM_HT_PROFORMA.setText("TX_REM_HT_PROFORMA");
					} else {
						fieldTX_REM_HT_PROFORMA = new DecoratedField(paTotaux, SWT.BORDER, new TextControlCreator());
						tfTX_REM_HT_PROFORMA = (Text)fieldTX_REM_HT_PROFORMA.getControl();
						fieldTX_REM_HT_PROFORMA.getLayoutControl().setLayoutData(tfTX_REM_HT_FACTURELData);
					}
				}
				{
					laTX_REM_TTC_PROFORMA = new Label(paTotaux, SWT.NONE);
					laTX_REM_TTC_PROFORMA.setText("Escompte accordé %");
				}
				{
					...
					if(!decore) {
						tfTX_REM_TTC_PROFORMA = new Text(paTotaux, SWT.BORDER);
						tfTX_REM_TTC_PROFORMA.setLayoutData(tfTX_REM_TTC_FACTURELData);
						tfTX_REM_TTC_PROFORMA.setText("TX_REM_TTC_PROFORMA");
					} else {
						fieldTX_REM_TTC_PROFORMA = new DecoratedField(paTotaux, SWT.BORDER, new TextControlCreator());
						tfTX_REM_TTC_PROFORMA = (Text)fieldTX_REM_TTC_PROFORMA.getControl();
						fieldTX_REM_TTC_PROFORMA.getLayoutControl().setLayoutData(tfTX_REM_TTC_FACTURELData);
					}
				}
				{
...
//	}
	...
	public Label getLaTX_REM_HT_PROFORMA() {
		return laTX_REM_HT_PROFORMA;
	}
...
//	}
	...
	public Text getTfTX_REM_TTC_PROFORMA() {
		return tfTX_REM_TTC_PROFORMA;
	}

	public Label getLaTX_REM_TTC_PROFORMA() {
		return laTX_REM_TTC_PROFORMA;
	}

	public Text getTfTX_REM_HT_PROFORMA() {
		return tfTX_REM_HT_PROFORMA;
	}
	...
	public DecoratedField getFieldTX_REM_TTC_PROFORMA() {
		return fieldTX_REM_TTC_PROFORMA;
	}
	...
	public DecoratedField getFieldTX_REM_HT_PROFORMA() {
		return fieldTX_REM_HT_PROFORMA;
	}
