...
import fr.legrain.document.etat.proforma.preferences.PreferenceConstants;
...
public class ParamControllerMini extends AbstractControllerMini implements RetourEcranListener {
	...
	private FormPageControllerProforma masterController = null;
	...
	public ParamControllerMini(FormPageControllerProforma masterContoller, PaFormPage vue, EntityManager em) {
		this.vue = vue;
