package fr.legrain.document.etat.proforma.editors;
...
import fr.legrain.document.etat.proforma.controllers.FormPageControllerProforma;
...
public class FormEditorEtat extends FormEditor implements ILgrEditor, ILgrRetourEditeur, /*IEditorArticlesExtension,*/IPartListener{
	...
	// FormPage principal
	private PaFormPageProforma defaultFormPage = null;
	private Map<PaFormPageProforma,FormPageControllerProforma> listeController = new HashMap<PaFormPageProforma,FormPageControllerProforma>();
