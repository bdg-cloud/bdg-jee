...
public class PublipostageOOoWin32 extends AbstractPublipostageOOo {

	static Logger logger = Logger.getLogger(PublipostageOOoWin32.class.getName());
	
	
	
	public PublipostageOOoWin32(List<ParamPublipostage> listeParamPublipostages) {
	...
	public void demarrerServeur() {
		...
		try {
			...
			logger.error("demarrerServeur() has problem for win32! ", e);
		}
	}
