 ...
 *
 */
public class TabControllerArticlesAcompte extends TabControllerArticles {

	public TabControllerArticlesAcompte(
	...
	public void initialiseModelIHM(int nbResult) {
		...
		super.listeArticles = taAcompteDAO.findMeilleursArticlesParCA(
