 ...
 *
 */
public class RepartitionControllerProforma extends RepartitionControllerMini{
	static Logger logger = Logger.getLogger(RepartitionControllerProforma.class.getName());	
	...
	public RepartitionControllerProforma(FormPageControllerPrincipal masterContoller,
	...
	public void initialiseModelIHM() {
		...
		if (Outils.isInternetReachable()){	// Connexion internet active
			...
			List<Object> listeRegions = taDepartementsDAO.chiffreDocParRegions("TaProforma",
			...
			mapChart.setLabel("Montant des Proforma");
			...
			" carte des proformas requiert une connexion internet active.");
		}
