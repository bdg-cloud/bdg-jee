 ...
 *
 */
public class ArticlesLabelProvider extends LgrViewerSupport {
	...
	static class MyLabelProvider extends ObservableMapLabelProvider implements ITableLabelProvider, ITableColorProvider {
        ...
        public String getColumnText(Object element, int columnIndex) {
    		...
    		} else if (columnIndex == 4 && result != null || columnIndex == 2 &&  result!=null) {
    			return formatterEUR.format(result);
    		}else if (columnIndex==2 && result !=null) {
     			return formatterBD.format(result);
     		}else {
